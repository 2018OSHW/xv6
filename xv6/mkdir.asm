...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     442:	0f b6 80 20 2c 00 00 	movzbl 0x2c20(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     57e:	75 25                	jne    5a5 <printf+0xff>
          s = "(null)";
     580:	c7 45 f4 f3 24 00 00 	movl   $0x24f3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     646:	a1 80 68 00 00       	mov    0x6880,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     711:	a3 80 68 00 00       	mov    %eax,0x6880
}
     716:	90                   	nop
     717:	c9                   	leave  
     718:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     772:	a1 80 68 00 00       	mov    0x6880,%eax
}
     777:	c9                   	leave  
     778:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     78e:	a1 80 68 00 00       	mov    0x6880,%eax
     793:	89 45 f0             	mov    %eax,-0x10(%ebp)
     796:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     79a:	75 23                	jne    7bf <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     79c:	c7 45 f0 78 68 00 00 	movl   $0x6878,-0x10(%ebp)
     7a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
     7a6:	a3 80 68 00 00       	mov    %eax,0x6880
     7ab:	a1 80 68 00 00       	mov    0x6880,%eax
     7b0:	a3 78 68 00 00       	mov    %eax,0x6878
    base.s.size = 0;
     7b5:	c7 05 7c 68 00 00 00 	movl   $0x0,0x687c
     7bc:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     812:	a3 80 68 00 00       	mov    %eax,0x6880
      return (void*)(p + 1);
    ...
    if(p == freep)
     81f:	a1 80 68 00 00       	mov    0x6880,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     95d:	79 2e                	jns    98d <APLoadBitmap+0x61>
    {
     ...
     965:	68 fa 24 00 00       	push   $0x24fa
     96a:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    1309:	05 40 2c 00 00       	add    $0x2c40,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1596:	68 0c 25 00 00       	push   $0x250c
    159b:	6a 01                	push   $0x1
    ...
    160b:	68 2c 25 00 00       	push   $0x252c
    1610:	6a 01                	push   $0x1
    ...
    16af:	68 50 25 00 00       	push   $0x2550
    16b4:	6a 01                	push   $0x1
    ...
    1794:	68 78 25 00 00       	push   $0x2578
    1799:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    1931:	a1 84 68 00 00       	mov    0x6884,%eax
    1936:	85 c0                	test   %eax,%eax
    1938:	0f 85 7a 02 00 00    	jne    1bb8 <APGridPaint+0x290>
    {
        iconReady = 1;
    193e:	c7 05 84 68 00 00 01 	movl   $0x1,0x6884
    1945:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    1948:	8d 45 88             	lea    -0x78(%ebp),%eax
    194b:	83 ec 08             	sub    $0x8,%esp
    194e:	68 9f 25 00 00       	push   $0x259f
    1953:	50                   	push   %eax
    1954:	e8 d3 ef ff ff       	call   92c <APLoadBitmap>
    1959:	83 c4 0c             	add    $0xc,%esp
    195c:	8b 45 88             	mov    -0x78(%ebp),%eax
    195f:	a3 a8 68 00 00       	mov    %eax,0x68a8
    1964:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1967:	a3 ac 68 00 00       	mov    %eax,0x68ac
    196c:	8b 45 90             	mov    -0x70(%ebp),%eax
    196f:	a3 b0 68 00 00       	mov    %eax,0x68b0
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    1974:	83 ec 04             	sub    $0x4,%esp
    1977:	ff 35 b0 68 00 00    	pushl  0x68b0
    197d:	ff 35 ac 68 00 00    	pushl  0x68ac
    1983:	ff 35 a8 68 00 00    	pushl  0x68a8
    1989:	e8 d8 f1 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    198e:	83 c4 10             	add    $0x10,%esp
    1991:	a3 b4 68 00 00       	mov    %eax,0x68b4
        grid_river = APLoadBitmap ("grid_river.bmp");
    1996:	8d 45 88             	lea    -0x78(%ebp),%eax
    1999:	83 ec 08             	sub    $0x8,%esp
    199c:	68 ad 25 00 00       	push   $0x25ad
    19a1:	50                   	push   %eax
    19a2:	e8 85 ef ff ff       	call   92c <APLoadBitmap>
    19a7:	83 c4 0c             	add    $0xc,%esp
    19aa:	8b 45 88             	mov    -0x78(%ebp),%eax
    19ad:	a3 f0 68 00 00       	mov    %eax,0x68f0
    19b2:	8b 45 8c             	mov    -0x74(%ebp),%eax
    19b5:	a3 f4 68 00 00       	mov    %eax,0x68f4
    19ba:	8b 45 90             	mov    -0x70(%ebp),%eax
    19bd:	a3 f8 68 00 00       	mov    %eax,0x68f8
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    19c2:	83 ec 04             	sub    $0x4,%esp
    19c5:	ff 35 f8 68 00 00    	pushl  0x68f8
    19cb:	ff 35 f4 68 00 00    	pushl  0x68f4
    19d1:	ff 35 f0 68 00 00    	pushl  0x68f0
    19d7:	e8 8a f1 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    19dc:	83 c4 10             	add    $0x10,%esp
    19df:	a3 e0 68 00 00       	mov    %eax,0x68e0
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    19e4:	8d 45 88             	lea    -0x78(%ebp),%eax
    19e7:	83 ec 08             	sub    $0x8,%esp
    19ea:	68 bc 25 00 00       	push   $0x25bc
    19ef:	50                   	push   %eax
    19f0:	e8 37 ef ff ff       	call   92c <APLoadBitmap>
    19f5:	83 c4 0c             	add    $0xc,%esp
    19f8:	8b 45 88             	mov    -0x78(%ebp),%eax
    19fb:	a3 e4 68 00 00       	mov    %eax,0x68e4
    1a00:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a03:	a3 e8 68 00 00       	mov    %eax,0x68e8
    1a08:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a0b:	a3 ec 68 00 00       	mov    %eax,0x68ec
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    1a10:	83 ec 04             	sub    $0x4,%esp
    1a13:	ff 35 ec 68 00 00    	pushl  0x68ec
    1a19:	ff 35 e8 68 00 00    	pushl  0x68e8
    1a1f:	ff 35 e4 68 00 00    	pushl  0x68e4
    1a25:	e8 3c f1 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1a2a:	83 c4 10             	add    $0x10,%esp
    1a2d:	a3 88 68 00 00       	mov    %eax,0x6888
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1a32:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a35:	83 ec 08             	sub    $0x8,%esp
    1a38:	68 cb 25 00 00       	push   $0x25cb
    1a3d:	50                   	push   %eax
    1a3e:	e8 e9 ee ff ff       	call   92c <APLoadBitmap>
    1a43:	83 c4 0c             	add    $0xc,%esp
    1a46:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a49:	a3 bc 68 00 00       	mov    %eax,0x68bc
    1a4e:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a51:	a3 c0 68 00 00       	mov    %eax,0x68c0
    1a56:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a59:	a3 c4 68 00 00       	mov    %eax,0x68c4
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1a5e:	83 ec 04             	sub    $0x4,%esp
    1a61:	ff 35 c4 68 00 00    	pushl  0x68c4
    1a67:	ff 35 c0 68 00 00    	pushl  0x68c0
    1a6d:	ff 35 bc 68 00 00    	pushl  0x68bc
    1a73:	e8 ee f0 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1a78:	83 c4 10             	add    $0x10,%esp
    1a7b:	a3 00 69 00 00       	mov    %eax,0x6900
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1a80:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a83:	83 ec 08             	sub    $0x8,%esp
    1a86:	68 d9 25 00 00       	push   $0x25d9
    1a8b:	50                   	push   %eax
    1a8c:	e8 9b ee ff ff       	call   92c <APLoadBitmap>
    1a91:	83 c4 0c             	add    $0xc,%esp
    1a94:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a97:	a3 98 68 00 00       	mov    %eax,0x6898
    1a9c:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a9f:	a3 9c 68 00 00       	mov    %eax,0x689c
    1aa4:	8b 45 90             	mov    -0x70(%ebp),%eax
    1aa7:	a3 a0 68 00 00       	mov    %eax,0x68a0
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1aac:	83 ec 04             	sub    $0x4,%esp
    1aaf:	ff 35 a0 68 00 00    	pushl  0x68a0
    1ab5:	ff 35 9c 68 00 00    	pushl  0x689c
    1abb:	ff 35 98 68 00 00    	pushl  0x6898
    1ac1:	e8 a0 f0 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1ac6:	83 c4 10             	add    $0x10,%esp
    1ac9:	a3 b8 68 00 00       	mov    %eax,0x68b8
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1ace:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ad1:	83 ec 08             	sub    $0x8,%esp
    1ad4:	68 e9 25 00 00       	push   $0x25e9
    1ad9:	50                   	push   %eax
    1ada:	e8 4d ee ff ff       	call   92c <APLoadBitmap>
    1adf:	83 c4 0c             	add    $0xc,%esp
    1ae2:	8b 45 88             	mov    -0x78(%ebp),%eax
    1ae5:	a3 8c 68 00 00       	mov    %eax,0x688c
    1aea:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1aed:	a3 90 68 00 00       	mov    %eax,0x6890
    1af2:	8b 45 90             	mov    -0x70(%ebp),%eax
    1af5:	a3 94 68 00 00       	mov    %eax,0x6894
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1afa:	83 ec 04             	sub    $0x4,%esp
    1afd:	ff 35 94 68 00 00    	pushl  0x6894
    1b03:	ff 35 90 68 00 00    	pushl  0x6890
    1b09:	ff 35 8c 68 00 00    	pushl  0x688c
    1b0f:	e8 52 f0 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1b14:	83 c4 10             	add    $0x10,%esp
    1b17:	a3 a4 68 00 00       	mov    %eax,0x68a4
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1b1c:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b1f:	83 ec 08             	sub    $0x8,%esp
    1b22:	68 fb 25 00 00       	push   $0x25fb
    1b27:	50                   	push   %eax
    1b28:	e8 ff ed ff ff       	call   92c <APLoadBitmap>
    1b2d:	83 c4 0c             	add    $0xc,%esp
    1b30:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b33:	a3 d4 68 00 00       	mov    %eax,0x68d4
    1b38:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b3b:	a3 d8 68 00 00       	mov    %eax,0x68d8
    1b40:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b43:	a3 dc 68 00 00       	mov    %eax,0x68dc
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1b48:	83 ec 04             	sub    $0x4,%esp
    1b4b:	ff 35 dc 68 00 00    	pushl  0x68dc
    1b51:	ff 35 d8 68 00 00    	pushl  0x68d8
    1b57:	ff 35 d4 68 00 00    	pushl  0x68d4
    1b5d:	e8 04 f0 ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1b62:	83 c4 10             	add    $0x10,%esp
    1b65:	a3 04 69 00 00       	mov    %eax,0x6904
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1b6a:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b6d:	83 ec 08             	sub    $0x8,%esp
    1b70:	68 0a 26 00 00       	push   $0x260a
    1b75:	50                   	push   %eax
    1b76:	e8 b1 ed ff ff       	call   92c <APLoadBitmap>
    1b7b:	83 c4 0c             	add    $0xc,%esp
    1b7e:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b81:	a3 c8 68 00 00       	mov    %eax,0x68c8
    1b86:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b89:	a3 cc 68 00 00       	mov    %eax,0x68cc
    1b8e:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b91:	a3 d0 68 00 00       	mov    %eax,0x68d0
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1b96:	83 ec 04             	sub    $0x4,%esp
    1b99:	ff 35 d0 68 00 00    	pushl  0x68d0
    1b9f:	ff 35 cc 68 00 00    	pushl  0x68cc
    1ba5:	ff 35 c8 68 00 00    	pushl  0x68c8
    1bab:	e8 b6 ef ff ff       	call   b66 <APCreateCompatibleDCFromBitmap>
    1bb0:	83 c4 10             	add    $0x10,%esp
    1bb3:	a3 fc 68 00 00       	mov    %eax,0x68fc
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1bb8:	8b 45 08             	mov    0x8(%ebp),%eax
    1bbb:	8b 40 08             	mov    0x8(%eax),%eax
    1bbe:	85 c0                	test   %eax,%eax
    1bc0:	75 17                	jne    1bd9 <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1bc2:	83 ec 08             	sub    $0x8,%esp
    1bc5:	68 1c 26 00 00       	push   $0x261c
    1bca:	6a 01                	push   $0x1
    1bcc:	e8 d5 e8 ff ff       	call   4a6 <printf>
    1bd1:	83 c4 10             	add    $0x10,%esp
        return;
    1bd4:	e9 65 05 00 00       	jmp    213e <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1bd9:	8b 45 08             	mov    0x8(%ebp),%eax
    1bdc:	8b 40 10             	mov    0x10(%eax),%eax
    1bdf:	85 c0                	test   %eax,%eax
    1be1:	7e 10                	jle    1bf3 <APGridPaint+0x2cb>
    1be3:	8b 45 08             	mov    0x8(%ebp),%eax
    1be6:	8b 50 14             	mov    0x14(%eax),%edx
    1be9:	8b 45 08             	mov    0x8(%ebp),%eax
    1bec:	8b 40 10             	mov    0x10(%eax),%eax
    1bef:	39 c2                	cmp    %eax,%edx
    1bf1:	7c 17                	jl     1c0a <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1bf3:	83 ec 08             	sub    $0x8,%esp
    1bf6:	68 42 26 00 00       	push   $0x2642
    1bfb:	6a 01                	push   $0x1
    1bfd:	e8 a4 e8 ff ff       	call   4a6 <printf>
    1c02:	83 c4 10             	add    $0x10,%esp
        return;
    1c05:	e9 34 05 00 00       	jmp    213e <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1c0a:	8b 45 08             	mov    0x8(%ebp),%eax
    1c0d:	8b 40 14             	mov    0x14(%eax),%eax
    1c10:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1c16:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1c19:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1c1c:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1c1f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1c26:	e9 f4 03 00 00       	jmp    201f <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1c2b:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1c32:	e9 da 03 00 00       	jmp    2011 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1c37:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1c3a:	c1 e0 04             	shl    $0x4,%eax
    1c3d:	89 c2                	mov    %eax,%edx
    1c3f:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1c42:	01 c2                	add    %eax,%edx
    1c44:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1c47:	01 d0                	add    %edx,%eax
    1c49:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1c4c:	8b 45 08             	mov    0x8(%ebp),%eax
    1c4f:	8b 40 0c             	mov    0xc(%eax),%eax
    1c52:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1c55:	c1 e2 02             	shl    $0x2,%edx
    1c58:	01 d0                	add    %edx,%eax
    1c5a:	8b 00                	mov    (%eax),%eax
    1c5c:	83 f8 0a             	cmp    $0xa,%eax
    1c5f:	0f 87 a7 03 00 00    	ja     200c <APGridPaint+0x6e4>
    1c65:	8b 04 85 58 26 00 00 	mov    0x2658(,%eax,4),%eax
    1c6c:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1c6e:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1c71:	6a 0c                	push   $0xc
    1c73:	6a 0c                	push   $0xc
    1c75:	6a 0c                	push   $0xc
    1c77:	50                   	push   %eax
    1c78:	e8 91 f8 ff ff       	call   150e <RGB>
    1c7d:	83 c4 0c             	add    $0xc,%esp
    1c80:	8b 1d b4 68 00 00    	mov    0x68b4,%ebx
    1c86:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1c89:	6b c8 32             	imul   $0x32,%eax,%ecx
    1c8c:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1c8f:	6b c0 32             	imul   $0x32,%eax,%eax
    1c92:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1c95:	8b 45 08             	mov    0x8(%ebp),%eax
    1c98:	8d 78 3c             	lea    0x3c(%eax),%edi
    1c9b:	83 ec 0c             	sub    $0xc,%esp
    1c9e:	83 ec 04             	sub    $0x4,%esp
    1ca1:	89 e0                	mov    %esp,%eax
    1ca3:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1ca7:	66 89 30             	mov    %si,(%eax)
    1caa:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1cae:	88 50 02             	mov    %dl,0x2(%eax)
    1cb1:	6a 32                	push   $0x32
    1cb3:	6a 32                	push   $0x32
    1cb5:	6a 00                	push   $0x0
    1cb7:	6a 00                	push   $0x0
    1cb9:	53                   	push   %ebx
    1cba:	51                   	push   %ecx
    1cbb:	ff 75 84             	pushl  -0x7c(%ebp)
    1cbe:	57                   	push   %edi
    1cbf:	e8 a6 f6 ff ff       	call   136a <APDcCopy>
    1cc4:	83 c4 30             	add    $0x30,%esp
                    break;
    1cc7:	e9 41 03 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1ccc:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ccf:	6a 69                	push   $0x69
    1cd1:	6a 69                	push   $0x69
    1cd3:	6a 69                	push   $0x69
    1cd5:	50                   	push   %eax
    1cd6:	e8 33 f8 ff ff       	call   150e <RGB>
    1cdb:	83 c4 0c             	add    $0xc,%esp
    1cde:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1ce2:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1ce6:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1cea:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1ced:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1cf4:	8d 45 88             	lea    -0x78(%ebp),%eax
    1cf7:	6a 69                	push   $0x69
    1cf9:	6a 69                	push   $0x69
    1cfb:	6a 69                	push   $0x69
    1cfd:	50                   	push   %eax
    1cfe:	e8 0b f8 ff ff       	call   150e <RGB>
    1d03:	83 c4 0c             	add    $0xc,%esp
    1d06:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1d0a:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1d0e:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1d12:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1d15:	8b 45 08             	mov    0x8(%ebp),%eax
    1d18:	8d 50 3c             	lea    0x3c(%eax),%edx
    1d1b:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d1e:	ff 75 ac             	pushl  -0x54(%ebp)
    1d21:	ff 75 a8             	pushl  -0x58(%ebp)
    1d24:	52                   	push   %edx
    1d25:	50                   	push   %eax
    1d26:	e8 d0 ee ff ff       	call   bfb <APSetPen>
    1d2b:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1d2e:	8b 45 08             	mov    0x8(%ebp),%eax
    1d31:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1d34:	8d 55 88             	lea    -0x78(%ebp),%edx
    1d37:	83 ec 04             	sub    $0x4,%esp
    1d3a:	83 ec 04             	sub    $0x4,%esp
    1d3d:	89 e0                	mov    %esp,%eax
    1d3f:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1d43:	66 89 08             	mov    %cx,(%eax)
    1d46:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    1d4a:	88 48 02             	mov    %cl,0x2(%eax)
    1d4d:	53                   	push   %ebx
    1d4e:	52                   	push   %edx
    1d4f:	e8 e0 ee ff ff       	call   c34 <APSetBrush>
    1d54:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1d57:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1d5a:	6b d0 32             	imul   $0x32,%eax,%edx
    1d5d:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1d60:	6b c0 32             	imul   $0x32,%eax,%eax
    1d63:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1d66:	83 c1 3c             	add    $0x3c,%ecx
    1d69:	83 ec 0c             	sub    $0xc,%esp
    1d6c:	6a 32                	push   $0x32
    1d6e:	6a 32                	push   $0x32
    1d70:	52                   	push   %edx
    1d71:	50                   	push   %eax
    1d72:	51                   	push   %ecx
    1d73:	e8 e6 f2 ff ff       	call   105e <APDrawRect>
    1d78:	83 c4 20             	add    $0x20,%esp
                    break;
    1d7b:	e9 8d 02 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1d80:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1d83:	6a 0c                	push   $0xc
    1d85:	6a 0c                	push   $0xc
    1d87:	6a 0c                	push   $0xc
    1d89:	50                   	push   %eax
    1d8a:	e8 7f f7 ff ff       	call   150e <RGB>
    1d8f:	83 c4 0c             	add    $0xc,%esp
    1d92:	8b 1d 04 69 00 00    	mov    0x6904,%ebx
    ...
    1db5:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1db9:	66 89 30             	mov    %si,(%eax)
    1dbc:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    1dd0:	57                   	push   %edi
    1dd1:	e8 94 f5 ff ff       	call   136a <APDcCopy>
    1dd6:	83 c4 30             	add    $0x30,%esp
                    break;
    1dd9:	e9 2f 02 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1dde:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1de1:	6a 0c                	push   $0xc
    1de3:	6a 0c                	push   $0xc
    1de5:	6a 0c                	push   $0xc
    1de7:	50                   	push   %eax
    1de8:	e8 21 f7 ff ff       	call   150e <RGB>
    1ded:	83 c4 0c             	add    $0xc,%esp
    1df0:	8b 1d e0 68 00 00    	mov    0x68e0,%ebx
    ...
    1e13:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1e17:	66 89 30             	mov    %si,(%eax)
    1e1a:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    1e2e:	57                   	push   %edi
    1e2f:	e8 36 f5 ff ff       	call   136a <APDcCopy>
    1e34:	83 c4 30             	add    $0x30,%esp
                    break;
    1e37:	e9 d1 01 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e3c:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1e3f:	6a 0c                	push   $0xc
    1e41:	6a 0c                	push   $0xc
    1e43:	6a 0c                	push   $0xc
    1e45:	50                   	push   %eax
    1e46:	e8 c3 f6 ff ff       	call   150e <RGB>
    1e4b:	83 c4 0c             	add    $0xc,%esp
    1e4e:	8b 1d b8 68 00 00    	mov    0x68b8,%ebx
    ...
    1e71:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1e75:	66 89 30             	mov    %si,(%eax)
    1e78:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    1e8c:	57                   	push   %edi
    1e8d:	e8 d8 f4 ff ff       	call   136a <APDcCopy>
    1e92:	83 c4 30             	add    $0x30,%esp
                    break;
    1e95:	e9 73 01 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e9a:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1e9d:	6a 0c                	push   $0xc
    1e9f:	6a 0c                	push   $0xc
    1ea1:	6a 0c                	push   $0xc
    1ea3:	50                   	push   %eax
    1ea4:	e8 65 f6 ff ff       	call   150e <RGB>
    1ea9:	83 c4 0c             	add    $0xc,%esp
    1eac:	8b 1d 00 69 00 00    	mov    0x6900,%ebx
    ...
    1ecf:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1ed3:	66 89 30             	mov    %si,(%eax)
    1ed6:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    1eea:	57                   	push   %edi
    1eeb:	e8 7a f4 ff ff       	call   136a <APDcCopy>
    1ef0:	83 c4 30             	add    $0x30,%esp
                    break;
    1ef3:	e9 15 01 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ef8:	8d 45 cf             	lea    -0x31(%ebp),%eax
    1efb:	6a 0c                	push   $0xc
    1efd:	6a 0c                	push   $0xc
    1eff:	6a 0c                	push   $0xc
    1f01:	50                   	push   %eax
    1f02:	e8 07 f6 ff ff       	call   150e <RGB>
    1f07:	83 c4 0c             	add    $0xc,%esp
    1f0a:	8b 1d 88 68 00 00    	mov    0x6888,%ebx
    1f10:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f13:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f16:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f19:	6b c0 32             	imul   $0x32,%eax,%eax
    1f1c:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f1f:	8b 45 08             	mov    0x8(%ebp),%eax
    1f22:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f25:	83 ec 0c             	sub    $0xc,%esp
    1f28:	83 ec 04             	sub    $0x4,%esp
    1f2b:	89 e0                	mov    %esp,%eax
    1f2d:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    1f31:	66 89 30             	mov    %si,(%eax)
    1f34:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    1f38:	88 50 02             	mov    %dl,0x2(%eax)
    1f3b:	6a 32                	push   $0x32
    1f3d:	6a 32                	push   $0x32
    1f3f:	6a 00                	push   $0x0
    1f41:	6a 00                	push   $0x0
    1f43:	53                   	push   %ebx
    1f44:	51                   	push   %ecx
    1f45:	ff 75 84             	pushl  -0x7c(%ebp)
    1f48:	57                   	push   %edi
    1f49:	e8 1c f4 ff ff       	call   136a <APDcCopy>
    1f4e:	83 c4 30             	add    $0x30,%esp
                    break;
    1f51:	e9 b7 00 00 00       	jmp    200d <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f56:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    1f59:	6a 0c                	push   $0xc
    1f5b:	6a 0c                	push   $0xc
    1f5d:	6a 0c                	push   $0xc
    1f5f:	50                   	push   %eax
    1f60:	e8 a9 f5 ff ff       	call   150e <RGB>
    1f65:	83 c4 0c             	add    $0xc,%esp
    1f68:	8b 1d a4 68 00 00    	mov    0x68a4,%ebx
    1f6e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f71:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f74:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f77:	6b c0 32             	imul   $0x32,%eax,%eax
    1f7a:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f7d:	8b 45 08             	mov    0x8(%ebp),%eax
    1f80:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f83:	83 ec 0c             	sub    $0xc,%esp
    1f86:	83 ec 04             	sub    $0x4,%esp
    1f89:	89 e0                	mov    %esp,%eax
    1f8b:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    1f8f:	66 89 30             	mov    %si,(%eax)
    1f92:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    1f96:	88 50 02             	mov    %dl,0x2(%eax)
    1f99:	6a 32                	push   $0x32
    1f9b:	6a 32                	push   $0x32
    1f9d:	6a 00                	push   $0x0
    1f9f:	6a 00                	push   $0x0
    1fa1:	53                   	push   %ebx
    1fa2:	51                   	push   %ecx
    1fa3:	ff 75 84             	pushl  -0x7c(%ebp)
    1fa6:	57                   	push   %edi
    1fa7:	e8 be f3 ff ff       	call   136a <APDcCopy>
    1fac:	83 c4 30             	add    $0x30,%esp
                    break;
    1faf:	eb 5c                	jmp    200d <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fb1:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    1fb4:	6a 0c                	push   $0xc
    1fb6:	6a 0c                	push   $0xc
    1fb8:	6a 0c                	push   $0xc
    1fba:	50                   	push   %eax
    1fbb:	e8 4e f5 ff ff       	call   150e <RGB>
    1fc0:	83 c4 0c             	add    $0xc,%esp
    1fc3:	8b 1d fc 68 00 00    	mov    0x68fc,%ebx
    1fc9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fcc:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fcf:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fd2:	6b c0 32             	imul   $0x32,%eax,%eax
    1fd5:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1fd8:	8b 45 08             	mov    0x8(%ebp),%eax
    1fdb:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fde:	83 ec 0c             	sub    $0xc,%esp
    1fe1:	83 ec 04             	sub    $0x4,%esp
    1fe4:	89 e0                	mov    %esp,%eax
    1fe6:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    1fea:	66 89 30             	mov    %si,(%eax)
    1fed:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    1ff1:	88 50 02             	mov    %dl,0x2(%eax)
    1ff4:	6a 32                	push   $0x32
    1ff6:	6a 32                	push   $0x32
    1ff8:	6a 00                	push   $0x0
    1ffa:	6a 00                	push   $0x0
    1ffc:	53                   	push   %ebx
    1ffd:	51                   	push   %ecx
    1ffe:	ff 75 84             	pushl  -0x7c(%ebp)
    2001:	57                   	push   %edi
    2002:	e8 63 f3 ff ff       	call   136a <APDcCopy>
    2007:	83 c4 30             	add    $0x30,%esp
                    break;
    200a:	eb 01                	jmp    200d <APGridPaint+0x6e5>
                default: break;
    200c:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    200d:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    2011:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2015:	0f 8e 1c fc ff ff    	jle    1c37 <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    201b:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    201f:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    2023:	0f 8e 02 fc ff ff    	jle    1c2b <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    2029:	8d 45 88             	lea    -0x78(%ebp),%eax
    202c:	68 cd 00 00 00       	push   $0xcd
    2031:	6a 74                	push   $0x74
    2033:	6a 18                	push   $0x18
    2035:	50                   	push   %eax
    2036:	e8 d3 f4 ff ff       	call   150e <RGB>
    203b:	83 c4 0c             	add    $0xc,%esp
    203e:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2042:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    2046:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    204a:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    204d:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2054:	8d 45 88             	lea    -0x78(%ebp),%eax
    2057:	68 cd 00 00 00       	push   $0xcd
    205c:	6a 74                	push   $0x74
    205e:	6a 18                	push   $0x18
    2060:	50                   	push   %eax
    2061:	e8 a8 f4 ff ff       	call   150e <RGB>
    2066:	83 c4 0c             	add    $0xc,%esp
    2069:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    206d:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    2071:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2075:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    2078:	8b 45 08             	mov    0x8(%ebp),%eax
    207b:	8d 50 58             	lea    0x58(%eax),%edx
    207e:	8d 45 88             	lea    -0x78(%ebp),%eax
    2081:	ff 75 bc             	pushl  -0x44(%ebp)
    2084:	ff 75 b8             	pushl  -0x48(%ebp)
    2087:	52                   	push   %edx
    2088:	50                   	push   %eax
    2089:	e8 6d eb ff ff       	call   bfb <APSetPen>
    208e:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    2091:	8b 45 08             	mov    0x8(%ebp),%eax
    2094:	8d 58 58             	lea    0x58(%eax),%ebx
    2097:	8d 55 88             	lea    -0x78(%ebp),%edx
    209a:	83 ec 04             	sub    $0x4,%esp
    209d:	83 ec 04             	sub    $0x4,%esp
    20a0:	89 e0                	mov    %esp,%eax
    20a2:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    20a6:	66 89 08             	mov    %cx,(%eax)
    20a9:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    20ad:	88 48 02             	mov    %cl,0x2(%eax)
    20b0:	53                   	push   %ebx
    20b1:	52                   	push   %edx
    20b2:	e8 7d eb ff ff       	call   c34 <APSetBrush>
    20b7:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    20ba:	8b 45 08             	mov    0x8(%ebp),%eax
    20bd:	83 c0 58             	add    $0x58,%eax
    20c0:	83 ec 0c             	sub    $0xc,%esp
    20c3:	6a 32                	push   $0x32
    20c5:	68 20 03 00 00       	push   $0x320
    20ca:	6a 00                	push   $0x0
    20cc:	6a 00                	push   $0x0
    20ce:	50                   	push   %eax
    20cf:	e8 8a ef ff ff       	call   105e <APDrawRect>
    20d4:	83 c4 20             	add    $0x20,%esp


    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    20d7:	8d 45 88             	lea    -0x78(%ebp),%eax
    20da:	6a 08                	push   $0x8
    20dc:	6a 08                	push   $0x8
    20de:	6a 08                	push   $0x8
    20e0:	50                   	push   %eax
    20e1:	e8 28 f4 ff ff       	call   150e <RGB>
    20e6:	83 c4 0c             	add    $0xc,%esp
    20e9:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    20ed:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    20f1:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    20f5:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    2109:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    210d:	66 89 08             	mov    %cx,(%eax)
    2110:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    2114:	88 48 02             	mov    %cl,0x2(%eax)
    2117:	53                   	push   %ebx
    2118:	52                   	push   %edx
    2119:	e8 58 eb ff ff       	call   c76 <APSetFont>
    211e:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    2121:	8b 45 08             	mov    0x8(%ebp),%eax
    2124:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    212a:	8b 45 08             	mov    0x8(%ebp),%eax
    212d:	83 c0 58             	add    $0x58,%eax
    2130:	6a 14                	push   $0x14
    2132:	6a 14                	push   $0x14
    2134:	52                   	push   %edx
    2135:	50                   	push   %eax
    2136:	e8 28 f1 ff ff       	call   1263 <APDrawText>
...
rand_num = seed;
    ...
    2152:	a3 60 68 00 00       	mov    %eax,0x6860
}
rand_num *= 3;
    2157:	8b 15 60 68 00 00    	mov    0x6860,%edx
    215d:	89 d0                	mov    %edx,%eax
    215f:	01 c0                	add    %eax,%eax
    2161:	01 d0                	add    %edx,%eax
    2163:	a3 60 68 00 00       	mov    %eax,0x6860
if (rand_num < 0)
    2168:	a1 60 68 00 00       	mov    0x6860,%eax
    216d:	85 c0                	test   %eax,%eax
    216f:	79 0c                	jns    217d <random+0x37>
{
rand_num *= (-1);
    2171:	a1 60 68 00 00       	mov    0x6860,%eax
    2176:	f7 d8                	neg    %eax
    2178:	a3 60 68 00 00       	mov    %eax,0x6860
}
return rand_num % 997;
    217d:	8b 0d 60 68 00 00    	mov    0x6860,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    21f9:	0f b6 80 64 68 00 00 	movzbl 0x6864(%eax),%eax
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    23cd:	75 25                	jne    23f4 <sprintf+0x169>
                    s = "(null)";
    23cf:	c7 45 f4 84 26 00 00 	movl   $0x2684,-0xc(%ebp)
                while(*s != 0){
