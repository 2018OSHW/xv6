...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     432:	0f b6 80 60 29 00 00 	movzbl 0x2960(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     56e:	75 25                	jne    595 <printf+0xff>
          s = "(null)";
     570:	c7 45 f4 8b 22 00 00 	movl   $0x228b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     636:	a1 94 29 00 00       	mov    0x2994,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     701:	a3 94 29 00 00       	mov    %eax,0x2994
}
     706:	90                   	nop
     707:	c9                   	leave  
     708:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     762:	a1 94 29 00 00       	mov    0x2994,%eax
}
     767:	c9                   	leave  
     768:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     77e:	a1 94 29 00 00       	mov    0x2994,%eax
     783:	89 45 f0             	mov    %eax,-0x10(%ebp)
     786:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     78a:	75 23                	jne    7af <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     78c:	c7 45 f0 8c 29 00 00 	movl   $0x298c,-0x10(%ebp)
     793:	8b 45 f0             	mov    -0x10(%ebp),%eax
     796:	a3 94 29 00 00       	mov    %eax,0x2994
     79b:	a1 94 29 00 00       	mov    0x2994,%eax
     7a0:	a3 8c 29 00 00       	mov    %eax,0x298c
    base.s.size = 0;
     7a5:	c7 05 90 29 00 00 00 	movl   $0x0,0x2990
     7ac:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     802:	a3 94 29 00 00       	mov    %eax,0x2994
      return (void*)(p + 1);
    ...
    if(p == freep)
     80f:	a1 94 29 00 00       	mov    0x2994,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     94d:	79 2e                	jns    97d <APLoadBitmap+0x61>
    {
     ...
     955:	68 92 22 00 00       	push   $0x2292
     95a:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1443:	68 a4 22 00 00       	push   $0x22a4
    1448:	6a 01                	push   $0x1
    ...
    14b8:	68 c4 22 00 00       	push   $0x22c4
    14bd:	6a 01                	push   $0x1
    ...
    155c:	68 e8 22 00 00       	push   $0x22e8
    1561:	6a 01                	push   $0x1
    ...
    1641:	68 10 23 00 00       	push   $0x2310
    1646:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1a24:	68 a4 23 00 00       	push   $0x23a4
    1a29:	6a 01                	push   $0x1
    ...
    1a55:	68 ca 23 00 00       	push   $0x23ca
    1a5a:	6a 01                	push   $0x1
    ...
    1ac4:	8b 04 85 e0 23 00 00 	mov    0x23e0(,%eax,4),%eax
    1acb:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1adf:	8b 1d c8 29 00 00    	mov    0x29c8,%ebx
    ...
    1bf1:	8b 1d 08 2a 00 00    	mov    0x2a08,%ebx
    ...
    1c4f:	8b 1d e8 29 00 00    	mov    0x29e8,%ebx
    ...
    1cad:	8b 1d cc 29 00 00    	mov    0x29cc,%ebx
    ...
    1d0b:	8b 1d 04 2a 00 00    	mov    0x2a04,%ebx
    ...
    1d69:	8b 1d 9c 29 00 00    	mov    0x299c,%ebx
    ...
    1dc4:	8b 1d b8 29 00 00    	mov    0x29b8,%ebx
...
rand_num = seed;
    ...
    1eec:	a3 74 29 00 00       	mov    %eax,0x2974
}
rand_num *= 3;
    1ef1:	8b 15 74 29 00 00    	mov    0x2974,%edx
    1ef7:	89 d0                	mov    %edx,%eax
    1ef9:	01 c0                	add    %eax,%eax
    1efb:	01 d0                	add    %edx,%eax
    1efd:	a3 74 29 00 00       	mov    %eax,0x2974
if (rand_num < 0)
    1f02:	a1 74 29 00 00       	mov    0x2974,%eax
    1f07:	85 c0                	test   %eax,%eax
    1f09:	79 0c                	jns    1f17 <random+0x37>
{
rand_num *= (-1);
    1f0b:	a1 74 29 00 00       	mov    0x2974,%eax
    1f10:	f7 d8                	neg    %eax
    1f12:	a3 74 29 00 00       	mov    %eax,0x2974
}
return rand_num % 997;
    1f17:	8b 0d 74 29 00 00    	mov    0x2974,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    1f93:	0f b6 80 78 29 00 00 	movzbl 0x2978(%eax),%eax
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2167:	75 25                	jne    218e <sprintf+0x169>
                    s = "(null)";
    2169:	c7 45 f4 00 24 00 00 	movl   $0x2400,-0xc(%ebp)
                while(*s != 0){
