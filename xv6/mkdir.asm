...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     42a:	0f b6 80 14 28 00 00 	movzbl 0x2814(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     566:	75 25                	jne    58d <printf+0xff>
          s = "(null)";
     568:	c7 45 f4 67 21 00 00 	movl   $0x2167,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     62e:	a1 48 28 00 00       	mov    0x2848,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6f9:	a3 48 28 00 00       	mov    %eax,0x2848
}
     6fe:	90                   	nop
     6ff:	c9                   	leave  
     700:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     75a:	a1 48 28 00 00       	mov    0x2848,%eax
}
     75f:	c9                   	leave  
     760:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     776:	a1 48 28 00 00       	mov    0x2848,%eax
     77b:	89 45 f0             	mov    %eax,-0x10(%ebp)
     77e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     782:	75 23                	jne    7a7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     784:	c7 45 f0 40 28 00 00 	movl   $0x2840,-0x10(%ebp)
     78b:	8b 45 f0             	mov    -0x10(%ebp),%eax
     78e:	a3 48 28 00 00       	mov    %eax,0x2848
     793:	a1 48 28 00 00       	mov    0x2848,%eax
     798:	a3 40 28 00 00       	mov    %eax,0x2840
    base.s.size = 0;
     79d:	c7 05 44 28 00 00 00 	movl   $0x0,0x2844
     7a4:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7fa:	a3 48 28 00 00       	mov    %eax,0x2848
      return (void*)(p + 1);
    ...
    if(p == freep)
     807:	a1 48 28 00 00       	mov    0x2848,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     945:	79 2e                	jns    975 <APLoadBitmap+0x61>
    {
     ...
     94d:	68 6e 21 00 00       	push   $0x216e
     952:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1435:	68 80 21 00 00       	push   $0x2180
    143a:	6a 01                	push   $0x1
    ...
    14a8:	68 a0 21 00 00       	push   $0x21a0
    14ad:	6a 01                	push   $0x1
    ...
    154c:	68 c4 21 00 00       	push   $0x21c4
    1551:	6a 01                	push   $0x1
    ...
    161d:	68 ec 21 00 00       	push   $0x21ec
    1622:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    19af:	68 80 22 00 00       	push   $0x2280
    19b4:	6a 01                	push   $0x1
    ...
    19e0:	68 a6 22 00 00       	push   $0x22a6
    19e5:	6a 01                	push   $0x1
    ...
    1a4f:	8b 04 85 bc 22 00 00 	mov    0x22bc(,%eax,4),%eax
    1a56:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a6a:	8b 1d 7c 28 00 00    	mov    0x287c,%ebx
    ...
    1b7c:	8b 1d bc 28 00 00    	mov    0x28bc,%ebx
    ...
    1bda:	8b 1d 9c 28 00 00    	mov    0x289c,%ebx
    ...
    1c38:	8b 1d 80 28 00 00    	mov    0x2880,%ebx
    ...
    1c96:	8b 1d b8 28 00 00    	mov    0x28b8,%ebx
    ...
    1cf4:	8b 1d 50 28 00 00    	mov    0x2850,%ebx
    ...
    1d4f:	8b 1d 6c 28 00 00    	mov    0x286c,%ebx
...
if (seed > 0)
    1dc0:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    1dc4:	7e 08                	jle    1dce <random+0x11>
{
rand_num = seed;
    1dc6:	8b 45 08             	mov    0x8(%ebp),%eax
    1dc9:	a3 28 28 00 00       	mov    %eax,0x2828
}
rand_num *= 3;
    1dce:	8b 15 28 28 00 00    	mov    0x2828,%edx
    1dd4:	89 d0                	mov    %edx,%eax
    1dd6:	01 c0                	add    %eax,%eax
    1dd8:	01 d0                	add    %edx,%eax
    1dda:	a3 28 28 00 00       	mov    %eax,0x2828
if (rand_num < 0)
    1ddf:	a1 28 28 00 00       	mov    0x2828,%eax
    1de4:	85 c0                	test   %eax,%eax
    1de6:	79 0c                	jns    1df4 <random+0x37>
{
rand_num *= (-1);
    1de8:	a1 28 28 00 00       	mov    0x2828,%eax
    1ded:	f7 d8                	neg    %eax
    1def:	a3 28 28 00 00       	mov    %eax,0x2828
}
return rand_num % 997;
    1df4:	8b 0d 28 28 00 00    	mov    0x2828,%ecx
    1dfa:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    1dff:	89 c8                	mov    %ecx,%eax
    1e01:	f7 ea                	imul   %edx
    1e03:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    1e06:	c1 f8 09             	sar    $0x9,%eax
    1e09:	89 c2                	mov    %eax,%edx
    1e0b:	89 c8                	mov    %ecx,%eax
    1e0d:	c1 f8 1f             	sar    $0x1f,%eax
    1e10:	29 c2                	sub    %eax,%edx
    1e12:	89 d0                	mov    %edx,%eax
    1e14:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    1e1a:	29 c1                	sub    %eax,%ecx
    1e1c:	89 c8                	mov    %ecx,%eax
}
    1e1e:	5d                   	pop    %ebp
    1e1f:	c3                   	ret    
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1e27:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1e2e:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1e32:	74 17                	je     1e4b <sprintint+0x2b>
    1e34:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1e38:	79 11                	jns    1e4b <sprintint+0x2b>
        neg = 1;
    1e3a:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1e41:	8b 45 10             	mov    0x10(%ebp),%eax
    1e44:	f7 d8                	neg    %eax
    1e46:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1e49:	eb 06                	jmp    1e51 <sprintint+0x31>
    } else {
        x = xx;
    1e4b:	8b 45 10             	mov    0x10(%ebp),%eax
    1e4e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    1e51:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1e58:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1e5b:	8d 41 01             	lea    0x1(%ecx),%eax
    1e5e:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1e61:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1e64:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e67:	ba 00 00 00 00       	mov    $0x0,%edx
    1e6c:	f7 f3                	div    %ebx
    1e6e:	89 d0                	mov    %edx,%eax
    1e70:	0f b6 80 2c 28 00 00 	movzbl 0x282c(%eax),%eax
    1e77:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1e7b:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1e7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e81:	ba 00 00 00 00       	mov    $0x0,%edx
    1e86:	f7 f3                	div    %ebx
    1e88:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1e8b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e8f:	75 c7                	jne    1e58 <sprintint+0x38>
    if(neg)
    1e91:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1e95:	74 0e                	je     1ea5 <sprintint+0x85>
        buf[i++] = '-';
    1e97:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e9a:	8d 50 01             	lea    0x1(%eax),%edx
    1e9d:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1ea0:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1ea5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1ea8:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1eab:	eb 1b                	jmp    1ec8 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1ead:	8b 45 0c             	mov    0xc(%ebp),%eax
    1eb0:	8b 00                	mov    (%eax),%eax
    1eb2:	8d 48 01             	lea    0x1(%eax),%ecx
    1eb5:	8b 55 0c             	mov    0xc(%ebp),%edx
    1eb8:	89 0a                	mov    %ecx,(%edx)
    1eba:	89 c2                	mov    %eax,%edx
    1ebc:	8b 45 08             	mov    0x8(%ebp),%eax
    1ebf:	01 d0                	add    %edx,%eax
    1ec1:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1ec4:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1ec8:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1ecc:	7f df                	jg     1ead <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1ece:	eb 21                	jmp    1ef1 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1ed0:	8b 45 0c             	mov    0xc(%ebp),%eax
    1ed3:	8b 00                	mov    (%eax),%eax
    1ed5:	8d 48 01             	lea    0x1(%eax),%ecx
    1ed8:	8b 55 0c             	mov    0xc(%ebp),%edx
    1edb:	89 0a                	mov    %ecx,(%edx)
    1edd:	89 c2                	mov    %eax,%edx
    1edf:	8b 45 08             	mov    0x8(%ebp),%eax
    1ee2:	01 c2                	add    %eax,%edx
    1ee4:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1ee7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1eea:	01 c8                	add    %ecx,%eax
    1eec:	0f b6 00             	movzbl (%eax),%eax
    1eef:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1ef1:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1ef5:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1ef9:	79 d5                	jns    1ed0 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1efb:	90                   	nop
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1f05:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1f08:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1f0f:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1f16:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1f1d:	8d 45 0c             	lea    0xc(%ebp),%eax
    1f20:	83 c0 04             	add    $0x4,%eax
    1f23:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1f26:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1f2d:	e9 d9 01 00 00       	jmp    210b <sprintf+0x209>
        c = fmt[i] & 0xff;
    1f32:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f35:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1f38:	01 d0                	add    %edx,%eax
    1f3a:	0f b6 00             	movzbl (%eax),%eax
    1f3d:	0f be c0             	movsbl %al,%eax
    1f40:	25 ff 00 00 00       	and    $0xff,%eax
    1f45:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1f48:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1f4c:	75 2c                	jne    1f7a <sprintf+0x78>
            if(c == '%'){
    1f4e:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1f52:	75 0c                	jne    1f60 <sprintf+0x5e>
                state = '%';
    1f54:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1f5b:	e9 a7 01 00 00       	jmp    2107 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1f60:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1f63:	8d 50 01             	lea    0x1(%eax),%edx
    1f66:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1f69:	89 c2                	mov    %eax,%edx
    1f6b:	8b 45 08             	mov    0x8(%ebp),%eax
    1f6e:	01 d0                	add    %edx,%eax
    1f70:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1f73:	88 10                	mov    %dl,(%eax)
    1f75:	e9 8d 01 00 00       	jmp    2107 <sprintf+0x205>
            }
        } else if(state == '%'){
    1f7a:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1f7e:	0f 85 83 01 00 00    	jne    2107 <sprintf+0x205>
            if(c == 'd'){
    1f84:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1f88:	75 4c                	jne    1fd6 <sprintf+0xd4>
                buf[bi] = '\0';
    1f8a:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f90:	01 d0                	add    %edx,%eax
    1f92:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f95:	83 ec 0c             	sub    $0xc,%esp
    1f98:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f9b:	50                   	push   %eax
    1f9c:	e8 b4 e2 ff ff       	call   255 <atoi>
    1fa1:	83 c4 10             	add    $0x10,%esp
    1fa4:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    1fa7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    1fae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fb1:	8b 00                	mov    (%eax),%eax
    1fb3:	83 ec 08             	sub    $0x8,%esp
    1fb6:	ff 75 d8             	pushl  -0x28(%ebp)
    1fb9:	6a 01                	push   $0x1
    1fbb:	6a 0a                	push   $0xa
    1fbd:	50                   	push   %eax
    1fbe:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1fc1:	50                   	push   %eax
    1fc2:	ff 75 08             	pushl  0x8(%ebp)
    1fc5:	e8 56 fe ff ff       	call   1e20 <sprintint>
    1fca:	83 c4 20             	add    $0x20,%esp
                ap++;
    1fcd:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1fd1:	e9 2a 01 00 00       	jmp    2100 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    1fd6:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    1fda:	74 06                	je     1fe2 <sprintf+0xe0>
    1fdc:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    1fe0:	75 4c                	jne    202e <sprintf+0x12c>
                buf[bi] = '\0';
    1fe2:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1fe5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1fe8:	01 d0                	add    %edx,%eax
    1fea:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1fed:	83 ec 0c             	sub    $0xc,%esp
    1ff0:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1ff3:	50                   	push   %eax
    1ff4:	e8 5c e2 ff ff       	call   255 <atoi>
    1ff9:	83 c4 10             	add    $0x10,%esp
    1ffc:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    1fff:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2006:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2009:	8b 00                	mov    (%eax),%eax
    200b:	83 ec 08             	sub    $0x8,%esp
    200e:	ff 75 dc             	pushl  -0x24(%ebp)
    2011:	6a 00                	push   $0x0
    2013:	6a 10                	push   $0x10
    2015:	50                   	push   %eax
    2016:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2019:	50                   	push   %eax
    201a:	ff 75 08             	pushl  0x8(%ebp)
    201d:	e8 fe fd ff ff       	call   1e20 <sprintint>
    2022:	83 c4 20             	add    $0x20,%esp
                ap++;
    2025:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2029:	e9 d2 00 00 00       	jmp    2100 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    202e:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2032:	75 46                	jne    207a <sprintf+0x178>
                s = (char*)*ap;
    2034:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2037:	8b 00                	mov    (%eax),%eax
    2039:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    203c:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    2040:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2044:	75 25                	jne    206b <sprintf+0x169>
                    s = "(null)";
    2046:	c7 45 f4 dc 22 00 00 	movl   $0x22dc,-0xc(%ebp)
                while(*s != 0){
    204d:	eb 1c                	jmp    206b <sprintf+0x169>
                    dst[j++] = *s;
    ...
    205d:	01 c2                	add    %eax,%edx
    205f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2062:	0f b6 00             	movzbl (%eax),%eax
    2065:	88 02                	mov    %al,(%edx)
                    s++;
    2067:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
    ...
    206e:	0f b6 00             	movzbl (%eax),%eax
    2071:	84 c0                	test   %al,%al
    2073:	75 da                	jne    204f <sprintf+0x14d>
    2075:	e9 86 00 00 00       	jmp    2100 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    207a:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    207e:	75 1d                	jne    209d <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    208e:	01 c2                	add    %eax,%edx
    2090:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2093:	8b 00                	mov    (%eax),%eax
    2095:	88 02                	mov    %al,(%edx)
                ap++;
    2097:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    209b:	eb 63                	jmp    2100 <sprintf+0x1fe>
            } else if(c == '%'){
    209d:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    20a1:	75 17                	jne    20ba <sprintf+0x1b8>
                dst[j++] = c;
    20a3:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20a6:	8d 50 01             	lea    0x1(%eax),%edx
    20a9:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20ac:	89 c2                	mov    %eax,%edx
    20ae:	8b 45 08             	mov    0x8(%ebp),%eax
    20b1:	01 d0                	add    %edx,%eax
    20b3:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20b6:	88 10                	mov    %dl,(%eax)
    20b8:	eb 46                	jmp    2100 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    20ba:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    20be:	7e 18                	jle    20d8 <sprintf+0x1d6>
    20c0:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    20c4:	7f 12                	jg     20d8 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    20c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    20c9:	8d 50 01             	lea    0x1(%eax),%edx
    20cc:	89 55 f0             	mov    %edx,-0x10(%ebp)
    20cf:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20d2:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    20d6:	eb 2f                	jmp    2107 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    20d8:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20db:	8d 50 01             	lea    0x1(%eax),%edx
    20de:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20e1:	89 c2                	mov    %eax,%edx
    20e3:	8b 45 08             	mov    0x8(%ebp),%eax
    20e6:	01 d0                	add    %edx,%eax
    20e8:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    20eb:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20ee:	8d 50 01             	lea    0x1(%eax),%edx
    20f1:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20f4:	89 c2                	mov    %eax,%edx
    20f6:	8b 45 08             	mov    0x8(%ebp),%eax
    20f9:	01 d0                	add    %edx,%eax
    20fb:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20fe:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    2100:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2107:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    210b:	8b 55 0c             	mov    0xc(%ebp),%edx
    210e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2111:	01 d0                	add    %edx,%eax
    2113:	0f b6 00             	movzbl (%eax),%eax
    2116:	84 c0                	test   %al,%al
    2118:	0f 85 14 fe ff ff    	jne    1f32 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    211e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2121:	8d 50 01             	lea    0x1(%eax),%edx
    2124:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2127:	89 c2                	mov    %eax,%edx
    2129:	8b 45 08             	mov    0x8(%ebp),%eax
    212c:	01 d0                	add    %edx,%eax
    212e:	c6 00 00             	movb   $0x0,(%eax)
}
    2131:	90                   	nop
    2132:	c9                   	leave  
    2133:	c3                   	ret    
