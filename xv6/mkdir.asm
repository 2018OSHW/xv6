...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     422:	0f b6 80 50 29 00 00 	movzbl 0x2950(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     55e:	75 25                	jne    585 <printf+0xff>
          s = "(null)";
     560:	c7 45 f4 7b 22 00 00 	movl   $0x227b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     626:	a1 84 29 00 00       	mov    0x2984,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6f1:	a3 84 29 00 00       	mov    %eax,0x2984
}
     6f6:	90                   	nop
     6f7:	c9                   	leave  
     6f8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     752:	a1 84 29 00 00       	mov    0x2984,%eax
}
     757:	c9                   	leave  
     758:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     76e:	a1 84 29 00 00       	mov    0x2984,%eax
     773:	89 45 f0             	mov    %eax,-0x10(%ebp)
     776:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     77a:	75 23                	jne    79f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     77c:	c7 45 f0 7c 29 00 00 	movl   $0x297c,-0x10(%ebp)
     783:	8b 45 f0             	mov    -0x10(%ebp),%eax
     786:	a3 84 29 00 00       	mov    %eax,0x2984
     78b:	a1 84 29 00 00       	mov    0x2984,%eax
     790:	a3 7c 29 00 00       	mov    %eax,0x297c
    base.s.size = 0;
     795:	c7 05 80 29 00 00 00 	movl   $0x0,0x2980
     79c:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7f2:	a3 84 29 00 00       	mov    %eax,0x2984
      return (void*)(p + 1);
    ...
    if(p == freep)
     7ff:	a1 84 29 00 00       	mov    0x2984,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     93d:	79 2e                	jns    96d <APLoadBitmap+0x61>
    {
     ...
     945:	68 82 22 00 00       	push   $0x2282
     94a:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1433:	68 94 22 00 00       	push   $0x2294
    1438:	6a 01                	push   $0x1
    ...
    14a8:	68 b4 22 00 00       	push   $0x22b4
    14ad:	6a 01                	push   $0x1
    ...
    154c:	68 d8 22 00 00       	push   $0x22d8
    1551:	6a 01                	push   $0x1
    ...
    1631:	68 00 23 00 00       	push   $0x2300
    1636:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1a14:	68 94 23 00 00       	push   $0x2394
    1a19:	6a 01                	push   $0x1
    ...
    1a45:	68 ba 23 00 00       	push   $0x23ba
    1a4a:	6a 01                	push   $0x1
    ...
    1ab4:	8b 04 85 d0 23 00 00 	mov    0x23d0(,%eax,4),%eax
    1abb:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1acf:	8b 1d b8 29 00 00    	mov    0x29b8,%ebx
    ...
    1be1:	8b 1d f8 29 00 00    	mov    0x29f8,%ebx
    ...
    1c3f:	8b 1d d8 29 00 00    	mov    0x29d8,%ebx
    ...
    1c9d:	8b 1d bc 29 00 00    	mov    0x29bc,%ebx
    ...
    1cfb:	8b 1d f4 29 00 00    	mov    0x29f4,%ebx
    ...
    1d59:	8b 1d 8c 29 00 00    	mov    0x298c,%ebx
    ...
    1db4:	8b 1d a8 29 00 00    	mov    0x29a8,%ebx
...
rand_num = seed;
    ...
    1edc:	a3 64 29 00 00       	mov    %eax,0x2964
}
rand_num *= 3;
    1ee1:	8b 15 64 29 00 00    	mov    0x2964,%edx
    1ee7:	89 d0                	mov    %edx,%eax
    1ee9:	01 c0                	add    %eax,%eax
    1eeb:	01 d0                	add    %edx,%eax
    1eed:	a3 64 29 00 00       	mov    %eax,0x2964
if (rand_num < 0)
    1ef2:	a1 64 29 00 00       	mov    0x2964,%eax
    1ef7:	85 c0                	test   %eax,%eax
    1ef9:	79 0c                	jns    1f07 <random+0x37>
{
rand_num *= (-1);
    1efb:	a1 64 29 00 00       	mov    0x2964,%eax
    1f00:	f7 d8                	neg    %eax
    1f02:	a3 64 29 00 00       	mov    %eax,0x2964
}
return rand_num % 997;
    1f07:	8b 0d 64 29 00 00    	mov    0x2964,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    1f83:	0f b6 80 68 29 00 00 	movzbl 0x2968(%eax),%eax
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2157:	75 25                	jne    217e <sprintf+0x169>
                    s = "(null)";
    2159:	c7 45 f4 f0 23 00 00 	movl   $0x23f0,-0xc(%ebp)
                while(*s != 0){
