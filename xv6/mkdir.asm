...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     42a:	0f b6 80 94 27 00 00 	movzbl 0x2794(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     566:	75 25                	jne    58d <printf+0xff>
          s = "(null)";
     568:	c7 45 f4 07 21 00 00 	movl   $0x2107,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     62e:	a1 c4 27 00 00       	mov    0x27c4,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6f9:	a3 c4 27 00 00       	mov    %eax,0x27c4
}
     6fe:	90                   	nop
     6ff:	c9                   	leave  
     700:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     75a:	a1 c4 27 00 00       	mov    0x27c4,%eax
}
     75f:	c9                   	leave  
     760:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     776:	a1 c4 27 00 00       	mov    0x27c4,%eax
     77b:	89 45 f0             	mov    %eax,-0x10(%ebp)
     77e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     782:	75 23                	jne    7a7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     784:	c7 45 f0 bc 27 00 00 	movl   $0x27bc,-0x10(%ebp)
     78b:	8b 45 f0             	mov    -0x10(%ebp),%eax
     78e:	a3 c4 27 00 00       	mov    %eax,0x27c4
     793:	a1 c4 27 00 00       	mov    0x27c4,%eax
     798:	a3 bc 27 00 00       	mov    %eax,0x27bc
    base.s.size = 0;
     79d:	c7 05 c0 27 00 00 00 	movl   $0x0,0x27c0
     7a4:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7fa:	a3 c4 27 00 00       	mov    %eax,0x27c4
      return (void*)(p + 1);
    ...
    if(p == freep)
     807:	a1 c4 27 00 00       	mov    0x27c4,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     945:	79 2e                	jns    975 <APLoadBitmap+0x61>
    {
     ...
     94d:	68 0e 21 00 00       	push   $0x210e
     952:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1435:	68 20 21 00 00       	push   $0x2120
    143a:	6a 01                	push   $0x1
    ...
    14a8:	68 40 21 00 00       	push   $0x2140
    14ad:	6a 01                	push   $0x1
    ...
    154c:	68 64 21 00 00       	push   $0x2164
    1551:	6a 01                	push   $0x1
    ...
    161d:	68 8c 21 00 00       	push   $0x218c
    1622:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    19af:	68 20 22 00 00       	push   $0x2220
    19b4:	6a 01                	push   $0x1
    ...
    19e0:	68 46 22 00 00       	push   $0x2246
    19e5:	6a 01                	push   $0x1
    ...
    1a4f:	8b 04 85 5c 22 00 00 	mov    0x225c(,%eax,4),%eax
    1a56:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a6a:	8b 1d f8 27 00 00    	mov    0x27f8,%ebx
    ...
    1b7c:	8b 1d 38 28 00 00    	mov    0x2838,%ebx
    ...
    1bda:	8b 1d 18 28 00 00    	mov    0x2818,%ebx
    ...
    1c38:	8b 1d fc 27 00 00    	mov    0x27fc,%ebx
    ...
    1c96:	8b 1d 34 28 00 00    	mov    0x2834,%ebx
    ...
    1cf4:	8b 1d cc 27 00 00    	mov    0x27cc,%ebx
    ...
    1d4f:	8b 1d e8 27 00 00    	mov    0x27e8,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    1e0d:	0f b6 80 a8 27 00 00 	movzbl 0x27a8(%eax),%eax
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1fe1:	75 25                	jne    2008 <sprintf+0x169>
                    s = "(null)";
    1fe3:	c7 45 f4 7c 22 00 00 	movl   $0x227c,-0xc(%ebp)
                while(*s != 0){
