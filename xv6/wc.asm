...
wc(int fd, char *name)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    for(i=0; i<n; i++){
      ...
      32:	05 c0 29 00 00       	add    $0x29c0,%eax
      ...
      45:	05 c0 29 00 00       	add    $0x29c0,%eax
      4a:	0f b6 00             	movzbl (%eax),%eax
      4d:	0f be c0             	movsbl %al,%eax
      50:	83 ec 08             	sub    $0x8,%esp
      53:	50                   	push   %eax
      54:	68 64 22 00 00       	push   $0x2264
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    wc(0, "");
     ...
     10a:	68 87 22 00 00       	push   $0x2287
     10f:	6a 00                	push   $0x0
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     166:	50                   	push   %eax
     167:	68 88 22 00 00       	push   $0x2288
     16c:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     557:	0f b6 80 68 29 00 00 	movzbl 0x2968(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     693:	75 25                	jne    6ba <printf+0xff>
          s = "(null)";
     695:	c7 45 f4 9c 22 00 00 	movl   $0x229c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     75b:	a1 a8 29 00 00       	mov    0x29a8,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     826:	a3 a8 29 00 00       	mov    %eax,0x29a8
}
     82b:	90                   	nop
     82c:	c9                   	leave  
     82d:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     887:	a1 a8 29 00 00       	mov    0x29a8,%eax
}
     88c:	c9                   	leave  
     88d:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     8a3:	a1 a8 29 00 00       	mov    0x29a8,%eax
     8a8:	89 45 f0             	mov    %eax,-0x10(%ebp)
     8ab:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     8af:	75 23                	jne    8d4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     8b1:	c7 45 f0 a0 29 00 00 	movl   $0x29a0,-0x10(%ebp)
     8b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
     8bb:	a3 a8 29 00 00       	mov    %eax,0x29a8
     8c0:	a1 a8 29 00 00       	mov    0x29a8,%eax
     8c5:	a3 a0 29 00 00       	mov    %eax,0x29a0
    base.s.size = 0;
     8ca:	c7 05 a4 29 00 00 00 	movl   $0x0,0x29a4
     8d1:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     927:	a3 a8 29 00 00       	mov    %eax,0x29a8
      return (void*)(p + 1);
    ...
    if(p == freep)
     934:	a1 a8 29 00 00       	mov    0x29a8,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     a72:	79 2e                	jns    aa2 <APLoadBitmap+0x61>
    {
     ...
     a7a:	68 a3 22 00 00       	push   $0x22a3
     a7f:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1562:	68 b4 22 00 00       	push   $0x22b4
    1567:	6a 01                	push   $0x1
    ...
    15d5:	68 d4 22 00 00       	push   $0x22d4
    15da:	6a 01                	push   $0x1
    ...
    1679:	68 f8 22 00 00       	push   $0x22f8
    167e:	6a 01                	push   $0x1
    ...
    174a:	68 20 23 00 00       	push   $0x2320
    174f:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1adc:	68 b4 23 00 00       	push   $0x23b4
    1ae1:	6a 01                	push   $0x1
    ...
    1b0d:	68 da 23 00 00       	push   $0x23da
    1b12:	6a 01                	push   $0x1
    ...
    1b7c:	8b 04 85 f0 23 00 00 	mov    0x23f0(,%eax,4),%eax
    1b83:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1b97:	8b 1d ec 2b 00 00    	mov    0x2bec,%ebx
    ...
    1ca9:	8b 1d 2c 2c 00 00    	mov    0x2c2c,%ebx
    ...
    1d07:	8b 1d 0c 2c 00 00    	mov    0x2c0c,%ebx
    ...
    1d65:	8b 1d f0 2b 00 00    	mov    0x2bf0,%ebx
    ...
    1dc3:	8b 1d 28 2c 00 00    	mov    0x2c28,%ebx
    ...
    1e21:	8b 1d c0 2b 00 00    	mov    0x2bc0,%ebx
    ...
    1e7c:	8b 1d dc 2b 00 00    	mov    0x2bdc,%ebx
...
if (seed > 0)
    1eed:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    1ef1:	7e 08                	jle    1efb <random+0x11>
{
rand_num = seed;
    1ef3:	8b 45 08             	mov    0x8(%ebp),%eax
    1ef6:	a3 7c 29 00 00       	mov    %eax,0x297c
}
rand_num *= 3;
    1efb:	8b 15 7c 29 00 00    	mov    0x297c,%edx
    1f01:	89 d0                	mov    %edx,%eax
    1f03:	01 c0                	add    %eax,%eax
    1f05:	01 d0                	add    %edx,%eax
    1f07:	a3 7c 29 00 00       	mov    %eax,0x297c
if (rand_num < 0)
    1f0c:	a1 7c 29 00 00       	mov    0x297c,%eax
    1f11:	85 c0                	test   %eax,%eax
    1f13:	79 0c                	jns    1f21 <random+0x37>
{
rand_num *= (-1);
    1f15:	a1 7c 29 00 00       	mov    0x297c,%eax
    1f1a:	f7 d8                	neg    %eax
    1f1c:	a3 7c 29 00 00       	mov    %eax,0x297c
}
return rand_num % 997;
    1f21:	8b 0d 7c 29 00 00    	mov    0x297c,%ecx
    1f27:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    1f2c:	89 c8                	mov    %ecx,%eax
    1f2e:	f7 ea                	imul   %edx
    1f30:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    1f33:	c1 f8 09             	sar    $0x9,%eax
    1f36:	89 c2                	mov    %eax,%edx
    1f38:	89 c8                	mov    %ecx,%eax
    1f3a:	c1 f8 1f             	sar    $0x1f,%eax
    1f3d:	29 c2                	sub    %eax,%edx
    1f3f:	89 d0                	mov    %edx,%eax
    1f41:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    1f47:	29 c1                	sub    %eax,%ecx
    1f49:	89 c8                	mov    %ecx,%eax
}
    1f4b:	5d                   	pop    %ebp
    1f4c:	c3                   	ret    
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    if(sgn && xx < 0){
    1f5b:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1f5f:	74 17                	je     1f78 <sprintint+0x2b>
    1f61:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1f65:	79 11                	jns    1f78 <sprintint+0x2b>
        neg = 1;
    1f67:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1f6e:	8b 45 10             	mov    0x10(%ebp),%eax
    1f71:	f7 d8                	neg    %eax
    1f73:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1f76:	eb 06                	jmp    1f7e <sprintint+0x31>
    } else {
        x = xx;
    1f78:	8b 45 10             	mov    0x10(%ebp),%eax
    1f7b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    1f7e:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1f85:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1f88:	8d 41 01             	lea    0x1(%ecx),%eax
    1f8b:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1f8e:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1f91:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f94:	ba 00 00 00 00       	mov    $0x0,%edx
    1f99:	f7 f3                	div    %ebx
    1f9b:	89 d0                	mov    %edx,%eax
    1f9d:	0f b6 80 80 29 00 00 	movzbl 0x2980(%eax),%eax
    1fa4:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1fa8:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1fab:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1fae:	ba 00 00 00 00       	mov    $0x0,%edx
    1fb3:	f7 f3                	div    %ebx
    1fb5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1fb8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1fbc:	75 c7                	jne    1f85 <sprintint+0x38>
    if(neg)
    1fbe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fc2:	74 0e                	je     1fd2 <sprintint+0x85>
        buf[i++] = '-';
    1fc4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1fc7:	8d 50 01             	lea    0x1(%eax),%edx
    1fca:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1fcd:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1fd2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1fd5:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1fd8:	eb 1b                	jmp    1ff5 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1fda:	8b 45 0c             	mov    0xc(%ebp),%eax
    1fdd:	8b 00                	mov    (%eax),%eax
    1fdf:	8d 48 01             	lea    0x1(%eax),%ecx
    1fe2:	8b 55 0c             	mov    0xc(%ebp),%edx
    1fe5:	89 0a                	mov    %ecx,(%edx)
    1fe7:	89 c2                	mov    %eax,%edx
    1fe9:	8b 45 08             	mov    0x8(%ebp),%eax
    1fec:	01 d0                	add    %edx,%eax
    1fee:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1ff1:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1ff5:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1ff9:	7f df                	jg     1fda <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1ffb:	eb 21                	jmp    201e <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1ffd:	8b 45 0c             	mov    0xc(%ebp),%eax
    2000:	8b 00                	mov    (%eax),%eax
    2002:	8d 48 01             	lea    0x1(%eax),%ecx
    2005:	8b 55 0c             	mov    0xc(%ebp),%edx
    2008:	89 0a                	mov    %ecx,(%edx)
    200a:	89 c2                	mov    %eax,%edx
    200c:	8b 45 08             	mov    0x8(%ebp),%eax
    200f:	01 c2                	add    %eax,%edx
    2011:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2014:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2017:	01 c8                	add    %ecx,%eax
    2019:	0f b6 00             	movzbl (%eax),%eax
    201c:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    201e:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2022:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2026:	79 d5                	jns    1ffd <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2028:	90                   	nop
    2029:	83 c4 20             	add    $0x20,%esp
    202c:	5b                   	pop    %ebx
    202d:	5d                   	pop    %ebp
    202e:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2032:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    2035:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    203c:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2043:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    204a:	8d 45 0c             	lea    0xc(%ebp),%eax
    204d:	83 c0 04             	add    $0x4,%eax
    2050:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2053:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    205a:	e9 d9 01 00 00       	jmp    2238 <sprintf+0x209>
        c = fmt[i] & 0xff;
    205f:	8b 55 0c             	mov    0xc(%ebp),%edx
    2062:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2065:	01 d0                	add    %edx,%eax
    2067:	0f b6 00             	movzbl (%eax),%eax
    206a:	0f be c0             	movsbl %al,%eax
    206d:	25 ff 00 00 00       	and    $0xff,%eax
    2072:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    2075:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    2079:	75 2c                	jne    20a7 <sprintf+0x78>
            if(c == '%'){
    207b:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    207f:	75 0c                	jne    208d <sprintf+0x5e>
                state = '%';
    2081:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    2088:	e9 a7 01 00 00       	jmp    2234 <sprintf+0x205>
            } else {
                dst[j++] = c;
    208d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2090:	8d 50 01             	lea    0x1(%eax),%edx
    2093:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2096:	89 c2                	mov    %eax,%edx
    2098:	8b 45 08             	mov    0x8(%ebp),%eax
    209b:	01 d0                	add    %edx,%eax
    209d:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20a0:	88 10                	mov    %dl,(%eax)
    20a2:	e9 8d 01 00 00       	jmp    2234 <sprintf+0x205>
            }
        } else if(state == '%'){
    20a7:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    20ab:	0f 85 83 01 00 00    	jne    2234 <sprintf+0x205>
            if(c == 'd'){
    20b1:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    20b5:	75 4c                	jne    2103 <sprintf+0xd4>
                buf[bi] = '\0';
    20b7:	8d 55 ce             	lea    -0x32(%ebp),%edx
    20ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
    20bd:	01 d0                	add    %edx,%eax
    20bf:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    20c2:	83 ec 0c             	sub    $0xc,%esp
    20c5:	8d 45 ce             	lea    -0x32(%ebp),%eax
    20c8:	50                   	push   %eax
    20c9:	e8 b4 e2 ff ff       	call   382 <atoi>
    20ce:	83 c4 10             	add    $0x10,%esp
    20d1:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    20d4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    20db:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20de:	8b 00                	mov    (%eax),%eax
    20e0:	83 ec 08             	sub    $0x8,%esp
    20e3:	ff 75 d8             	pushl  -0x28(%ebp)
    20e6:	6a 01                	push   $0x1
    20e8:	6a 0a                	push   $0xa
    20ea:	50                   	push   %eax
    20eb:	8d 45 c8             	lea    -0x38(%ebp),%eax
    20ee:	50                   	push   %eax
    20ef:	ff 75 08             	pushl  0x8(%ebp)
    20f2:	e8 56 fe ff ff       	call   1f4d <sprintint>
    20f7:	83 c4 20             	add    $0x20,%esp
                ap++;
    20fa:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    20fe:	e9 2a 01 00 00       	jmp    222d <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2103:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2107:	74 06                	je     210f <sprintf+0xe0>
    2109:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    210d:	75 4c                	jne    215b <sprintf+0x12c>
                buf[bi] = '\0';
    210f:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2112:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2115:	01 d0                	add    %edx,%eax
    2117:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    211a:	83 ec 0c             	sub    $0xc,%esp
    211d:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2120:	50                   	push   %eax
    2121:	e8 5c e2 ff ff       	call   382 <atoi>
    2126:	83 c4 10             	add    $0x10,%esp
    2129:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    212c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2133:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2136:	8b 00                	mov    (%eax),%eax
    2138:	83 ec 08             	sub    $0x8,%esp
    213b:	ff 75 dc             	pushl  -0x24(%ebp)
    213e:	6a 00                	push   $0x0
    2140:	6a 10                	push   $0x10
    2142:	50                   	push   %eax
    2143:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2146:	50                   	push   %eax
    2147:	ff 75 08             	pushl  0x8(%ebp)
    214a:	e8 fe fd ff ff       	call   1f4d <sprintint>
    214f:	83 c4 20             	add    $0x20,%esp
                ap++;
    2152:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2156:	e9 d2 00 00 00       	jmp    222d <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    215b:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    215f:	75 46                	jne    21a7 <sprintf+0x178>
                s = (char*)*ap;
    2161:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2164:	8b 00                	mov    (%eax),%eax
    2166:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    2169:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    216d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2171:	75 25                	jne    2198 <sprintf+0x169>
                    s = "(null)";
    2173:	c7 45 f4 10 24 00 00 	movl   $0x2410,-0xc(%ebp)
                while(*s != 0){
    217a:	eb 1c                	jmp    2198 <sprintf+0x169>
                    dst[j++] = *s;
    217c:	8b 45 c8             	mov    -0x38(%ebp),%eax
    217f:	8d 50 01             	lea    0x1(%eax),%edx
    2182:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2185:	89 c2                	mov    %eax,%edx
    2187:	8b 45 08             	mov    0x8(%ebp),%eax
    218a:	01 c2                	add    %eax,%edx
    218c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    218f:	0f b6 00             	movzbl (%eax),%eax
    2192:	88 02                	mov    %al,(%edx)
                    s++;
    2194:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
    ...
    219e:	84 c0                	test   %al,%al
    21a0:	75 da                	jne    217c <sprintf+0x14d>
    21a2:	e9 86 00 00 00       	jmp    222d <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    21a7:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    21ab:	75 1d                	jne    21ca <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    21bb:	01 c2                	add    %eax,%edx
    21bd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    21c0:	8b 00                	mov    (%eax),%eax
    21c2:	88 02                	mov    %al,(%edx)
                ap++;
    21c4:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    21c8:	eb 63                	jmp    222d <sprintf+0x1fe>
            } else if(c == '%'){
    21ca:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    21ce:	75 17                	jne    21e7 <sprintf+0x1b8>
                dst[j++] = c;
    ...
    21e0:	8b 55 e0             	mov    -0x20(%ebp),%edx
    21e3:	88 10                	mov    %dl,(%eax)
    21e5:	eb 46                	jmp    222d <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    21e7:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    21eb:	7e 18                	jle    2205 <sprintf+0x1d6>
    21ed:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    21f1:	7f 12                	jg     2205 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    21f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    21f6:	8d 50 01             	lea    0x1(%eax),%edx
    21f9:	89 55 f0             	mov    %edx,-0x10(%ebp)
    21fc:	8b 55 e0             	mov    -0x20(%ebp),%edx
    21ff:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2203:	eb 2f                	jmp    2234 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2205:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2208:	8d 50 01             	lea    0x1(%eax),%edx
    220b:	89 55 c8             	mov    %edx,-0x38(%ebp)
    220e:	89 c2                	mov    %eax,%edx
    2210:	8b 45 08             	mov    0x8(%ebp),%eax
    2213:	01 d0                	add    %edx,%eax
    2215:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    ...
    2228:	8b 55 e0             	mov    -0x20(%ebp),%edx
    222b:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    222d:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2234:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2238:	8b 55 0c             	mov    0xc(%ebp),%edx
    223b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    223e:	01 d0                	add    %edx,%eax
    2240:	0f b6 00             	movzbl (%eax),%eax
    2243:	84 c0                	test   %al,%al
    2245:	0f 85 14 fe ff ff    	jne    205f <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    224b:	8b 45 c8             	mov    -0x38(%ebp),%eax
    224e:	8d 50 01             	lea    0x1(%eax),%edx
    2251:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2254:	89 c2                	mov    %eax,%edx
    2256:	8b 45 08             	mov    0x8(%ebp),%eax
    2259:	01 d0                	add    %edx,%eax
    225b:	c6 00 00             	movb   $0x0,(%eax)
}
    225e:	90                   	nop
    225f:	c9                   	leave  
    2260:	c3                   	ret    
