...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    1a5e:	a1 cc 69 00 00       	mov    0x69cc,%eax
    1a63:	85 c0                	test   %eax,%eax
    1a65:	0f 85 7a 02 00 00    	jne    1ce5 <APGridPaint+0x290>
    {
        iconReady = 1;
    1a6b:	c7 05 cc 69 00 00 01 	movl   $0x1,0x69cc
    1a72:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    1a75:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a78:	83 ec 08             	sub    $0x8,%esp
    1a7b:	68 cf 26 00 00       	push   $0x26cf
    1a80:	50                   	push   %eax
    1a81:	e8 d3 ef ff ff       	call   a59 <APLoadBitmap>
    1a86:	83 c4 0c             	add    $0xc,%esp
    1a89:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a8c:	a3 00 6c 00 00       	mov    %eax,0x6c00
    1a91:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a94:	a3 04 6c 00 00       	mov    %eax,0x6c04
    1a99:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a9c:	a3 08 6c 00 00       	mov    %eax,0x6c08
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    1aa1:	83 ec 04             	sub    $0x4,%esp
    1aa4:	ff 35 08 6c 00 00    	pushl  0x6c08
    1aaa:	ff 35 04 6c 00 00    	pushl  0x6c04
    1ab0:	ff 35 00 6c 00 00    	pushl  0x6c00
    1ab6:	e8 d8 f1 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1abb:	83 c4 10             	add    $0x10,%esp
    1abe:	a3 0c 6c 00 00       	mov    %eax,0x6c0c
        grid_river = APLoadBitmap ("grid_river.bmp");
    1ac3:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ac6:	83 ec 08             	sub    $0x8,%esp
    1ac9:	68 dd 26 00 00       	push   $0x26dd
    1ace:	50                   	push   %eax
    1acf:	e8 85 ef ff ff       	call   a59 <APLoadBitmap>
    1ad4:	83 c4 0c             	add    $0xc,%esp
    1ad7:	8b 45 88             	mov    -0x78(%ebp),%eax
    1ada:	a3 48 6c 00 00       	mov    %eax,0x6c48
    1adf:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1ae2:	a3 4c 6c 00 00       	mov    %eax,0x6c4c
    1ae7:	8b 45 90             	mov    -0x70(%ebp),%eax
    1aea:	a3 50 6c 00 00       	mov    %eax,0x6c50
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    1aef:	83 ec 04             	sub    $0x4,%esp
    1af2:	ff 35 50 6c 00 00    	pushl  0x6c50
    1af8:	ff 35 4c 6c 00 00    	pushl  0x6c4c
    1afe:	ff 35 48 6c 00 00    	pushl  0x6c48
    1b04:	e8 8a f1 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1b09:	83 c4 10             	add    $0x10,%esp
    1b0c:	a3 38 6c 00 00       	mov    %eax,0x6c38
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    1b11:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b14:	83 ec 08             	sub    $0x8,%esp
    1b17:	68 ec 26 00 00       	push   $0x26ec
    1b1c:	50                   	push   %eax
    1b1d:	e8 37 ef ff ff       	call   a59 <APLoadBitmap>
    1b22:	83 c4 0c             	add    $0xc,%esp
    1b25:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b28:	a3 3c 6c 00 00       	mov    %eax,0x6c3c
    1b2d:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b30:	a3 40 6c 00 00       	mov    %eax,0x6c40
    1b35:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b38:	a3 44 6c 00 00       	mov    %eax,0x6c44
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    1b3d:	83 ec 04             	sub    $0x4,%esp
    1b40:	ff 35 44 6c 00 00    	pushl  0x6c44
    1b46:	ff 35 40 6c 00 00    	pushl  0x6c40
    1b4c:	ff 35 3c 6c 00 00    	pushl  0x6c3c
    1b52:	e8 3c f1 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1b57:	83 c4 10             	add    $0x10,%esp
    1b5a:	a3 e0 6b 00 00       	mov    %eax,0x6be0
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1b5f:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b62:	83 ec 08             	sub    $0x8,%esp
    1b65:	68 fb 26 00 00       	push   $0x26fb
    1b6a:	50                   	push   %eax
    1b6b:	e8 e9 ee ff ff       	call   a59 <APLoadBitmap>
    1b70:	83 c4 0c             	add    $0xc,%esp
    1b73:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b76:	a3 14 6c 00 00       	mov    %eax,0x6c14
    1b7b:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b7e:	a3 18 6c 00 00       	mov    %eax,0x6c18
    1b83:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b86:	a3 1c 6c 00 00       	mov    %eax,0x6c1c
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1b8b:	83 ec 04             	sub    $0x4,%esp
    1b8e:	ff 35 1c 6c 00 00    	pushl  0x6c1c
    1b94:	ff 35 18 6c 00 00    	pushl  0x6c18
    1b9a:	ff 35 14 6c 00 00    	pushl  0x6c14
    1ba0:	e8 ee f0 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1ba5:	83 c4 10             	add    $0x10,%esp
    1ba8:	a3 58 6c 00 00       	mov    %eax,0x6c58
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1bad:	8d 45 88             	lea    -0x78(%ebp),%eax
    1bb0:	83 ec 08             	sub    $0x8,%esp
    1bb3:	68 09 27 00 00       	push   $0x2709
    1bb8:	50                   	push   %eax
    1bb9:	e8 9b ee ff ff       	call   a59 <APLoadBitmap>
    1bbe:	83 c4 0c             	add    $0xc,%esp
    1bc1:	8b 45 88             	mov    -0x78(%ebp),%eax
    1bc4:	a3 f0 6b 00 00       	mov    %eax,0x6bf0
    1bc9:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1bcc:	a3 f4 6b 00 00       	mov    %eax,0x6bf4
    1bd1:	8b 45 90             	mov    -0x70(%ebp),%eax
    1bd4:	a3 f8 6b 00 00       	mov    %eax,0x6bf8
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1bd9:	83 ec 04             	sub    $0x4,%esp
    1bdc:	ff 35 f8 6b 00 00    	pushl  0x6bf8
    1be2:	ff 35 f4 6b 00 00    	pushl  0x6bf4
    1be8:	ff 35 f0 6b 00 00    	pushl  0x6bf0
    1bee:	e8 a0 f0 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1bf3:	83 c4 10             	add    $0x10,%esp
    1bf6:	a3 10 6c 00 00       	mov    %eax,0x6c10
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1bfb:	8d 45 88             	lea    -0x78(%ebp),%eax
    1bfe:	83 ec 08             	sub    $0x8,%esp
    1c01:	68 19 27 00 00       	push   $0x2719
    1c06:	50                   	push   %eax
    1c07:	e8 4d ee ff ff       	call   a59 <APLoadBitmap>
    1c0c:	83 c4 0c             	add    $0xc,%esp
    1c0f:	8b 45 88             	mov    -0x78(%ebp),%eax
    1c12:	a3 e4 6b 00 00       	mov    %eax,0x6be4
    1c17:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1c1a:	a3 e8 6b 00 00       	mov    %eax,0x6be8
    1c1f:	8b 45 90             	mov    -0x70(%ebp),%eax
    1c22:	a3 ec 6b 00 00       	mov    %eax,0x6bec
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1c27:	83 ec 04             	sub    $0x4,%esp
    1c2a:	ff 35 ec 6b 00 00    	pushl  0x6bec
    1c30:	ff 35 e8 6b 00 00    	pushl  0x6be8
    1c36:	ff 35 e4 6b 00 00    	pushl  0x6be4
    1c3c:	e8 52 f0 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1c41:	83 c4 10             	add    $0x10,%esp
    1c44:	a3 fc 6b 00 00       	mov    %eax,0x6bfc
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1c49:	8d 45 88             	lea    -0x78(%ebp),%eax
    1c4c:	83 ec 08             	sub    $0x8,%esp
    1c4f:	68 2b 27 00 00       	push   $0x272b
    1c54:	50                   	push   %eax
    1c55:	e8 ff ed ff ff       	call   a59 <APLoadBitmap>
    1c5a:	83 c4 0c             	add    $0xc,%esp
    1c5d:	8b 45 88             	mov    -0x78(%ebp),%eax
    1c60:	a3 2c 6c 00 00       	mov    %eax,0x6c2c
    1c65:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1c68:	a3 30 6c 00 00       	mov    %eax,0x6c30
    1c6d:	8b 45 90             	mov    -0x70(%ebp),%eax
    1c70:	a3 34 6c 00 00       	mov    %eax,0x6c34
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1c75:	83 ec 04             	sub    $0x4,%esp
    1c78:	ff 35 34 6c 00 00    	pushl  0x6c34
    1c7e:	ff 35 30 6c 00 00    	pushl  0x6c30
    1c84:	ff 35 2c 6c 00 00    	pushl  0x6c2c
    1c8a:	e8 04 f0 ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1c8f:	83 c4 10             	add    $0x10,%esp
    1c92:	a3 5c 6c 00 00       	mov    %eax,0x6c5c
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1c97:	8d 45 88             	lea    -0x78(%ebp),%eax
    1c9a:	83 ec 08             	sub    $0x8,%esp
    1c9d:	68 3a 27 00 00       	push   $0x273a
    1ca2:	50                   	push   %eax
    1ca3:	e8 b1 ed ff ff       	call   a59 <APLoadBitmap>
    1ca8:	83 c4 0c             	add    $0xc,%esp
    1cab:	8b 45 88             	mov    -0x78(%ebp),%eax
    1cae:	a3 20 6c 00 00       	mov    %eax,0x6c20
    1cb3:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1cb6:	a3 24 6c 00 00       	mov    %eax,0x6c24
    1cbb:	8b 45 90             	mov    -0x70(%ebp),%eax
    1cbe:	a3 28 6c 00 00       	mov    %eax,0x6c28
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1cc3:	83 ec 04             	sub    $0x4,%esp
    1cc6:	ff 35 28 6c 00 00    	pushl  0x6c28
    1ccc:	ff 35 24 6c 00 00    	pushl  0x6c24
    1cd2:	ff 35 20 6c 00 00    	pushl  0x6c20
    1cd8:	e8 b6 ef ff ff       	call   c93 <APCreateCompatibleDCFromBitmap>
    1cdd:	83 c4 10             	add    $0x10,%esp
    1ce0:	a3 54 6c 00 00       	mov    %eax,0x6c54
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1ce5:	8b 45 08             	mov    0x8(%ebp),%eax
    1ce8:	8b 40 08             	mov    0x8(%eax),%eax
    1ceb:	85 c0                	test   %eax,%eax
    1ced:	75 17                	jne    1d06 <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1cef:	83 ec 08             	sub    $0x8,%esp
    1cf2:	68 4c 27 00 00       	push   $0x274c
    1cf7:	6a 01                	push   $0x1
    1cf9:	e8 d5 e8 ff ff       	call   5d3 <printf>
    1cfe:	83 c4 10             	add    $0x10,%esp
        return;
    1d01:	e9 65 05 00 00       	jmp    226b <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1d06:	8b 45 08             	mov    0x8(%ebp),%eax
    1d09:	8b 40 10             	mov    0x10(%eax),%eax
    1d0c:	85 c0                	test   %eax,%eax
    1d0e:	7e 10                	jle    1d20 <APGridPaint+0x2cb>
    1d10:	8b 45 08             	mov    0x8(%ebp),%eax
    1d13:	8b 50 14             	mov    0x14(%eax),%edx
    1d16:	8b 45 08             	mov    0x8(%ebp),%eax
    1d19:	8b 40 10             	mov    0x10(%eax),%eax
    1d1c:	39 c2                	cmp    %eax,%edx
    1d1e:	7c 17                	jl     1d37 <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1d20:	83 ec 08             	sub    $0x8,%esp
    1d23:	68 72 27 00 00       	push   $0x2772
    1d28:	6a 01                	push   $0x1
    1d2a:	e8 a4 e8 ff ff       	call   5d3 <printf>
    1d2f:	83 c4 10             	add    $0x10,%esp
        return;
    1d32:	e9 34 05 00 00       	jmp    226b <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1d37:	8b 45 08             	mov    0x8(%ebp),%eax
    1d3a:	8b 40 14             	mov    0x14(%eax),%eax
    1d3d:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1d43:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1d46:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1d49:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1d4c:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1d53:	e9 f4 03 00 00       	jmp    214c <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1d58:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1d5f:	e9 da 03 00 00       	jmp    213e <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1d64:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1d67:	c1 e0 04             	shl    $0x4,%eax
    1d6a:	89 c2                	mov    %eax,%edx
    1d6c:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1d6f:	01 c2                	add    %eax,%edx
    1d71:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1d74:	01 d0                	add    %edx,%eax
    1d76:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1d79:	8b 45 08             	mov    0x8(%ebp),%eax
    1d7c:	8b 40 0c             	mov    0xc(%eax),%eax
    1d7f:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1d82:	c1 e2 02             	shl    $0x2,%edx
    1d85:	01 d0                	add    %edx,%eax
    1d87:	8b 00                	mov    (%eax),%eax
    1d89:	83 f8 0a             	cmp    $0xa,%eax
    1d8c:	0f 87 a7 03 00 00    	ja     2139 <APGridPaint+0x6e4>
    1d92:	8b 04 85 88 27 00 00 	mov    0x2788(,%eax,4),%eax
    1d99:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1d9b:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1d9e:	6a 0c                	push   $0xc
    1da0:	6a 0c                	push   $0xc
    1da2:	6a 0c                	push   $0xc
    1da4:	50                   	push   %eax
    1da5:	e8 91 f8 ff ff       	call   163b <RGB>
    1daa:	83 c4 0c             	add    $0xc,%esp
    1dad:	8b 1d 0c 6c 00 00    	mov    0x6c0c,%ebx
    1db3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1db6:	6b c8 32             	imul   $0x32,%eax,%ecx
    1db9:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1dbc:	6b c0 32             	imul   $0x32,%eax,%eax
    1dbf:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1dc2:	8b 45 08             	mov    0x8(%ebp),%eax
    1dc5:	8d 78 3c             	lea    0x3c(%eax),%edi
    1dc8:	83 ec 0c             	sub    $0xc,%esp
    1dcb:	83 ec 04             	sub    $0x4,%esp
    1dce:	89 e0                	mov    %esp,%eax
    1dd0:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1dd4:	66 89 30             	mov    %si,(%eax)
    1dd7:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1ddb:	88 50 02             	mov    %dl,0x2(%eax)
    1dde:	6a 32                	push   $0x32
    1de0:	6a 32                	push   $0x32
    1de2:	6a 00                	push   $0x0
    1de4:	6a 00                	push   $0x0
    1de6:	53                   	push   %ebx
    1de7:	51                   	push   %ecx
    1de8:	ff 75 84             	pushl  -0x7c(%ebp)
    1deb:	57                   	push   %edi
    1dec:	e8 a6 f6 ff ff       	call   1497 <APDcCopy>
    1df1:	83 c4 30             	add    $0x30,%esp
                    break;
    1df4:	e9 41 03 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1df9:	8d 45 88             	lea    -0x78(%ebp),%eax
    1dfc:	6a 69                	push   $0x69
    1dfe:	6a 69                	push   $0x69
    1e00:	6a 69                	push   $0x69
    1e02:	50                   	push   %eax
    1e03:	e8 33 f8 ff ff       	call   163b <RGB>
    1e08:	83 c4 0c             	add    $0xc,%esp
    1e0b:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1e0f:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1e13:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1e17:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1e1a:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1e21:	8d 45 88             	lea    -0x78(%ebp),%eax
    1e24:	6a 69                	push   $0x69
    1e26:	6a 69                	push   $0x69
    1e28:	6a 69                	push   $0x69
    1e2a:	50                   	push   %eax
    1e2b:	e8 0b f8 ff ff       	call   163b <RGB>
    1e30:	83 c4 0c             	add    $0xc,%esp
    1e33:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1e37:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1e3b:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1e3f:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1e42:	8b 45 08             	mov    0x8(%ebp),%eax
    1e45:	8d 50 3c             	lea    0x3c(%eax),%edx
    1e48:	8d 45 88             	lea    -0x78(%ebp),%eax
    1e4b:	ff 75 ac             	pushl  -0x54(%ebp)
    1e4e:	ff 75 a8             	pushl  -0x58(%ebp)
    1e51:	52                   	push   %edx
    1e52:	50                   	push   %eax
    1e53:	e8 d0 ee ff ff       	call   d28 <APSetPen>
    1e58:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1e5b:	8b 45 08             	mov    0x8(%ebp),%eax
    1e5e:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1e61:	8d 55 88             	lea    -0x78(%ebp),%edx
    1e64:	83 ec 04             	sub    $0x4,%esp
    1e67:	83 ec 04             	sub    $0x4,%esp
    1e6a:	89 e0                	mov    %esp,%eax
    1e6c:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1e70:	66 89 08             	mov    %cx,(%eax)
    1e73:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    1e77:	88 48 02             	mov    %cl,0x2(%eax)
    1e7a:	53                   	push   %ebx
    1e7b:	52                   	push   %edx
    1e7c:	e8 e0 ee ff ff       	call   d61 <APSetBrush>
    1e81:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1e84:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1e87:	6b d0 32             	imul   $0x32,%eax,%edx
    1e8a:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1e8d:	6b c0 32             	imul   $0x32,%eax,%eax
    1e90:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1e93:	83 c1 3c             	add    $0x3c,%ecx
    ...
    1e9e:	50                   	push   %eax
    1e9f:	51                   	push   %ecx
    1ea0:	e8 e6 f2 ff ff       	call   118b <APDrawRect>
    1ea5:	83 c4 20             	add    $0x20,%esp
                    break;
    1ea8:	e9 8d 02 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ead:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1eb0:	6a 0c                	push   $0xc
    1eb2:	6a 0c                	push   $0xc
    1eb4:	6a 0c                	push   $0xc
    1eb6:	50                   	push   %eax
    1eb7:	e8 7f f7 ff ff       	call   163b <RGB>
    1ebc:	83 c4 0c             	add    $0xc,%esp
    1ebf:	8b 1d 5c 6c 00 00    	mov    0x6c5c,%ebx
    ...
    1ee2:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1ee6:	66 89 30             	mov    %si,(%eax)
    1ee9:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    1efd:	57                   	push   %edi
    1efe:	e8 94 f5 ff ff       	call   1497 <APDcCopy>
    1f03:	83 c4 30             	add    $0x30,%esp
                    break;
    1f06:	e9 2f 02 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f0b:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1f0e:	6a 0c                	push   $0xc
    1f10:	6a 0c                	push   $0xc
    1f12:	6a 0c                	push   $0xc
    1f14:	50                   	push   %eax
    1f15:	e8 21 f7 ff ff       	call   163b <RGB>
    1f1a:	83 c4 0c             	add    $0xc,%esp
    1f1d:	8b 1d 38 6c 00 00    	mov    0x6c38,%ebx
    ...
    1f40:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1f44:	66 89 30             	mov    %si,(%eax)
    1f47:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    1f5b:	57                   	push   %edi
    1f5c:	e8 36 f5 ff ff       	call   1497 <APDcCopy>
    1f61:	83 c4 30             	add    $0x30,%esp
                    break;
    1f64:	e9 d1 01 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f69:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1f6c:	6a 0c                	push   $0xc
    1f6e:	6a 0c                	push   $0xc
    1f70:	6a 0c                	push   $0xc
    1f72:	50                   	push   %eax
    1f73:	e8 c3 f6 ff ff       	call   163b <RGB>
    1f78:	83 c4 0c             	add    $0xc,%esp
    1f7b:	8b 1d 10 6c 00 00    	mov    0x6c10,%ebx
    ...
    1f9e:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1fa2:	66 89 30             	mov    %si,(%eax)
    1fa5:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    1fb9:	57                   	push   %edi
    1fba:	e8 d8 f4 ff ff       	call   1497 <APDcCopy>
    1fbf:	83 c4 30             	add    $0x30,%esp
                    break;
    1fc2:	e9 73 01 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fc7:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1fca:	6a 0c                	push   $0xc
    1fcc:	6a 0c                	push   $0xc
    1fce:	6a 0c                	push   $0xc
    1fd0:	50                   	push   %eax
    1fd1:	e8 65 f6 ff ff       	call   163b <RGB>
    1fd6:	83 c4 0c             	add    $0xc,%esp
    1fd9:	8b 1d 58 6c 00 00    	mov    0x6c58,%ebx
    ...
    1ffc:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    2000:	66 89 30             	mov    %si,(%eax)
    2003:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    2017:	57                   	push   %edi
    2018:	e8 7a f4 ff ff       	call   1497 <APDcCopy>
    201d:	83 c4 30             	add    $0x30,%esp
                    break;
    2020:	e9 15 01 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2025:	8d 45 cf             	lea    -0x31(%ebp),%eax
    2028:	6a 0c                	push   $0xc
    202a:	6a 0c                	push   $0xc
    202c:	6a 0c                	push   $0xc
    202e:	50                   	push   %eax
    202f:	e8 07 f6 ff ff       	call   163b <RGB>
    2034:	83 c4 0c             	add    $0xc,%esp
    2037:	8b 1d e0 6b 00 00    	mov    0x6be0,%ebx
    203d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2040:	6b c8 32             	imul   $0x32,%eax,%ecx
    2043:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2046:	6b c0 32             	imul   $0x32,%eax,%eax
    2049:	89 45 84             	mov    %eax,-0x7c(%ebp)
    204c:	8b 45 08             	mov    0x8(%ebp),%eax
    204f:	8d 78 3c             	lea    0x3c(%eax),%edi
    2052:	83 ec 0c             	sub    $0xc,%esp
    2055:	83 ec 04             	sub    $0x4,%esp
    2058:	89 e0                	mov    %esp,%eax
    205a:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    205e:	66 89 30             	mov    %si,(%eax)
    2061:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2065:	88 50 02             	mov    %dl,0x2(%eax)
    2068:	6a 32                	push   $0x32
    206a:	6a 32                	push   $0x32
    206c:	6a 00                	push   $0x0
    206e:	6a 00                	push   $0x0
    2070:	53                   	push   %ebx
    2071:	51                   	push   %ecx
    2072:	ff 75 84             	pushl  -0x7c(%ebp)
    2075:	57                   	push   %edi
    2076:	e8 1c f4 ff ff       	call   1497 <APDcCopy>
    207b:	83 c4 30             	add    $0x30,%esp
                    break;
    207e:	e9 b7 00 00 00       	jmp    213a <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2083:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2086:	6a 0c                	push   $0xc
    2088:	6a 0c                	push   $0xc
    208a:	6a 0c                	push   $0xc
    208c:	50                   	push   %eax
    208d:	e8 a9 f5 ff ff       	call   163b <RGB>
    2092:	83 c4 0c             	add    $0xc,%esp
    2095:	8b 1d fc 6b 00 00    	mov    0x6bfc,%ebx
    209b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    209e:	6b c8 32             	imul   $0x32,%eax,%ecx
    20a1:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20a4:	6b c0 32             	imul   $0x32,%eax,%eax
    20a7:	89 45 84             	mov    %eax,-0x7c(%ebp)
    20aa:	8b 45 08             	mov    0x8(%ebp),%eax
    20ad:	8d 78 3c             	lea    0x3c(%eax),%edi
    20b0:	83 ec 0c             	sub    $0xc,%esp
    20b3:	83 ec 04             	sub    $0x4,%esp
    20b6:	89 e0                	mov    %esp,%eax
    20b8:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    20bc:	66 89 30             	mov    %si,(%eax)
    20bf:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    20c3:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    20ce:	53                   	push   %ebx
    20cf:	51                   	push   %ecx
    20d0:	ff 75 84             	pushl  -0x7c(%ebp)
    20d3:	57                   	push   %edi
    20d4:	e8 be f3 ff ff       	call   1497 <APDcCopy>
    20d9:	83 c4 30             	add    $0x30,%esp
                    break;
    20dc:	eb 5c                	jmp    213a <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    20de:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    20e1:	6a 0c                	push   $0xc
    20e3:	6a 0c                	push   $0xc
    20e5:	6a 0c                	push   $0xc
    20e7:	50                   	push   %eax
    20e8:	e8 4e f5 ff ff       	call   163b <RGB>
    20ed:	83 c4 0c             	add    $0xc,%esp
    20f0:	8b 1d 54 6c 00 00    	mov    0x6c54,%ebx
    20f6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20f9:	6b c8 32             	imul   $0x32,%eax,%ecx
    20fc:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20ff:	6b c0 32             	imul   $0x32,%eax,%eax
    2102:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2105:	8b 45 08             	mov    0x8(%ebp),%eax
    2108:	8d 78 3c             	lea    0x3c(%eax),%edi
    210b:	83 ec 0c             	sub    $0xc,%esp
    210e:	83 ec 04             	sub    $0x4,%esp
    2111:	89 e0                	mov    %esp,%eax
    2113:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    2117:	66 89 30             	mov    %si,(%eax)
    211a:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    211e:	88 50 02             	mov    %dl,0x2(%eax)
    2121:	6a 32                	push   $0x32
    2123:	6a 32                	push   $0x32
    2125:	6a 00                	push   $0x0
    2127:	6a 00                	push   $0x0
    2129:	53                   	push   %ebx
    212a:	51                   	push   %ecx
    212b:	ff 75 84             	pushl  -0x7c(%ebp)
    212e:	57                   	push   %edi
    212f:	e8 63 f3 ff ff       	call   1497 <APDcCopy>
    2134:	83 c4 30             	add    $0x30,%esp
                    break;
    2137:	eb 01                	jmp    213a <APGridPaint+0x6e5>
                default: break;
    2139:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    213a:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    213e:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2142:	0f 8e 1c fc ff ff    	jle    1d64 <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2148:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    214c:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    2150:	0f 8e 02 fc ff ff    	jle    1d58 <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    2159:	68 cd 00 00 00       	push   $0xcd
    215e:	6a 74                	push   $0x74
    2160:	6a 18                	push   $0x18
    2162:	50                   	push   %eax
    2163:	e8 d3 f4 ff ff       	call   163b <RGB>
    2168:	83 c4 0c             	add    $0xc,%esp
    216b:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    216f:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    2173:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2177:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    217a:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2181:	8d 45 88             	lea    -0x78(%ebp),%eax
    2184:	68 cd 00 00 00       	push   $0xcd
    2189:	6a 74                	push   $0x74
    218b:	6a 18                	push   $0x18
    218d:	50                   	push   %eax
    218e:	e8 a8 f4 ff ff       	call   163b <RGB>
    2193:	83 c4 0c             	add    $0xc,%esp
    2196:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    219a:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    219e:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    21a2:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    21a5:	8b 45 08             	mov    0x8(%ebp),%eax
    21a8:	8d 50 58             	lea    0x58(%eax),%edx
    21ab:	8d 45 88             	lea    -0x78(%ebp),%eax
    21ae:	ff 75 bc             	pushl  -0x44(%ebp)
    21b1:	ff 75 b8             	pushl  -0x48(%ebp)
    21b4:	52                   	push   %edx
    21b5:	50                   	push   %eax
    21b6:	e8 6d eb ff ff       	call   d28 <APSetPen>
    21bb:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    21be:	8b 45 08             	mov    0x8(%ebp),%eax
    21c1:	8d 58 58             	lea    0x58(%eax),%ebx
    21c4:	8d 55 88             	lea    -0x78(%ebp),%edx
    21c7:	83 ec 04             	sub    $0x4,%esp
    21ca:	83 ec 04             	sub    $0x4,%esp
    21cd:	89 e0                	mov    %esp,%eax
    21cf:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    21d3:	66 89 08             	mov    %cx,(%eax)
    21d6:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    21da:	88 48 02             	mov    %cl,0x2(%eax)
    21dd:	53                   	push   %ebx
    21de:	52                   	push   %edx
    21df:	e8 7d eb ff ff       	call   d61 <APSetBrush>
    21e4:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    21e7:	8b 45 08             	mov    0x8(%ebp),%eax
    21ea:	83 c0 58             	add    $0x58,%eax
    21ed:	83 ec 0c             	sub    $0xc,%esp
    21f0:	6a 32                	push   $0x32
    21f2:	68 20 03 00 00       	push   $0x320
    21f7:	6a 00                	push   $0x0
    21f9:	6a 00                	push   $0x0
    21fb:	50                   	push   %eax
    21fc:	e8 8a ef ff ff       	call   118b <APDrawRect>
    2201:	83 c4 20             	add    $0x20,%esp


    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    2204:	8d 45 88             	lea    -0x78(%ebp),%eax
    2207:	6a 08                	push   $0x8
    2209:	6a 08                	push   $0x8
    220b:	6a 08                	push   $0x8
    220d:	50                   	push   %eax
    220e:	e8 28 f4 ff ff       	call   163b <RGB>
    2213:	83 c4 0c             	add    $0xc,%esp
    2216:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    221a:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    221e:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2222:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    2236:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    223a:	66 89 08             	mov    %cx,(%eax)
    223d:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    2241:	88 48 02             	mov    %cl,0x2(%eax)
    2244:	53                   	push   %ebx
    2245:	52                   	push   %edx
    2246:	e8 58 eb ff ff       	call   da3 <APSetFont>
    224b:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    224e:	8b 45 08             	mov    0x8(%ebp),%eax
    2251:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    2257:	8b 45 08             	mov    0x8(%ebp),%eax
    225a:	83 c0 58             	add    $0x58,%eax
    225d:	6a 14                	push   $0x14
    225f:	6a 14                	push   $0x14
    2261:	52                   	push   %edx
    2262:	50                   	push   %eax
    2263:	e8 28 f1 ff ff       	call   1390 <APDrawText>
