...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
    ...
    mknod("console", 1, 1);
      ...
      2a:	6a 01                	push   $0x1
      2c:	6a 01                	push   $0x1
      2e:	68 47 21 00 00       	push   $0x2147
      33:	e8 68 03 00 00       	call   3a0 <mknod>
      38:	83 c4 10             	add    $0x10,%esp
    open("console", O_RDWR);
      3b:	83 ec 08             	sub    $0x8,%esp
      3e:	6a 02                	push   $0x2
      40:	68 47 21 00 00       	push   $0x2147
  ...
  for(;;){
    ...
    if(pid == 0){
     ...
     // exec("sh", argv);
      ...
      a7:	68 34 28 00 00       	push   $0x2834
      ac:	68 7c 21 00 00       	push   $0x217c
      b1:	e8 da 02 00 00       	call   390 <exec>
      b6:	83 c4 10             	add    $0x10,%esp
      printf(1, "init: exec desktop failed\n");
      b9:	83 ec 08             	sub    $0x8,%esp
      bc:	68 86 21 00 00       	push   $0x2186
      c1:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     49b:	0f b6 80 3c 28 00 00 	movzbl 0x283c(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     5d7:	75 25                	jne    5fe <printf+0xff>
          s = "(null)";
     5d9:	c7 45 f4 aa 21 00 00 	movl   $0x21aa,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     69f:	a1 6c 28 00 00       	mov    0x286c,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     76a:	a3 6c 28 00 00       	mov    %eax,0x286c
}
     76f:	90                   	nop
     770:	c9                   	leave  
     771:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     7cb:	a1 6c 28 00 00       	mov    0x286c,%eax
}
     7d0:	c9                   	leave  
     7d1:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     7e7:	a1 6c 28 00 00       	mov    0x286c,%eax
     7ec:	89 45 f0             	mov    %eax,-0x10(%ebp)
     7ef:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     7f3:	75 23                	jne    818 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     7f5:	c7 45 f0 64 28 00 00 	movl   $0x2864,-0x10(%ebp)
     7fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
     7ff:	a3 6c 28 00 00       	mov    %eax,0x286c
     804:	a1 6c 28 00 00       	mov    0x286c,%eax
     809:	a3 64 28 00 00       	mov    %eax,0x2864
    base.s.size = 0;
     80e:	c7 05 68 28 00 00 00 	movl   $0x0,0x2868
     815:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     86b:	a3 6c 28 00 00       	mov    %eax,0x286c
      return (void*)(p + 1);
    ...
    if(p == freep)
     878:	a1 6c 28 00 00       	mov    0x286c,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     9b6:	79 2e                	jns    9e6 <APLoadBitmap+0x61>
    {
     ...
     9be:	68 b1 21 00 00       	push   $0x21b1
     9c3:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    14a6:	68 c4 21 00 00       	push   $0x21c4
    14ab:	6a 01                	push   $0x1
    ...
    1519:	68 e4 21 00 00       	push   $0x21e4
    151e:	6a 01                	push   $0x1
    ...
    15bd:	68 08 22 00 00       	push   $0x2208
    15c2:	6a 01                	push   $0x1
    ...
    168e:	68 30 22 00 00       	push   $0x2230
    1693:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1a20:	68 c4 22 00 00       	push   $0x22c4
    1a25:	6a 01                	push   $0x1
    ...
    1a51:	68 ea 22 00 00       	push   $0x22ea
    1a56:	6a 01                	push   $0x1
    ...
    1ac0:	8b 04 85 00 23 00 00 	mov    0x2300(,%eax,4),%eax
    1ac7:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1adb:	8b 1d a0 28 00 00    	mov    0x28a0,%ebx
    ...
    1bed:	8b 1d e0 28 00 00    	mov    0x28e0,%ebx
    ...
    1c4b:	8b 1d c0 28 00 00    	mov    0x28c0,%ebx
    ...
    1ca9:	8b 1d a4 28 00 00    	mov    0x28a4,%ebx
    ...
    1d07:	8b 1d dc 28 00 00    	mov    0x28dc,%ebx
    ...
    1d65:	8b 1d 74 28 00 00    	mov    0x2874,%ebx
    ...
    1dc0:	8b 1d 90 28 00 00    	mov    0x2890,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1e35:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1e3c:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1e40:	74 17                	je     1e59 <sprintint+0x2b>
    1e42:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1e46:	79 11                	jns    1e59 <sprintint+0x2b>
        neg = 1;
    1e48:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1e4f:	8b 45 10             	mov    0x10(%ebp),%eax
    1e52:	f7 d8                	neg    %eax
    1e54:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1e57:	eb 06                	jmp    1e5f <sprintint+0x31>
    } else {
        x = xx;
    1e59:	8b 45 10             	mov    0x10(%ebp),%eax
    1e5c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    1e5f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1e66:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1e69:	8d 41 01             	lea    0x1(%ecx),%eax
    1e6c:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1e6f:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1e72:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e75:	ba 00 00 00 00       	mov    $0x0,%edx
    1e7a:	f7 f3                	div    %ebx
    1e7c:	89 d0                	mov    %edx,%eax
    1e7e:	0f b6 80 50 28 00 00 	movzbl 0x2850(%eax),%eax
    1e85:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1e89:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1e8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e8f:	ba 00 00 00 00       	mov    $0x0,%edx
    1e94:	f7 f3                	div    %ebx
    1e96:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1e99:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e9d:	75 c7                	jne    1e66 <sprintint+0x38>
    if(neg)
    1e9f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1ea3:	74 0e                	je     1eb3 <sprintint+0x85>
        buf[i++] = '-';
    1ea5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1ea8:	8d 50 01             	lea    0x1(%eax),%edx
    1eab:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1eae:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1eb3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1eb6:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1eb9:	eb 1b                	jmp    1ed6 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1ebb:	8b 45 0c             	mov    0xc(%ebp),%eax
    1ebe:	8b 00                	mov    (%eax),%eax
    1ec0:	8d 48 01             	lea    0x1(%eax),%ecx
    1ec3:	8b 55 0c             	mov    0xc(%ebp),%edx
    1ec6:	89 0a                	mov    %ecx,(%edx)
    1ec8:	89 c2                	mov    %eax,%edx
    1eca:	8b 45 08             	mov    0x8(%ebp),%eax
    1ecd:	01 d0                	add    %edx,%eax
    1ecf:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1ed2:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1ed6:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1eda:	7f df                	jg     1ebb <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1edc:	eb 21                	jmp    1eff <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1ede:	8b 45 0c             	mov    0xc(%ebp),%eax
    1ee1:	8b 00                	mov    (%eax),%eax
    1ee3:	8d 48 01             	lea    0x1(%eax),%ecx
    1ee6:	8b 55 0c             	mov    0xc(%ebp),%edx
    1ee9:	89 0a                	mov    %ecx,(%edx)
    1eeb:	89 c2                	mov    %eax,%edx
    1eed:	8b 45 08             	mov    0x8(%ebp),%eax
    1ef0:	01 c2                	add    %eax,%edx
    1ef2:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1ef5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1ef8:	01 c8                	add    %ecx,%eax
    1efa:	0f b6 00             	movzbl (%eax),%eax
    1efd:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1eff:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1f03:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1f07:	79 d5                	jns    1ede <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1f09:	90                   	nop
    1f0a:	83 c4 20             	add    $0x20,%esp
    1f0d:	5b                   	pop    %ebx
    1f0e:	5d                   	pop    %ebp
    1f0f:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1f13:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1f16:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1f1d:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1f24:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1f2b:	8d 45 0c             	lea    0xc(%ebp),%eax
    1f2e:	83 c0 04             	add    $0x4,%eax
    1f31:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1f34:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1f3b:	e9 d9 01 00 00       	jmp    2119 <sprintf+0x209>
        c = fmt[i] & 0xff;
    1f40:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f43:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1f46:	01 d0                	add    %edx,%eax
    1f48:	0f b6 00             	movzbl (%eax),%eax
    1f4b:	0f be c0             	movsbl %al,%eax
    1f4e:	25 ff 00 00 00       	and    $0xff,%eax
    1f53:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1f56:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1f5a:	75 2c                	jne    1f88 <sprintf+0x78>
            if(c == '%'){
    1f5c:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1f60:	75 0c                	jne    1f6e <sprintf+0x5e>
                state = '%';
    1f62:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1f69:	e9 a7 01 00 00       	jmp    2115 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1f6e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1f71:	8d 50 01             	lea    0x1(%eax),%edx
    1f74:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1f77:	89 c2                	mov    %eax,%edx
    1f79:	8b 45 08             	mov    0x8(%ebp),%eax
    1f7c:	01 d0                	add    %edx,%eax
    1f7e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1f81:	88 10                	mov    %dl,(%eax)
    1f83:	e9 8d 01 00 00       	jmp    2115 <sprintf+0x205>
            }
        } else if(state == '%'){
    1f88:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1f8c:	0f 85 83 01 00 00    	jne    2115 <sprintf+0x205>
            if(c == 'd'){
    1f92:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1f96:	75 4c                	jne    1fe4 <sprintf+0xd4>
                buf[bi] = '\0';
    1f98:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f9e:	01 d0                	add    %edx,%eax
    1fa0:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1fa3:	83 ec 0c             	sub    $0xc,%esp
    1fa6:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1fa9:	50                   	push   %eax
    1faa:	e8 17 e3 ff ff       	call   2c6 <atoi>
    1faf:	83 c4 10             	add    $0x10,%esp
    1fb2:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    1fb5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    1fbc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fbf:	8b 00                	mov    (%eax),%eax
    1fc1:	83 ec 08             	sub    $0x8,%esp
    1fc4:	ff 75 d8             	pushl  -0x28(%ebp)
    1fc7:	6a 01                	push   $0x1
    1fc9:	6a 0a                	push   $0xa
    1fcb:	50                   	push   %eax
    1fcc:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1fcf:	50                   	push   %eax
    1fd0:	ff 75 08             	pushl  0x8(%ebp)
    1fd3:	e8 56 fe ff ff       	call   1e2e <sprintint>
    1fd8:	83 c4 20             	add    $0x20,%esp
                ap++;
    1fdb:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1fdf:	e9 2a 01 00 00       	jmp    210e <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    1fe4:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    1fe8:	74 06                	je     1ff0 <sprintf+0xe0>
    1fea:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    1fee:	75 4c                	jne    203c <sprintf+0x12c>
                buf[bi] = '\0';
    1ff0:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1ff3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1ff6:	01 d0                	add    %edx,%eax
    1ff8:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1ffb:	83 ec 0c             	sub    $0xc,%esp
    1ffe:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2001:	50                   	push   %eax
    2002:	e8 bf e2 ff ff       	call   2c6 <atoi>
    2007:	83 c4 10             	add    $0x10,%esp
    200a:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    200d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2014:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2017:	8b 00                	mov    (%eax),%eax
    2019:	83 ec 08             	sub    $0x8,%esp
    201c:	ff 75 dc             	pushl  -0x24(%ebp)
    201f:	6a 00                	push   $0x0
    2021:	6a 10                	push   $0x10
    2023:	50                   	push   %eax
    2024:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2027:	50                   	push   %eax
    2028:	ff 75 08             	pushl  0x8(%ebp)
    202b:	e8 fe fd ff ff       	call   1e2e <sprintint>
    ...
    2037:	e9 d2 00 00 00       	jmp    210e <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    203c:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2040:	75 46                	jne    2088 <sprintf+0x178>
                s = (char*)*ap;
    2042:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2045:	8b 00                	mov    (%eax),%eax
    2047:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    204a:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    204e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2052:	75 25                	jne    2079 <sprintf+0x169>
                    s = "(null)";
    2054:	c7 45 f4 20 23 00 00 	movl   $0x2320,-0xc(%ebp)
                while(*s != 0){
    205b:	eb 1c                	jmp    2079 <sprintf+0x169>
                    dst[j++] = *s;
    205d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2060:	8d 50 01             	lea    0x1(%eax),%edx
    2063:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2066:	89 c2                	mov    %eax,%edx
    2068:	8b 45 08             	mov    0x8(%ebp),%eax
    206b:	01 c2                	add    %eax,%edx
    206d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2070:	0f b6 00             	movzbl (%eax),%eax
    2073:	88 02                	mov    %al,(%edx)
                    s++;
    2075:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    2079:	8b 45 f4             	mov    -0xc(%ebp),%eax
    207c:	0f b6 00             	movzbl (%eax),%eax
    207f:	84 c0                	test   %al,%al
    2081:	75 da                	jne    205d <sprintf+0x14d>
    2083:	e9 86 00 00 00       	jmp    210e <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    2088:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    208c:	75 1d                	jne    20ab <sprintf+0x19b>
                dst[j++] = *ap;
    208e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2091:	8d 50 01             	lea    0x1(%eax),%edx
    2094:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2097:	89 c2                	mov    %eax,%edx
    2099:	8b 45 08             	mov    0x8(%ebp),%eax
    209c:	01 c2                	add    %eax,%edx
    209e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20a1:	8b 00                	mov    (%eax),%eax
    20a3:	88 02                	mov    %al,(%edx)
                ap++;
    20a5:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    20a9:	eb 63                	jmp    210e <sprintf+0x1fe>
            } else if(c == '%'){
    20ab:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    20af:	75 17                	jne    20c8 <sprintf+0x1b8>
                dst[j++] = c;
    20b1:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20b4:	8d 50 01             	lea    0x1(%eax),%edx
    20b7:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20ba:	89 c2                	mov    %eax,%edx
    20bc:	8b 45 08             	mov    0x8(%ebp),%eax
    20bf:	01 d0                	add    %edx,%eax
    20c1:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20c4:	88 10                	mov    %dl,(%eax)
    20c6:	eb 46                	jmp    210e <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    20c8:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    20cc:	7e 18                	jle    20e6 <sprintf+0x1d6>
    20ce:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    20d2:	7f 12                	jg     20e6 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    20d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    20d7:	8d 50 01             	lea    0x1(%eax),%edx
    20da:	89 55 f0             	mov    %edx,-0x10(%ebp)
    20dd:	8b 55 e0             	mov    -0x20(%ebp),%edx
    20e0:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    20e4:	eb 2f                	jmp    2115 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    20e6:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20e9:	8d 50 01             	lea    0x1(%eax),%edx
    20ec:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20ef:	89 c2                	mov    %eax,%edx
    20f1:	8b 45 08             	mov    0x8(%ebp),%eax
    20f4:	01 d0                	add    %edx,%eax
    20f6:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    20f9:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20fc:	8d 50 01             	lea    0x1(%eax),%edx
    20ff:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2102:	89 c2                	mov    %eax,%edx
    2104:	8b 45 08             	mov    0x8(%ebp),%eax
    2107:	01 d0                	add    %edx,%eax
    2109:	8b 55 e0             	mov    -0x20(%ebp),%edx
    210c:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    210e:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2115:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2119:	8b 55 0c             	mov    0xc(%ebp),%edx
    211c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    211f:	01 d0                	add    %edx,%eax
    2121:	0f b6 00             	movzbl (%eax),%eax
    2124:	84 c0                	test   %al,%al
    2126:	0f 85 14 fe ff ff    	jne    1f40 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    212c:	8b 45 c8             	mov    -0x38(%ebp),%eax
    212f:	8d 50 01             	lea    0x1(%eax),%edx
    2132:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2135:	89 c2                	mov    %eax,%edx
    2137:	8b 45 08             	mov    0x8(%ebp),%eax
    213a:	01 d0                	add    %edx,%eax
    213c:	c6 00 00             	movb   $0x0,(%eax)
}
    213f:	90                   	nop
    2140:	c9                   	leave  
    2141:	c3                   	ret    
