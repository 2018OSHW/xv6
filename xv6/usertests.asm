...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 54 81 00 00       	mov    0x8154,%eax
       b:	83 ec 08             	sub    $0x8,%esp
       e:	68 0e 5f 00 00       	push   $0x5f0e
      13:	50                   	push   %eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      37:	a1 54 81 00 00       	mov    0x8154,%eax
      3c:	83 ec 08             	sub    $0x8,%esp
      3f:	68 19 5f 00 00       	push   $0x5f19
      44:	50                   	push   %eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7b:	a1 54 81 00 00       	mov    0x8154,%eax
      80:	83 ec 08             	sub    $0x8,%esp
      83:	68 39 5f 00 00       	push   $0x5f39
      88:	50                   	push   %eax
  ...
  printf(stdout, "open test ok\n");
      96:	a1 54 81 00 00       	mov    0x8154,%eax
      9b:	83 ec 08             	sub    $0x8,%esp
      9e:	68 57 5f 00 00       	push   $0x5f57
      a3:	50                   	push   %eax
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b5:	a1 54 81 00 00       	mov    0x8154,%eax
      ba:	83 ec 08             	sub    $0x8,%esp
      bd:	68 65 5f 00 00       	push   $0x5f65
      c2:	50                   	push   %eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e9:	a1 54 81 00 00       	mov    0x8154,%eax
      ee:	83 ec 08             	sub    $0x8,%esp
      f1:	68 7c 5f 00 00       	push   $0x5f7c
      f6:	50                   	push   %eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     10b:	a1 54 81 00 00       	mov    0x8154,%eax
     110:	83 ec 08             	sub    $0x8,%esp
     113:	68 97 5f 00 00       	push   $0x5f97
     118:	50                   	push   %eax
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     129:	6a 0a                	push   $0xa
     12b:	68 b3 5f 00 00       	push   $0x5fb3
     ...
     140:	a1 54 81 00 00       	mov    0x8154,%eax
     145:	83 ec 04             	sub    $0x4,%esp
     148:	ff 75 f4             	pushl  -0xc(%ebp)
     14b:	68 c0 5f 00 00       	push   $0x5fc0
     150:	50                   	push   %eax
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     161:	6a 0a                	push   $0xa
     163:	68 e4 5f 00 00       	push   $0x5fe4
     ...
     178:	a1 54 81 00 00       	mov    0x8154,%eax
     17d:	83 ec 04             	sub    $0x4,%esp
     180:	ff 75 f4             	pushl  -0xc(%ebp)
     183:	68 f0 5f 00 00       	push   $0x5ff0
     188:	50                   	push   %eax
  ...
  printf(stdout, "writes ok\n");
     1a0:	a1 54 81 00 00       	mov    0x8154,%eax
     1a5:	83 ec 08             	sub    $0x8,%esp
     1a8:	68 14 60 00 00       	push   $0x6014
     1ad:	50                   	push   %eax
  ...
  fd = open("small", O_RDONLY);
     ...
     1c7:	6a 00                	push   $0x0
     1c9:	68 76 5f 00 00       	push   $0x5f76
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1df:	a1 54 81 00 00       	mov    0x8154,%eax
     1e4:	83 ec 08             	sub    $0x8,%esp
     1e7:	68 1f 60 00 00       	push   $0x601f
     1ec:	50                   	push   %eax
  ...
  i = read(fd, buf, 2000);
     ...
     1fd:	68 80 e5 00 00       	push   $0xe580
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     21b:	a1 54 81 00 00       	mov    0x8154,%eax
     220:	83 ec 08             	sub    $0x8,%esp
     223:	68 38 60 00 00       	push   $0x6038
     228:	50                   	push   %eax
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     236:	a1 54 81 00 00       	mov    0x8154,%eax
     23b:	83 ec 08             	sub    $0x8,%esp
     23e:	68 53 60 00 00       	push   $0x6053
     243:	50                   	push   %eax
  ...
  if(unlink("small") < 0){
     ...
     25d:	68 76 5f 00 00       	push   $0x5f76
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     270:	a1 54 81 00 00       	mov    0x8154,%eax
     275:	83 ec 08             	sub    $0x8,%esp
     278:	68 66 60 00 00       	push   $0x6066
     27d:	50                   	push   %eax
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28b:	a1 54 81 00 00       	mov    0x8154,%eax
     290:	83 ec 08             	sub    $0x8,%esp
     293:	68 73 60 00 00       	push   $0x6073
     298:	50                   	push   %eax
  ...
  printf(stdout, "small file test ok\n");
     2a6:	a1 54 81 00 00       	mov    0x8154,%eax
     2ab:	83 ec 08             	sub    $0x8,%esp
     2ae:	68 88 60 00 00       	push   $0x6088
     2b3:	50                   	push   %eax
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c5:	a1 54 81 00 00       	mov    0x8154,%eax
     2ca:	83 ec 08             	sub    $0x8,%esp
     2cd:	68 9c 60 00 00       	push   $0x609c
     2d2:	50                   	push   %eax
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e3:	68 ac 60 00 00       	push   $0x60ac
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f9:	a1 54 81 00 00       	mov    0x8154,%eax
     2fe:	83 ec 08             	sub    $0x8,%esp
     301:	68 b0 60 00 00       	push   $0x60b0
     306:	50                   	push   %eax
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     346:	a1 54 81 00 00       	mov    0x8154,%eax
     34b:	83 ec 04             	sub    $0x4,%esp
     34e:	ff 75 f4             	pushl  -0xc(%ebp)
     351:	68 ca 60 00 00       	push   $0x60ca
     356:	50                   	push   %eax
  ...
  fd = open("big", O_RDONLY);
     ...
     383:	6a 00                	push   $0x0
     385:	68 ac 60 00 00       	push   $0x60ac
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39b:	a1 54 81 00 00       	mov    0x8154,%eax
     3a0:	83 ec 08             	sub    $0x8,%esp
     3a3:	68 e8 60 00 00       	push   $0x60e8
     3a8:	50                   	push   %eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c5:	68 80 e5 00 00       	push   $0xe580
    ...
    if(i == 0){
     ...
     3e7:	a1 54 81 00 00       	mov    0x8154,%eax
     3ec:	83 ec 04             	sub    $0x4,%esp
     3ef:	ff 75 f0             	pushl  -0x10(%ebp)
     3f2:	68 01 61 00 00       	push   $0x6101
     3f7:	50                   	push   %eax
     ...
     40e:	a1 54 81 00 00       	mov    0x8154,%eax
     413:	83 ec 04             	sub    $0x4,%esp
     416:	ff 75 f4             	pushl  -0xc(%ebp)
     419:	68 1e 61 00 00       	push   $0x611e
     41e:	50                   	push   %eax
    ...
    if(((int*)buf)[0] != n){
     ...
     43f:	a1 54 81 00 00       	mov    0x8154,%eax
     444:	52                   	push   %edx
     445:	ff 75 f0             	pushl  -0x10(%ebp)
     448:	68 30 61 00 00       	push   $0x6130
     44d:	50                   	push   %eax
  ...
  if(unlink("big") < 0){
     ...
     476:	68 ac 60 00 00       	push   $0x60ac
    ...
    printf(stdout, "unlink big failed\n");
     487:	a1 54 81 00 00       	mov    0x8154,%eax
     48c:	83 ec 08             	sub    $0x8,%esp
     48f:	68 50 61 00 00       	push   $0x6150
     494:	50                   	push   %eax
  ...
  printf(stdout, "big files ok\n");
     4a2:	a1 54 81 00 00       	mov    0x8154,%eax
     4a7:	83 ec 08             	sub    $0x8,%esp
     4aa:	68 63 61 00 00       	push   $0x6163
     4af:	50                   	push   %eax
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4c1:	a1 54 81 00 00       	mov    0x8154,%eax
     4c6:	83 ec 08             	sub    $0x8,%esp
     4c9:	68 74 61 00 00       	push   $0x6174
     4ce:	50                   	push   %eax
     4cf:	e8 ee 38 00 00       	call   3dc2 <printf>
     4d4:	83 c4 10             	add    $0x10,%esp

  name[0] = 'a';
     4d7:	c6 05 80 05 01 00 61 	movb   $0x61,0x10580
  name[2] = '\0';
     4de:	c6 05 82 05 01 00 00 	movb   $0x0,0x10582
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     4f4:	a2 81 05 01 00       	mov    %al,0x10581
    fd = open(name, O_CREATE|O_RDWR);
     4f9:	83 ec 08             	sub    $0x8,%esp
     4fc:	68 02 02 00 00       	push   $0x202
     501:	68 80 05 01 00       	push   $0x10580
  ...
  name[0] = 'a';
     529:	c6 05 80 05 01 00 61 	movb   $0x61,0x10580
  name[2] = '\0';
     530:	c6 05 82 05 01 00 00 	movb   $0x0,0x10582
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     546:	a2 81 05 01 00       	mov    %al,0x10581
    unlink(name);
     54b:	83 ec 0c             	sub    $0xc,%esp
     54e:	68 80 05 01 00       	push   $0x10580
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     565:	a1 54 81 00 00       	mov    0x8154,%eax
     56a:	83 ec 08             	sub    $0x8,%esp
     56d:	68 9c 61 00 00       	push   $0x619c
     572:	50                   	push   %eax
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     584:	a1 54 81 00 00       	mov    0x8154,%eax
     589:	83 ec 08             	sub    $0x8,%esp
     58c:	68 c2 61 00 00       	push   $0x61c2
     591:	50                   	push   %eax
  ...
  printf(stdout, "mkdir test\n");
     656:	a1 54 81 00 00       	mov    0x8154,%eax
     65b:	83 ec 08             	sub    $0x8,%esp
     65e:	68 c2 61 00 00       	push   $0x61c2
     663:	50                   	push   %eax
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     6de:	68 39 62 00 00       	push   $0x6239
     6e3:	6a 01                	push   $0x1
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     73a:	05 80 e5 00 00       	add    $0xe580,%eax
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     759:	68 80 e5 00 00       	push   $0xe580
     75e:	50                   	push   %eax
     ...
     771:	68 48 62 00 00       	push   $0x6248
     776:	6a 01                	push   $0x1
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c9:	05 80 e5 00 00       	add    $0xe580,%eax
     ...
     7e9:	68 56 62 00 00       	push   $0x6256
     7ee:	6a 01                	push   $0x1
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     82c:	68 80 e5 00 00       	push   $0xe580
     831:	50                   	push   %eax
    ...
    if(total != 5 * 1033){
     ...
     856:	68 64 62 00 00       	push   $0x6264
     85b:	6a 01                	push   $0x1
  ...
  printf(1, "pipe1 ok\n");
     ...
     881:	68 8a 62 00 00       	push   $0x628a
     886:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     ...
     895:	68 7b 62 00 00       	push   $0x627b
     89a:	6a 01                	push   $0x1
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     8b4:	68 94 62 00 00       	push   $0x6294
     8b9:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     915:	6a 01                	push   $0x1
     917:	68 9e 62 00 00       	push   $0x629e
     91c:	50                   	push   %eax
     ...
     92d:	68 a0 62 00 00       	push   $0x62a0
     932:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     967:	68 80 e5 00 00       	push   $0xe580
     96c:	50                   	push   %eax
    ...
    printf(1, "preempt read error");
     ...
     97d:	68 b4 62 00 00       	push   $0x62b4
     982:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     ...
     9a0:	68 c7 62 00 00       	push   $0x62c7
     9a5:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     ...
     9dc:	68 d0 62 00 00       	push   $0x62d0
     9e1:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     ...
     9fd:	68 d9 62 00 00       	push   $0x62d9
     a02:	6a 01                	push   $0x1
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a2e:	68 e5 62 00 00       	push   $0x62e5
     a33:	6a 01                	push   $0x1
    ...
    if(pid){
     ...
     a52:	68 f2 62 00 00       	push   $0x62f2
     a57:	6a 01                	push   $0x1
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     a75:	68 02 63 00 00       	push   $0x6302
     a7a:	6a 01                	push   $0x1
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     a8f:	68 0f 63 00 00       	push   $0x630f
     a94:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b28:	68 19 63 00 00       	push   $0x6319
     b2d:	6a 01                	push   $0x1
    ...
    printf(1, "mem ok\n");
     ...
     b5b:	68 33 63 00 00       	push   $0x6333
     b60:	6a 01                	push   $0x1
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     b80:	68 3b 63 00 00       	push   $0x633b
     b85:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     bc0:	68 54 63 00 00       	push   $0x6354
     bc5:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c25:	68 80 63 00 00       	push   $0x6380
     c2a:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     c64:	6a 00                	push   $0x0
     c66:	68 4a 63 00 00       	push   $0x634a
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     c7f:	68 a0 63 00 00       	push   $0x63a0
     c84:	6a 01                	push   $0x1
  ...
  unlink("sharedfd");
     ...
     d0b:	68 4a 63 00 00       	push   $0x634a
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     d2d:	68 cb 63 00 00       	push   $0x63cb
     d32:	6a 01                	push   $0x1
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d44:	68 d8 63 00 00       	push   $0x63d8
     d49:	6a 01                	push   $0x1
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     ...
     d63:	68 ed 63 00 00       	push   $0x63ed
     d68:	6a 01                	push   $0x1
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     ...
     da3:	68 e5 62 00 00       	push   $0x62e5
     da8:	6a 01                	push   $0x1
  ...
  fname = pid ? "f1" : "f2";
     ...
     dbd:	b8 fc 63 00 00       	mov    $0x63fc,%eax
     dc2:	eb 05                	jmp    dc9 <twofiles+0x6f>
     dc4:	b8 ff 63 00 00       	mov    $0x63ff,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ...
     deb:	68 02 64 00 00       	push   $0x6402
     df0:	6a 01                	push   $0x1
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e19:	50                   	push   %eax
     e1a:	68 80 e5 00 00       	push   $0xe580
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e38:	68 80 e5 00 00       	push   $0xe580
     ...
     e5a:	68 11 64 00 00       	push   $0x6411
     e5f:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea8:	b8 fc 63 00 00       	mov    $0x63fc,%eax
     ead:	eb 05                	jmp    eb4 <twofiles+0x15a>
     eaf:	b8 ff 63 00 00       	mov    $0x63ff,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     eda:	05 80 e5 00 00       	add    $0xe580,%eax
     ...
     efe:	68 22 64 00 00       	push   $0x6422
     f03:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f2c:	68 80 e5 00 00       	push   $0xe580
    ...
    if(total != 12*500){
     ...
     f62:	68 2e 64 00 00       	push   $0x642e
     f67:	6a 01                	push   $0x1
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     ...
     fc2:	68 4c 64 00 00       	push   $0x644c
     fc7:	6a 01                	push   $0x1
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     ...
     fe2:	68 e5 62 00 00       	push   $0x62e5
     fe7:	6a 01                	push   $0x1
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	68 02 64 00 00       	push   $0x6402
    1049:	6a 01                	push   $0x1
    ...
    109e:	68 5f 64 00 00       	push   $0x645f
    10a3:	6a 01                	push   $0x1
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	50                   	push   %eax
    1116:	68 70 64 00 00       	push   $0x6470
    111b:	6a 01                	push   $0x1
    ...
    1142:	50                   	push   %eax
    1143:	68 94 64 00 00       	push   $0x6494
    1148:	6a 01                	push   $0x1
    ...
    11a4:	50                   	push   %eax
    11a5:	68 70 64 00 00       	push   $0x6470
    11aa:	6a 01                	push   $0x1
    ...
    11d1:	50                   	push   %eax
    11d2:	68 94 64 00 00       	push   $0x6494
    11d7:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    124d:	68 b4 64 00 00       	push   $0x64b4
    1252:	6a 01                	push   $0x1
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1268:	68 c5 64 00 00       	push   $0x64c5
    126d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    127f:	68 d6 64 00 00       	push   $0x64d6
  ...
  if(fd < 0){
    ...
    1298:	68 e1 64 00 00       	push   $0x64e1
    129d:	6a 01                	push   $0x1
  ...
  write(fd, "hello", 5);
    ...
    12af:	6a 05                	push   $0x5
    12b1:	68 fb 64 00 00       	push   $0x64fb
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12d2:	6a 02                	push   $0x2
    12d4:	68 d6 64 00 00       	push   $0x64d6
  ...
  if(fd < 0){
    ...
    12ed:	68 01 65 00 00       	push   $0x6501
    12f2:	6a 01                	push   $0x1
  ...
  if(unlink("unlinkread") != 0){
    ...
    1304:	68 d6 64 00 00       	push   $0x64d6
    ...
    1318:	68 19 65 00 00       	push   $0x6519
    131d:	6a 01                	push   $0x1
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1334:	68 d6 64 00 00       	push   $0x64d6
  ...
  write(fd1, "yyy", 3);
    ...
    1347:	6a 03                	push   $0x3
    1349:	68 33 65 00 00       	push   $0x6533
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    136f:	68 80 e5 00 00       	push   $0xe580
    ...
    1387:	68 37 65 00 00       	push   $0x6537
    138c:	6a 01                	push   $0x1
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13c0:	6a 0a                	push   $0xa
    13c2:	68 80 e5 00 00       	push   $0xe580
    ...
    13da:	68 65 65 00 00       	push   $0x6565
    13df:	6a 01                	push   $0x1
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    142a:	68 8d 65 00 00       	push   $0x658d
    142f:	6a 01                	push   $0x1
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    1461:	68 97 65 00 00       	push   $0x6597
  ...
  if(fd < 0){
    ...
    147a:	68 9f 65 00 00       	push   $0x659f
    147f:	6a 01                	push   $0x1
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1491:	6a 05                	push   $0x5
    1493:	68 fb 64 00 00       	push   $0x64fb
    ...
    14ab:	68 b2 65 00 00       	push   $0x65b2
    14b0:	6a 01                	push   $0x1
  ...
  if(link("lf1", "lf2") < 0){
    ...
    14d0:	68 9b 65 00 00       	push   $0x659b
    14d5:	68 97 65 00 00       	push   $0x6597
    ...
    14e9:	68 c4 65 00 00       	push   $0x65c4
    14ee:	6a 01                	push   $0x1
  ...
  unlink("lf1");
    ...
    1500:	68 97 65 00 00       	push   $0x6597
  ...
  if(open("lf1", 0) >= 0){
    ...
    1510:	6a 00                	push   $0x0
    1512:	68 97 65 00 00       	push   $0x6597
    ...
    1526:	68 dc 65 00 00       	push   $0x65dc
    152b:	6a 01                	push   $0x1
  ...
  fd = open("lf2", 0);
    ...
    153d:	6a 00                	push   $0x0
    153f:	68 9b 65 00 00       	push   $0x659b
  ...
  if(fd < 0){
    ...
    1558:	68 01 66 00 00       	push   $0x6601
    155d:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1574:	68 80 e5 00 00       	push   $0xe580
    ...
    158c:	68 12 66 00 00       	push   $0x6612
    1591:	6a 01                	push   $0x1
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    15b1:	68 9b 65 00 00       	push   $0x659b
    15b6:	68 9b 65 00 00       	push   $0x659b
    ...
    15ca:	68 23 66 00 00       	push   $0x6623
    15cf:	6a 01                	push   $0x1
  ...
  unlink("lf2");
    ...
    15e1:	68 9b 65 00 00       	push   $0x659b
    15e6:	e8 68 26 00 00       	call   3c53 <unlink>
    15eb:	83 c4 10             	add    $0x10,%esp
  if(link("lf2", "lf1") >= 0){
    15ee:	83 ec 08             	sub    $0x8,%esp
    15f1:	68 97 65 00 00       	push   $0x6597
    15f6:	68 9b 65 00 00       	push   $0x659b
    ...
    160a:	68 44 66 00 00       	push   $0x6644
    160f:	6a 01                	push   $0x1
  ...
  if(link(".", "lf1") >= 0){
    ...
    1621:	68 97 65 00 00       	push   $0x6597
    1626:	68 67 66 00 00       	push   $0x6667
    ...
    163a:	68 69 66 00 00       	push   $0x6669
    163f:	6a 01                	push   $0x1
  ...
  printf(1, "linktest ok\n");
    ...
    1651:	68 85 66 00 00       	push   $0x6685
    1656:	6a 01                	push   $0x1
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    166c:	68 92 66 00 00       	push   $0x6692
    1671:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    16dd:	50                   	push   %eax
    16de:	68 a2 66 00 00       	push   $0x66a2
    ...
    1721:	50                   	push   %eax
    1722:	68 a2 66 00 00       	push   $0x66a2
    ...
    1754:	50                   	push   %eax
    1755:	68 a5 66 00 00       	push   $0x66a5
    175a:	6a 01                	push   $0x1
  ...
  fd = open(".", 0);
    ...
    17ab:	6a 00                	push   $0x0
    17ad:	68 67 66 00 00       	push   $0x6667
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    180b:	50                   	push   %eax
    180c:	68 c1 66 00 00       	push   $0x66c1
    1811:	6a 01                	push   $0x1
    ...
    1838:	50                   	push   %eax
    1839:	68 da 66 00 00       	push   $0x66da
    183e:	6a 01                	push   $0x1
  ...
  if(n != 40){
    ...
    188f:	68 f8 66 00 00       	push   $0x66f8
    1894:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    18c9:	68 e5 62 00 00       	push   $0x62e5
    18ce:	6a 01                	push   $0x1
  ...
  printf(1, "concreate ok\n");
    ...
    1a01:	68 29 67 00 00       	push   $0x6729
    1a06:	6a 01                	push   $0x1
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1a1c:	68 37 67 00 00       	push   $0x6737
    1a21:	6a 01                	push   $0x1
  ...
  unlink("x");
    ...
    1a2e:	68 9e 62 00 00       	push   $0x629e
  ...
  if(pid < 0){
    ...
    1a4c:	68 e5 62 00 00       	push   $0x62e5
    1a51:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 100; i++){
    ...
    1ab8:	68 9e 62 00 00       	push   $0x629e
    ...
    1af3:	68 9e 62 00 00       	push   $0x629e
    1af8:	68 48 67 00 00       	push   $0x6748
    ...
    1b0a:	68 9e 62 00 00       	push   $0x629e
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b3a:	68 4c 67 00 00       	push   $0x674c
    1b3f:	6a 01                	push   $0x1
...
bigdir(void)
{
  ...
  fd = open("bd", O_CREATE);
    ...
    1b7c:	68 68 67 00 00       	push   $0x6768
  ...
  if(fd < 0){
    ...
    1b95:	68 6b 67 00 00       	push   $0x676b
    1b9a:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 500; i++){
    ...
    1bf6:	50                   	push   %eax
    1bf7:	68 68 67 00 00       	push   $0x6768
    ...
    1c0b:	68 81 67 00 00       	push   $0x6781
    1c10:	6a 01                	push   $0x1
  ...
  unlink("bd");
    ...
    1c2f:	68 68 67 00 00       	push   $0x6768
  ...
  for(i = 0; i < 500; i++){
    ...
    1c8b:	68 95 67 00 00       	push   $0x6795
    1c90:	6a 01                	push   $0x1
  ...
  printf(1, "bigdir ok\n");
    ...
    1caf:	68 aa 67 00 00       	push   $0x67aa
    1cb4:	6a 01                	push   $0x1
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1cca:	68 b5 67 00 00       	push   $0x67b5
    1ccf:	6a 01                	push   $0x1
  ...
  if(mkdir("dd") != 0){
    ...
    1d00:	68 c8 67 00 00       	push   $0x67c8
    1d05:	6a 01                	push   $0x1
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d1c:	68 e0 67 00 00       	push   $0x67e0
  ...
  if(fd < 0){
    ...
    1d35:	68 e6 67 00 00       	push   $0x67e6
    1d3a:	6a 01                	push   $0x1
  ...
  write(fd, "ff", 2);
    ...
    1d4c:	6a 02                	push   $0x2
    1d4e:	68 c2 67 00 00       	push   $0x67c2
  ...
  if(unlink("dd") >= 0){
    ...
    1d6f:	68 c5 67 00 00       	push   $0x67c5
    ...
    1d83:	68 fc 67 00 00       	push   $0x67fc
    1d88:	6a 01                	push   $0x1
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9a:	68 22 68 00 00       	push   $0x6822
    ...
    1dae:	68 29 68 00 00       	push   $0x6829
    1db3:	6a 01                	push   $0x1
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dca:	68 44 68 00 00       	push   $0x6844
  ...
  if(fd < 0){
    ...
    1de3:	68 4d 68 00 00       	push   $0x684d
    1de8:	6a 01                	push   $0x1
  ...
  write(fd, "FF", 2);
    ...
    1dfa:	6a 02                	push   $0x2
    1dfc:	68 65 68 00 00       	push   $0x6865
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e1d:	6a 00                	push   $0x0
    1e1f:	68 68 68 00 00       	push   $0x6868
  ...
  if(fd < 0){
    ...
    1e38:	68 74 68 00 00       	push   $0x6874
    1e3d:	6a 01                	push   $0x1
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e54:	68 80 e5 00 00       	push   $0xe580
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1ea0:	68 a8 68 00 00       	push   $0x68a8
    1ea5:	68 44 68 00 00       	push   $0x6844
    ...
    1eb9:	68 b4 68 00 00       	push   $0x68b4
    1ebe:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1ed0:	68 44 68 00 00       	push   $0x6844
    ...
    1ee4:	68 d5 68 00 00       	push   $0x68d5
    1ee9:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1efb:	6a 00                	push   $0x0
    1efd:	68 44 68 00 00       	push   $0x6844
    ...
    1f11:	68 f0 68 00 00       	push   $0x68f0
    1f16:	6a 01                	push   $0x1
  ...
  if(chdir("dd") != 0){
    ...
    1f28:	68 c5 67 00 00       	push   $0x67c5
    ...
    1f3c:	68 14 69 00 00       	push   $0x6914
    1f41:	6a 01                	push   $0x1
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f53:	68 25 69 00 00       	push   $0x6925
    ...
    1f67:	68 31 69 00 00       	push   $0x6931
    1f6c:	6a 01                	push   $0x1
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f7e:	68 4b 69 00 00       	push   $0x694b
    ...
    1f92:	68 31 69 00 00       	push   $0x6931
    1f97:	6a 01                	push   $0x1
  ...
  if(chdir("./..") != 0){
    ...
    1fa9:	68 5a 69 00 00       	push   $0x695a
    ...
    1fbd:	68 5f 69 00 00       	push   $0x695f
    1fc2:	6a 01                	push   $0x1
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fd4:	6a 00                	push   $0x0
    1fd6:	68 a8 68 00 00       	push   $0x68a8
  ...
  if(fd < 0){
    ...
    1fef:	68 72 69 00 00       	push   $0x6972
    1ff4:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    200b:	68 80 e5 00 00       	push   $0xe580
    ...
    2023:	68 8a 69 00 00       	push   $0x698a
    2028:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2048:	6a 00                	push   $0x0
    204a:	68 44 68 00 00       	push   $0x6844
    ...
    205e:	68 a8 69 00 00       	push   $0x69a8
    2063:	6a 01                	push   $0x1
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    207a:	68 cd 69 00 00       	push   $0x69cd
    ...
    208e:	68 d6 69 00 00       	push   $0x69d6
    2093:	6a 01                	push   $0x1
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    20aa:	68 f2 69 00 00       	push   $0x69f2
    ...
    20be:	68 fb 69 00 00       	push   $0x69fb
    20c3:	6a 01                	push   $0x1
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    20da:	68 c5 67 00 00       	push   $0x67c5
    ...
    20ee:	68 17 6a 00 00       	push   $0x6a17
    20f3:	6a 01                	push   $0x1
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2105:	6a 02                	push   $0x2
    2107:	68 c5 67 00 00       	push   $0x67c5
    ...
    211b:	68 2d 6a 00 00       	push   $0x6a2d
    2120:	6a 01                	push   $0x1
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2132:	6a 01                	push   $0x1
    2134:	68 c5 67 00 00       	push   $0x67c5
    ...
    2148:	68 46 6a 00 00       	push   $0x6a46
    214d:	6a 01                	push   $0x1
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    215f:	68 61 6a 00 00       	push   $0x6a61
    2164:	68 cd 69 00 00       	push   $0x69cd
    ...
    2178:	68 6c 6a 00 00       	push   $0x6a6c
    217d:	6a 01                	push   $0x1
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    218f:	68 61 6a 00 00       	push   $0x6a61
    2194:	68 f2 69 00 00       	push   $0x69f2
    ...
    21a8:	68 90 6a 00 00       	push   $0x6a90
    21ad:	6a 01                	push   $0x1
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    21bf:	68 a8 68 00 00       	push   $0x68a8
    21c4:	68 e0 67 00 00       	push   $0x67e0
    ...
    21d8:	68 b4 6a 00 00       	push   $0x6ab4
    21dd:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    21ef:	68 cd 69 00 00       	push   $0x69cd
    ...
    2203:	68 d6 6a 00 00       	push   $0x6ad6
    2208:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    221a:	68 f2 69 00 00       	push   $0x69f2
    ...
    222e:	68 f1 6a 00 00       	push   $0x6af1
    2233:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2245:	68 a8 68 00 00       	push   $0x68a8
    ...
    2259:	68 0c 6b 00 00       	push   $0x6b0c
    225e:	6a 01                	push   $0x1
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2270:	68 f2 69 00 00       	push   $0x69f2
    ...
    2284:	68 29 6b 00 00       	push   $0x6b29
    2289:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    229b:	68 cd 69 00 00       	push   $0x69cd
    ...
    22af:	68 45 6b 00 00       	push   $0x6b45
    22b4:	6a 01                	push   $0x1
  ...
  if(chdir("dd/ff") == 0){
    ...
    22c6:	68 e0 67 00 00       	push   $0x67e0
    ...
    22da:	68 61 6b 00 00       	push   $0x6b61
    22df:	6a 01                	push   $0x1
  ...
  if(chdir("dd/xx") == 0){
    ...
    22f1:	68 79 6b 00 00       	push   $0x6b79
    ...
    2305:	68 7f 6b 00 00       	push   $0x6b7f
    230a:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    231c:	68 a8 68 00 00       	push   $0x68a8
    ...
    2330:	68 d5 68 00 00       	push   $0x68d5
    2335:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff") != 0){
    ...
    2347:	68 e0 67 00 00       	push   $0x67e0
    ...
    235b:	68 97 6b 00 00       	push   $0x6b97
    2360:	6a 01                	push   $0x1
  ...
  if(unlink("dd") == 0){
    ...
    2372:	68 c5 67 00 00       	push   $0x67c5
    ...
    2386:	68 ac 6b 00 00       	push   $0x6bac
    238b:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd") < 0){
    ...
    239d:	68 cc 6b 00 00       	push   $0x6bcc
    ...
    23b1:	68 d2 6b 00 00       	push   $0x6bd2
    23b6:	6a 01                	push   $0x1
  ...
  if(unlink("dd") < 0){
    ...
    23c8:	68 c5 67 00 00       	push   $0x67c5
    ...
    23dc:	68 e7 6b 00 00       	push   $0x6be7
    23e1:	6a 01                	push   $0x1
  ...
  printf(1, "subdir ok\n");
    ...
    23f3:	68 f9 6b 00 00       	push   $0x6bf9
    23f8:	6a 01                	push   $0x1
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    240e:	68 04 6c 00 00       	push   $0x6c04
    2413:	6a 01                	push   $0x1
  ...
  unlink("bigwrite");
    ...
    2420:	68 13 6c 00 00       	push   $0x6c13
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2441:	68 13 6c 00 00       	push   $0x6c13
    ...
    245a:	68 1c 6c 00 00       	push   $0x6c1c
    245f:	6a 01                	push   $0x1
    ...
    247d:	68 80 e5 00 00       	push   $0xe580
    ...
    249e:	68 34 6c 00 00       	push   $0x6c34
    24a3:	6a 01                	push   $0x1
    ...
    24cd:	68 13 6c 00 00       	push   $0x6c13
  ...
  printf(1, "bigwrite ok\n");
    ...
    24f1:	68 46 6c 00 00       	push   $0x6c46
    24f6:	6a 01                	push   $0x1
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    250c:	68 53 6c 00 00       	push   $0x6c53
    2511:	6a 01                	push   $0x1
  ...
  unlink("bigfile");
    ...
    251e:	68 61 6c 00 00       	push   $0x6c61
  ...
  fd = open("bigfile", O_CREATE | O_RDWR);
    ...
    2533:	68 61 6c 00 00       	push   $0x6c61
  ...
  if(fd < 0){
    ...
    254c:	68 69 6c 00 00       	push   $0x6c69
    2551:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 20; i++){
    ...
    2574:	68 80 e5 00 00       	push   $0xe580
    ...
    2589:	68 80 e5 00 00       	push   $0xe580
    ...
    25a3:	68 7f 6c 00 00       	push   $0x6c7f
    25a8:	6a 01                	push   $0x1
  ...
  fd = open("bigfile", 0);
    ...
    25d2:	6a 00                	push   $0x0
    25d4:	68 61 6c 00 00       	push   $0x6c61
  ...
  if(fd < 0){
    ...
    25ed:	68 95 6c 00 00       	push   $0x6c95
    25f2:	6a 01                	push   $0x1
  ...
  for(i = 0; ; i++){
    ...
    2617:	68 80 e5 00 00       	push   $0xe580
    ...
    2633:	68 aa 6c 00 00       	push   $0x6caa
    2638:	6a 01                	push   $0x1
    ...
    2659:	68 bf 6c 00 00       	push   $0x6cbf
    265e:	6a 01                	push   $0x1
    ...
    266d:	0f b6 05 80 e5 00 00 	movzbl 0xe580,%eax
    ...
    2687:	0f b6 05 ab e6 00 00 	movzbl 0xe6ab,%eax
    ...
    26a4:	68 d3 6c 00 00       	push   $0x6cd3
    26a9:	6a 01                	push   $0x1
  ...
  if(total != 20*600){
    ...
    26e2:	68 ec 6c 00 00       	push   $0x6cec
    26e7:	6a 01                	push   $0x1
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    2724:	68 17 6d 00 00       	push   $0x6d17
    2729:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2736:	68 26 6d 00 00       	push   $0x6d26
    ...
    274a:	68 35 6d 00 00       	push   $0x6d35
    274f:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2761:	68 54 6d 00 00       	push   $0x6d54
    ...
    2775:	68 74 6d 00 00       	push   $0x6d74
    277a:	6a 01                	push   $0x1
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2791:	68 a4 6d 00 00       	push   $0x6da4
  ...
  if(fd < 0){
    ...
    27aa:	68 d4 6d 00 00       	push   $0x6dd4
    27af:	6a 01                	push   $0x1
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27cf:	6a 00                	push   $0x0
    27d1:	68 14 6e 00 00       	push   $0x6e14
  ...
  if(fd < 0){
    ...
    27ea:	68 44 6e 00 00       	push   $0x6e44
    27ef:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    280f:	68 7e 6e 00 00       	push   $0x6e7e
    ...
    2823:	68 9c 6e 00 00       	push   $0x6e9c
    2828:	6a 01                	push   $0x1
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    283a:	68 cc 6e 00 00       	push   $0x6ecc
    ...
    284e:	68 ec 6e 00 00       	push   $0x6eec
    2853:	6a 01                	push   $0x1
  ...
  printf(1, "fourteen ok\n");
    ...
    2865:	68 1d 6f 00 00       	push   $0x6f1d
    286a:	6a 01                	push   $0x1
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    28a6:	68 3b 6f 00 00       	push   $0x6f3b
    28ab:	6a 01                	push   $0x1
  ...
  if(chdir("dots") != 0){
    ...
    28bd:	68 36 6f 00 00       	push   $0x6f36
    ...
    28d1:	68 4e 6f 00 00       	push   $0x6f4e
    28d6:	6a 01                	push   $0x1
  ...
  if(unlink(".") == 0){
    ...
    28e8:	68 67 66 00 00       	push   $0x6667
    ...
    28fc:	68 61 6f 00 00       	push   $0x6f61
    2901:	6a 01                	push   $0x1
  ...
  if(unlink("..") == 0){
    ...
    2913:	68 f4 61 00 00       	push   $0x61f4
    ...
    2927:	68 6f 6f 00 00       	push   $0x6f6f
    292c:	6a 01                	push   $0x1
  ...
  if(chdir("/") != 0){
    ...
    293e:	68 7e 6f 00 00       	push   $0x6f7e
    ...
    2952:	68 80 6f 00 00       	push   $0x6f80
    2957:	6a 01                	push   $0x1
  ...
  if(unlink("dots/.") == 0){
    ...
    2969:	68 90 6f 00 00       	push   $0x6f90
    ...
    297d:	68 97 6f 00 00       	push   $0x6f97
    2982:	6a 01                	push   $0x1
  ...
  if(unlink("dots/..") == 0){
    ...
    2994:	68 ae 6f 00 00       	push   $0x6fae
    ...
    29a8:	68 b6 6f 00 00       	push   $0x6fb6
    29ad:	6a 01                	push   $0x1
  ...
  if(unlink("dots") != 0){
    ...
    29bf:	68 36 6f 00 00       	push   $0x6f36
    ...
    29d3:	68 ce 6f 00 00       	push   $0x6fce
    29d8:	6a 01                	push   $0x1
  ...
  printf(1, "rmdot ok\n");
    ...
    29ea:	68 e3 6f 00 00       	push   $0x6fe3
    29ef:	6a 01                	push   $0x1
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2a05:	68 ed 6f 00 00       	push   $0x6fed
    2a0a:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a1c:	68 fa 6f 00 00       	push   $0x6ffa
  ...
  if(fd < 0){
    ...
    2a35:	68 02 70 00 00       	push   $0x7002
    2a3a:	6a 01                	push   $0x1
  ...
  if(chdir("dirfile") == 0){
    ...
    2a5a:	68 fa 6f 00 00       	push   $0x6ffa
    ...
    2a6e:	68 19 70 00 00       	push   $0x7019
    2a73:	6a 01                	push   $0x1
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a85:	6a 00                	push   $0x0
    2a87:	68 33 70 00 00       	push   $0x7033
  ...
  if(fd >= 0){
    ...
    2aa0:	68 3e 70 00 00       	push   $0x703e
    2aa5:	6a 01                	push   $0x1
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2abc:	68 33 70 00 00       	push   $0x7033
  ...
  if(fd >= 0){
    ...
    2ad5:	68 3e 70 00 00       	push   $0x703e
    2ada:	6a 01                	push   $0x1
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2aec:	68 33 70 00 00       	push   $0x7033
    ...
    2b00:	68 5c 70 00 00       	push   $0x705c
    2b05:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b17:	68 33 70 00 00       	push   $0x7033
    ...
    2b2b:	68 79 70 00 00       	push   $0x7079
    2b30:	6a 01                	push   $0x1
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2b42:	68 33 70 00 00       	push   $0x7033
    2b47:	68 97 70 00 00       	push   $0x7097
    ...
    2b5b:	68 a0 70 00 00       	push   $0x70a0
    2b60:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile") != 0){
    ...
    2b72:	68 fa 6f 00 00       	push   $0x6ffa
    ...
    2b86:	68 bf 70 00 00       	push   $0x70bf
    2b8b:	6a 01                	push   $0x1
  ...
  fd = open(".", O_RDWR);
    ...
    2b9d:	6a 02                	push   $0x2
    2b9f:	68 67 66 00 00       	push   $0x6667
  ...
  if(fd >= 0){
    ...
    2bb8:	68 d8 70 00 00       	push   $0x70d8
    2bbd:	6a 01                	push   $0x1
  ...
  fd = open(".", 0);
    ...
    2bcf:	6a 00                	push   $0x0
    2bd1:	68 67 66 00 00       	push   $0x6667
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2be4:	6a 01                	push   $0x1
    2be6:	68 9e 62 00 00       	push   $0x629e
    ...
    2bfd:	68 f7 70 00 00       	push   $0x70f7
    2c02:	6a 01                	push   $0x1
  ...
  printf(1, "dir vs file OK\n");
    ...
    2c22:	68 0b 71 00 00       	push   $0x710b
    2c27:	6a 01                	push   $0x1
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2c3d:	68 1b 71 00 00       	push   $0x711b
    2c42:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c5b:	68 2c 71 00 00       	push   $0x712c
    ...
    2c6f:	68 32 71 00 00       	push   $0x7132
    2c74:	6a 01                	push   $0x1
    ...
    2c86:	68 2c 71 00 00       	push   $0x712c
    ...
    2c9a:	68 46 71 00 00       	push   $0x7146
    2c9f:	6a 01                	push   $0x1
    ...
    2d07:	68 5b 71 00 00       	push   $0x715b
    ...
    2d2e:	68 5b 71 00 00       	push   $0x715b
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2d77:	68 72 71 00 00       	push   $0x7172
    2d7c:	6a 01                	push   $0x1
    ...
    2da3:	e8 5b 0e 00 00       	call   3c03 <exit>
{
  ...
  if(n == 1000){
    ...
    2dc4:	68 80 71 00 00       	push   $0x7180
    2dc9:	6a 01                	push   $0x1
  ...
  for(; n > 0; n--){
    ...
    2de4:	68 a2 71 00 00       	push   $0x71a2
    2de9:	6a 01                	push   $0x1
  ...
  if(wait() != -1){
    ...
    2e0f:	68 b6 71 00 00       	push   $0x71b6
    2e14:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2e26:	68 c9 71 00 00       	push   $0x71c9
    2e2b:	6a 01                	push   $0x1
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e3f:	a1 54 81 00 00       	mov    0x8154,%eax
    2e44:	83 ec 08             	sub    $0x8,%esp
    2e47:	68 d7 71 00 00       	push   $0x71d7
    2e4c:	50                   	push   %eax
  ...
  if(pid < 0){
    ...
    2ee4:	a1 54 81 00 00       	mov    0x8154,%eax
    2ee9:	83 ec 08             	sub    $0x8,%esp
    2eec:	68 fd 71 00 00       	push   $0x71fd
    2ef1:	50                   	push   %eax
  ...
  if(c != a + 1){
    ...
    2f2a:	a1 54 81 00 00       	mov    0x8154,%eax
    2f2f:	83 ec 08             	sub    $0x8,%esp
    2f32:	68 14 72 00 00       	push   $0x7214
    2f37:	50                   	push   %eax
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2f8e:	a1 54 81 00 00       	mov    0x8154,%eax
    2f93:	83 ec 08             	sub    $0x8,%esp
    2f96:	68 30 72 00 00       	push   $0x7230
    2f9b:	50                   	push   %eax
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2fdf:	a1 54 81 00 00       	mov    0x8154,%eax
    2fe4:	83 ec 08             	sub    $0x8,%esp
    2fe7:	68 6e 72 00 00       	push   $0x726e
    2fec:	50                   	push   %eax
  ...
  if(c != a - 4096){
    ...
    3017:	a1 54 81 00 00       	mov    0x8154,%eax
    301c:	ff 75 e0             	pushl  -0x20(%ebp)
    301f:	ff 75 f4             	pushl  -0xc(%ebp)
    3022:	68 8c 72 00 00       	push   $0x728c
    3027:	50                   	push   %eax
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    307b:	a1 54 81 00 00       	mov    0x8154,%eax
    3080:	ff 75 e0             	pushl  -0x20(%ebp)
    3083:	ff 75 f4             	pushl  -0xc(%ebp)
    3086:	68 c4 72 00 00       	push   $0x72c4
    308b:	50                   	push   %eax
  ...
  if(*lastaddr == 99){
    ...
    30a3:	a1 54 81 00 00       	mov    0x8154,%eax
    30a8:	83 ec 08             	sub    $0x8,%esp
    30ab:	68 ec 72 00 00       	push   $0x72ec
    30b0:	50                   	push   %eax
  ...
  if(c != a){
    ...
    30f9:	a1 54 81 00 00       	mov    0x8154,%eax
    30fe:	ff 75 e0             	pushl  -0x20(%ebp)
    3101:	ff 75 f4             	pushl  -0xc(%ebp)
    3104:	68 1c 73 00 00       	push   $0x731c
    3109:	50                   	push   %eax
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3136:	a1 54 81 00 00       	mov    0x8154,%eax
    313b:	83 ec 08             	sub    $0x8,%esp
    313e:	68 e5 62 00 00       	push   $0x62e5
    3143:	50                   	push   %eax
    ...
    3160:	a1 54 81 00 00       	mov    0x8154,%eax
    3165:	52                   	push   %edx
    3166:	ff 75 f4             	pushl  -0xc(%ebp)
    3169:	68 3d 73 00 00       	push   $0x733d
    316e:	50                   	push   %eax
  ...
  if(pipe(fds) != 0){
    ...
    31b5:	68 39 62 00 00       	push   $0x6239
    31ba:	6a 01                	push   $0x1
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3216:	6a 01                	push   $0x1
    3218:	68 9e 62 00 00       	push   $0x629e
    321d:	50                   	push   %eax
  ...
  if(c == (char*)0xffffffff){
    ...
    32be:	a1 54 81 00 00       	mov    0x8154,%eax
    32c3:	83 ec 08             	sub    $0x8,%esp
    32c6:	68 56 73 00 00       	push   $0x7356
    32cb:	50                   	push   %eax
  ...
  printf(stdout, "sbrk test OK\n");
    330b:	a1 54 81 00 00       	mov    0x8154,%eax
    3310:	83 ec 08             	sub    $0x8,%esp
    3313:	68 71 73 00 00       	push   $0x7371
    3318:	50                   	push   %eax
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3350:	a1 54 81 00 00       	mov    0x8154,%eax
    3355:	83 ec 08             	sub    $0x8,%esp
    3358:	68 7f 73 00 00       	push   $0x737f
    335d:	50                   	push   %eax
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ce:	50                   	push   %eax
    33cf:	68 8e 73 00 00       	push   $0x738e
    ...
    33e1:	a1 54 81 00 00       	mov    0x8154,%eax
    33e6:	83 ec 08             	sub    $0x8,%esp
    33e9:	68 99 73 00 00       	push   $0x7399
    33ee:	50                   	push   %eax
  ...
  printf(stdout, "validate ok\n");
    340f:	a1 54 81 00 00       	mov    0x8154,%eax
    3414:	83 ec 08             	sub    $0x8,%esp
    3417:	68 b2 73 00 00       	push   $0x73b2
    341c:	50                   	push   %eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    342e:	a1 54 81 00 00       	mov    0x8154,%eax
    3433:	83 ec 08             	sub    $0x8,%esp
    3436:	68 bf 73 00 00       	push   $0x73bf
    343b:	50                   	push   %eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3485:	a1 54 81 00 00       	mov    0x8154,%eax
    348a:	83 ec 08             	sub    $0x8,%esp
    348d:	68 da 73 00 00       	push   $0x73da
    3492:	50                   	push   %eax
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    34a7:	68 e7 73 00 00       	push   $0x73e7
  ...
  if(pid == 0){
    ...
    34d2:	c7 04 85 c0 bd 00 00 	movl   $0x73f4,0xbdc0(,%eax,4)
    34d9:	f4 73 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34e5:	7e e8                	jle    34cf <bigargtest+0x31>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34e7:	c7 05 3c be 00 00 00 	movl   $0x0,0xbe3c
    34ee:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f1:	a1 54 81 00 00       	mov    0x8154,%eax
    34f6:	83 ec 08             	sub    $0x8,%esp
    34f9:	68 d1 74 00 00       	push   $0x74d1
    34fe:	50                   	push   %eax
    34ff:	e8 be 08 00 00       	call   3dc2 <printf>
    3504:	83 c4 10             	add    $0x10,%esp
    exec("echo", args);
    3507:	83 ec 08             	sub    $0x8,%esp
    350a:	68 c0 bd 00 00       	push   $0xbdc0
    350f:	68 f8 5e 00 00       	push   $0x5ef8
    3514:	e8 22 07 00 00       	call   3c3b <exec>
    3519:	83 c4 10             	add    $0x10,%esp
    printf(stdout, "bigarg test ok\n");
    351c:	a1 54 81 00 00       	mov    0x8154,%eax
    3521:	83 ec 08             	sub    $0x8,%esp
    3524:	68 de 74 00 00       	push   $0x74de
    3529:	50                   	push   %eax
    ...
    353a:	68 e7 73 00 00       	push   $0x73e7
    ...
    3563:	a1 54 81 00 00       	mov    0x8154,%eax
    3568:	83 ec 08             	sub    $0x8,%esp
    356b:	68 ee 74 00 00       	push   $0x74ee
    3570:	50                   	push   %eax
  ...
  fd = open("bigarg-ok", 0);
    ...
    3586:	6a 00                	push   $0x0
    3588:	68 e7 73 00 00       	push   $0x73e7
  ...
  if(fd < 0){
    ...
    359e:	a1 54 81 00 00       	mov    0x8154,%eax
    35a3:	83 ec 08             	sub    $0x8,%esp
    35a6:	68 07 75 00 00       	push   $0x7507
    35ab:	50                   	push   %eax
  ...
  unlink("bigarg-ok");
    ...
    35ca:	68 e7 73 00 00       	push   $0x73e7
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    35eb:	68 1c 75 00 00       	push   $0x751c
    35f0:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cf:	50                   	push   %eax
    36d0:	68 29 75 00 00       	push   $0x7529
    36d5:	6a 01                	push   $0x1
    ...
    3702:	50                   	push   %eax
    3703:	68 35 75 00 00       	push   $0x7535
    3708:	6a 01                	push   $0x1
    ...
    3723:	68 80 e5 00 00       	push   $0xe580
    ...
    3752:	68 45 75 00 00       	push   $0x7545
    3757:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    386c:	68 55 75 00 00       	push   $0x7555
    3871:	6a 01                	push   $0x1
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3884:	a1 58 81 00 00       	mov    0x8158,%eax
    3889:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    388f:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3894:	a3 58 81 00 00       	mov    %eax,0x8158
  return randstate;
    3899:	a1 58 81 00 00       	mov    0x8158,%eax
}
    389e:	5d                   	pop    %ebp
    389f:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    38b4:	68 6b 75 00 00       	push   $0x756b
    38b9:	6a 01                	push   $0x1
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    38c6:	6a 00                	push   $0x0
    38c8:	68 7f 75 00 00       	push   $0x757f
    ...
    38dc:	68 90 75 00 00       	push   $0x7590
    38e1:	6a 01                	push   $0x1
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    38f8:	68 7f 75 00 00       	push   $0x757f
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d5e:	0f b6 80 5c 81 00 00 	movzbl 0x815c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e9a:	75 25                	jne    3ec1 <printf+0xff>
          s = "(null)";
    3e9c:	c7 45 f4 ba 75 00 00 	movl   $0x75ba,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f62:	a1 48 be 00 00       	mov    0xbe48,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    402d:	a3 48 be 00 00       	mov    %eax,0xbe48
}
    4032:	90                   	nop
    4033:	c9                   	leave  
    4034:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    408e:	a1 48 be 00 00       	mov    0xbe48,%eax
}
    4093:	c9                   	leave  
    4094:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40aa:	a1 48 be 00 00       	mov    0xbe48,%eax
    40af:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40b2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40b6:	75 23                	jne    40db <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40b8:	c7 45 f0 40 be 00 00 	movl   $0xbe40,-0x10(%ebp)
    40bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40c2:	a3 48 be 00 00       	mov    %eax,0xbe48
    40c7:	a1 48 be 00 00       	mov    0xbe48,%eax
    40cc:	a3 40 be 00 00       	mov    %eax,0xbe40
    base.s.size = 0;
    40d1:	c7 05 44 be 00 00 00 	movl   $0x0,0xbe44
    40d8:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    412e:	a3 48 be 00 00       	mov    %eax,0xbe48
      return (void*)(p + 1);
    ...
    if(p == freep)
    413b:	a1 48 be 00 00       	mov    0xbe48,%eax
...
ABitmap APLoadBitmap(char * filename)
{
    ...
    4281:	68 c1 75 00 00       	push   $0x75c1
    4286:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    4c25:	05 80 81 00 00       	add    $0x8180,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    4eb2:	68 d4 75 00 00       	push   $0x75d4
    4eb7:	6a 01                	push   $0x1
    ...
    4f27:	68 f4 75 00 00       	push   $0x75f4
    4f2c:	6a 01                	push   $0x1
    ...
    4fcb:	68 18 76 00 00       	push   $0x7618
    4fd0:	6a 01                	push   $0x1
    ...
    50b0:	68 40 76 00 00       	push   $0x7640
    50b5:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    5199:	e8 c5 08 00 00       	call   5a63 <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    52b7:	a1 4c be 00 00       	mov    0xbe4c,%eax
    52bc:	85 c0                	test   %eax,%eax
    52be:	0f 85 c8 02 00 00    	jne    558c <APGridPaint+0x2de>
    {
        iconReady = 1;
    52c4:	c7 05 4c be 00 00 01 	movl   $0x1,0xbe4c
    52cb:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    52ce:	8d 45 98             	lea    -0x68(%ebp),%eax
    52d1:	83 ec 08             	sub    $0x8,%esp
    52d4:	68 67 76 00 00       	push   $0x7667
    52d9:	50                   	push   %eax
    52da:	e8 69 ef ff ff       	call   4248 <APLoadBitmap>
    52df:	83 c4 0c             	add    $0xc,%esp
    52e2:	8b 45 98             	mov    -0x68(%ebp),%eax
    52e5:	a3 b0 05 01 00       	mov    %eax,0x105b0
    52ea:	8b 45 9c             	mov    -0x64(%ebp),%eax
    52ed:	a3 b4 05 01 00       	mov    %eax,0x105b4
    52f2:	8b 45 a0             	mov    -0x60(%ebp),%eax
    52f5:	a3 b8 05 01 00       	mov    %eax,0x105b8
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    52fa:	83 ec 04             	sub    $0x4,%esp
    52fd:	ff 35 b8 05 01 00    	pushl  0x105b8
    5303:	ff 35 b4 05 01 00    	pushl  0x105b4
    5309:	ff 35 b0 05 01 00    	pushl  0x105b0
    530f:	e8 6e f1 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5314:	83 c4 10             	add    $0x10,%esp
    5317:	a3 bc 05 01 00       	mov    %eax,0x105bc
        grid_river = APLoadBitmap ("grid_river.bmp");
    531c:	8d 45 98             	lea    -0x68(%ebp),%eax
    531f:	83 ec 08             	sub    $0x8,%esp
    5322:	68 75 76 00 00       	push   $0x7675
    5327:	50                   	push   %eax
    5328:	e8 1b ef ff ff       	call   4248 <APLoadBitmap>
    532d:	83 c4 0c             	add    $0xc,%esp
    5330:	8b 45 98             	mov    -0x68(%ebp),%eax
    5333:	a3 fc 05 01 00       	mov    %eax,0x105fc
    5338:	8b 45 9c             	mov    -0x64(%ebp),%eax
    533b:	a3 00 06 01 00       	mov    %eax,0x10600
    5340:	8b 45 a0             	mov    -0x60(%ebp),%eax
    5343:	a3 04 06 01 00       	mov    %eax,0x10604
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    5348:	83 ec 04             	sub    $0x4,%esp
    534b:	ff 35 04 06 01 00    	pushl  0x10604
    5351:	ff 35 00 06 01 00    	pushl  0x10600
    5357:	ff 35 fc 05 01 00    	pushl  0x105fc
    535d:	e8 20 f1 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5362:	83 c4 10             	add    $0x10,%esp
    5365:	a3 ec 05 01 00       	mov    %eax,0x105ec
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    536a:	8d 45 98             	lea    -0x68(%ebp),%eax
    536d:	83 ec 08             	sub    $0x8,%esp
    5370:	68 84 76 00 00       	push   $0x7684
    5375:	50                   	push   %eax
    5376:	e8 cd ee ff ff       	call   4248 <APLoadBitmap>
    537b:	83 c4 0c             	add    $0xc,%esp
    537e:	8b 45 98             	mov    -0x68(%ebp),%eax
    5381:	a3 f0 05 01 00       	mov    %eax,0x105f0
    5386:	8b 45 9c             	mov    -0x64(%ebp),%eax
    5389:	a3 f4 05 01 00       	mov    %eax,0x105f4
    538e:	8b 45 a0             	mov    -0x60(%ebp),%eax
    5391:	a3 f8 05 01 00       	mov    %eax,0x105f8
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    5396:	83 ec 04             	sub    $0x4,%esp
    5399:	ff 35 f8 05 01 00    	pushl  0x105f8
    539f:	ff 35 f4 05 01 00    	pushl  0x105f4
    53a5:	ff 35 f0 05 01 00    	pushl  0x105f0
    53ab:	e8 d2 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    53b0:	83 c4 10             	add    $0x10,%esp
    53b3:	a3 84 05 01 00       	mov    %eax,0x10584
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    53b8:	8d 45 98             	lea    -0x68(%ebp),%eax
    53bb:	83 ec 08             	sub    $0x8,%esp
    53be:	68 93 76 00 00       	push   $0x7693
    53c3:	50                   	push   %eax
    53c4:	e8 7f ee ff ff       	call   4248 <APLoadBitmap>
    53c9:	83 c4 0c             	add    $0xc,%esp
    53cc:	8b 45 98             	mov    -0x68(%ebp),%eax
    53cf:	a3 88 05 01 00       	mov    %eax,0x10588
    53d4:	8b 45 9c             	mov    -0x64(%ebp),%eax
    53d7:	a3 8c 05 01 00       	mov    %eax,0x1058c
    53dc:	8b 45 a0             	mov    -0x60(%ebp),%eax
    53df:	a3 90 05 01 00       	mov    %eax,0x10590
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    53e4:	83 ec 04             	sub    $0x4,%esp
    53e7:	ff 35 90 05 01 00    	pushl  0x10590
    53ed:	ff 35 8c 05 01 00    	pushl  0x1058c
    53f3:	ff 35 88 05 01 00    	pushl  0x10588
    53f9:	e8 84 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    53fe:	83 c4 10             	add    $0x10,%esp
    5401:	a3 ac 05 01 00       	mov    %eax,0x105ac
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    5406:	8d 45 98             	lea    -0x68(%ebp),%eax
    5409:	83 ec 08             	sub    $0x8,%esp
    540c:	68 a5 76 00 00       	push   $0x76a5
    5411:	50                   	push   %eax
    5412:	e8 31 ee ff ff       	call   4248 <APLoadBitmap>
    5417:	83 c4 0c             	add    $0xc,%esp
    541a:	8b 45 98             	mov    -0x68(%ebp),%eax
    541d:	a3 c8 05 01 00       	mov    %eax,0x105c8
    5422:	8b 45 9c             	mov    -0x64(%ebp),%eax
    5425:	a3 cc 05 01 00       	mov    %eax,0x105cc
    542a:	8b 45 a0             	mov    -0x60(%ebp),%eax
    542d:	a3 d0 05 01 00       	mov    %eax,0x105d0
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    5432:	83 ec 04             	sub    $0x4,%esp
    5435:	ff 35 d0 05 01 00    	pushl  0x105d0
    543b:	ff 35 cc 05 01 00    	pushl  0x105cc
    5441:	ff 35 c8 05 01 00    	pushl  0x105c8
    5447:	e8 36 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    544c:	83 c4 10             	add    $0x10,%esp
    544f:	a3 0c 06 01 00       	mov    %eax,0x1060c
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    5454:	8d 45 98             	lea    -0x68(%ebp),%eax
    5457:	83 ec 08             	sub    $0x8,%esp
    545a:	68 b3 76 00 00       	push   $0x76b3
    545f:	50                   	push   %eax
    5460:	e8 e3 ed ff ff       	call   4248 <APLoadBitmap>
    5465:	83 c4 0c             	add    $0xc,%esp
    5468:	8b 45 98             	mov    -0x68(%ebp),%eax
    546b:	a3 a0 05 01 00       	mov    %eax,0x105a0
    5470:	8b 45 9c             	mov    -0x64(%ebp),%eax
    5473:	a3 a4 05 01 00       	mov    %eax,0x105a4
    5478:	8b 45 a0             	mov    -0x60(%ebp),%eax
    547b:	a3 a8 05 01 00       	mov    %eax,0x105a8
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    5480:	83 ec 04             	sub    $0x4,%esp
    5483:	ff 35 a8 05 01 00    	pushl  0x105a8
    5489:	ff 35 a4 05 01 00    	pushl  0x105a4
    548f:	ff 35 a0 05 01 00    	pushl  0x105a0
    5495:	e8 e8 ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    549a:	83 c4 10             	add    $0x10,%esp
    549d:	a3 c0 05 01 00       	mov    %eax,0x105c0
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    54a2:	8d 45 98             	lea    -0x68(%ebp),%eax
    54a5:	83 ec 08             	sub    $0x8,%esp
    54a8:	68 c3 76 00 00       	push   $0x76c3
    54ad:	50                   	push   %eax
    54ae:	e8 95 ed ff ff       	call   4248 <APLoadBitmap>
    54b3:	83 c4 0c             	add    $0xc,%esp
    54b6:	8b 45 98             	mov    -0x68(%ebp),%eax
    54b9:	a3 e0 05 01 00       	mov    %eax,0x105e0
    54be:	8b 45 9c             	mov    -0x64(%ebp),%eax
    54c1:	a3 e4 05 01 00       	mov    %eax,0x105e4
    54c6:	8b 45 a0             	mov    -0x60(%ebp),%eax
    54c9:	a3 e8 05 01 00       	mov    %eax,0x105e8
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    54ce:	83 ec 04             	sub    $0x4,%esp
    54d1:	ff 35 e8 05 01 00    	pushl  0x105e8
    54d7:	ff 35 e4 05 01 00    	pushl  0x105e4
    54dd:	ff 35 e0 05 01 00    	pushl  0x105e0
    54e3:	e8 9a ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    54e8:	83 c4 10             	add    $0x10,%esp
    54eb:	a3 10 06 01 00       	mov    %eax,0x10610
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    54f0:	8d 45 98             	lea    -0x68(%ebp),%eax
    54f3:	83 ec 08             	sub    $0x8,%esp
    54f6:	68 d2 76 00 00       	push   $0x76d2
    54fb:	50                   	push   %eax
    54fc:	e8 47 ed ff ff       	call   4248 <APLoadBitmap>
    5501:	83 c4 0c             	add    $0xc,%esp
    5504:	8b 45 98             	mov    -0x68(%ebp),%eax
    5507:	a3 d4 05 01 00       	mov    %eax,0x105d4
    550c:	8b 45 9c             	mov    -0x64(%ebp),%eax
    550f:	a3 d8 05 01 00       	mov    %eax,0x105d8
    5514:	8b 45 a0             	mov    -0x60(%ebp),%eax
    5517:	a3 dc 05 01 00       	mov    %eax,0x105dc
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    551c:	83 ec 04             	sub    $0x4,%esp
    551f:	ff 35 dc 05 01 00    	pushl  0x105dc
    5525:	ff 35 d8 05 01 00    	pushl  0x105d8
    552b:	ff 35 d4 05 01 00    	pushl  0x105d4
    5531:	e8 4c ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5536:	83 c4 10             	add    $0x10,%esp
    5539:	a3 08 06 01 00       	mov    %eax,0x10608
        grid_tower = APLoadBitmap ("grid_tower.bmp");
    553e:	8d 45 98             	lea    -0x68(%ebp),%eax
    5541:	83 ec 08             	sub    $0x8,%esp
    5544:	68 e1 76 00 00       	push   $0x76e1
    5549:	50                   	push   %eax
    554a:	e8 f9 ec ff ff       	call   4248 <APLoadBitmap>
    554f:	83 c4 0c             	add    $0xc,%esp
    5552:	8b 45 98             	mov    -0x68(%ebp),%eax
    5555:	a3 94 05 01 00       	mov    %eax,0x10594
    555a:	8b 45 9c             	mov    -0x64(%ebp),%eax
    555d:	a3 98 05 01 00       	mov    %eax,0x10598
    5562:	8b 45 a0             	mov    -0x60(%ebp),%eax
    5565:	a3 9c 05 01 00       	mov    %eax,0x1059c
        g_tower = APCreateCompatibleDCFromBitmap(grid_tower);
    556a:	83 ec 04             	sub    $0x4,%esp
    556d:	ff 35 9c 05 01 00    	pushl  0x1059c
    5573:	ff 35 98 05 01 00    	pushl  0x10598
    5579:	ff 35 94 05 01 00    	pushl  0x10594
    557f:	e8 fe ee ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5584:	83 c4 10             	add    $0x10,%esp
    5587:	a3 c4 05 01 00       	mov    %eax,0x105c4
    ...
    558f:	8b 40 08             	mov    0x8(%eax),%eax
    5592:	85 c0                	test   %eax,%eax
    5594:	75 17                	jne    55ad <APGridPaint+0x2ff>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    5596:	83 ec 08             	sub    $0x8,%esp
    5599:	68 f0 76 00 00       	push   $0x76f0
    559e:	6a 01                	push   $0x1
    55a0:	e8 1d e8 ff ff       	call   3dc2 <printf>
    55a5:	83 c4 10             	add    $0x10,%esp
        return;
    55a8:	e9 ae 04 00 00       	jmp    5a5b <APGridPaint+0x7ad>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    55ad:	8b 45 08             	mov    0x8(%ebp),%eax
    55b0:	8b 40 10             	mov    0x10(%eax),%eax
    55b3:	85 c0                	test   %eax,%eax
    55b5:	7e 10                	jle    55c7 <APGridPaint+0x319>
    55b7:	8b 45 08             	mov    0x8(%ebp),%eax
    55ba:	8b 50 14             	mov    0x14(%eax),%edx
    55bd:	8b 45 08             	mov    0x8(%ebp),%eax
    55c0:	8b 40 10             	mov    0x10(%eax),%eax
    55c3:	39 c2                	cmp    %eax,%edx
    55c5:	7c 17                	jl     55de <APGridPaint+0x330>
    {
        printf(1,"Grid mode page error!");
    55c7:	83 ec 08             	sub    $0x8,%esp
    55ca:	68 16 77 00 00       	push   $0x7716
    55cf:	6a 01                	push   $0x1
    55d1:	e8 ec e7 ff ff       	call   3dc2 <printf>
    55d6:	83 c4 10             	add    $0x10,%esp
        return;
    55d9:	e9 7d 04 00 00       	jmp    5a5b <APGridPaint+0x7ad>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    55de:	8b 45 08             	mov    0x8(%ebp),%eax
    55e1:	8b 40 14             	mov    0x14(%eax),%eax
    55e4:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    55ea:	89 45 dc             	mov    %eax,-0x24(%ebp)
    55ed:	8b 45 dc             	mov    -0x24(%ebp),%eax
    55f0:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    55f3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    55fa:	e9 52 04 00 00       	jmp    5a51 <APGridPaint+0x7a3>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    55ff:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    5606:	e9 38 04 00 00       	jmp    5a43 <APGridPaint+0x795>
        {
            index = start + GRID_W_NUMBER * j + i;
    560b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    560e:	c1 e0 04             	shl    $0x4,%eax
    5611:	89 c2                	mov    %eax,%edx
    5613:	8b 45 d8             	mov    -0x28(%ebp),%eax
    5616:	01 c2                	add    %eax,%edx
    5618:	8b 45 e0             	mov    -0x20(%ebp),%eax
    561b:	01 d0                	add    %edx,%eax
    561d:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    5620:	8b 45 08             	mov    0x8(%ebp),%eax
    5623:	8b 40 0c             	mov    0xc(%eax),%eax
    5626:	8b 55 dc             	mov    -0x24(%ebp),%edx
    5629:	c1 e2 02             	shl    $0x2,%edx
    562c:	01 d0                	add    %edx,%eax
    562e:	8b 00                	mov    (%eax),%eax
    5630:	83 f8 0b             	cmp    $0xb,%eax
    5633:	0f 87 05 04 00 00    	ja     5a3e <APGridPaint+0x790>
    5639:	8b 04 85 2c 77 00 00 	mov    0x772c(,%eax,4),%eax
    5640:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5642:	8d 45 bd             	lea    -0x43(%ebp),%eax
    5645:	6a 0c                	push   $0xc
    5647:	6a 0c                	push   $0xc
    5649:	6a 0c                	push   $0xc
    564b:	50                   	push   %eax
    564c:	e8 d9 f7 ff ff       	call   4e2a <RGB>
    5651:	83 c4 0c             	add    $0xc,%esp
    5654:	8b 1d bc 05 01 00    	mov    0x105bc,%ebx
    565a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    565d:	6b c8 32             	imul   $0x32,%eax,%ecx
    5660:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5663:	6b c0 32             	imul   $0x32,%eax,%eax
    5666:	89 45 94             	mov    %eax,-0x6c(%ebp)
    5669:	8b 45 08             	mov    0x8(%ebp),%eax
    566c:	8d 78 3c             	lea    0x3c(%eax),%edi
    566f:	83 ec 0c             	sub    $0xc,%esp
    5672:	83 ec 04             	sub    $0x4,%esp
    5675:	89 e0                	mov    %esp,%eax
    5677:	0f b7 75 bd          	movzwl -0x43(%ebp),%esi
    567b:	66 89 30             	mov    %si,(%eax)
    567e:	0f b6 55 bf          	movzbl -0x41(%ebp),%edx
    5682:	88 50 02             	mov    %dl,0x2(%eax)
    5685:	6a 32                	push   $0x32
    5687:	6a 32                	push   $0x32
    5689:	6a 00                	push   $0x0
    568b:	6a 00                	push   $0x0
    568d:	53                   	push   %ebx
    568e:	51                   	push   %ecx
    568f:	ff 75 94             	pushl  -0x6c(%ebp)
    5692:	57                   	push   %edi
    5693:	e8 ee f5 ff ff       	call   4c86 <APDcCopy>
    5698:	83 c4 30             	add    $0x30,%esp
                    break;
    569b:	e9 9f 03 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    56a0:	8d 45 98             	lea    -0x68(%ebp),%eax
    56a3:	6a 69                	push   $0x69
    56a5:	6a 69                	push   $0x69
    56a7:	6a 69                	push   $0x69
    56a9:	50                   	push   %eax
    56aa:	e8 7b f7 ff ff       	call   4e2a <RGB>
    56af:	83 c4 0c             	add    $0xc,%esp
    56b2:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    56b6:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    56ba:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    56be:	88 45 b6             	mov    %al,-0x4a(%ebp)
                    pen.size = 1;
    56c1:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    56c8:	8d 45 98             	lea    -0x68(%ebp),%eax
    56cb:	6a 69                	push   $0x69
    56cd:	6a 69                	push   $0x69
    56cf:	6a 69                	push   $0x69
    56d1:	50                   	push   %eax
    56d2:	e8 53 f7 ff ff       	call   4e2a <RGB>
    56d7:	83 c4 0c             	add    $0xc,%esp
    56da:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    56de:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    56e2:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    56e6:	88 45 b3             	mov    %al,-0x4d(%ebp)
                    APSetPen(&wnd->Dc,pen);
    56e9:	8b 45 08             	mov    0x8(%ebp),%eax
    56ec:	8d 50 3c             	lea    0x3c(%eax),%edx
    56ef:	8d 45 98             	lea    -0x68(%ebp),%eax
    56f2:	ff 75 b8             	pushl  -0x48(%ebp)
    56f5:	ff 75 b4             	pushl  -0x4c(%ebp)
    56f8:	52                   	push   %edx
    56f9:	50                   	push   %eax
    56fa:	e8 18 ee ff ff       	call   4517 <APSetPen>
    56ff:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    5702:	8b 45 08             	mov    0x8(%ebp),%eax
    5705:	8d 58 3c             	lea    0x3c(%eax),%ebx
    5708:	8d 55 98             	lea    -0x68(%ebp),%edx
    570b:	83 ec 04             	sub    $0x4,%esp
    570e:	83 ec 04             	sub    $0x4,%esp
    5711:	89 e0                	mov    %esp,%eax
    5713:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    5717:	66 89 08             	mov    %cx,(%eax)
    571a:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    571e:	88 48 02             	mov    %cl,0x2(%eax)
    5721:	53                   	push   %ebx
    5722:	52                   	push   %edx
    5723:	e8 28 ee ff ff       	call   4550 <APSetBrush>
    5728:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    572b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    572e:	6b d0 32             	imul   $0x32,%eax,%edx
    5731:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5734:	6b c0 32             	imul   $0x32,%eax,%eax
    5737:	8b 4d 08             	mov    0x8(%ebp),%ecx
    573a:	83 c1 3c             	add    $0x3c,%ecx
    573d:	83 ec 0c             	sub    $0xc,%esp
    5740:	6a 32                	push   $0x32
    5742:	6a 32                	push   $0x32
    5744:	52                   	push   %edx
    5745:	50                   	push   %eax
    5746:	51                   	push   %ecx
    5747:	e8 2e f2 ff ff       	call   497a <APDrawRect>
    574c:	83 c4 20             	add    $0x20,%esp
                    break;
    574f:	e9 eb 02 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5754:	8d 45 c0             	lea    -0x40(%ebp),%eax
    5757:	6a 0c                	push   $0xc
    5759:	6a 0c                	push   $0xc
    575b:	6a 0c                	push   $0xc
    575d:	50                   	push   %eax
    575e:	e8 c7 f6 ff ff       	call   4e2a <RGB>
    5763:	83 c4 0c             	add    $0xc,%esp
    5766:	8b 1d 10 06 01 00    	mov    0x10610,%ebx
    576c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    576f:	6b c8 32             	imul   $0x32,%eax,%ecx
    5772:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5775:	6b c0 32             	imul   $0x32,%eax,%eax
    5778:	89 45 94             	mov    %eax,-0x6c(%ebp)
    577b:	8b 45 08             	mov    0x8(%ebp),%eax
    577e:	8d 78 3c             	lea    0x3c(%eax),%edi
    5781:	83 ec 0c             	sub    $0xc,%esp
    5784:	83 ec 04             	sub    $0x4,%esp
    5787:	89 e0                	mov    %esp,%eax
    5789:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    578d:	66 89 30             	mov    %si,(%eax)
    5790:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    5794:	88 50 02             	mov    %dl,0x2(%eax)
    5797:	6a 32                	push   $0x32
    5799:	6a 32                	push   $0x32
    579b:	6a 00                	push   $0x0
    579d:	6a 00                	push   $0x0
    579f:	53                   	push   %ebx
    57a0:	51                   	push   %ecx
    57a1:	ff 75 94             	pushl  -0x6c(%ebp)
    57a4:	57                   	push   %edi
    57a5:	e8 dc f4 ff ff       	call   4c86 <APDcCopy>
    57aa:	83 c4 30             	add    $0x30,%esp
                    break;
    57ad:	e9 8d 02 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    57b2:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    57b5:	6a 0c                	push   $0xc
    57b7:	6a 0c                	push   $0xc
    57b9:	6a 0c                	push   $0xc
    57bb:	50                   	push   %eax
    57bc:	e8 69 f6 ff ff       	call   4e2a <RGB>
    57c1:	83 c4 0c             	add    $0xc,%esp
    57c4:	8b 1d ec 05 01 00    	mov    0x105ec,%ebx
    57ca:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    57cd:	6b c8 32             	imul   $0x32,%eax,%ecx
    57d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    57d3:	6b c0 32             	imul   $0x32,%eax,%eax
    57d6:	89 45 94             	mov    %eax,-0x6c(%ebp)
    57d9:	8b 45 08             	mov    0x8(%ebp),%eax
    57dc:	8d 78 3c             	lea    0x3c(%eax),%edi
    57df:	83 ec 0c             	sub    $0xc,%esp
    57e2:	83 ec 04             	sub    $0x4,%esp
    57e5:	89 e0                	mov    %esp,%eax
    57e7:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    57eb:	66 89 30             	mov    %si,(%eax)
    57ee:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    57f2:	88 50 02             	mov    %dl,0x2(%eax)
    57f5:	6a 32                	push   $0x32
    57f7:	6a 32                	push   $0x32
    57f9:	6a 00                	push   $0x0
    57fb:	6a 00                	push   $0x0
    57fd:	53                   	push   %ebx
    57fe:	51                   	push   %ecx
    57ff:	ff 75 94             	pushl  -0x6c(%ebp)
    5802:	57                   	push   %edi
    5803:	e8 7e f4 ff ff       	call   4c86 <APDcCopy>
    5808:	83 c4 30             	add    $0x30,%esp
                    break;
    580b:	e9 2f 02 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5810:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    5813:	6a 0c                	push   $0xc
    5815:	6a 0c                	push   $0xc
    5817:	6a 0c                	push   $0xc
    5819:	50                   	push   %eax
    581a:	e8 0b f6 ff ff       	call   4e2a <RGB>
    581f:	83 c4 0c             	add    $0xc,%esp
    5822:	8b 1d c0 05 01 00    	mov    0x105c0,%ebx
    5828:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    582b:	6b c8 32             	imul   $0x32,%eax,%ecx
    582e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5831:	6b c0 32             	imul   $0x32,%eax,%eax
    5834:	89 45 94             	mov    %eax,-0x6c(%ebp)
    5837:	8b 45 08             	mov    0x8(%ebp),%eax
    583a:	8d 78 3c             	lea    0x3c(%eax),%edi
    583d:	83 ec 0c             	sub    $0xc,%esp
    5840:	83 ec 04             	sub    $0x4,%esp
    5843:	89 e0                	mov    %esp,%eax
    5845:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    5849:	66 89 30             	mov    %si,(%eax)
    584c:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    5850:	88 50 02             	mov    %dl,0x2(%eax)
    5853:	6a 32                	push   $0x32
    5855:	6a 32                	push   $0x32
    5857:	6a 00                	push   $0x0
    5859:	6a 00                	push   $0x0
    585b:	53                   	push   %ebx
    585c:	51                   	push   %ecx
    585d:	ff 75 94             	pushl  -0x6c(%ebp)
    5860:	57                   	push   %edi
    5861:	e8 20 f4 ff ff       	call   4c86 <APDcCopy>
    5866:	83 c4 30             	add    $0x30,%esp
                    break;
    5869:	e9 d1 01 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    586e:	8d 45 c9             	lea    -0x37(%ebp),%eax
    5871:	6a 0c                	push   $0xc
    5873:	6a 0c                	push   $0xc
    5875:	6a 0c                	push   $0xc
    5877:	50                   	push   %eax
    5878:	e8 ad f5 ff ff       	call   4e2a <RGB>
    587d:	83 c4 0c             	add    $0xc,%esp
    5880:	8b 1d 0c 06 01 00    	mov    0x1060c,%ebx
    5886:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5889:	6b c8 32             	imul   $0x32,%eax,%ecx
    588c:	8b 45 e0             	mov    -0x20(%ebp),%eax
    588f:	6b c0 32             	imul   $0x32,%eax,%eax
    5892:	89 45 94             	mov    %eax,-0x6c(%ebp)
    5895:	8b 45 08             	mov    0x8(%ebp),%eax
    5898:	8d 78 3c             	lea    0x3c(%eax),%edi
    589b:	83 ec 0c             	sub    $0xc,%esp
    589e:	83 ec 04             	sub    $0x4,%esp
    58a1:	89 e0                	mov    %esp,%eax
    58a3:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    58a7:	66 89 30             	mov    %si,(%eax)
    58aa:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    58ae:	88 50 02             	mov    %dl,0x2(%eax)
    58b1:	6a 32                	push   $0x32
    58b3:	6a 32                	push   $0x32
    58b5:	6a 00                	push   $0x0
    58b7:	6a 00                	push   $0x0
    58b9:	53                   	push   %ebx
    58ba:	51                   	push   %ecx
    58bb:	ff 75 94             	pushl  -0x6c(%ebp)
    58be:	57                   	push   %edi
    58bf:	e8 c2 f3 ff ff       	call   4c86 <APDcCopy>
    58c4:	83 c4 30             	add    $0x30,%esp
                    break;
    58c7:	e9 73 01 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    58cc:	8d 45 cc             	lea    -0x34(%ebp),%eax
    58cf:	6a 0c                	push   $0xc
    58d1:	6a 0c                	push   $0xc
    58d3:	6a 0c                	push   $0xc
    58d5:	50                   	push   %eax
    58d6:	e8 4f f5 ff ff       	call   4e2a <RGB>
    58db:	83 c4 0c             	add    $0xc,%esp
    58de:	8b 1d 84 05 01 00    	mov    0x10584,%ebx
    58e4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    58e7:	6b c8 32             	imul   $0x32,%eax,%ecx
    58ea:	8b 45 e0             	mov    -0x20(%ebp),%eax
    58ed:	6b c0 32             	imul   $0x32,%eax,%eax
    58f0:	89 45 94             	mov    %eax,-0x6c(%ebp)
    58f3:	8b 45 08             	mov    0x8(%ebp),%eax
    58f6:	8d 78 3c             	lea    0x3c(%eax),%edi
    58f9:	83 ec 0c             	sub    $0xc,%esp
    58fc:	83 ec 04             	sub    $0x4,%esp
    58ff:	89 e0                	mov    %esp,%eax
    5901:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    5905:	66 89 30             	mov    %si,(%eax)
    5908:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    590c:	88 50 02             	mov    %dl,0x2(%eax)
    590f:	6a 32                	push   $0x32
    5911:	6a 32                	push   $0x32
    5913:	6a 00                	push   $0x0
    5915:	6a 00                	push   $0x0
    5917:	53                   	push   %ebx
    5918:	51                   	push   %ecx
    5919:	ff 75 94             	pushl  -0x6c(%ebp)
    591c:	57                   	push   %edi
    591d:	e8 64 f3 ff ff       	call   4c86 <APDcCopy>
    5922:	83 c4 30             	add    $0x30,%esp
                    break;
    5925:	e9 15 01 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    592a:	8d 45 cf             	lea    -0x31(%ebp),%eax
    592d:	6a 0c                	push   $0xc
    592f:	6a 0c                	push   $0xc
    5931:	6a 0c                	push   $0xc
    5933:	50                   	push   %eax
    5934:	e8 f1 f4 ff ff       	call   4e2a <RGB>
    5939:	83 c4 0c             	add    $0xc,%esp
    593c:	8b 1d ac 05 01 00    	mov    0x105ac,%ebx
    5942:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5945:	6b c8 32             	imul   $0x32,%eax,%ecx
    5948:	8b 45 e0             	mov    -0x20(%ebp),%eax
    594b:	6b c0 32             	imul   $0x32,%eax,%eax
    594e:	89 45 94             	mov    %eax,-0x6c(%ebp)
    5951:	8b 45 08             	mov    0x8(%ebp),%eax
    5954:	8d 78 3c             	lea    0x3c(%eax),%edi
    5957:	83 ec 0c             	sub    $0xc,%esp
    595a:	83 ec 04             	sub    $0x4,%esp
    595d:	89 e0                	mov    %esp,%eax
    595f:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    5963:	66 89 30             	mov    %si,(%eax)
    5966:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    596a:	88 50 02             	mov    %dl,0x2(%eax)
    596d:	6a 32                	push   $0x32
    596f:	6a 32                	push   $0x32
    5971:	6a 00                	push   $0x0
    5973:	6a 00                	push   $0x0
    5975:	53                   	push   %ebx
    5976:	51                   	push   %ecx
    5977:	ff 75 94             	pushl  -0x6c(%ebp)
    597a:	57                   	push   %edi
    597b:	e8 06 f3 ff ff       	call   4c86 <APDcCopy>
    5980:	83 c4 30             	add    $0x30,%esp
                    break;
    5983:	e9 b7 00 00 00       	jmp    5a3f <APGridPaint+0x791>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5988:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    598b:	6a 0c                	push   $0xc
    598d:	6a 0c                	push   $0xc
    598f:	6a 0c                	push   $0xc
    5991:	50                   	push   %eax
    5992:	e8 93 f4 ff ff       	call   4e2a <RGB>
    5997:	83 c4 0c             	add    $0xc,%esp
    599a:	8b 1d 08 06 01 00    	mov    0x10608,%ebx
    59a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    59a3:	6b c8 32             	imul   $0x32,%eax,%ecx
    59a6:	8b 45 e0             	mov    -0x20(%ebp),%eax
    59a9:	6b c0 32             	imul   $0x32,%eax,%eax
    59ac:	89 45 94             	mov    %eax,-0x6c(%ebp)
    59af:	8b 45 08             	mov    0x8(%ebp),%eax
    59b2:	8d 78 3c             	lea    0x3c(%eax),%edi
    59b5:	83 ec 0c             	sub    $0xc,%esp
    59b8:	83 ec 04             	sub    $0x4,%esp
    59bb:	89 e0                	mov    %esp,%eax
    59bd:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    59c1:	66 89 30             	mov    %si,(%eax)
    59c4:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    59c8:	88 50 02             	mov    %dl,0x2(%eax)
    59cb:	6a 32                	push   $0x32
    59cd:	6a 32                	push   $0x32
    59cf:	6a 00                	push   $0x0
    59d1:	6a 00                	push   $0x0
    59d3:	53                   	push   %ebx
    59d4:	51                   	push   %ecx
    59d5:	ff 75 94             	pushl  -0x6c(%ebp)
    59d8:	57                   	push   %edi
    59d9:	e8 a8 f2 ff ff       	call   4c86 <APDcCopy>
    59de:	83 c4 30             	add    $0x30,%esp
                    break;
    59e1:	eb 5c                	jmp    5a3f <APGridPaint+0x791>
                case GRID_PROGRAM_TOWER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_tower,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    59e3:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    59e6:	6a 0c                	push   $0xc
    59e8:	6a 0c                	push   $0xc
    59ea:	6a 0c                	push   $0xc
    59ec:	50                   	push   %eax
    59ed:	e8 38 f4 ff ff       	call   4e2a <RGB>
    59f2:	83 c4 0c             	add    $0xc,%esp
    59f5:	8b 1d c4 05 01 00    	mov    0x105c4,%ebx
    59fb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    59fe:	6b c8 32             	imul   $0x32,%eax,%ecx
    5a01:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5a04:	6b c0 32             	imul   $0x32,%eax,%eax
    5a07:	89 45 94             	mov    %eax,-0x6c(%ebp)
    5a0a:	8b 45 08             	mov    0x8(%ebp),%eax
    5a0d:	8d 78 3c             	lea    0x3c(%eax),%edi
    5a10:	83 ec 0c             	sub    $0xc,%esp
    5a13:	83 ec 04             	sub    $0x4,%esp
    5a16:	89 e0                	mov    %esp,%eax
    5a18:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    5a1c:	66 89 30             	mov    %si,(%eax)
    5a1f:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    5a23:	88 50 02             	mov    %dl,0x2(%eax)
    5a26:	6a 32                	push   $0x32
    5a28:	6a 32                	push   $0x32
    5a2a:	6a 00                	push   $0x0
    5a2c:	6a 00                	push   $0x0
    5a2e:	53                   	push   %ebx
    5a2f:	51                   	push   %ecx
    5a30:	ff 75 94             	pushl  -0x6c(%ebp)
    5a33:	57                   	push   %edi
    5a34:	e8 4d f2 ff ff       	call   4c86 <APDcCopy>
    5a39:	83 c4 30             	add    $0x30,%esp
                    break;
    5a3c:	eb 01                	jmp    5a3f <APGridPaint+0x791>
                default: break;
    5a3e:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    5a3f:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    5a43:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    5a47:	0f 8e be fb ff ff    	jle    560b <APGridPaint+0x35d>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    5a4d:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    5a51:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    5a55:	0f 8e a4 fb ff ff    	jle    55ff <APGridPaint+0x351>
                    break;
                default: break;
            }
        }
...
void updateword(AHwnd hwnd,char* str)
{
    ...
    5a66:	53                   	push   %ebx
    5a67:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    5a6a:	8d 45 d8             	lea    -0x28(%ebp),%eax
    5a6d:	68 cd 00 00 00       	push   $0xcd
    5a72:	6a 74                	push   $0x74
    5a74:	6a 18                	push   $0x18
    5a76:	50                   	push   %eax
    5a77:	e8 ae f3 ff ff       	call   4e2a <RGB>
    5a7c:	83 c4 0c             	add    $0xc,%esp
    5a7f:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    5a83:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    5a87:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    5a8b:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    5a8e:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    5a95:	8d 45 d8             	lea    -0x28(%ebp),%eax
    5a98:	68 cd 00 00 00       	push   $0xcd
    5a9d:	6a 74                	push   $0x74
    5a9f:	6a 18                	push   $0x18
    5aa1:	50                   	push   %eax
    5aa2:	e8 83 f3 ff ff       	call   4e2a <RGB>
    5aa7:	83 c4 0c             	add    $0xc,%esp
    5aaa:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    5aae:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    5ab2:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    5ab6:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    5ab9:	8b 45 08             	mov    0x8(%ebp),%eax
    5abc:	8d 50 58             	lea    0x58(%eax),%edx
    5abf:	8d 45 d8             	lea    -0x28(%ebp),%eax
    5ac2:	ff 75 f4             	pushl  -0xc(%ebp)
    5ac5:	ff 75 f0             	pushl  -0x10(%ebp)
    5ac8:	52                   	push   %edx
    5ac9:	50                   	push   %eax
    5aca:	e8 48 ea ff ff       	call   4517 <APSetPen>
    5acf:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    5ad2:	8b 45 08             	mov    0x8(%ebp),%eax
    5ad5:	8d 58 58             	lea    0x58(%eax),%ebx
    5ad8:	8d 55 d8             	lea    -0x28(%ebp),%edx
    5adb:	83 ec 04             	sub    $0x4,%esp
    5ade:	83 ec 04             	sub    $0x4,%esp
    5ae1:	89 e0                	mov    %esp,%eax
    5ae3:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    5ae7:	66 89 08             	mov    %cx,(%eax)
    5aea:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    5aee:	88 48 02             	mov    %cl,0x2(%eax)
    5af1:	53                   	push   %ebx
    5af2:	52                   	push   %edx
    5af3:	e8 58 ea ff ff       	call   4550 <APSetBrush>
    5af8:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    5afb:	8b 45 08             	mov    0x8(%ebp),%eax
    5afe:	83 c0 58             	add    $0x58,%eax
    5b01:	83 ec 0c             	sub    $0xc,%esp
    5b04:	6a 32                	push   $0x32
    5b06:	68 20 03 00 00       	push   $0x320
    5b0b:	6a 00                	push   $0x0
    5b0d:	6a 00                	push   $0x0
    5b0f:	50                   	push   %eax
    5b10:	e8 65 ee ff ff       	call   497a <APDrawRect>
    5b15:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    5b18:	8d 45 d8             	lea    -0x28(%ebp),%eax
    5b1b:	6a 08                	push   $0x8
    5b1d:	6a 08                	push   $0x8
    5b1f:	6a 08                	push   $0x8
    5b21:	50                   	push   %eax
    5b22:	e8 03 f3 ff ff       	call   4e2a <RGB>
    5b27:	83 c4 0c             	add    $0xc,%esp
    5b2a:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    5b2e:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    5b32:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    5b36:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    5b39:	8b 45 08             	mov    0x8(%ebp),%eax
    5b3c:	8d 58 58             	lea    0x58(%eax),%ebx
    5b3f:	8d 55 d8             	lea    -0x28(%ebp),%edx
    5b42:	83 ec 04             	sub    $0x4,%esp
    5b45:	83 ec 04             	sub    $0x4,%esp
    5b48:	89 e0                	mov    %esp,%eax
    5b4a:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    5b4e:	66 89 08             	mov    %cx,(%eax)
    5b51:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    5b55:	88 48 02             	mov    %cl,0x2(%eax)
    5b58:	53                   	push   %ebx
    5b59:	52                   	push   %edx
    5b5a:	e8 33 ea ff ff       	call   4592 <APSetFont>
    5b5f:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    5b62:	8b 45 08             	mov    0x8(%ebp),%eax
    5b65:	83 c0 58             	add    $0x58,%eax
    5b68:	6a 14                	push   $0x14
    5b6a:	6a 0a                	push   $0xa
    5b6c:	ff 75 0c             	pushl  0xc(%ebp)
    5b6f:	50                   	push   %eax
    5b70:	e8 0a f0 ff ff       	call   4b7f <APDrawText>
    5b75:	83 c4 10             	add    $0x10,%esp
}
    5b78:	90                   	nop
...
if (seed > 0)
    5b81:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    5b85:	7e 08                	jle    5b8f <random+0x11>
{
rand_num = seed;
    5b87:	8b 45 08             	mov    0x8(%ebp),%eax
    5b8a:	a3 a0 bd 00 00       	mov    %eax,0xbda0
}
rand_num *= 3;
    5b8f:	8b 15 a0 bd 00 00    	mov    0xbda0,%edx
    5b95:	89 d0                	mov    %edx,%eax
    5b97:	01 c0                	add    %eax,%eax
    5b99:	01 d0                	add    %edx,%eax
    5b9b:	a3 a0 bd 00 00       	mov    %eax,0xbda0
if (rand_num < 0)
    5ba0:	a1 a0 bd 00 00       	mov    0xbda0,%eax
    5ba5:	85 c0                	test   %eax,%eax
    5ba7:	79 0c                	jns    5bb5 <random+0x37>
{
rand_num *= (-1);
    5ba9:	a1 a0 bd 00 00       	mov    0xbda0,%eax
    5bae:	f7 d8                	neg    %eax
    5bb0:	a3 a0 bd 00 00       	mov    %eax,0xbda0
}
return rand_num % 997;
    5bb5:	8b 0d a0 bd 00 00    	mov    0xbda0,%ecx
    5bbb:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    5bc0:	89 c8                	mov    %ecx,%eax
    5bc2:	f7 ea                	imul   %edx
    5bc4:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    5bc7:	c1 f8 09             	sar    $0x9,%eax
    5bca:	89 c2                	mov    %eax,%edx
    5bcc:	89 c8                	mov    %ecx,%eax
    5bce:	c1 f8 1f             	sar    $0x1f,%eax
    5bd1:	29 c2                	sub    %eax,%edx
    5bd3:	89 d0                	mov    %edx,%eax
    5bd5:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    5bdb:	29 c1                	sub    %eax,%ecx
    5bdd:	89 c8                	mov    %ecx,%eax
}
    5bdf:	5d                   	pop    %ebp
    5be0:	c3                   	ret    
...
{
    5be1:	55                   	push   %ebp
    5be2:	89 e5                	mov    %esp,%ebp
    5be4:	53                   	push   %ebx
    5be5:	83 ec 20             	sub    $0x20,%esp
    static char digits[] = "0123456789ABCDEF";
    char buf[16];
    int i, neg;
    uint x;
    ...
    neg = 0;
    5be8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    5bef:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    5bf3:	74 17                	je     5c0c <sprintint+0x2b>
    5bf5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    5bf9:	79 11                	jns    5c0c <sprintint+0x2b>
        neg = 1;
    5bfb:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    5c02:	8b 45 10             	mov    0x10(%ebp),%eax
    5c05:	f7 d8                	neg    %eax
    5c07:	89 45 f0             	mov    %eax,-0x10(%ebp)
    5c0a:	eb 06                	jmp    5c12 <sprintint+0x31>
    } else {
        x = xx;
    5c0c:	8b 45 10             	mov    0x10(%ebp),%eax
    5c0f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    5c12:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    5c19:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    5c1c:	8d 41 01             	lea    0x1(%ecx),%eax
    5c1f:	89 45 f8             	mov    %eax,-0x8(%ebp)
    5c22:	8b 5d 14             	mov    0x14(%ebp),%ebx
    5c25:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5c28:	ba 00 00 00 00       	mov    $0x0,%edx
    5c2d:	f7 f3                	div    %ebx
    5c2f:	89 d0                	mov    %edx,%eax
    5c31:	0f b6 80 a4 bd 00 00 	movzbl 0xbda4(%eax),%eax
    5c38:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    5c3c:	8b 5d 14             	mov    0x14(%ebp),%ebx
    5c3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5c42:	ba 00 00 00 00       	mov    $0x0,%edx
    5c47:	f7 f3                	div    %ebx
    5c49:	89 45 f0             	mov    %eax,-0x10(%ebp)
    5c4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    5c50:	75 c7                	jne    5c19 <sprintint+0x38>
    if(neg)
    5c52:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    5c56:	74 0e                	je     5c66 <sprintint+0x85>
        buf[i++] = '-';
    5c58:	8b 45 f8             	mov    -0x8(%ebp),%eax
    5c5b:	8d 50 01             	lea    0x1(%eax),%edx
    5c5e:	89 55 f8             	mov    %edx,-0x8(%ebp)
    5c61:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    5c66:	8b 45 f8             	mov    -0x8(%ebp),%eax
    5c69:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    5c6c:	eb 1b                	jmp    5c89 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    5c6e:	8b 45 0c             	mov    0xc(%ebp),%eax
    5c71:	8b 00                	mov    (%eax),%eax
    5c73:	8d 48 01             	lea    0x1(%eax),%ecx
    5c76:	8b 55 0c             	mov    0xc(%ebp),%edx
    5c79:	89 0a                	mov    %ecx,(%edx)
    5c7b:	89 c2                	mov    %eax,%edx
    5c7d:	8b 45 08             	mov    0x8(%ebp),%eax
    5c80:	01 d0                	add    %edx,%eax
    5c82:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    5c85:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    5c89:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    5c8d:	7f df                	jg     5c6e <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    5c8f:	eb 21                	jmp    5cb2 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    5c91:	8b 45 0c             	mov    0xc(%ebp),%eax
    5c94:	8b 00                	mov    (%eax),%eax
    5c96:	8d 48 01             	lea    0x1(%eax),%ecx
    5c99:	8b 55 0c             	mov    0xc(%ebp),%edx
    5c9c:	89 0a                	mov    %ecx,(%edx)
    5c9e:	89 c2                	mov    %eax,%edx
    5ca0:	8b 45 08             	mov    0x8(%ebp),%eax
    5ca3:	01 c2                	add    %eax,%edx
    5ca5:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    5ca8:	8b 45 f8             	mov    -0x8(%ebp),%eax
    5cab:	01 c8                	add    %ecx,%eax
    5cad:	0f b6 00             	movzbl (%eax),%eax
    5cb0:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    5cb2:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    5cb6:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    5cba:	79 d5                	jns    5c91 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    5cbc:	90                   	nop
    5cbd:	83 c4 20             	add    $0x20,%esp
    5cc0:	5b                   	pop    %ebx
    5cc1:	5d                   	pop    %ebp
    5cc2:	c3                   	ret    
...
{
    5cc3:	55                   	push   %ebp
    5cc4:	89 e5                	mov    %esp,%ebp
    5cc6:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    5cc9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    5cd0:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    5cd7:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    5cde:	8d 45 0c             	lea    0xc(%ebp),%eax
    5ce1:	83 c0 04             	add    $0x4,%eax
    5ce4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    5ce7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    5cee:	e9 d9 01 00 00       	jmp    5ecc <sprintf+0x209>
        c = fmt[i] & 0xff;
    5cf3:	8b 55 0c             	mov    0xc(%ebp),%edx
    5cf6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    5cf9:	01 d0                	add    %edx,%eax
    5cfb:	0f b6 00             	movzbl (%eax),%eax
    5cfe:	0f be c0             	movsbl %al,%eax
    5d01:	25 ff 00 00 00       	and    $0xff,%eax
    5d06:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    5d09:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    5d0d:	75 2c                	jne    5d3b <sprintf+0x78>
            if(c == '%'){
    5d0f:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    5d13:	75 0c                	jne    5d21 <sprintf+0x5e>
                state = '%';
    5d15:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    5d1c:	e9 a7 01 00 00       	jmp    5ec8 <sprintf+0x205>
            } else {
                dst[j++] = c;
    5d21:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5d24:	8d 50 01             	lea    0x1(%eax),%edx
    5d27:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5d2a:	89 c2                	mov    %eax,%edx
    5d2c:	8b 45 08             	mov    0x8(%ebp),%eax
    5d2f:	01 d0                	add    %edx,%eax
    5d31:	8b 55 e0             	mov    -0x20(%ebp),%edx
    5d34:	88 10                	mov    %dl,(%eax)
    5d36:	e9 8d 01 00 00       	jmp    5ec8 <sprintf+0x205>
            }
        } else if(state == '%'){
    5d3b:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    5d3f:	0f 85 83 01 00 00    	jne    5ec8 <sprintf+0x205>
            if(c == 'd'){
    5d45:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    5d49:	75 4c                	jne    5d97 <sprintf+0xd4>
                buf[bi] = '\0';
    5d4b:	8d 55 ce             	lea    -0x32(%ebp),%edx
    5d4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5d51:	01 d0                	add    %edx,%eax
    5d53:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    5d56:	83 ec 0c             	sub    $0xc,%esp
    5d59:	8d 45 ce             	lea    -0x32(%ebp),%eax
    5d5c:	50                   	push   %eax
    5d5d:	e8 0f de ff ff       	call   3b71 <atoi>
    5d62:	83 c4 10             	add    $0x10,%esp
    5d65:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    5d68:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    5d6f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5d72:	8b 00                	mov    (%eax),%eax
    5d74:	83 ec 08             	sub    $0x8,%esp
    5d77:	ff 75 d8             	pushl  -0x28(%ebp)
    5d7a:	6a 01                	push   $0x1
    5d7c:	6a 0a                	push   $0xa
    5d7e:	50                   	push   %eax
    5d7f:	8d 45 c8             	lea    -0x38(%ebp),%eax
    5d82:	50                   	push   %eax
    5d83:	ff 75 08             	pushl  0x8(%ebp)
    5d86:	e8 56 fe ff ff       	call   5be1 <sprintint>
    5d8b:	83 c4 20             	add    $0x20,%esp
                ap++;
    5d8e:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    5d92:	e9 2a 01 00 00       	jmp    5ec1 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    5d97:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    5d9b:	74 06                	je     5da3 <sprintf+0xe0>
    5d9d:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    5da1:	75 4c                	jne    5def <sprintf+0x12c>
                buf[bi] = '\0';
    5da3:	8d 55 ce             	lea    -0x32(%ebp),%edx
    5da6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5da9:	01 d0                	add    %edx,%eax
    5dab:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    5dae:	83 ec 0c             	sub    $0xc,%esp
    5db1:	8d 45 ce             	lea    -0x32(%ebp),%eax
    5db4:	50                   	push   %eax
    5db5:	e8 b7 dd ff ff       	call   3b71 <atoi>
    5dba:	83 c4 10             	add    $0x10,%esp
    5dbd:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    5dc0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    5dc7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5dca:	8b 00                	mov    (%eax),%eax
    5dcc:	83 ec 08             	sub    $0x8,%esp
    5dcf:	ff 75 dc             	pushl  -0x24(%ebp)
    5dd2:	6a 00                	push   $0x0
    5dd4:	6a 10                	push   $0x10
    5dd6:	50                   	push   %eax
    5dd7:	8d 45 c8             	lea    -0x38(%ebp),%eax
    5dda:	50                   	push   %eax
    5ddb:	ff 75 08             	pushl  0x8(%ebp)
    5dde:	e8 fe fd ff ff       	call   5be1 <sprintint>
    5de3:	83 c4 20             	add    $0x20,%esp
                ap++;
    5de6:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    5dea:	e9 d2 00 00 00       	jmp    5ec1 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    5def:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    5df3:	75 46                	jne    5e3b <sprintf+0x178>
                s = (char*)*ap;
    5df5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5df8:	8b 00                	mov    (%eax),%eax
    5dfa:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    5dfd:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    5e01:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    5e05:	75 25                	jne    5e2c <sprintf+0x169>
                    s = "(null)";
    5e07:	c7 45 f4 5c 77 00 00 	movl   $0x775c,-0xc(%ebp)
                while(*s != 0){
    5e0e:	eb 1c                	jmp    5e2c <sprintf+0x169>
                    dst[j++] = *s;
    5e10:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5e13:	8d 50 01             	lea    0x1(%eax),%edx
    5e16:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5e19:	89 c2                	mov    %eax,%edx
    5e1b:	8b 45 08             	mov    0x8(%ebp),%eax
    5e1e:	01 c2                	add    %eax,%edx
    5e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
    5e23:	0f b6 00             	movzbl (%eax),%eax
    5e26:	88 02                	mov    %al,(%edx)
                    s++;
    5e28:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    5e2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    5e2f:	0f b6 00             	movzbl (%eax),%eax
    5e32:	84 c0                	test   %al,%al
    5e34:	75 da                	jne    5e10 <sprintf+0x14d>
    5e36:	e9 86 00 00 00       	jmp    5ec1 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    5e3b:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    5e3f:	75 1d                	jne    5e5e <sprintf+0x19b>
                dst[j++] = *ap;
    5e41:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5e44:	8d 50 01             	lea    0x1(%eax),%edx
    5e47:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5e4a:	89 c2                	mov    %eax,%edx
    5e4c:	8b 45 08             	mov    0x8(%ebp),%eax
    5e4f:	01 c2                	add    %eax,%edx
    5e51:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5e54:	8b 00                	mov    (%eax),%eax
    5e56:	88 02                	mov    %al,(%edx)
                ap++;
    5e58:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    5e5c:	eb 63                	jmp    5ec1 <sprintf+0x1fe>
            } else if(c == '%'){
    5e5e:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    5e62:	75 17                	jne    5e7b <sprintf+0x1b8>
                dst[j++] = c;
    5e64:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5e67:	8d 50 01             	lea    0x1(%eax),%edx
    5e6a:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5e6d:	89 c2                	mov    %eax,%edx
    5e6f:	8b 45 08             	mov    0x8(%ebp),%eax
    5e72:	01 d0                	add    %edx,%eax
    5e74:	8b 55 e0             	mov    -0x20(%ebp),%edx
    5e77:	88 10                	mov    %dl,(%eax)
    5e79:	eb 46                	jmp    5ec1 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    5e7b:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    5e7f:	7e 18                	jle    5e99 <sprintf+0x1d6>
    5e81:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    5e85:	7f 12                	jg     5e99 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    5e87:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5e8a:	8d 50 01             	lea    0x1(%eax),%edx
    5e8d:	89 55 f0             	mov    %edx,-0x10(%ebp)
    5e90:	8b 55 e0             	mov    -0x20(%ebp),%edx
    5e93:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    5e97:	eb 2f                	jmp    5ec8 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    5e99:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5e9c:	8d 50 01             	lea    0x1(%eax),%edx
    5e9f:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5ea2:	89 c2                	mov    %eax,%edx
    5ea4:	8b 45 08             	mov    0x8(%ebp),%eax
    5ea7:	01 d0                	add    %edx,%eax
    5ea9:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    5eac:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5eaf:	8d 50 01             	lea    0x1(%eax),%edx
    5eb2:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5eb5:	89 c2                	mov    %eax,%edx
    5eb7:	8b 45 08             	mov    0x8(%ebp),%eax
    5eba:	01 d0                	add    %edx,%eax
    5ebc:	8b 55 e0             	mov    -0x20(%ebp),%edx
    5ebf:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    5ec1:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    5ec8:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    5ecc:	8b 55 0c             	mov    0xc(%ebp),%edx
    5ecf:	8b 45 ec             	mov    -0x14(%ebp),%eax
    5ed2:	01 d0                	add    %edx,%eax
    5ed4:	0f b6 00             	movzbl (%eax),%eax
    5ed7:	84 c0                	test   %al,%al
    5ed9:	0f 85 14 fe ff ff    	jne    5cf3 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    5edf:	8b 45 c8             	mov    -0x38(%ebp),%eax
    5ee2:	8d 50 01             	lea    0x1(%eax),%edx
    5ee5:	89 55 c8             	mov    %edx,-0x38(%ebp)
    5ee8:	89 c2                	mov    %eax,%edx
    5eea:	8b 45 08             	mov    0x8(%ebp),%eax
    5eed:	01 d0                	add    %edx,%eax
    5eef:	c6 00 00             	movb   $0x0,(%eax)
}
    5ef2:	90                   	nop
    5ef3:	c9                   	leave  
    5ef4:	c3                   	ret    
