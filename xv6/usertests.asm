...
void APGridPaint(AHwnd wnd)
{
    ...
    524d:	8d 45 88             	lea    -0x78(%ebp),%eax
    5250:	6a 08                	push   $0x8
    5252:	6a 08                	push   $0x8
    5254:	6a 08                	push   $0x8
    5256:	50                   	push   %eax
    5257:	e8 ce fb ff ff       	call   4e2a <RGB>
    525c:	83 c4 0c             	add    $0xc,%esp
    525f:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    5263:	66 89 45 bd          	mov    %ax,-0x43(%ebp)
    5267:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    526b:	88 45 bf             	mov    %al,-0x41(%ebp)
    APSetFont(&wnd->TitleDc,font);
    526e:	8b 45 08             	mov    0x8(%ebp),%eax
    5271:	8d 58 58             	lea    0x58(%eax),%ebx
    5274:	8d 55 88             	lea    -0x78(%ebp),%edx
    5277:	83 ec 04             	sub    $0x4,%esp
    527a:	83 ec 04             	sub    $0x4,%esp
    527d:	89 e0                	mov    %esp,%eax
    527f:	0f b7 4d bd          	movzwl -0x43(%ebp),%ecx
    5283:	66 89 08             	mov    %cx,(%eax)
    5286:	0f b6 4d bf          	movzbl -0x41(%ebp),%ecx
    528a:	88 48 02             	mov    %cl,0x2(%eax)
    528d:	53                   	push   %ebx
    528e:	52                   	push   %edx
    528f:	e8 fe f2 ff ff       	call   4592 <APSetFont>
    5294:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    5297:	8b 45 08             	mov    0x8(%ebp),%eax
    529a:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    52a0:	8b 45 08             	mov    0x8(%ebp),%eax
    52a3:	83 c0 58             	add    $0x58,%eax
    52a6:	6a 14                	push   $0x14
    52a8:	6a 14                	push   $0x14
    52aa:	52                   	push   %edx
    52ab:	50                   	push   %eax
    52ac:	e8 ce f8 ff ff       	call   4b7f <APDrawText>
    52b1:	83 c4 10             	add    $0x10,%esp
    
    if (!iconReady)
    52b4:	a1 ec bc 00 00       	mov    0xbcec,%eax
    52b9:	85 c0                	test   %eax,%eax
    52bb:	0f 85 7a 02 00 00    	jne    553b <APGridPaint+0x2f7>
    {
        iconReady = 1;
    52c1:	c7 05 ec bc 00 00 01 	movl   $0x1,0xbcec
    52c8:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    52cb:	8d 45 88             	lea    -0x78(%ebp),%eax
    52ce:	83 ec 08             	sub    $0x8,%esp
    52d1:	68 4b 75 00 00       	push   $0x754b
    52d6:	50                   	push   %eax
    52d7:	e8 6c ef ff ff       	call   4248 <APLoadBitmap>
    52dc:	83 c4 0c             	add    $0xc,%esp
    52df:	8b 45 88             	mov    -0x78(%ebp),%eax
    52e2:	a3 44 04 01 00       	mov    %eax,0x10444
    52e7:	8b 45 8c             	mov    -0x74(%ebp),%eax
    52ea:	a3 48 04 01 00       	mov    %eax,0x10448
    52ef:	8b 45 90             	mov    -0x70(%ebp),%eax
    52f2:	a3 4c 04 01 00       	mov    %eax,0x1044c
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    52f7:	83 ec 04             	sub    $0x4,%esp
    52fa:	ff 35 4c 04 01 00    	pushl  0x1044c
    5300:	ff 35 48 04 01 00    	pushl  0x10448
    5306:	ff 35 44 04 01 00    	pushl  0x10444
    530c:	e8 71 f1 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5311:	83 c4 10             	add    $0x10,%esp
    5314:	a3 50 04 01 00       	mov    %eax,0x10450
        grid_river = APLoadBitmap ("grid_river.bmp");
    5319:	8d 45 88             	lea    -0x78(%ebp),%eax
    531c:	83 ec 08             	sub    $0x8,%esp
    531f:	68 59 75 00 00       	push   $0x7559
    5324:	50                   	push   %eax
    5325:	e8 1e ef ff ff       	call   4248 <APLoadBitmap>
    532a:	83 c4 0c             	add    $0xc,%esp
    532d:	8b 45 88             	mov    -0x78(%ebp),%eax
    5330:	a3 8c 04 01 00       	mov    %eax,0x1048c
    5335:	8b 45 8c             	mov    -0x74(%ebp),%eax
    5338:	a3 90 04 01 00       	mov    %eax,0x10490
    533d:	8b 45 90             	mov    -0x70(%ebp),%eax
    5340:	a3 94 04 01 00       	mov    %eax,0x10494
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    5345:	83 ec 04             	sub    $0x4,%esp
    5348:	ff 35 94 04 01 00    	pushl  0x10494
    534e:	ff 35 90 04 01 00    	pushl  0x10490
    5354:	ff 35 8c 04 01 00    	pushl  0x1048c
    535a:	e8 23 f1 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    535f:	83 c4 10             	add    $0x10,%esp
    5362:	a3 7c 04 01 00       	mov    %eax,0x1047c
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    5367:	8d 45 88             	lea    -0x78(%ebp),%eax
    536a:	83 ec 08             	sub    $0x8,%esp
    536d:	68 68 75 00 00       	push   $0x7568
    5372:	50                   	push   %eax
    5373:	e8 d0 ee ff ff       	call   4248 <APLoadBitmap>
    5378:	83 c4 0c             	add    $0xc,%esp
    537b:	8b 45 88             	mov    -0x78(%ebp),%eax
    537e:	a3 80 04 01 00       	mov    %eax,0x10480
    5383:	8b 45 8c             	mov    -0x74(%ebp),%eax
    5386:	a3 84 04 01 00       	mov    %eax,0x10484
    538b:	8b 45 90             	mov    -0x70(%ebp),%eax
    538e:	a3 88 04 01 00       	mov    %eax,0x10488
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    5393:	83 ec 04             	sub    $0x4,%esp
    5396:	ff 35 88 04 01 00    	pushl  0x10488
    539c:	ff 35 84 04 01 00    	pushl  0x10484
    53a2:	ff 35 80 04 01 00    	pushl  0x10480
    53a8:	e8 d5 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    53ad:	83 c4 10             	add    $0x10,%esp
    53b0:	a3 24 04 01 00       	mov    %eax,0x10424
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    53b5:	8d 45 88             	lea    -0x78(%ebp),%eax
    53b8:	83 ec 08             	sub    $0x8,%esp
    53bb:	68 77 75 00 00       	push   $0x7577
    53c0:	50                   	push   %eax
    53c1:	e8 82 ee ff ff       	call   4248 <APLoadBitmap>
    53c6:	83 c4 0c             	add    $0xc,%esp
    53c9:	8b 45 88             	mov    -0x78(%ebp),%eax
    53cc:	a3 58 04 01 00       	mov    %eax,0x10458
    53d1:	8b 45 8c             	mov    -0x74(%ebp),%eax
    53d4:	a3 5c 04 01 00       	mov    %eax,0x1045c
    53d9:	8b 45 90             	mov    -0x70(%ebp),%eax
    53dc:	a3 60 04 01 00       	mov    %eax,0x10460
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    53e1:	83 ec 04             	sub    $0x4,%esp
    53e4:	ff 35 60 04 01 00    	pushl  0x10460
    53ea:	ff 35 5c 04 01 00    	pushl  0x1045c
    53f0:	ff 35 58 04 01 00    	pushl  0x10458
    53f6:	e8 87 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    53fb:	83 c4 10             	add    $0x10,%esp
    53fe:	a3 9c 04 01 00       	mov    %eax,0x1049c
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    5403:	8d 45 88             	lea    -0x78(%ebp),%eax
    5406:	83 ec 08             	sub    $0x8,%esp
    5409:	68 85 75 00 00       	push   $0x7585
    540e:	50                   	push   %eax
    540f:	e8 34 ee ff ff       	call   4248 <APLoadBitmap>
    5414:	83 c4 0c             	add    $0xc,%esp
    5417:	8b 45 88             	mov    -0x78(%ebp),%eax
    541a:	a3 34 04 01 00       	mov    %eax,0x10434
    541f:	8b 45 8c             	mov    -0x74(%ebp),%eax
    5422:	a3 38 04 01 00       	mov    %eax,0x10438
    5427:	8b 45 90             	mov    -0x70(%ebp),%eax
    542a:	a3 3c 04 01 00       	mov    %eax,0x1043c
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    542f:	83 ec 04             	sub    $0x4,%esp
    5432:	ff 35 3c 04 01 00    	pushl  0x1043c
    5438:	ff 35 38 04 01 00    	pushl  0x10438
    543e:	ff 35 34 04 01 00    	pushl  0x10434
    5444:	e8 39 f0 ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5449:	83 c4 10             	add    $0x10,%esp
    544c:	a3 54 04 01 00       	mov    %eax,0x10454
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    5451:	8d 45 88             	lea    -0x78(%ebp),%eax
    5454:	83 ec 08             	sub    $0x8,%esp
    5457:	68 95 75 00 00       	push   $0x7595
    545c:	50                   	push   %eax
    545d:	e8 e6 ed ff ff       	call   4248 <APLoadBitmap>
    5462:	83 c4 0c             	add    $0xc,%esp
    5465:	8b 45 88             	mov    -0x78(%ebp),%eax
    5468:	a3 28 04 01 00       	mov    %eax,0x10428
    546d:	8b 45 8c             	mov    -0x74(%ebp),%eax
    5470:	a3 2c 04 01 00       	mov    %eax,0x1042c
    5475:	8b 45 90             	mov    -0x70(%ebp),%eax
    5478:	a3 30 04 01 00       	mov    %eax,0x10430
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    547d:	83 ec 04             	sub    $0x4,%esp
    5480:	ff 35 30 04 01 00    	pushl  0x10430
    5486:	ff 35 2c 04 01 00    	pushl  0x1042c
    548c:	ff 35 28 04 01 00    	pushl  0x10428
    5492:	e8 eb ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5497:	83 c4 10             	add    $0x10,%esp
    549a:	a3 40 04 01 00       	mov    %eax,0x10440
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    549f:	8d 45 88             	lea    -0x78(%ebp),%eax
    54a2:	83 ec 08             	sub    $0x8,%esp
    54a5:	68 a7 75 00 00       	push   $0x75a7
    54aa:	50                   	push   %eax
    54ab:	e8 98 ed ff ff       	call   4248 <APLoadBitmap>
    54b0:	83 c4 0c             	add    $0xc,%esp
    54b3:	8b 45 88             	mov    -0x78(%ebp),%eax
    54b6:	a3 70 04 01 00       	mov    %eax,0x10470
    54bb:	8b 45 8c             	mov    -0x74(%ebp),%eax
    54be:	a3 74 04 01 00       	mov    %eax,0x10474
    54c3:	8b 45 90             	mov    -0x70(%ebp),%eax
    54c6:	a3 78 04 01 00       	mov    %eax,0x10478
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    54cb:	83 ec 04             	sub    $0x4,%esp
    54ce:	ff 35 78 04 01 00    	pushl  0x10478
    54d4:	ff 35 74 04 01 00    	pushl  0x10474
    54da:	ff 35 70 04 01 00    	pushl  0x10470
    54e0:	e8 9d ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    54e5:	83 c4 10             	add    $0x10,%esp
    54e8:	a3 a0 04 01 00       	mov    %eax,0x104a0
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    54ed:	8d 45 88             	lea    -0x78(%ebp),%eax
    54f0:	83 ec 08             	sub    $0x8,%esp
    54f3:	68 b6 75 00 00       	push   $0x75b6
    54f8:	50                   	push   %eax
    54f9:	e8 4a ed ff ff       	call   4248 <APLoadBitmap>
    54fe:	83 c4 0c             	add    $0xc,%esp
    5501:	8b 45 88             	mov    -0x78(%ebp),%eax
    5504:	a3 64 04 01 00       	mov    %eax,0x10464
    5509:	8b 45 8c             	mov    -0x74(%ebp),%eax
    550c:	a3 68 04 01 00       	mov    %eax,0x10468
    5511:	8b 45 90             	mov    -0x70(%ebp),%eax
    5514:	a3 6c 04 01 00       	mov    %eax,0x1046c
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    5519:	83 ec 04             	sub    $0x4,%esp
    551c:	ff 35 6c 04 01 00    	pushl  0x1046c
    5522:	ff 35 68 04 01 00    	pushl  0x10468
    5528:	ff 35 64 04 01 00    	pushl  0x10464
    552e:	e8 4f ef ff ff       	call   4482 <APCreateCompatibleDCFromBitmap>
    5533:	83 c4 10             	add    $0x10,%esp
    5536:	a3 98 04 01 00       	mov    %eax,0x10498
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    553b:	8b 45 08             	mov    0x8(%ebp),%eax
    553e:	8b 40 08             	mov    0x8(%eax),%eax
    5541:	85 c0                	test   %eax,%eax
    5543:	75 17                	jne    555c <APGridPaint+0x318>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    5545:	83 ec 08             	sub    $0x8,%esp
    5548:	68 c8 75 00 00       	push   $0x75c8
    554d:	6a 01                	push   $0x1
    554f:	e8 6e e8 ff ff       	call   3dc2 <printf>
    5554:	83 c4 10             	add    $0x10,%esp
        return;
    5557:	e9 fe 04 00 00       	jmp    5a5a <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    555c:	8b 45 08             	mov    0x8(%ebp),%eax
    555f:	8b 40 10             	mov    0x10(%eax),%eax
    5562:	85 c0                	test   %eax,%eax
    5564:	7e 10                	jle    5576 <APGridPaint+0x332>
    5566:	8b 45 08             	mov    0x8(%ebp),%eax
    5569:	8b 50 14             	mov    0x14(%eax),%edx
    556c:	8b 45 08             	mov    0x8(%ebp),%eax
    556f:	8b 40 10             	mov    0x10(%eax),%eax
    5572:	39 c2                	cmp    %eax,%edx
    5574:	7c 17                	jl     558d <APGridPaint+0x349>
    {
        printf(1,"Grid mode page error!");
    5576:	83 ec 08             	sub    $0x8,%esp
    5579:	68 ee 75 00 00       	push   $0x75ee
    557e:	6a 01                	push   $0x1
    5580:	e8 3d e8 ff ff       	call   3dc2 <printf>
    5585:	83 c4 10             	add    $0x10,%esp
        return;
    5588:	e9 cd 04 00 00       	jmp    5a5a <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    558d:	8b 45 08             	mov    0x8(%ebp),%eax
    5590:	8b 40 14             	mov    0x14(%eax),%eax
    5593:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    5599:	89 45 dc             	mov    %eax,-0x24(%ebp)
    559c:	8b 45 dc             	mov    -0x24(%ebp),%eax
    559f:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    55a2:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    55a9:	e9 f4 03 00 00       	jmp    59a2 <APGridPaint+0x75e>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    55ae:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    55b5:	e9 da 03 00 00       	jmp    5994 <APGridPaint+0x750>
        {
            index = start + GRID_W_NUMBER * j + i;
    55ba:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    55bd:	c1 e0 04             	shl    $0x4,%eax
    55c0:	89 c2                	mov    %eax,%edx
    55c2:	8b 45 d8             	mov    -0x28(%ebp),%eax
    55c5:	01 c2                	add    %eax,%edx
    55c7:	8b 45 e0             	mov    -0x20(%ebp),%eax
    55ca:	01 d0                	add    %edx,%eax
    55cc:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    55cf:	8b 45 08             	mov    0x8(%ebp),%eax
    55d2:	8b 40 0c             	mov    0xc(%eax),%eax
    55d5:	8b 55 dc             	mov    -0x24(%ebp),%edx
    55d8:	c1 e2 02             	shl    $0x2,%edx
    55db:	01 d0                	add    %edx,%eax
    55dd:	8b 00                	mov    (%eax),%eax
    55df:	83 f8 0a             	cmp    $0xa,%eax
    55e2:	0f 87 a7 03 00 00    	ja     598f <APGridPaint+0x74b>
    55e8:	8b 04 85 04 76 00 00 	mov    0x7604(,%eax,4),%eax
    55ef:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    55f1:	8d 45 c0             	lea    -0x40(%ebp),%eax
    55f4:	6a 0c                	push   $0xc
    55f6:	6a 0c                	push   $0xc
    55f8:	6a 0c                	push   $0xc
    55fa:	50                   	push   %eax
    55fb:	e8 2a f8 ff ff       	call   4e2a <RGB>
    5600:	83 c4 0c             	add    $0xc,%esp
    5603:	8b 1d 50 04 01 00    	mov    0x10450,%ebx
    5609:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    560c:	6b c8 32             	imul   $0x32,%eax,%ecx
    560f:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5612:	6b c0 32             	imul   $0x32,%eax,%eax
    5615:	89 45 84             	mov    %eax,-0x7c(%ebp)
    5618:	8b 45 08             	mov    0x8(%ebp),%eax
    561b:	8d 78 3c             	lea    0x3c(%eax),%edi
    561e:	83 ec 0c             	sub    $0xc,%esp
    5621:	83 ec 04             	sub    $0x4,%esp
    5624:	89 e0                	mov    %esp,%eax
    5626:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    562a:	66 89 30             	mov    %si,(%eax)
    562d:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    5631:	88 50 02             	mov    %dl,0x2(%eax)
    5634:	6a 32                	push   $0x32
    5636:	6a 32                	push   $0x32
    5638:	6a 00                	push   $0x0
    563a:	6a 00                	push   $0x0
    563c:	53                   	push   %ebx
    563d:	51                   	push   %ecx
    563e:	ff 75 84             	pushl  -0x7c(%ebp)
    5641:	57                   	push   %edi
    5642:	e8 3f f6 ff ff       	call   4c86 <APDcCopy>
    5647:	83 c4 30             	add    $0x30,%esp
                    break;
    564a:	e9 41 03 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    564f:	8d 45 88             	lea    -0x78(%ebp),%eax
    5652:	6a 69                	push   $0x69
    5654:	6a 69                	push   $0x69
    5656:	6a 69                	push   $0x69
    5658:	50                   	push   %eax
    5659:	e8 cc f7 ff ff       	call   4e2a <RGB>
    565e:	83 c4 0c             	add    $0xc,%esp
    5661:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    5665:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    5669:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    566d:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    5670:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    5677:	8d 45 88             	lea    -0x78(%ebp),%eax
    567a:	6a 69                	push   $0x69
    567c:	6a 69                	push   $0x69
    567e:	6a 69                	push   $0x69
    5680:	50                   	push   %eax
    5681:	e8 a4 f7 ff ff       	call   4e2a <RGB>
    5686:	83 c4 0c             	add    $0xc,%esp
    5689:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    568d:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    5691:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    5695:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    5698:	8b 45 08             	mov    0x8(%ebp),%eax
    569b:	8d 50 3c             	lea    0x3c(%eax),%edx
    569e:	8d 45 88             	lea    -0x78(%ebp),%eax
    56a1:	ff 75 ac             	pushl  -0x54(%ebp)
    56a4:	ff 75 a8             	pushl  -0x58(%ebp)
    56a7:	52                   	push   %edx
    56a8:	50                   	push   %eax
    56a9:	e8 69 ee ff ff       	call   4517 <APSetPen>
    56ae:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    56b1:	8b 45 08             	mov    0x8(%ebp),%eax
    56b4:	8d 58 3c             	lea    0x3c(%eax),%ebx
    56b7:	8d 55 88             	lea    -0x78(%ebp),%edx
    56ba:	83 ec 04             	sub    $0x4,%esp
    56bd:	83 ec 04             	sub    $0x4,%esp
    56c0:	89 e0                	mov    %esp,%eax
    56c2:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    56c6:	66 89 08             	mov    %cx,(%eax)
    56c9:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    56cd:	88 48 02             	mov    %cl,0x2(%eax)
    56d0:	53                   	push   %ebx
    56d1:	52                   	push   %edx
    56d2:	e8 79 ee ff ff       	call   4550 <APSetBrush>
    56d7:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    56da:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    56dd:	6b d0 32             	imul   $0x32,%eax,%edx
    56e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    56e3:	6b c0 32             	imul   $0x32,%eax,%eax
    56e6:	8b 4d 08             	mov    0x8(%ebp),%ecx
    56e9:	83 c1 3c             	add    $0x3c,%ecx
    56ec:	83 ec 0c             	sub    $0xc,%esp
    56ef:	6a 32                	push   $0x32
    56f1:	6a 32                	push   $0x32
    56f3:	52                   	push   %edx
    56f4:	50                   	push   %eax
    56f5:	51                   	push   %ecx
    56f6:	e8 7f f2 ff ff       	call   497a <APDrawRect>
    56fb:	83 c4 20             	add    $0x20,%esp
                    break;
    56fe:	e9 8d 02 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5703:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    5706:	6a 0c                	push   $0xc
    5708:	6a 0c                	push   $0xc
    570a:	6a 0c                	push   $0xc
    570c:	50                   	push   %eax
    570d:	e8 18 f7 ff ff       	call   4e2a <RGB>
    5712:	83 c4 0c             	add    $0xc,%esp
    5715:	8b 1d a0 04 01 00    	mov    0x104a0,%ebx
    571b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    571e:	6b c8 32             	imul   $0x32,%eax,%ecx
    5721:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5724:	6b c0 32             	imul   $0x32,%eax,%eax
    5727:	89 45 84             	mov    %eax,-0x7c(%ebp)
    572a:	8b 45 08             	mov    0x8(%ebp),%eax
    572d:	8d 78 3c             	lea    0x3c(%eax),%edi
    5730:	83 ec 0c             	sub    $0xc,%esp
    5733:	83 ec 04             	sub    $0x4,%esp
    5736:	89 e0                	mov    %esp,%eax
    5738:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    573c:	66 89 30             	mov    %si,(%eax)
    573f:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    5743:	88 50 02             	mov    %dl,0x2(%eax)
    5746:	6a 32                	push   $0x32
    5748:	6a 32                	push   $0x32
    574a:	6a 00                	push   $0x0
    574c:	6a 00                	push   $0x0
    574e:	53                   	push   %ebx
    574f:	51                   	push   %ecx
    5750:	ff 75 84             	pushl  -0x7c(%ebp)
    5753:	57                   	push   %edi
    5754:	e8 2d f5 ff ff       	call   4c86 <APDcCopy>
    5759:	83 c4 30             	add    $0x30,%esp
                    break;
    575c:	e9 2f 02 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5761:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    5764:	6a 0c                	push   $0xc
    5766:	6a 0c                	push   $0xc
    5768:	6a 0c                	push   $0xc
    576a:	50                   	push   %eax
    576b:	e8 ba f6 ff ff       	call   4e2a <RGB>
    5770:	83 c4 0c             	add    $0xc,%esp
    5773:	8b 1d 7c 04 01 00    	mov    0x1047c,%ebx
    5779:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    577c:	6b c8 32             	imul   $0x32,%eax,%ecx
    577f:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5782:	6b c0 32             	imul   $0x32,%eax,%eax
    5785:	89 45 84             	mov    %eax,-0x7c(%ebp)
    5788:	8b 45 08             	mov    0x8(%ebp),%eax
    578b:	8d 78 3c             	lea    0x3c(%eax),%edi
    578e:	83 ec 0c             	sub    $0xc,%esp
    5791:	83 ec 04             	sub    $0x4,%esp
    5794:	89 e0                	mov    %esp,%eax
    5796:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    579a:	66 89 30             	mov    %si,(%eax)
    579d:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    57a1:	88 50 02             	mov    %dl,0x2(%eax)
    57a4:	6a 32                	push   $0x32
    57a6:	6a 32                	push   $0x32
    57a8:	6a 00                	push   $0x0
    57aa:	6a 00                	push   $0x0
    57ac:	53                   	push   %ebx
    57ad:	51                   	push   %ecx
    57ae:	ff 75 84             	pushl  -0x7c(%ebp)
    57b1:	57                   	push   %edi
    57b2:	e8 cf f4 ff ff       	call   4c86 <APDcCopy>
    57b7:	83 c4 30             	add    $0x30,%esp
                    break;
    57ba:	e9 d1 01 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    57bf:	8d 45 c9             	lea    -0x37(%ebp),%eax
    57c2:	6a 0c                	push   $0xc
    57c4:	6a 0c                	push   $0xc
    57c6:	6a 0c                	push   $0xc
    57c8:	50                   	push   %eax
    57c9:	e8 5c f6 ff ff       	call   4e2a <RGB>
    57ce:	83 c4 0c             	add    $0xc,%esp
    57d1:	8b 1d 54 04 01 00    	mov    0x10454,%ebx
    57d7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    57da:	6b c8 32             	imul   $0x32,%eax,%ecx
    57dd:	8b 45 e0             	mov    -0x20(%ebp),%eax
    57e0:	6b c0 32             	imul   $0x32,%eax,%eax
    57e3:	89 45 84             	mov    %eax,-0x7c(%ebp)
    57e6:	8b 45 08             	mov    0x8(%ebp),%eax
    57e9:	8d 78 3c             	lea    0x3c(%eax),%edi
    57ec:	83 ec 0c             	sub    $0xc,%esp
    57ef:	83 ec 04             	sub    $0x4,%esp
    57f2:	89 e0                	mov    %esp,%eax
    57f4:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    57f8:	66 89 30             	mov    %si,(%eax)
    57fb:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    57ff:	88 50 02             	mov    %dl,0x2(%eax)
    5802:	6a 32                	push   $0x32
    5804:	6a 32                	push   $0x32
    5806:	6a 00                	push   $0x0
    5808:	6a 00                	push   $0x0
    580a:	53                   	push   %ebx
    580b:	51                   	push   %ecx
    580c:	ff 75 84             	pushl  -0x7c(%ebp)
    580f:	57                   	push   %edi
    5810:	e8 71 f4 ff ff       	call   4c86 <APDcCopy>
    5815:	83 c4 30             	add    $0x30,%esp
                    break;
    5818:	e9 73 01 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    581d:	8d 45 cc             	lea    -0x34(%ebp),%eax
    5820:	6a 0c                	push   $0xc
    5822:	6a 0c                	push   $0xc
    5824:	6a 0c                	push   $0xc
    5826:	50                   	push   %eax
    5827:	e8 fe f5 ff ff       	call   4e2a <RGB>
    582c:	83 c4 0c             	add    $0xc,%esp
    582f:	8b 1d 9c 04 01 00    	mov    0x1049c,%ebx
    5835:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5838:	6b c8 32             	imul   $0x32,%eax,%ecx
    583b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    583e:	6b c0 32             	imul   $0x32,%eax,%eax
    5841:	89 45 84             	mov    %eax,-0x7c(%ebp)
    5844:	8b 45 08             	mov    0x8(%ebp),%eax
    5847:	8d 78 3c             	lea    0x3c(%eax),%edi
    584a:	83 ec 0c             	sub    $0xc,%esp
    584d:	83 ec 04             	sub    $0x4,%esp
    5850:	89 e0                	mov    %esp,%eax
    5852:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    5856:	66 89 30             	mov    %si,(%eax)
    5859:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    585d:	88 50 02             	mov    %dl,0x2(%eax)
    5860:	6a 32                	push   $0x32
    5862:	6a 32                	push   $0x32
    5864:	6a 00                	push   $0x0
    5866:	6a 00                	push   $0x0
    5868:	53                   	push   %ebx
    5869:	51                   	push   %ecx
    586a:	ff 75 84             	pushl  -0x7c(%ebp)
    586d:	57                   	push   %edi
    586e:	e8 13 f4 ff ff       	call   4c86 <APDcCopy>
    5873:	83 c4 30             	add    $0x30,%esp
                    break;
    5876:	e9 15 01 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    587b:	8d 45 cf             	lea    -0x31(%ebp),%eax
    587e:	6a 0c                	push   $0xc
    5880:	6a 0c                	push   $0xc
    5882:	6a 0c                	push   $0xc
    5884:	50                   	push   %eax
    5885:	e8 a0 f5 ff ff       	call   4e2a <RGB>
    588a:	83 c4 0c             	add    $0xc,%esp
    588d:	8b 1d 24 04 01 00    	mov    0x10424,%ebx
    5893:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    5896:	6b c8 32             	imul   $0x32,%eax,%ecx
    5899:	8b 45 e0             	mov    -0x20(%ebp),%eax
    589c:	6b c0 32             	imul   $0x32,%eax,%eax
    589f:	89 45 84             	mov    %eax,-0x7c(%ebp)
    58a2:	8b 45 08             	mov    0x8(%ebp),%eax
    58a5:	8d 78 3c             	lea    0x3c(%eax),%edi
    58a8:	83 ec 0c             	sub    $0xc,%esp
    58ab:	83 ec 04             	sub    $0x4,%esp
    58ae:	89 e0                	mov    %esp,%eax
    58b0:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    58b4:	66 89 30             	mov    %si,(%eax)
    58b7:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    58bb:	88 50 02             	mov    %dl,0x2(%eax)
    58be:	6a 32                	push   $0x32
    58c0:	6a 32                	push   $0x32
    58c2:	6a 00                	push   $0x0
    58c4:	6a 00                	push   $0x0
    58c6:	53                   	push   %ebx
    58c7:	51                   	push   %ecx
    58c8:	ff 75 84             	pushl  -0x7c(%ebp)
    58cb:	57                   	push   %edi
    58cc:	e8 b5 f3 ff ff       	call   4c86 <APDcCopy>
    58d1:	83 c4 30             	add    $0x30,%esp
                    break;
    58d4:	e9 b7 00 00 00       	jmp    5990 <APGridPaint+0x74c>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    58d9:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    58dc:	6a 0c                	push   $0xc
    58de:	6a 0c                	push   $0xc
    58e0:	6a 0c                	push   $0xc
    58e2:	50                   	push   %eax
    58e3:	e8 42 f5 ff ff       	call   4e2a <RGB>
    58e8:	83 c4 0c             	add    $0xc,%esp
    58eb:	8b 1d 40 04 01 00    	mov    0x10440,%ebx
    58f1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    58f4:	6b c8 32             	imul   $0x32,%eax,%ecx
    58f7:	8b 45 e0             	mov    -0x20(%ebp),%eax
    58fa:	6b c0 32             	imul   $0x32,%eax,%eax
    58fd:	89 45 84             	mov    %eax,-0x7c(%ebp)
    5900:	8b 45 08             	mov    0x8(%ebp),%eax
    5903:	8d 78 3c             	lea    0x3c(%eax),%edi
    5906:	83 ec 0c             	sub    $0xc,%esp
    5909:	83 ec 04             	sub    $0x4,%esp
    590c:	89 e0                	mov    %esp,%eax
    590e:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    5912:	66 89 30             	mov    %si,(%eax)
    5915:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    5919:	88 50 02             	mov    %dl,0x2(%eax)
    591c:	6a 32                	push   $0x32
    591e:	6a 32                	push   $0x32
    5920:	6a 00                	push   $0x0
    5922:	6a 00                	push   $0x0
    5924:	53                   	push   %ebx
    5925:	51                   	push   %ecx
    5926:	ff 75 84             	pushl  -0x7c(%ebp)
    5929:	57                   	push   %edi
    592a:	e8 57 f3 ff ff       	call   4c86 <APDcCopy>
    592f:	83 c4 30             	add    $0x30,%esp
                    break;
    5932:	eb 5c                	jmp    5990 <APGridPaint+0x74c>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    5934:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    5937:	6a 0c                	push   $0xc
    5939:	6a 0c                	push   $0xc
    593b:	6a 0c                	push   $0xc
    593d:	50                   	push   %eax
    593e:	e8 e7 f4 ff ff       	call   4e2a <RGB>
    5943:	83 c4 0c             	add    $0xc,%esp
    5946:	8b 1d 98 04 01 00    	mov    0x10498,%ebx
    594c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    594f:	6b c8 32             	imul   $0x32,%eax,%ecx
    5952:	8b 45 e0             	mov    -0x20(%ebp),%eax
    5955:	6b c0 32             	imul   $0x32,%eax,%eax
    5958:	89 45 84             	mov    %eax,-0x7c(%ebp)
    595b:	8b 45 08             	mov    0x8(%ebp),%eax
    595e:	8d 78 3c             	lea    0x3c(%eax),%edi
    5961:	83 ec 0c             	sub    $0xc,%esp
    5964:	83 ec 04             	sub    $0x4,%esp
    5967:	89 e0                	mov    %esp,%eax
    5969:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    596d:	66 89 30             	mov    %si,(%eax)
    5970:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    5974:	88 50 02             	mov    %dl,0x2(%eax)
    5977:	6a 32                	push   $0x32
    5979:	6a 32                	push   $0x32
    597b:	6a 00                	push   $0x0
    597d:	6a 00                	push   $0x0
    597f:	53                   	push   %ebx
    5980:	51                   	push   %ecx
    5981:	ff 75 84             	pushl  -0x7c(%ebp)
    5984:	57                   	push   %edi
    5985:	e8 fc f2 ff ff       	call   4c86 <APDcCopy>
    598a:	83 c4 30             	add    $0x30,%esp
                    break;
    598d:	eb 01                	jmp    5990 <APGridPaint+0x74c>
                default: break;
    598f:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    5990:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    5994:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    5998:	0f 8e 1c fc ff ff    	jle    55ba <APGridPaint+0x376>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    599e:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    59a2:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    59a6:	0f 8e 02 fc ff ff    	jle    55ae <APGridPaint+0x36a>
        }
    }
    //Title Part
    APen pen;
    ...
    59ac:	8d 45 88             	lea    -0x78(%ebp),%eax
    59af:	68 cd 00 00 00       	push   $0xcd
    59b4:	6a 74                	push   $0x74
    59b6:	6a 18                	push   $0x18
    59b8:	50                   	push   %eax
    59b9:	e8 6c f4 ff ff       	call   4e2a <RGB>
    59be:	83 c4 0c             	add    $0xc,%esp
    59c1:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    59c5:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    59c9:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    59cd:	88 45 b6             	mov    %al,-0x4a(%ebp)
    pen.size = 1;
    59d0:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    59d7:	8d 45 88             	lea    -0x78(%ebp),%eax
    59da:	68 cd 00 00 00       	push   $0xcd
    59df:	6a 74                	push   $0x74
    59e1:	6a 18                	push   $0x18
    59e3:	50                   	push   %eax
    59e4:	e8 41 f4 ff ff       	call   4e2a <RGB>
    59e9:	83 c4 0c             	add    $0xc,%esp
    59ec:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    59f0:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    59f4:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    59f8:	88 45 b3             	mov    %al,-0x4d(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    59fb:	8b 45 08             	mov    0x8(%ebp),%eax
    59fe:	8d 50 58             	lea    0x58(%eax),%edx
    5a01:	8d 45 88             	lea    -0x78(%ebp),%eax
    5a04:	ff 75 b8             	pushl  -0x48(%ebp)
    5a07:	ff 75 b4             	pushl  -0x4c(%ebp)
    5a0a:	52                   	push   %edx
    5a0b:	50                   	push   %eax
    5a0c:	e8 06 eb ff ff       	call   4517 <APSetPen>
    5a11:	83 c4 0c             	add    $0xc,%esp
    ...
    5a25:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    5a29:	66 89 08             	mov    %cx,(%eax)
    5a2c:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    5a30:	88 48 02             	mov    %cl,0x2(%eax)
    5a33:	53                   	push   %ebx
    5a34:	52                   	push   %edx
    5a35:	e8 16 eb ff ff       	call   4550 <APSetBrush>
    5a3a:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    5a3d:	8b 45 08             	mov    0x8(%ebp),%eax
    5a40:	83 c0 58             	add    $0x58,%eax
    5a43:	83 ec 0c             	sub    $0xc,%esp
    5a46:	6a 32                	push   $0x32
    5a48:	68 20 03 00 00       	push   $0x320
    5a4d:	6a 00                	push   $0x0
    5a4f:	6a 00                	push   $0x0
    5a51:	50                   	push   %eax
    5a52:	e8 23 ef ff ff       	call   497a <APDrawRect>
