...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     4a9:	0f b6 80 a8 28 00 00 	movzbl 0x28a8(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     5e5:	75 25                	jne    60c <printf+0xff>
          s = "(null)";
     5e7:	c7 45 f4 da 21 00 00 	movl   $0x21da,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     6ad:	a1 e8 28 00 00       	mov    0x28e8,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     778:	a3 e8 28 00 00       	mov    %eax,0x28e8
}
     77d:	90                   	nop
     77e:	c9                   	leave  
     77f:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     7d9:	a1 e8 28 00 00       	mov    0x28e8,%eax
}
     7de:	c9                   	leave  
     7df:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     7f5:	a1 e8 28 00 00       	mov    0x28e8,%eax
     7fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
     7fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     801:	75 23                	jne    826 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     803:	c7 45 f0 e0 28 00 00 	movl   $0x28e0,-0x10(%ebp)
     80a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     80d:	a3 e8 28 00 00       	mov    %eax,0x28e8
     812:	a1 e8 28 00 00       	mov    0x28e8,%eax
     817:	a3 e0 28 00 00       	mov    %eax,0x28e0
    base.s.size = 0;
     81c:	c7 05 e4 28 00 00 00 	movl   $0x0,0x28e4
     823:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     879:	a3 e8 28 00 00       	mov    %eax,0x28e8
      return (void*)(p + 1);
    ...
    if(p == freep)
     886:	a1 e8 28 00 00       	mov    0x28e8,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     9c4:	79 2e                	jns    9f4 <APLoadBitmap+0x61>
    {
     ...
     9cc:	68 e1 21 00 00       	push   $0x21e1
     9d1:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    14b4:	68 f4 21 00 00       	push   $0x21f4
    14b9:	6a 01                	push   $0x1
    ...
    1527:	68 14 22 00 00       	push   $0x2214
    152c:	6a 01                	push   $0x1
    ...
    15cb:	68 38 22 00 00       	push   $0x2238
    15d0:	6a 01                	push   $0x1
    ...
    169c:	68 60 22 00 00       	push   $0x2260
    16a1:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1a2e:	68 f4 22 00 00       	push   $0x22f4
    1a33:	6a 01                	push   $0x1
    ...
    1a5f:	68 1a 23 00 00       	push   $0x231a
    1a64:	6a 01                	push   $0x1
    ...
    1ace:	8b 04 85 30 23 00 00 	mov    0x2330(,%eax,4),%eax
    1ad5:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1ae9:	8b 1d 2c 2b 00 00    	mov    0x2b2c,%ebx
    ...
    1bfb:	8b 1d 6c 2b 00 00    	mov    0x2b6c,%ebx
    ...
    1c59:	8b 1d 4c 2b 00 00    	mov    0x2b4c,%ebx
    ...
    1cb7:	8b 1d 30 2b 00 00    	mov    0x2b30,%ebx
    ...
    1d15:	8b 1d 68 2b 00 00    	mov    0x2b68,%ebx
    ...
    1d73:	8b 1d 00 2b 00 00    	mov    0x2b00,%ebx
    ...
    1dce:	8b 1d 1c 2b 00 00    	mov    0x2b1c,%ebx
...
if (seed > 0)
    1e3f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    1e43:	7e 08                	jle    1e4d <random+0x11>
{
rand_num = seed;
    1e45:	8b 45 08             	mov    0x8(%ebp),%eax
    1e48:	a3 bc 28 00 00       	mov    %eax,0x28bc
}
rand_num *= 3;
    1e4d:	8b 15 bc 28 00 00    	mov    0x28bc,%edx
    1e53:	89 d0                	mov    %edx,%eax
    1e55:	01 c0                	add    %eax,%eax
    1e57:	01 d0                	add    %edx,%eax
    1e59:	a3 bc 28 00 00       	mov    %eax,0x28bc
if (rand_num < 0)
    1e5e:	a1 bc 28 00 00       	mov    0x28bc,%eax
    1e63:	85 c0                	test   %eax,%eax
    1e65:	79 0c                	jns    1e73 <random+0x37>
{
rand_num *= (-1);
    1e67:	a1 bc 28 00 00       	mov    0x28bc,%eax
    1e6c:	f7 d8                	neg    %eax
    1e6e:	a3 bc 28 00 00       	mov    %eax,0x28bc
}
return rand_num % 997;
    1e73:	8b 0d bc 28 00 00    	mov    0x28bc,%ecx
    1e79:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    1e7e:	89 c8                	mov    %ecx,%eax
    1e80:	f7 ea                	imul   %edx
    1e82:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    1e85:	c1 f8 09             	sar    $0x9,%eax
    1e88:	89 c2                	mov    %eax,%edx
    1e8a:	89 c8                	mov    %ecx,%eax
    1e8c:	c1 f8 1f             	sar    $0x1f,%eax
    1e8f:	29 c2                	sub    %eax,%edx
    1e91:	89 d0                	mov    %edx,%eax
    1e93:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    1e99:	29 c1                	sub    %eax,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    if(sgn && xx < 0){
    1ead:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1eb1:	74 17                	je     1eca <sprintint+0x2b>
    1eb3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1eb7:	79 11                	jns    1eca <sprintint+0x2b>
        neg = 1;
    1eb9:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1ec0:	8b 45 10             	mov    0x10(%ebp),%eax
    1ec3:	f7 d8                	neg    %eax
    1ec5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1ec8:	eb 06                	jmp    1ed0 <sprintint+0x31>
    } else {
        x = xx;
    ...
    i = 0;
    1ed0:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1ed7:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1eda:	8d 41 01             	lea    0x1(%ecx),%eax
    1edd:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1ee0:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1ee3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1ee6:	ba 00 00 00 00       	mov    $0x0,%edx
    1eeb:	f7 f3                	div    %ebx
    1eed:	89 d0                	mov    %edx,%eax
    1eef:	0f b6 80 c0 28 00 00 	movzbl 0x28c0(%eax),%eax
    1ef6:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1efa:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1efd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f00:	ba 00 00 00 00       	mov    $0x0,%edx
    1f05:	f7 f3                	div    %ebx
    1f07:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1f0a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1f0e:	75 c7                	jne    1ed7 <sprintint+0x38>
    if(neg)
    1f10:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1f14:	74 0e                	je     1f24 <sprintint+0x85>
        buf[i++] = '-';
    1f16:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1f19:	8d 50 01             	lea    0x1(%eax),%edx
    1f1c:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1f1f:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1f24:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1f27:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1f2a:	eb 1b                	jmp    1f47 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1f2c:	8b 45 0c             	mov    0xc(%ebp),%eax
    1f2f:	8b 00                	mov    (%eax),%eax
    1f31:	8d 48 01             	lea    0x1(%eax),%ecx
    1f34:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f37:	89 0a                	mov    %ecx,(%edx)
    1f39:	89 c2                	mov    %eax,%edx
    1f3b:	8b 45 08             	mov    0x8(%ebp),%eax
    1f3e:	01 d0                	add    %edx,%eax
    1f40:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1f43:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1f47:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1f4b:	7f df                	jg     1f2c <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1f4d:	eb 21                	jmp    1f70 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1f4f:	8b 45 0c             	mov    0xc(%ebp),%eax
    1f52:	8b 00                	mov    (%eax),%eax
    1f54:	8d 48 01             	lea    0x1(%eax),%ecx
    1f57:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f5a:	89 0a                	mov    %ecx,(%edx)
    1f5c:	89 c2                	mov    %eax,%edx
    1f5e:	8b 45 08             	mov    0x8(%ebp),%eax
    1f61:	01 c2                	add    %eax,%edx
    1f63:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1f66:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1f69:	01 c8                	add    %ecx,%eax
    1f6b:	0f b6 00             	movzbl (%eax),%eax
    1f6e:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1f70:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1f74:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1f78:	79 d5                	jns    1f4f <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1f7a:	90                   	nop
    1f7b:	83 c4 20             	add    $0x20,%esp
    1f7e:	5b                   	pop    %ebx
    1f7f:	5d                   	pop    %ebp
    1f80:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1f84:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1f87:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1f8e:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1f95:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1f9c:	8d 45 0c             	lea    0xc(%ebp),%eax
    1f9f:	83 c0 04             	add    $0x4,%eax
    1fa2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1fa5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1fac:	e9 d9 01 00 00       	jmp    218a <sprintf+0x209>
        c = fmt[i] & 0xff;
    1fb1:	8b 55 0c             	mov    0xc(%ebp),%edx
    1fb4:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1fb7:	01 d0                	add    %edx,%eax
    1fb9:	0f b6 00             	movzbl (%eax),%eax
    1fbc:	0f be c0             	movsbl %al,%eax
    1fbf:	25 ff 00 00 00       	and    $0xff,%eax
    1fc4:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1fc7:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1fcb:	75 2c                	jne    1ff9 <sprintf+0x78>
            if(c == '%'){
    1fcd:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1fd1:	75 0c                	jne    1fdf <sprintf+0x5e>
                state = '%';
    1fd3:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1fda:	e9 a7 01 00 00       	jmp    2186 <sprintf+0x205>
            } else {
                dst[j++] = c;
    ...
    1fef:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1ff2:	88 10                	mov    %dl,(%eax)
    1ff4:	e9 8d 01 00 00       	jmp    2186 <sprintf+0x205>
            }
        } else if(state == '%'){
    1ff9:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1ffd:	0f 85 83 01 00 00    	jne    2186 <sprintf+0x205>
            if(c == 'd'){
    2003:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2007:	75 4c                	jne    2055 <sprintf+0xd4>
                buf[bi] = '\0';
    2009:	8d 55 ce             	lea    -0x32(%ebp),%edx
    200c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    200f:	01 d0                	add    %edx,%eax
    2011:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2014:	83 ec 0c             	sub    $0xc,%esp
    2017:	8d 45 ce             	lea    -0x32(%ebp),%eax
    201a:	50                   	push   %eax
    201b:	e8 b4 e2 ff ff       	call   2d4 <atoi>
    2020:	83 c4 10             	add    $0x10,%esp
    2023:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2026:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    202d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2030:	8b 00                	mov    (%eax),%eax
    2032:	83 ec 08             	sub    $0x8,%esp
    2035:	ff 75 d8             	pushl  -0x28(%ebp)
    2038:	6a 01                	push   $0x1
    203a:	6a 0a                	push   $0xa
    203c:	50                   	push   %eax
    203d:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2040:	50                   	push   %eax
    2041:	ff 75 08             	pushl  0x8(%ebp)
    2044:	e8 56 fe ff ff       	call   1e9f <sprintint>
    2049:	83 c4 20             	add    $0x20,%esp
                ap++;
    204c:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2050:	e9 2a 01 00 00       	jmp    217f <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2055:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2059:	74 06                	je     2061 <sprintf+0xe0>
    205b:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    205f:	75 4c                	jne    20ad <sprintf+0x12c>
                buf[bi] = '\0';
    2061:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2064:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2067:	01 d0                	add    %edx,%eax
    2069:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    206c:	83 ec 0c             	sub    $0xc,%esp
    206f:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2072:	50                   	push   %eax
    2073:	e8 5c e2 ff ff       	call   2d4 <atoi>
    2078:	83 c4 10             	add    $0x10,%esp
    207b:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    207e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2085:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2088:	8b 00                	mov    (%eax),%eax
    208a:	83 ec 08             	sub    $0x8,%esp
    208d:	ff 75 dc             	pushl  -0x24(%ebp)
    2090:	6a 00                	push   $0x0
    2092:	6a 10                	push   $0x10
    2094:	50                   	push   %eax
    2095:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2098:	50                   	push   %eax
    2099:	ff 75 08             	pushl  0x8(%ebp)
    209c:	e8 fe fd ff ff       	call   1e9f <sprintint>
    20a1:	83 c4 20             	add    $0x20,%esp
                ap++;
    20a4:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    20a8:	e9 d2 00 00 00       	jmp    217f <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    20ad:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    20b1:	75 46                	jne    20f9 <sprintf+0x178>
                s = (char*)*ap;
    20b3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20b6:	8b 00                	mov    (%eax),%eax
    20b8:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    20bb:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    20bf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20c3:	75 25                	jne    20ea <sprintf+0x169>
                    s = "(null)";
    20c5:	c7 45 f4 50 23 00 00 	movl   $0x2350,-0xc(%ebp)
                while(*s != 0){
    20cc:	eb 1c                	jmp    20ea <sprintf+0x169>
                    dst[j++] = *s;
    20ce:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20d1:	8d 50 01             	lea    0x1(%eax),%edx
    20d4:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20d7:	89 c2                	mov    %eax,%edx
    20d9:	8b 45 08             	mov    0x8(%ebp),%eax
    20dc:	01 c2                	add    %eax,%edx
    20de:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20e1:	0f b6 00             	movzbl (%eax),%eax
    20e4:	88 02                	mov    %al,(%edx)
                    s++;
    20e6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
    ...
    20f0:	84 c0                	test   %al,%al
    20f2:	75 da                	jne    20ce <sprintf+0x14d>
    20f4:	e9 86 00 00 00       	jmp    217f <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    20f9:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    20fd:	75 1d                	jne    211c <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    210f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2112:	8b 00                	mov    (%eax),%eax
    2114:	88 02                	mov    %al,(%edx)
                ap++;
    2116:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    211a:	eb 63                	jmp    217f <sprintf+0x1fe>
            } else if(c == '%'){
    211c:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2120:	75 17                	jne    2139 <sprintf+0x1b8>
                dst[j++] = c;
    ...
    2132:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2135:	88 10                	mov    %dl,(%eax)
    2137:	eb 46                	jmp    217f <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2139:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    213d:	7e 18                	jle    2157 <sprintf+0x1d6>
    213f:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2143:	7f 12                	jg     2157 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2145:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2148:	8d 50 01             	lea    0x1(%eax),%edx
    214b:	89 55 f0             	mov    %edx,-0x10(%ebp)
    214e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2151:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2155:	eb 2f                	jmp    2186 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2157:	8b 45 c8             	mov    -0x38(%ebp),%eax
    215a:	8d 50 01             	lea    0x1(%eax),%edx
    215d:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2160:	89 c2                	mov    %eax,%edx
    2162:	8b 45 08             	mov    0x8(%ebp),%eax
    2165:	01 d0                	add    %edx,%eax
    2167:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    216a:	8b 45 c8             	mov    -0x38(%ebp),%eax
    216d:	8d 50 01             	lea    0x1(%eax),%edx
    2170:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2173:	89 c2                	mov    %eax,%edx
    2175:	8b 45 08             	mov    0x8(%ebp),%eax
    2178:	01 d0                	add    %edx,%eax
    217a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    217d:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2186:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    218a:	8b 55 0c             	mov    0xc(%ebp),%edx
    218d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2190:	01 d0                	add    %edx,%eax
    2192:	0f b6 00             	movzbl (%eax),%eax
    2195:	84 c0                	test   %al,%al
    2197:	0f 85 14 fe ff ff    	jne    1fb1 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    219d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    21a0:	8d 50 01             	lea    0x1(%eax),%edx
    21a3:	89 55 c8             	mov    %edx,-0x38(%ebp)
    21a6:	89 c2                	mov    %eax,%edx
    21a8:	8b 45 08             	mov    0x8(%ebp),%eax
    21ab:	01 d0                	add    %edx,%eax
    21ad:	c6 00 00             	movb   $0x0,(%eax)
}
    21b0:	90                   	nop
    21b1:	c9                   	leave  
    21b2:	c3                   	ret    
