...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    19b0:	a1 0c 69 00 00       	mov    0x690c,%eax
    19b5:	85 c0                	test   %eax,%eax
    19b7:	0f 85 7a 02 00 00    	jne    1c37 <APGridPaint+0x290>
    {
        iconReady = 1;
    19bd:	c7 05 0c 69 00 00 01 	movl   $0x1,0x690c
    19c4:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    19c7:	8d 45 88             	lea    -0x78(%ebp),%eax
    19ca:	83 ec 08             	sub    $0x8,%esp
    19cd:	68 0f 26 00 00       	push   $0x260f
    19d2:	50                   	push   %eax
    19d3:	e8 d3 ef ff ff       	call   9ab <APLoadBitmap>
    19d8:	83 c4 0c             	add    $0xc,%esp
    19db:	8b 45 88             	mov    -0x78(%ebp),%eax
    19de:	a3 40 6b 00 00       	mov    %eax,0x6b40
    19e3:	8b 45 8c             	mov    -0x74(%ebp),%eax
    19e6:	a3 44 6b 00 00       	mov    %eax,0x6b44
    19eb:	8b 45 90             	mov    -0x70(%ebp),%eax
    19ee:	a3 48 6b 00 00       	mov    %eax,0x6b48
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    19f3:	83 ec 04             	sub    $0x4,%esp
    19f6:	ff 35 48 6b 00 00    	pushl  0x6b48
    19fc:	ff 35 44 6b 00 00    	pushl  0x6b44
    1a02:	ff 35 40 6b 00 00    	pushl  0x6b40
    1a08:	e8 d8 f1 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1a0d:	83 c4 10             	add    $0x10,%esp
    1a10:	a3 4c 6b 00 00       	mov    %eax,0x6b4c
        grid_river = APLoadBitmap ("grid_river.bmp");
    1a15:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a18:	83 ec 08             	sub    $0x8,%esp
    1a1b:	68 1d 26 00 00       	push   $0x261d
    1a20:	50                   	push   %eax
    1a21:	e8 85 ef ff ff       	call   9ab <APLoadBitmap>
    1a26:	83 c4 0c             	add    $0xc,%esp
    1a29:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a2c:	a3 88 6b 00 00       	mov    %eax,0x6b88
    1a31:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a34:	a3 8c 6b 00 00       	mov    %eax,0x6b8c
    1a39:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a3c:	a3 90 6b 00 00       	mov    %eax,0x6b90
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    1a41:	83 ec 04             	sub    $0x4,%esp
    1a44:	ff 35 90 6b 00 00    	pushl  0x6b90
    1a4a:	ff 35 8c 6b 00 00    	pushl  0x6b8c
    1a50:	ff 35 88 6b 00 00    	pushl  0x6b88
    1a56:	e8 8a f1 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1a5b:	83 c4 10             	add    $0x10,%esp
    1a5e:	a3 78 6b 00 00       	mov    %eax,0x6b78
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    1a63:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a66:	83 ec 08             	sub    $0x8,%esp
    1a69:	68 2c 26 00 00       	push   $0x262c
    1a6e:	50                   	push   %eax
    1a6f:	e8 37 ef ff ff       	call   9ab <APLoadBitmap>
    1a74:	83 c4 0c             	add    $0xc,%esp
    1a77:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a7a:	a3 7c 6b 00 00       	mov    %eax,0x6b7c
    1a7f:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a82:	a3 80 6b 00 00       	mov    %eax,0x6b80
    1a87:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a8a:	a3 84 6b 00 00       	mov    %eax,0x6b84
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    1a8f:	83 ec 04             	sub    $0x4,%esp
    1a92:	ff 35 84 6b 00 00    	pushl  0x6b84
    1a98:	ff 35 80 6b 00 00    	pushl  0x6b80
    1a9e:	ff 35 7c 6b 00 00    	pushl  0x6b7c
    1aa4:	e8 3c f1 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1aa9:	83 c4 10             	add    $0x10,%esp
    1aac:	a3 20 6b 00 00       	mov    %eax,0x6b20
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1ab1:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ab4:	83 ec 08             	sub    $0x8,%esp
    1ab7:	68 3b 26 00 00       	push   $0x263b
    1abc:	50                   	push   %eax
    1abd:	e8 e9 ee ff ff       	call   9ab <APLoadBitmap>
    1ac2:	83 c4 0c             	add    $0xc,%esp
    1ac5:	8b 45 88             	mov    -0x78(%ebp),%eax
    1ac8:	a3 54 6b 00 00       	mov    %eax,0x6b54
    1acd:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1ad0:	a3 58 6b 00 00       	mov    %eax,0x6b58
    1ad5:	8b 45 90             	mov    -0x70(%ebp),%eax
    1ad8:	a3 5c 6b 00 00       	mov    %eax,0x6b5c
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1add:	83 ec 04             	sub    $0x4,%esp
    1ae0:	ff 35 5c 6b 00 00    	pushl  0x6b5c
    1ae6:	ff 35 58 6b 00 00    	pushl  0x6b58
    1aec:	ff 35 54 6b 00 00    	pushl  0x6b54
    1af2:	e8 ee f0 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1af7:	83 c4 10             	add    $0x10,%esp
    1afa:	a3 98 6b 00 00       	mov    %eax,0x6b98
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1aff:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b02:	83 ec 08             	sub    $0x8,%esp
    1b05:	68 49 26 00 00       	push   $0x2649
    1b0a:	50                   	push   %eax
    1b0b:	e8 9b ee ff ff       	call   9ab <APLoadBitmap>
    1b10:	83 c4 0c             	add    $0xc,%esp
    1b13:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b16:	a3 30 6b 00 00       	mov    %eax,0x6b30
    1b1b:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b1e:	a3 34 6b 00 00       	mov    %eax,0x6b34
    1b23:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b26:	a3 38 6b 00 00       	mov    %eax,0x6b38
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1b2b:	83 ec 04             	sub    $0x4,%esp
    1b2e:	ff 35 38 6b 00 00    	pushl  0x6b38
    1b34:	ff 35 34 6b 00 00    	pushl  0x6b34
    1b3a:	ff 35 30 6b 00 00    	pushl  0x6b30
    1b40:	e8 a0 f0 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1b45:	83 c4 10             	add    $0x10,%esp
    1b48:	a3 50 6b 00 00       	mov    %eax,0x6b50
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1b4d:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b50:	83 ec 08             	sub    $0x8,%esp
    1b53:	68 59 26 00 00       	push   $0x2659
    1b58:	50                   	push   %eax
    1b59:	e8 4d ee ff ff       	call   9ab <APLoadBitmap>
    1b5e:	83 c4 0c             	add    $0xc,%esp
    1b61:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b64:	a3 24 6b 00 00       	mov    %eax,0x6b24
    1b69:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b6c:	a3 28 6b 00 00       	mov    %eax,0x6b28
    1b71:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b74:	a3 2c 6b 00 00       	mov    %eax,0x6b2c
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1b79:	83 ec 04             	sub    $0x4,%esp
    1b7c:	ff 35 2c 6b 00 00    	pushl  0x6b2c
    1b82:	ff 35 28 6b 00 00    	pushl  0x6b28
    1b88:	ff 35 24 6b 00 00    	pushl  0x6b24
    1b8e:	e8 52 f0 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1b93:	83 c4 10             	add    $0x10,%esp
    1b96:	a3 3c 6b 00 00       	mov    %eax,0x6b3c
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1b9b:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b9e:	83 ec 08             	sub    $0x8,%esp
    1ba1:	68 6b 26 00 00       	push   $0x266b
    1ba6:	50                   	push   %eax
    1ba7:	e8 ff ed ff ff       	call   9ab <APLoadBitmap>
    1bac:	83 c4 0c             	add    $0xc,%esp
    1baf:	8b 45 88             	mov    -0x78(%ebp),%eax
    1bb2:	a3 6c 6b 00 00       	mov    %eax,0x6b6c
    1bb7:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1bba:	a3 70 6b 00 00       	mov    %eax,0x6b70
    1bbf:	8b 45 90             	mov    -0x70(%ebp),%eax
    1bc2:	a3 74 6b 00 00       	mov    %eax,0x6b74
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1bc7:	83 ec 04             	sub    $0x4,%esp
    1bca:	ff 35 74 6b 00 00    	pushl  0x6b74
    1bd0:	ff 35 70 6b 00 00    	pushl  0x6b70
    1bd6:	ff 35 6c 6b 00 00    	pushl  0x6b6c
    1bdc:	e8 04 f0 ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1be1:	83 c4 10             	add    $0x10,%esp
    1be4:	a3 9c 6b 00 00       	mov    %eax,0x6b9c
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1be9:	8d 45 88             	lea    -0x78(%ebp),%eax
    1bec:	83 ec 08             	sub    $0x8,%esp
    1bef:	68 7a 26 00 00       	push   $0x267a
    1bf4:	50                   	push   %eax
    1bf5:	e8 b1 ed ff ff       	call   9ab <APLoadBitmap>
    1bfa:	83 c4 0c             	add    $0xc,%esp
    1bfd:	8b 45 88             	mov    -0x78(%ebp),%eax
    1c00:	a3 60 6b 00 00       	mov    %eax,0x6b60
    1c05:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1c08:	a3 64 6b 00 00       	mov    %eax,0x6b64
    1c0d:	8b 45 90             	mov    -0x70(%ebp),%eax
    1c10:	a3 68 6b 00 00       	mov    %eax,0x6b68
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1c15:	83 ec 04             	sub    $0x4,%esp
    1c18:	ff 35 68 6b 00 00    	pushl  0x6b68
    1c1e:	ff 35 64 6b 00 00    	pushl  0x6b64
    1c24:	ff 35 60 6b 00 00    	pushl  0x6b60
    1c2a:	e8 b6 ef ff ff       	call   be5 <APCreateCompatibleDCFromBitmap>
    1c2f:	83 c4 10             	add    $0x10,%esp
    1c32:	a3 94 6b 00 00       	mov    %eax,0x6b94
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1c37:	8b 45 08             	mov    0x8(%ebp),%eax
    1c3a:	8b 40 08             	mov    0x8(%eax),%eax
    1c3d:	85 c0                	test   %eax,%eax
    1c3f:	75 17                	jne    1c58 <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1c41:	83 ec 08             	sub    $0x8,%esp
    1c44:	68 8c 26 00 00       	push   $0x268c
    1c49:	6a 01                	push   $0x1
    1c4b:	e8 d5 e8 ff ff       	call   525 <printf>
    1c50:	83 c4 10             	add    $0x10,%esp
        return;
    1c53:	e9 65 05 00 00       	jmp    21bd <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1c58:	8b 45 08             	mov    0x8(%ebp),%eax
    1c5b:	8b 40 10             	mov    0x10(%eax),%eax
    1c5e:	85 c0                	test   %eax,%eax
    1c60:	7e 10                	jle    1c72 <APGridPaint+0x2cb>
    1c62:	8b 45 08             	mov    0x8(%ebp),%eax
    1c65:	8b 50 14             	mov    0x14(%eax),%edx
    1c68:	8b 45 08             	mov    0x8(%ebp),%eax
    1c6b:	8b 40 10             	mov    0x10(%eax),%eax
    1c6e:	39 c2                	cmp    %eax,%edx
    1c70:	7c 17                	jl     1c89 <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1c72:	83 ec 08             	sub    $0x8,%esp
    1c75:	68 b2 26 00 00       	push   $0x26b2
    1c7a:	6a 01                	push   $0x1
    1c7c:	e8 a4 e8 ff ff       	call   525 <printf>
    1c81:	83 c4 10             	add    $0x10,%esp
        return;
    1c84:	e9 34 05 00 00       	jmp    21bd <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1c89:	8b 45 08             	mov    0x8(%ebp),%eax
    1c8c:	8b 40 14             	mov    0x14(%eax),%eax
    1c8f:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1c95:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1c98:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1c9b:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1c9e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1ca5:	e9 f4 03 00 00       	jmp    209e <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1caa:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1cb1:	e9 da 03 00 00       	jmp    2090 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1cb6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1cb9:	c1 e0 04             	shl    $0x4,%eax
    1cbc:	89 c2                	mov    %eax,%edx
    1cbe:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1cc1:	01 c2                	add    %eax,%edx
    1cc3:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1cc6:	01 d0                	add    %edx,%eax
    1cc8:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1ccb:	8b 45 08             	mov    0x8(%ebp),%eax
    1cce:	8b 40 0c             	mov    0xc(%eax),%eax
    1cd1:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1cd4:	c1 e2 02             	shl    $0x2,%edx
    1cd7:	01 d0                	add    %edx,%eax
    1cd9:	8b 00                	mov    (%eax),%eax
    1cdb:	83 f8 0a             	cmp    $0xa,%eax
    1cde:	0f 87 a7 03 00 00    	ja     208b <APGridPaint+0x6e4>
    1ce4:	8b 04 85 c8 26 00 00 	mov    0x26c8(,%eax,4),%eax
    1ceb:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ced:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1cf0:	6a 0c                	push   $0xc
    1cf2:	6a 0c                	push   $0xc
    1cf4:	6a 0c                	push   $0xc
    1cf6:	50                   	push   %eax
    1cf7:	e8 91 f8 ff ff       	call   158d <RGB>
    1cfc:	83 c4 0c             	add    $0xc,%esp
    1cff:	8b 1d 4c 6b 00 00    	mov    0x6b4c,%ebx
    ...
    1d11:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1d14:	8b 45 08             	mov    0x8(%ebp),%eax
    1d17:	8d 78 3c             	lea    0x3c(%eax),%edi
    1d1a:	83 ec 0c             	sub    $0xc,%esp
    1d1d:	83 ec 04             	sub    $0x4,%esp
    1d20:	89 e0                	mov    %esp,%eax
    1d22:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1d26:	66 89 30             	mov    %si,(%eax)
    1d29:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    ...
    1d38:	53                   	push   %ebx
    1d39:	51                   	push   %ecx
    1d3a:	ff 75 84             	pushl  -0x7c(%ebp)
    1d3d:	57                   	push   %edi
    1d3e:	e8 a6 f6 ff ff       	call   13e9 <APDcCopy>
    1d43:	83 c4 30             	add    $0x30,%esp
                    break;
    1d46:	e9 41 03 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1d4b:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d4e:	6a 69                	push   $0x69
    1d50:	6a 69                	push   $0x69
    1d52:	6a 69                	push   $0x69
    1d54:	50                   	push   %eax
    1d55:	e8 33 f8 ff ff       	call   158d <RGB>
    1d5a:	83 c4 0c             	add    $0xc,%esp
    1d5d:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1d61:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1d65:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1d69:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1d6c:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1d73:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d76:	6a 69                	push   $0x69
    1d78:	6a 69                	push   $0x69
    1d7a:	6a 69                	push   $0x69
    1d7c:	50                   	push   %eax
    1d7d:	e8 0b f8 ff ff       	call   158d <RGB>
    1d82:	83 c4 0c             	add    $0xc,%esp
    1d85:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1d89:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1d8d:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1d91:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1d94:	8b 45 08             	mov    0x8(%ebp),%eax
    1d97:	8d 50 3c             	lea    0x3c(%eax),%edx
    1d9a:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d9d:	ff 75 ac             	pushl  -0x54(%ebp)
    1da0:	ff 75 a8             	pushl  -0x58(%ebp)
    1da3:	52                   	push   %edx
    1da4:	50                   	push   %eax
    1da5:	e8 d0 ee ff ff       	call   c7a <APSetPen>
    1daa:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1dad:	8b 45 08             	mov    0x8(%ebp),%eax
    1db0:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1db3:	8d 55 88             	lea    -0x78(%ebp),%edx
    1db6:	83 ec 04             	sub    $0x4,%esp
    1db9:	83 ec 04             	sub    $0x4,%esp
    1dbc:	89 e0                	mov    %esp,%eax
    1dbe:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1dc2:	66 89 08             	mov    %cx,(%eax)
    1dc5:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    1dc9:	88 48 02             	mov    %cl,0x2(%eax)
    1dcc:	53                   	push   %ebx
    1dcd:	52                   	push   %edx
    1dce:	e8 e0 ee ff ff       	call   cb3 <APSetBrush>
    1dd3:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1dd6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1dd9:	6b d0 32             	imul   $0x32,%eax,%edx
    1ddc:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1ddf:	6b c0 32             	imul   $0x32,%eax,%eax
    1de2:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1de5:	83 c1 3c             	add    $0x3c,%ecx
    1de8:	83 ec 0c             	sub    $0xc,%esp
    1deb:	6a 32                	push   $0x32
    1ded:	6a 32                	push   $0x32
    1def:	52                   	push   %edx
    1df0:	50                   	push   %eax
    1df1:	51                   	push   %ecx
    1df2:	e8 e6 f2 ff ff       	call   10dd <APDrawRect>
    1df7:	83 c4 20             	add    $0x20,%esp
                    break;
    1dfa:	e9 8d 02 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1dff:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1e02:	6a 0c                	push   $0xc
    1e04:	6a 0c                	push   $0xc
    1e06:	6a 0c                	push   $0xc
    1e08:	50                   	push   %eax
    1e09:	e8 7f f7 ff ff       	call   158d <RGB>
    1e0e:	83 c4 0c             	add    $0xc,%esp
    1e11:	8b 1d 9c 6b 00 00    	mov    0x6b9c,%ebx
    ...
    1e34:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1e38:	66 89 30             	mov    %si,(%eax)
    1e3b:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    1e4f:	57                   	push   %edi
    1e50:	e8 94 f5 ff ff       	call   13e9 <APDcCopy>
    1e55:	83 c4 30             	add    $0x30,%esp
                    break;
    1e58:	e9 2f 02 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e5d:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1e60:	6a 0c                	push   $0xc
    1e62:	6a 0c                	push   $0xc
    1e64:	6a 0c                	push   $0xc
    1e66:	50                   	push   %eax
    1e67:	e8 21 f7 ff ff       	call   158d <RGB>
    1e6c:	83 c4 0c             	add    $0xc,%esp
    1e6f:	8b 1d 78 6b 00 00    	mov    0x6b78,%ebx
    ...
    1e92:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1e96:	66 89 30             	mov    %si,(%eax)
    1e99:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    1ead:	57                   	push   %edi
    1eae:	e8 36 f5 ff ff       	call   13e9 <APDcCopy>
    1eb3:	83 c4 30             	add    $0x30,%esp
                    break;
    1eb6:	e9 d1 01 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ebb:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1ebe:	6a 0c                	push   $0xc
    1ec0:	6a 0c                	push   $0xc
    1ec2:	6a 0c                	push   $0xc
    1ec4:	50                   	push   %eax
    1ec5:	e8 c3 f6 ff ff       	call   158d <RGB>
    1eca:	83 c4 0c             	add    $0xc,%esp
    1ecd:	8b 1d 50 6b 00 00    	mov    0x6b50,%ebx
    ...
    1ef0:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1ef4:	66 89 30             	mov    %si,(%eax)
    1ef7:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    1f0b:	57                   	push   %edi
    1f0c:	e8 d8 f4 ff ff       	call   13e9 <APDcCopy>
    1f11:	83 c4 30             	add    $0x30,%esp
                    break;
    1f14:	e9 73 01 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f19:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1f1c:	6a 0c                	push   $0xc
    1f1e:	6a 0c                	push   $0xc
    1f20:	6a 0c                	push   $0xc
    1f22:	50                   	push   %eax
    1f23:	e8 65 f6 ff ff       	call   158d <RGB>
    1f28:	83 c4 0c             	add    $0xc,%esp
    1f2b:	8b 1d 98 6b 00 00    	mov    0x6b98,%ebx
    ...
    1f4e:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1f52:	66 89 30             	mov    %si,(%eax)
    1f55:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    1f69:	57                   	push   %edi
    1f6a:	e8 7a f4 ff ff       	call   13e9 <APDcCopy>
    1f6f:	83 c4 30             	add    $0x30,%esp
                    break;
    1f72:	e9 15 01 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f77:	8d 45 cf             	lea    -0x31(%ebp),%eax
    1f7a:	6a 0c                	push   $0xc
    1f7c:	6a 0c                	push   $0xc
    1f7e:	6a 0c                	push   $0xc
    1f80:	50                   	push   %eax
    1f81:	e8 07 f6 ff ff       	call   158d <RGB>
    1f86:	83 c4 0c             	add    $0xc,%esp
    1f89:	8b 1d 20 6b 00 00    	mov    0x6b20,%ebx
    1f8f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f92:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f95:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f98:	6b c0 32             	imul   $0x32,%eax,%eax
    1f9b:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f9e:	8b 45 08             	mov    0x8(%ebp),%eax
    1fa1:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fa4:	83 ec 0c             	sub    $0xc,%esp
    1fa7:	83 ec 04             	sub    $0x4,%esp
    1faa:	89 e0                	mov    %esp,%eax
    1fac:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    1fb0:	66 89 30             	mov    %si,(%eax)
    1fb3:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    1fb7:	88 50 02             	mov    %dl,0x2(%eax)
    1fba:	6a 32                	push   $0x32
    1fbc:	6a 32                	push   $0x32
    1fbe:	6a 00                	push   $0x0
    1fc0:	6a 00                	push   $0x0
    1fc2:	53                   	push   %ebx
    1fc3:	51                   	push   %ecx
    1fc4:	ff 75 84             	pushl  -0x7c(%ebp)
    1fc7:	57                   	push   %edi
    1fc8:	e8 1c f4 ff ff       	call   13e9 <APDcCopy>
    1fcd:	83 c4 30             	add    $0x30,%esp
                    break;
    1fd0:	e9 b7 00 00 00       	jmp    208c <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fd5:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    1fd8:	6a 0c                	push   $0xc
    1fda:	6a 0c                	push   $0xc
    1fdc:	6a 0c                	push   $0xc
    1fde:	50                   	push   %eax
    1fdf:	e8 a9 f5 ff ff       	call   158d <RGB>
    1fe4:	83 c4 0c             	add    $0xc,%esp
    1fe7:	8b 1d 3c 6b 00 00    	mov    0x6b3c,%ebx
    1fed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ff0:	6b c8 32             	imul   $0x32,%eax,%ecx
    1ff3:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1ff6:	6b c0 32             	imul   $0x32,%eax,%eax
    1ff9:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1ffc:	8b 45 08             	mov    0x8(%ebp),%eax
    1fff:	8d 78 3c             	lea    0x3c(%eax),%edi
    2002:	83 ec 0c             	sub    $0xc,%esp
    2005:	83 ec 04             	sub    $0x4,%esp
    2008:	89 e0                	mov    %esp,%eax
    200a:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    200e:	66 89 30             	mov    %si,(%eax)
    2011:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2015:	88 50 02             	mov    %dl,0x2(%eax)
    2018:	6a 32                	push   $0x32
    201a:	6a 32                	push   $0x32
    201c:	6a 00                	push   $0x0
    201e:	6a 00                	push   $0x0
    2020:	53                   	push   %ebx
    2021:	51                   	push   %ecx
    2022:	ff 75 84             	pushl  -0x7c(%ebp)
    2025:	57                   	push   %edi
    2026:	e8 be f3 ff ff       	call   13e9 <APDcCopy>
    202b:	83 c4 30             	add    $0x30,%esp
                    break;
    202e:	eb 5c                	jmp    208c <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2030:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    2033:	6a 0c                	push   $0xc
    2035:	6a 0c                	push   $0xc
    2037:	6a 0c                	push   $0xc
    2039:	50                   	push   %eax
    203a:	e8 4e f5 ff ff       	call   158d <RGB>
    203f:	83 c4 0c             	add    $0xc,%esp
    2042:	8b 1d 94 6b 00 00    	mov    0x6b94,%ebx
    2048:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    204b:	6b c8 32             	imul   $0x32,%eax,%ecx
    204e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2051:	6b c0 32             	imul   $0x32,%eax,%eax
    2054:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2057:	8b 45 08             	mov    0x8(%ebp),%eax
    205a:	8d 78 3c             	lea    0x3c(%eax),%edi
    205d:	83 ec 0c             	sub    $0xc,%esp
    2060:	83 ec 04             	sub    $0x4,%esp
    2063:	89 e0                	mov    %esp,%eax
    2065:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    2069:	66 89 30             	mov    %si,(%eax)
    206c:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    2070:	88 50 02             	mov    %dl,0x2(%eax)
    2073:	6a 32                	push   $0x32
    2075:	6a 32                	push   $0x32
    2077:	6a 00                	push   $0x0
    2079:	6a 00                	push   $0x0
    207b:	53                   	push   %ebx
    207c:	51                   	push   %ecx
    207d:	ff 75 84             	pushl  -0x7c(%ebp)
    2080:	57                   	push   %edi
    2081:	e8 63 f3 ff ff       	call   13e9 <APDcCopy>
    2086:	83 c4 30             	add    $0x30,%esp
                    break;
    2089:	eb 01                	jmp    208c <APGridPaint+0x6e5>
                default: break;
    208b:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    208c:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    2090:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2094:	0f 8e 1c fc ff ff    	jle    1cb6 <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    209a:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    209e:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    20a2:	0f 8e 02 fc ff ff    	jle    1caa <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    20a8:	8d 45 88             	lea    -0x78(%ebp),%eax
    20ab:	68 cd 00 00 00       	push   $0xcd
    20b0:	6a 74                	push   $0x74
    20b2:	6a 18                	push   $0x18
    20b4:	50                   	push   %eax
    20b5:	e8 d3 f4 ff ff       	call   158d <RGB>
    20ba:	83 c4 0c             	add    $0xc,%esp
    20bd:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    20c1:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    20c5:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    20c9:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    20cc:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    20d3:	8d 45 88             	lea    -0x78(%ebp),%eax
    20d6:	68 cd 00 00 00       	push   $0xcd
    20db:	6a 74                	push   $0x74
    20dd:	6a 18                	push   $0x18
    20df:	50                   	push   %eax
    20e0:	e8 a8 f4 ff ff       	call   158d <RGB>
    20e5:	83 c4 0c             	add    $0xc,%esp
    20e8:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    20ec:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    20f0:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    20f4:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    20f7:	8b 45 08             	mov    0x8(%ebp),%eax
    20fa:	8d 50 58             	lea    0x58(%eax),%edx
    20fd:	8d 45 88             	lea    -0x78(%ebp),%eax
    2100:	ff 75 bc             	pushl  -0x44(%ebp)
    2103:	ff 75 b8             	pushl  -0x48(%ebp)
    2106:	52                   	push   %edx
    2107:	50                   	push   %eax
    2108:	e8 6d eb ff ff       	call   c7a <APSetPen>
    210d:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    2110:	8b 45 08             	mov    0x8(%ebp),%eax
    2113:	8d 58 58             	lea    0x58(%eax),%ebx
    2116:	8d 55 88             	lea    -0x78(%ebp),%edx
    2119:	83 ec 04             	sub    $0x4,%esp
    211c:	83 ec 04             	sub    $0x4,%esp
    211f:	89 e0                	mov    %esp,%eax
    2121:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    2125:	66 89 08             	mov    %cx,(%eax)
    2128:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    212c:	88 48 02             	mov    %cl,0x2(%eax)
    212f:	53                   	push   %ebx
    2130:	52                   	push   %edx
    2131:	e8 7d eb ff ff       	call   cb3 <APSetBrush>
    2136:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    2139:	8b 45 08             	mov    0x8(%ebp),%eax
    213c:	83 c0 58             	add    $0x58,%eax
    213f:	83 ec 0c             	sub    $0xc,%esp
    2142:	6a 32                	push   $0x32
    2144:	68 20 03 00 00       	push   $0x320
    2149:	6a 00                	push   $0x0
    214b:	6a 00                	push   $0x0
    214d:	50                   	push   %eax
    214e:	e8 8a ef ff ff       	call   10dd <APDrawRect>
    ...
    215d:	6a 08                	push   $0x8
    215f:	50                   	push   %eax
    2160:	e8 28 f4 ff ff       	call   158d <RGB>
    2165:	83 c4 0c             	add    $0xc,%esp
    2168:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    216c:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    2170:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2174:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    2188:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    218c:	66 89 08             	mov    %cx,(%eax)
    218f:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    2193:	88 48 02             	mov    %cl,0x2(%eax)
    2196:	53                   	push   %ebx
    2197:	52                   	push   %edx
    2198:	e8 58 eb ff ff       	call   cf5 <APSetFont>
    219d:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    21a0:	8b 45 08             	mov    0x8(%ebp),%eax
    21a3:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    21a9:	8b 45 08             	mov    0x8(%ebp),%eax
    21ac:	83 c0 58             	add    $0x58,%eax
    21af:	6a 14                	push   $0x14
    21b1:	6a 14                	push   $0x14
    21b3:	52                   	push   %edx
    21b4:	50                   	push   %eax
    21b5:	e8 28 f1 ff ff       	call   12e2 <APDrawText>
