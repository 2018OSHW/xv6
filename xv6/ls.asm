...
fmtname(char *path)
{
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      9a:	05 dc 2a 00 00       	add    $0x2adc,%eax
  ...
  return buf;
      ae:	b8 dc 2a 00 00       	mov    $0x2adc,%eax
}
...
ls(char *path)
{
  ...
  if(fstat(fd, &st) < 0){
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     116:	68 9c 23 00 00       	push   $0x239c
     11b:	6a 02                	push   $0x2
  ...
  case T_FILE:
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
     ...
     177:	53                   	push   %ebx
     178:	50                   	push   %eax
     179:	68 b0 23 00 00       	push   $0x23b0
     17e:	6a 01                	push   $0x1
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1a8:	68 bd 23 00 00       	push   $0x23bd
     1ad:	6a 01                	push   $0x1
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     25b:	50                   	push   %eax
     25c:	68 9c 23 00 00       	push   $0x239c
     261:	6a 01                	push   $0x1
     ...
     29a:	53                   	push   %ebx
     29b:	50                   	push   %eax
     29c:	68 b0 23 00 00       	push   $0x23b0
     2a1:	6a 01                	push   $0x1
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     2fe:	68 d0 23 00 00       	push   $0x23d0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6e0:	0f b6 80 b4 2a 00 00 	movzbl 0x2ab4(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     81c:	75 25                	jne    843 <printf+0xff>
          s = "(null)";
     81e:	c7 45 f4 d2 23 00 00 	movl   $0x23d2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     8e4:	a1 f4 2a 00 00       	mov    0x2af4,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     9af:	a3 f4 2a 00 00       	mov    %eax,0x2af4
}
     9b4:	90                   	nop
     9b5:	c9                   	leave  
     9b6:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     a10:	a1 f4 2a 00 00       	mov    0x2af4,%eax
}
     a15:	c9                   	leave  
     a16:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     a2c:	a1 f4 2a 00 00       	mov    0x2af4,%eax
     a31:	89 45 f0             	mov    %eax,-0x10(%ebp)
     a34:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     a38:	75 23                	jne    a5d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     a3a:	c7 45 f0 ec 2a 00 00 	movl   $0x2aec,-0x10(%ebp)
     a41:	8b 45 f0             	mov    -0x10(%ebp),%eax
     a44:	a3 f4 2a 00 00       	mov    %eax,0x2af4
     a49:	a1 f4 2a 00 00       	mov    0x2af4,%eax
     a4e:	a3 ec 2a 00 00       	mov    %eax,0x2aec
    base.s.size = 0;
     a53:	c7 05 f0 2a 00 00 00 	movl   $0x0,0x2af0
     a5a:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     ab0:	a3 f4 2a 00 00       	mov    %eax,0x2af4
      return (void*)(p + 1);
    ...
    if(p == freep)
     abd:	a1 f4 2a 00 00       	mov    0x2af4,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     bfb:	79 2e                	jns    c2b <APLoadBitmap+0x61>
    {
     ...
     c03:	68 d9 23 00 00       	push   $0x23d9
     c08:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    16eb:	68 ec 23 00 00       	push   $0x23ec
    16f0:	6a 01                	push   $0x1
    ...
    175e:	68 0c 24 00 00       	push   $0x240c
    1763:	6a 01                	push   $0x1
    ...
    1802:	68 30 24 00 00       	push   $0x2430
    1807:	6a 01                	push   $0x1
    ...
    18d3:	68 58 24 00 00       	push   $0x2458
    18d8:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1c65:	68 ec 24 00 00       	push   $0x24ec
    1c6a:	6a 01                	push   $0x1
    ...
    1c96:	68 12 25 00 00       	push   $0x2512
    1c9b:	6a 01                	push   $0x1
    ...
    1d05:	8b 04 85 28 25 00 00 	mov    0x2528(,%eax,4),%eax
    1d0c:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1d20:	8b 1d 28 2b 00 00    	mov    0x2b28,%ebx
    ...
    1e32:	8b 1d 68 2b 00 00    	mov    0x2b68,%ebx
    ...
    1e90:	8b 1d 48 2b 00 00    	mov    0x2b48,%ebx
    ...
    1eee:	8b 1d 2c 2b 00 00    	mov    0x2b2c,%ebx
    ...
    1f4c:	8b 1d 64 2b 00 00    	mov    0x2b64,%ebx
    ...
    1faa:	8b 1d fc 2a 00 00    	mov    0x2afc,%ebx
    ...
    2005:	8b 1d 18 2b 00 00    	mov    0x2b18,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    if(sgn && xx < 0){
    2081:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    2085:	74 17                	je     209e <sprintint+0x2b>
    2087:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    208b:	79 11                	jns    209e <sprintint+0x2b>
        neg = 1;
    208d:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    2094:	8b 45 10             	mov    0x10(%ebp),%eax
    2097:	f7 d8                	neg    %eax
    2099:	89 45 f0             	mov    %eax,-0x10(%ebp)
    209c:	eb 06                	jmp    20a4 <sprintint+0x31>
    } else {
        x = xx;
    209e:	8b 45 10             	mov    0x10(%ebp),%eax
    20a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    20a4:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    20ab:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    20ae:	8d 41 01             	lea    0x1(%ecx),%eax
    20b1:	89 45 f8             	mov    %eax,-0x8(%ebp)
    20b4:	8b 5d 14             	mov    0x14(%ebp),%ebx
    20b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    20ba:	ba 00 00 00 00       	mov    $0x0,%edx
    20bf:	f7 f3                	div    %ebx
    20c1:	89 d0                	mov    %edx,%eax
    20c3:	0f b6 80 c8 2a 00 00 	movzbl 0x2ac8(%eax),%eax
    20ca:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    20ce:	8b 5d 14             	mov    0x14(%ebp),%ebx
    20d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    20d4:	ba 00 00 00 00       	mov    $0x0,%edx
    20d9:	f7 f3                	div    %ebx
    20db:	89 45 f0             	mov    %eax,-0x10(%ebp)
    20de:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    20e2:	75 c7                	jne    20ab <sprintint+0x38>
    if(neg)
    20e4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20e8:	74 0e                	je     20f8 <sprintint+0x85>
        buf[i++] = '-';
    20ea:	8b 45 f8             	mov    -0x8(%ebp),%eax
    20ed:	8d 50 01             	lea    0x1(%eax),%edx
    20f0:	89 55 f8             	mov    %edx,-0x8(%ebp)
    20f3:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    20f8:	8b 45 f8             	mov    -0x8(%ebp),%eax
    20fb:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    20fe:	eb 1b                	jmp    211b <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    ...
    2114:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    2117:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    211b:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    211f:	7f df                	jg     2100 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2121:	eb 21                	jmp    2144 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    2123:	8b 45 0c             	mov    0xc(%ebp),%eax
    2126:	8b 00                	mov    (%eax),%eax
    2128:	8d 48 01             	lea    0x1(%eax),%ecx
    212b:	8b 55 0c             	mov    0xc(%ebp),%edx
    212e:	89 0a                	mov    %ecx,(%edx)
    2130:	89 c2                	mov    %eax,%edx
    2132:	8b 45 08             	mov    0x8(%ebp),%eax
    2135:	01 c2                	add    %eax,%edx
    2137:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    213a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    213d:	01 c8                	add    %ecx,%eax
    213f:	0f b6 00             	movzbl (%eax),%eax
    2142:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2144:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2148:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    214c:	79 d5                	jns    2123 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    214e:	90                   	nop
...
{
    2155:	55                   	push   %ebp
    2156:	89 e5                	mov    %esp,%ebp
    2158:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    215b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    2162:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2169:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    2170:	8d 45 0c             	lea    0xc(%ebp),%eax
    2173:	83 c0 04             	add    $0x4,%eax
    2176:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2179:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    2180:	e9 d9 01 00 00       	jmp    235e <sprintf+0x209>
        c = fmt[i] & 0xff;
    2185:	8b 55 0c             	mov    0xc(%ebp),%edx
    2188:	8b 45 ec             	mov    -0x14(%ebp),%eax
    218b:	01 d0                	add    %edx,%eax
    218d:	0f b6 00             	movzbl (%eax),%eax
    2190:	0f be c0             	movsbl %al,%eax
    2193:	25 ff 00 00 00       	and    $0xff,%eax
    2198:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    219b:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    219f:	75 2c                	jne    21cd <sprintf+0x78>
            if(c == '%'){
    21a1:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    21a5:	75 0c                	jne    21b3 <sprintf+0x5e>
                state = '%';
    21a7:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    21ae:	e9 a7 01 00 00       	jmp    235a <sprintf+0x205>
            } else {
                dst[j++] = c;
    21b3:	8b 45 c8             	mov    -0x38(%ebp),%eax
    21b6:	8d 50 01             	lea    0x1(%eax),%edx
    21b9:	89 55 c8             	mov    %edx,-0x38(%ebp)
    21bc:	89 c2                	mov    %eax,%edx
    21be:	8b 45 08             	mov    0x8(%ebp),%eax
    21c1:	01 d0                	add    %edx,%eax
    21c3:	8b 55 e0             	mov    -0x20(%ebp),%edx
    21c6:	88 10                	mov    %dl,(%eax)
    21c8:	e9 8d 01 00 00       	jmp    235a <sprintf+0x205>
            }
        } else if(state == '%'){
    21cd:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    21d1:	0f 85 83 01 00 00    	jne    235a <sprintf+0x205>
            if(c == 'd'){
    21d7:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    21db:	75 4c                	jne    2229 <sprintf+0xd4>
                buf[bi] = '\0';
    21dd:	8d 55 ce             	lea    -0x32(%ebp),%edx
    21e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    21e3:	01 d0                	add    %edx,%eax
    21e5:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    21e8:	83 ec 0c             	sub    $0xc,%esp
    21eb:	8d 45 ce             	lea    -0x32(%ebp),%eax
    21ee:	50                   	push   %eax
    21ef:	e8 17 e3 ff ff       	call   50b <atoi>
    21f4:	83 c4 10             	add    $0x10,%esp
    21f7:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    21fa:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2201:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2204:	8b 00                	mov    (%eax),%eax
    2206:	83 ec 08             	sub    $0x8,%esp
    2209:	ff 75 d8             	pushl  -0x28(%ebp)
    220c:	6a 01                	push   $0x1
    220e:	6a 0a                	push   $0xa
    2210:	50                   	push   %eax
    2211:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2214:	50                   	push   %eax
    2215:	ff 75 08             	pushl  0x8(%ebp)
    2218:	e8 56 fe ff ff       	call   2073 <sprintint>
    221d:	83 c4 20             	add    $0x20,%esp
                ap++;
    2220:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2224:	e9 2a 01 00 00       	jmp    2353 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2229:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    222d:	74 06                	je     2235 <sprintf+0xe0>
    222f:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    2233:	75 4c                	jne    2281 <sprintf+0x12c>
                buf[bi] = '\0';
    2235:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2238:	8b 45 f0             	mov    -0x10(%ebp),%eax
    223b:	01 d0                	add    %edx,%eax
    223d:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2240:	83 ec 0c             	sub    $0xc,%esp
    2243:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2246:	50                   	push   %eax
    2247:	e8 bf e2 ff ff       	call   50b <atoi>
    224c:	83 c4 10             	add    $0x10,%esp
    224f:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    2252:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2259:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    225c:	8b 00                	mov    (%eax),%eax
    225e:	83 ec 08             	sub    $0x8,%esp
    2261:	ff 75 dc             	pushl  -0x24(%ebp)
    2264:	6a 00                	push   $0x0
    2266:	6a 10                	push   $0x10
    2268:	50                   	push   %eax
    2269:	8d 45 c8             	lea    -0x38(%ebp),%eax
    226c:	50                   	push   %eax
    226d:	ff 75 08             	pushl  0x8(%ebp)
    2270:	e8 fe fd ff ff       	call   2073 <sprintint>
    2275:	83 c4 20             	add    $0x20,%esp
                ap++;
    2278:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    227c:	e9 d2 00 00 00       	jmp    2353 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    2281:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2285:	75 46                	jne    22cd <sprintf+0x178>
                s = (char*)*ap;
    2287:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    228a:	8b 00                	mov    (%eax),%eax
    228c:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    228f:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    2293:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2297:	75 25                	jne    22be <sprintf+0x169>
                    s = "(null)";
    2299:	c7 45 f4 48 25 00 00 	movl   $0x2548,-0xc(%ebp)
                while(*s != 0){
    22a0:	eb 1c                	jmp    22be <sprintf+0x169>
                    dst[j++] = *s;
    ...
    22b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22b5:	0f b6 00             	movzbl (%eax),%eax
    22b8:	88 02                	mov    %al,(%edx)
                    s++;
    22ba:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
    ...
    22c1:	0f b6 00             	movzbl (%eax),%eax
    22c4:	84 c0                	test   %al,%al
    22c6:	75 da                	jne    22a2 <sprintf+0x14d>
    22c8:	e9 86 00 00 00       	jmp    2353 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    22cd:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    22d1:	75 1d                	jne    22f0 <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    22e1:	01 c2                	add    %eax,%edx
    22e3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    22e6:	8b 00                	mov    (%eax),%eax
    22e8:	88 02                	mov    %al,(%edx)
                ap++;
    22ea:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    22ee:	eb 63                	jmp    2353 <sprintf+0x1fe>
            } else if(c == '%'){
    22f0:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    22f4:	75 17                	jne    230d <sprintf+0x1b8>
                dst[j++] = c;
    22f6:	8b 45 c8             	mov    -0x38(%ebp),%eax
    22f9:	8d 50 01             	lea    0x1(%eax),%edx
    22fc:	89 55 c8             	mov    %edx,-0x38(%ebp)
    22ff:	89 c2                	mov    %eax,%edx
    2301:	8b 45 08             	mov    0x8(%ebp),%eax
    2304:	01 d0                	add    %edx,%eax
    2306:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2309:	88 10                	mov    %dl,(%eax)
    230b:	eb 46                	jmp    2353 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    230d:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2311:	7e 18                	jle    232b <sprintf+0x1d6>
    2313:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2317:	7f 12                	jg     232b <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2319:	8b 45 f0             	mov    -0x10(%ebp),%eax
    231c:	8d 50 01             	lea    0x1(%eax),%edx
    231f:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2322:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2325:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2329:	eb 2f                	jmp    235a <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    ...
    2351:	88 10                	mov    %dl,(%eax)
            ...
            state = 0;
    2353:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    235a:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    235e:	8b 55 0c             	mov    0xc(%ebp),%edx
    2361:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2364:	01 d0                	add    %edx,%eax
    2366:	0f b6 00             	movzbl (%eax),%eax
    2369:	84 c0                	test   %al,%al
    236b:	0f 85 14 fe ff ff    	jne    2185 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    2371:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2374:	8d 50 01             	lea    0x1(%eax),%edx
    2377:	89 55 c8             	mov    %edx,-0x38(%ebp)
    237a:	89 c2                	mov    %eax,%edx
    237c:	8b 45 08             	mov    0x8(%ebp),%eax
    237f:	01 d0                	add    %edx,%eax
    2381:	c6 00 00             	movb   $0x0,(%eax)
}
    2384:	90                   	nop
    2385:	c9                   	leave  
    2386:	c3                   	ret    
