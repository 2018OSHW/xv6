...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    1be7:	a1 c4 6b 00 00       	mov    0x6bc4,%eax
    1bec:	85 c0                	test   %eax,%eax
    1bee:	0f 85 7a 02 00 00    	jne    1e6e <APGridPaint+0x290>
    {
        iconReady = 1;
    1bf4:	c7 05 c4 6b 00 00 01 	movl   $0x1,0x6bc4
    1bfb:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    1bfe:	8d 45 88             	lea    -0x78(%ebp),%eax
    1c01:	83 ec 08             	sub    $0x8,%esp
    1c04:	68 6b 28 00 00       	push   $0x286b
    1c09:	50                   	push   %eax
    1c0a:	e8 d3 ef ff ff       	call   be2 <APLoadBitmap>
    1c0f:	83 c4 0c             	add    $0xc,%esp
    1c12:	8b 45 88             	mov    -0x78(%ebp),%eax
    1c15:	a3 e8 6b 00 00       	mov    %eax,0x6be8
    1c1a:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1c1d:	a3 ec 6b 00 00       	mov    %eax,0x6bec
    1c22:	8b 45 90             	mov    -0x70(%ebp),%eax
    1c25:	a3 f0 6b 00 00       	mov    %eax,0x6bf0
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    1c2a:	83 ec 04             	sub    $0x4,%esp
    1c2d:	ff 35 f0 6b 00 00    	pushl  0x6bf0
    1c33:	ff 35 ec 6b 00 00    	pushl  0x6bec
    1c39:	ff 35 e8 6b 00 00    	pushl  0x6be8
    1c3f:	e8 d8 f1 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1c44:	83 c4 10             	add    $0x10,%esp
    1c47:	a3 f4 6b 00 00       	mov    %eax,0x6bf4
        grid_river = APLoadBitmap ("grid_river.bmp");
    1c4c:	8d 45 88             	lea    -0x78(%ebp),%eax
    1c4f:	83 ec 08             	sub    $0x8,%esp
    1c52:	68 79 28 00 00       	push   $0x2879
    1c57:	50                   	push   %eax
    1c58:	e8 85 ef ff ff       	call   be2 <APLoadBitmap>
    1c5d:	83 c4 0c             	add    $0xc,%esp
    1c60:	8b 45 88             	mov    -0x78(%ebp),%eax
    1c63:	a3 30 6c 00 00       	mov    %eax,0x6c30
    1c68:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1c6b:	a3 34 6c 00 00       	mov    %eax,0x6c34
    1c70:	8b 45 90             	mov    -0x70(%ebp),%eax
    1c73:	a3 38 6c 00 00       	mov    %eax,0x6c38
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    1c78:	83 ec 04             	sub    $0x4,%esp
    1c7b:	ff 35 38 6c 00 00    	pushl  0x6c38
    1c81:	ff 35 34 6c 00 00    	pushl  0x6c34
    1c87:	ff 35 30 6c 00 00    	pushl  0x6c30
    1c8d:	e8 8a f1 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1c92:	83 c4 10             	add    $0x10,%esp
    1c95:	a3 20 6c 00 00       	mov    %eax,0x6c20
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    1c9a:	8d 45 88             	lea    -0x78(%ebp),%eax
    1c9d:	83 ec 08             	sub    $0x8,%esp
    1ca0:	68 88 28 00 00       	push   $0x2888
    1ca5:	50                   	push   %eax
    1ca6:	e8 37 ef ff ff       	call   be2 <APLoadBitmap>
    1cab:	83 c4 0c             	add    $0xc,%esp
    1cae:	8b 45 88             	mov    -0x78(%ebp),%eax
    1cb1:	a3 24 6c 00 00       	mov    %eax,0x6c24
    1cb6:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1cb9:	a3 28 6c 00 00       	mov    %eax,0x6c28
    1cbe:	8b 45 90             	mov    -0x70(%ebp),%eax
    1cc1:	a3 2c 6c 00 00       	mov    %eax,0x6c2c
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    1cc6:	83 ec 04             	sub    $0x4,%esp
    1cc9:	ff 35 2c 6c 00 00    	pushl  0x6c2c
    1ccf:	ff 35 28 6c 00 00    	pushl  0x6c28
    1cd5:	ff 35 24 6c 00 00    	pushl  0x6c24
    1cdb:	e8 3c f1 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1ce0:	83 c4 10             	add    $0x10,%esp
    1ce3:	a3 c8 6b 00 00       	mov    %eax,0x6bc8
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1ce8:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ceb:	83 ec 08             	sub    $0x8,%esp
    1cee:	68 97 28 00 00       	push   $0x2897
    1cf3:	50                   	push   %eax
    1cf4:	e8 e9 ee ff ff       	call   be2 <APLoadBitmap>
    1cf9:	83 c4 0c             	add    $0xc,%esp
    1cfc:	8b 45 88             	mov    -0x78(%ebp),%eax
    1cff:	a3 fc 6b 00 00       	mov    %eax,0x6bfc
    1d04:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1d07:	a3 00 6c 00 00       	mov    %eax,0x6c00
    1d0c:	8b 45 90             	mov    -0x70(%ebp),%eax
    1d0f:	a3 04 6c 00 00       	mov    %eax,0x6c04
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1d14:	83 ec 04             	sub    $0x4,%esp
    1d17:	ff 35 04 6c 00 00    	pushl  0x6c04
    1d1d:	ff 35 00 6c 00 00    	pushl  0x6c00
    1d23:	ff 35 fc 6b 00 00    	pushl  0x6bfc
    1d29:	e8 ee f0 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1d2e:	83 c4 10             	add    $0x10,%esp
    1d31:	a3 40 6c 00 00       	mov    %eax,0x6c40
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1d36:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d39:	83 ec 08             	sub    $0x8,%esp
    1d3c:	68 a5 28 00 00       	push   $0x28a5
    1d41:	50                   	push   %eax
    1d42:	e8 9b ee ff ff       	call   be2 <APLoadBitmap>
    1d47:	83 c4 0c             	add    $0xc,%esp
    1d4a:	8b 45 88             	mov    -0x78(%ebp),%eax
    1d4d:	a3 d8 6b 00 00       	mov    %eax,0x6bd8
    1d52:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1d55:	a3 dc 6b 00 00       	mov    %eax,0x6bdc
    1d5a:	8b 45 90             	mov    -0x70(%ebp),%eax
    1d5d:	a3 e0 6b 00 00       	mov    %eax,0x6be0
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1d62:	83 ec 04             	sub    $0x4,%esp
    1d65:	ff 35 e0 6b 00 00    	pushl  0x6be0
    1d6b:	ff 35 dc 6b 00 00    	pushl  0x6bdc
    1d71:	ff 35 d8 6b 00 00    	pushl  0x6bd8
    1d77:	e8 a0 f0 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1d7c:	83 c4 10             	add    $0x10,%esp
    1d7f:	a3 f8 6b 00 00       	mov    %eax,0x6bf8
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1d84:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d87:	83 ec 08             	sub    $0x8,%esp
    1d8a:	68 b5 28 00 00       	push   $0x28b5
    1d8f:	50                   	push   %eax
    1d90:	e8 4d ee ff ff       	call   be2 <APLoadBitmap>
    1d95:	83 c4 0c             	add    $0xc,%esp
    1d98:	8b 45 88             	mov    -0x78(%ebp),%eax
    1d9b:	a3 cc 6b 00 00       	mov    %eax,0x6bcc
    1da0:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1da3:	a3 d0 6b 00 00       	mov    %eax,0x6bd0
    1da8:	8b 45 90             	mov    -0x70(%ebp),%eax
    1dab:	a3 d4 6b 00 00       	mov    %eax,0x6bd4
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1db0:	83 ec 04             	sub    $0x4,%esp
    1db3:	ff 35 d4 6b 00 00    	pushl  0x6bd4
    1db9:	ff 35 d0 6b 00 00    	pushl  0x6bd0
    1dbf:	ff 35 cc 6b 00 00    	pushl  0x6bcc
    1dc5:	e8 52 f0 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1dca:	83 c4 10             	add    $0x10,%esp
    1dcd:	a3 e4 6b 00 00       	mov    %eax,0x6be4
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1dd2:	8d 45 88             	lea    -0x78(%ebp),%eax
    1dd5:	83 ec 08             	sub    $0x8,%esp
    1dd8:	68 c7 28 00 00       	push   $0x28c7
    1ddd:	50                   	push   %eax
    1dde:	e8 ff ed ff ff       	call   be2 <APLoadBitmap>
    1de3:	83 c4 0c             	add    $0xc,%esp
    1de6:	8b 45 88             	mov    -0x78(%ebp),%eax
    1de9:	a3 14 6c 00 00       	mov    %eax,0x6c14
    1dee:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1df1:	a3 18 6c 00 00       	mov    %eax,0x6c18
    1df6:	8b 45 90             	mov    -0x70(%ebp),%eax
    1df9:	a3 1c 6c 00 00       	mov    %eax,0x6c1c
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1dfe:	83 ec 04             	sub    $0x4,%esp
    1e01:	ff 35 1c 6c 00 00    	pushl  0x6c1c
    1e07:	ff 35 18 6c 00 00    	pushl  0x6c18
    1e0d:	ff 35 14 6c 00 00    	pushl  0x6c14
    1e13:	e8 04 f0 ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1e18:	83 c4 10             	add    $0x10,%esp
    1e1b:	a3 44 6c 00 00       	mov    %eax,0x6c44
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1e20:	8d 45 88             	lea    -0x78(%ebp),%eax
    1e23:	83 ec 08             	sub    $0x8,%esp
    1e26:	68 d6 28 00 00       	push   $0x28d6
    1e2b:	50                   	push   %eax
    1e2c:	e8 b1 ed ff ff       	call   be2 <APLoadBitmap>
    1e31:	83 c4 0c             	add    $0xc,%esp
    1e34:	8b 45 88             	mov    -0x78(%ebp),%eax
    1e37:	a3 08 6c 00 00       	mov    %eax,0x6c08
    1e3c:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1e3f:	a3 0c 6c 00 00       	mov    %eax,0x6c0c
    1e44:	8b 45 90             	mov    -0x70(%ebp),%eax
    1e47:	a3 10 6c 00 00       	mov    %eax,0x6c10
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1e4c:	83 ec 04             	sub    $0x4,%esp
    1e4f:	ff 35 10 6c 00 00    	pushl  0x6c10
    1e55:	ff 35 0c 6c 00 00    	pushl  0x6c0c
    1e5b:	ff 35 08 6c 00 00    	pushl  0x6c08
    1e61:	e8 b6 ef ff ff       	call   e1c <APCreateCompatibleDCFromBitmap>
    1e66:	83 c4 10             	add    $0x10,%esp
    1e69:	a3 3c 6c 00 00       	mov    %eax,0x6c3c
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1e6e:	8b 45 08             	mov    0x8(%ebp),%eax
    1e71:	8b 40 08             	mov    0x8(%eax),%eax
    1e74:	85 c0                	test   %eax,%eax
    1e76:	75 17                	jne    1e8f <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1e78:	83 ec 08             	sub    $0x8,%esp
    1e7b:	68 e8 28 00 00       	push   $0x28e8
    1e80:	6a 01                	push   $0x1
    1e82:	e8 d5 e8 ff ff       	call   75c <printf>
    1e87:	83 c4 10             	add    $0x10,%esp
        return;
    1e8a:	e9 65 05 00 00       	jmp    23f4 <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1e8f:	8b 45 08             	mov    0x8(%ebp),%eax
    1e92:	8b 40 10             	mov    0x10(%eax),%eax
    1e95:	85 c0                	test   %eax,%eax
    1e97:	7e 10                	jle    1ea9 <APGridPaint+0x2cb>
    1e99:	8b 45 08             	mov    0x8(%ebp),%eax
    1e9c:	8b 50 14             	mov    0x14(%eax),%edx
    1e9f:	8b 45 08             	mov    0x8(%ebp),%eax
    1ea2:	8b 40 10             	mov    0x10(%eax),%eax
    1ea5:	39 c2                	cmp    %eax,%edx
    1ea7:	7c 17                	jl     1ec0 <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1ea9:	83 ec 08             	sub    $0x8,%esp
    1eac:	68 0e 29 00 00       	push   $0x290e
    1eb1:	6a 01                	push   $0x1
    1eb3:	e8 a4 e8 ff ff       	call   75c <printf>
    1eb8:	83 c4 10             	add    $0x10,%esp
        return;
    1ebb:	e9 34 05 00 00       	jmp    23f4 <APGridPaint+0x816>
    }
    ...
    1ec6:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1ecc:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1ecf:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1ed2:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1ed5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1edc:	e9 f4 03 00 00       	jmp    22d5 <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1ee1:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1ee8:	e9 da 03 00 00       	jmp    22c7 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1eed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ef0:	c1 e0 04             	shl    $0x4,%eax
    1ef3:	89 c2                	mov    %eax,%edx
    1ef5:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1ef8:	01 c2                	add    %eax,%edx
    1efa:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1efd:	01 d0                	add    %edx,%eax
    1eff:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1f02:	8b 45 08             	mov    0x8(%ebp),%eax
    1f05:	8b 40 0c             	mov    0xc(%eax),%eax
    1f08:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1f0b:	c1 e2 02             	shl    $0x2,%edx
    1f0e:	01 d0                	add    %edx,%eax
    1f10:	8b 00                	mov    (%eax),%eax
    1f12:	83 f8 0a             	cmp    $0xa,%eax
    1f15:	0f 87 a7 03 00 00    	ja     22c2 <APGridPaint+0x6e4>
    1f1b:	8b 04 85 24 29 00 00 	mov    0x2924(,%eax,4),%eax
    1f22:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f24:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1f27:	6a 0c                	push   $0xc
    1f29:	6a 0c                	push   $0xc
    1f2b:	6a 0c                	push   $0xc
    1f2d:	50                   	push   %eax
    1f2e:	e8 91 f8 ff ff       	call   17c4 <RGB>
    1f33:	83 c4 0c             	add    $0xc,%esp
    1f36:	8b 1d f4 6b 00 00    	mov    0x6bf4,%ebx
    1f3c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f3f:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f42:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f45:	6b c0 32             	imul   $0x32,%eax,%eax
    1f48:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f4b:	8b 45 08             	mov    0x8(%ebp),%eax
    1f4e:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f51:	83 ec 0c             	sub    $0xc,%esp
    1f54:	83 ec 04             	sub    $0x4,%esp
    1f57:	89 e0                	mov    %esp,%eax
    1f59:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1f5d:	66 89 30             	mov    %si,(%eax)
    1f60:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1f64:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    1f6f:	53                   	push   %ebx
    1f70:	51                   	push   %ecx
    1f71:	ff 75 84             	pushl  -0x7c(%ebp)
    1f74:	57                   	push   %edi
    1f75:	e8 a6 f6 ff ff       	call   1620 <APDcCopy>
    1f7a:	83 c4 30             	add    $0x30,%esp
                    break;
    1f7d:	e9 41 03 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1f82:	8d 45 88             	lea    -0x78(%ebp),%eax
    1f85:	6a 69                	push   $0x69
    1f87:	6a 69                	push   $0x69
    1f89:	6a 69                	push   $0x69
    1f8b:	50                   	push   %eax
    1f8c:	e8 33 f8 ff ff       	call   17c4 <RGB>
    1f91:	83 c4 0c             	add    $0xc,%esp
    1f94:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1f98:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1f9c:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1fa0:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1fa3:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1faa:	8d 45 88             	lea    -0x78(%ebp),%eax
    1fad:	6a 69                	push   $0x69
    1faf:	6a 69                	push   $0x69
    1fb1:	6a 69                	push   $0x69
    1fb3:	50                   	push   %eax
    1fb4:	e8 0b f8 ff ff       	call   17c4 <RGB>
    1fb9:	83 c4 0c             	add    $0xc,%esp
    1fbc:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1fc0:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1fc4:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1fc8:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1fcb:	8b 45 08             	mov    0x8(%ebp),%eax
    1fce:	8d 50 3c             	lea    0x3c(%eax),%edx
    1fd1:	8d 45 88             	lea    -0x78(%ebp),%eax
    1fd4:	ff 75 ac             	pushl  -0x54(%ebp)
    1fd7:	ff 75 a8             	pushl  -0x58(%ebp)
    1fda:	52                   	push   %edx
    1fdb:	50                   	push   %eax
    1fdc:	e8 d0 ee ff ff       	call   eb1 <APSetPen>
    1fe1:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1fe4:	8b 45 08             	mov    0x8(%ebp),%eax
    1fe7:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1fea:	8d 55 88             	lea    -0x78(%ebp),%edx
    1fed:	83 ec 04             	sub    $0x4,%esp
    1ff0:	83 ec 04             	sub    $0x4,%esp
    1ff3:	89 e0                	mov    %esp,%eax
    1ff5:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1ff9:	66 89 08             	mov    %cx,(%eax)
    1ffc:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    2000:	88 48 02             	mov    %cl,0x2(%eax)
    2003:	53                   	push   %ebx
    2004:	52                   	push   %edx
    2005:	e8 e0 ee ff ff       	call   eea <APSetBrush>
    200a:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    200d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2010:	6b d0 32             	imul   $0x32,%eax,%edx
    2013:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2016:	6b c0 32             	imul   $0x32,%eax,%eax
    2019:	8b 4d 08             	mov    0x8(%ebp),%ecx
    201c:	83 c1 3c             	add    $0x3c,%ecx
    201f:	83 ec 0c             	sub    $0xc,%esp
    2022:	6a 32                	push   $0x32
    2024:	6a 32                	push   $0x32
    2026:	52                   	push   %edx
    2027:	50                   	push   %eax
    2028:	51                   	push   %ecx
    2029:	e8 e6 f2 ff ff       	call   1314 <APDrawRect>
    202e:	83 c4 20             	add    $0x20,%esp
                    break;
    2031:	e9 8d 02 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2036:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    2039:	6a 0c                	push   $0xc
    203b:	6a 0c                	push   $0xc
    203d:	6a 0c                	push   $0xc
    203f:	50                   	push   %eax
    2040:	e8 7f f7 ff ff       	call   17c4 <RGB>
    2045:	83 c4 0c             	add    $0xc,%esp
    2048:	8b 1d 44 6c 00 00    	mov    0x6c44,%ebx
    ...
    206b:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    206f:	66 89 30             	mov    %si,(%eax)
    2072:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    2086:	57                   	push   %edi
    2087:	e8 94 f5 ff ff       	call   1620 <APDcCopy>
    208c:	83 c4 30             	add    $0x30,%esp
                    break;
    208f:	e9 2f 02 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2094:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    2097:	6a 0c                	push   $0xc
    2099:	6a 0c                	push   $0xc
    209b:	6a 0c                	push   $0xc
    209d:	50                   	push   %eax
    209e:	e8 21 f7 ff ff       	call   17c4 <RGB>
    20a3:	83 c4 0c             	add    $0xc,%esp
    20a6:	8b 1d 20 6c 00 00    	mov    0x6c20,%ebx
    ...
    20c9:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    20cd:	66 89 30             	mov    %si,(%eax)
    20d0:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    20e4:	57                   	push   %edi
    20e5:	e8 36 f5 ff ff       	call   1620 <APDcCopy>
    20ea:	83 c4 30             	add    $0x30,%esp
                    break;
    20ed:	e9 d1 01 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    20f2:	8d 45 c9             	lea    -0x37(%ebp),%eax
    20f5:	6a 0c                	push   $0xc
    20f7:	6a 0c                	push   $0xc
    20f9:	6a 0c                	push   $0xc
    20fb:	50                   	push   %eax
    20fc:	e8 c3 f6 ff ff       	call   17c4 <RGB>
    2101:	83 c4 0c             	add    $0xc,%esp
    2104:	8b 1d f8 6b 00 00    	mov    0x6bf8,%ebx
    ...
    2127:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    212b:	66 89 30             	mov    %si,(%eax)
    212e:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    2142:	57                   	push   %edi
    2143:	e8 d8 f4 ff ff       	call   1620 <APDcCopy>
    2148:	83 c4 30             	add    $0x30,%esp
                    break;
    214b:	e9 73 01 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2150:	8d 45 cc             	lea    -0x34(%ebp),%eax
    2153:	6a 0c                	push   $0xc
    2155:	6a 0c                	push   $0xc
    2157:	6a 0c                	push   $0xc
    2159:	50                   	push   %eax
    215a:	e8 65 f6 ff ff       	call   17c4 <RGB>
    215f:	83 c4 0c             	add    $0xc,%esp
    2162:	8b 1d 40 6c 00 00    	mov    0x6c40,%ebx
    ...
    2185:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    2189:	66 89 30             	mov    %si,(%eax)
    218c:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    21a0:	57                   	push   %edi
    21a1:	e8 7a f4 ff ff       	call   1620 <APDcCopy>
    21a6:	83 c4 30             	add    $0x30,%esp
                    break;
    21a9:	e9 15 01 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    21ae:	8d 45 cf             	lea    -0x31(%ebp),%eax
    21b1:	6a 0c                	push   $0xc
    21b3:	6a 0c                	push   $0xc
    21b5:	6a 0c                	push   $0xc
    21b7:	50                   	push   %eax
    21b8:	e8 07 f6 ff ff       	call   17c4 <RGB>
    21bd:	83 c4 0c             	add    $0xc,%esp
    21c0:	8b 1d c8 6b 00 00    	mov    0x6bc8,%ebx
    21c6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    21c9:	6b c8 32             	imul   $0x32,%eax,%ecx
    21cc:	8b 45 e0             	mov    -0x20(%ebp),%eax
    21cf:	6b c0 32             	imul   $0x32,%eax,%eax
    21d2:	89 45 84             	mov    %eax,-0x7c(%ebp)
    21d5:	8b 45 08             	mov    0x8(%ebp),%eax
    21d8:	8d 78 3c             	lea    0x3c(%eax),%edi
    21db:	83 ec 0c             	sub    $0xc,%esp
    21de:	83 ec 04             	sub    $0x4,%esp
    21e1:	89 e0                	mov    %esp,%eax
    21e3:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    21e7:	66 89 30             	mov    %si,(%eax)
    21ea:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    21ee:	88 50 02             	mov    %dl,0x2(%eax)
    21f1:	6a 32                	push   $0x32
    21f3:	6a 32                	push   $0x32
    21f5:	6a 00                	push   $0x0
    21f7:	6a 00                	push   $0x0
    21f9:	53                   	push   %ebx
    21fa:	51                   	push   %ecx
    21fb:	ff 75 84             	pushl  -0x7c(%ebp)
    21fe:	57                   	push   %edi
    21ff:	e8 1c f4 ff ff       	call   1620 <APDcCopy>
    2204:	83 c4 30             	add    $0x30,%esp
                    break;
    2207:	e9 b7 00 00 00       	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    220c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    220f:	6a 0c                	push   $0xc
    2211:	6a 0c                	push   $0xc
    2213:	6a 0c                	push   $0xc
    2215:	50                   	push   %eax
    2216:	e8 a9 f5 ff ff       	call   17c4 <RGB>
    221b:	83 c4 0c             	add    $0xc,%esp
    221e:	8b 1d e4 6b 00 00    	mov    0x6be4,%ebx
    2224:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2227:	6b c8 32             	imul   $0x32,%eax,%ecx
    222a:	8b 45 e0             	mov    -0x20(%ebp),%eax
    222d:	6b c0 32             	imul   $0x32,%eax,%eax
    2230:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2233:	8b 45 08             	mov    0x8(%ebp),%eax
    2236:	8d 78 3c             	lea    0x3c(%eax),%edi
    2239:	83 ec 0c             	sub    $0xc,%esp
    223c:	83 ec 04             	sub    $0x4,%esp
    223f:	89 e0                	mov    %esp,%eax
    2241:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    2245:	66 89 30             	mov    %si,(%eax)
    2248:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    224c:	88 50 02             	mov    %dl,0x2(%eax)
    224f:	6a 32                	push   $0x32
    2251:	6a 32                	push   $0x32
    2253:	6a 00                	push   $0x0
    2255:	6a 00                	push   $0x0
    2257:	53                   	push   %ebx
    2258:	51                   	push   %ecx
    2259:	ff 75 84             	pushl  -0x7c(%ebp)
    225c:	57                   	push   %edi
    225d:	e8 be f3 ff ff       	call   1620 <APDcCopy>
    2262:	83 c4 30             	add    $0x30,%esp
                    break;
    2265:	eb 5c                	jmp    22c3 <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2267:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    226a:	6a 0c                	push   $0xc
    226c:	6a 0c                	push   $0xc
    226e:	6a 0c                	push   $0xc
    2270:	50                   	push   %eax
    2271:	e8 4e f5 ff ff       	call   17c4 <RGB>
    2276:	83 c4 0c             	add    $0xc,%esp
    2279:	8b 1d 3c 6c 00 00    	mov    0x6c3c,%ebx
    227f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2282:	6b c8 32             	imul   $0x32,%eax,%ecx
    2285:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2288:	6b c0 32             	imul   $0x32,%eax,%eax
    228b:	89 45 84             	mov    %eax,-0x7c(%ebp)
    228e:	8b 45 08             	mov    0x8(%ebp),%eax
    2291:	8d 78 3c             	lea    0x3c(%eax),%edi
    2294:	83 ec 0c             	sub    $0xc,%esp
    2297:	83 ec 04             	sub    $0x4,%esp
    229a:	89 e0                	mov    %esp,%eax
    229c:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    22a0:	66 89 30             	mov    %si,(%eax)
    22a3:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    22a7:	88 50 02             	mov    %dl,0x2(%eax)
    22aa:	6a 32                	push   $0x32
    22ac:	6a 32                	push   $0x32
    22ae:	6a 00                	push   $0x0
    22b0:	6a 00                	push   $0x0
    22b2:	53                   	push   %ebx
    22b3:	51                   	push   %ecx
    ...
    22b7:	57                   	push   %edi
    22b8:	e8 63 f3 ff ff       	call   1620 <APDcCopy>
    22bd:	83 c4 30             	add    $0x30,%esp
                    break;
    22c0:	eb 01                	jmp    22c3 <APGridPaint+0x6e5>
                default: break;
    22c2:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    22c3:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    22c7:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    22cb:	0f 8e 1c fc ff ff    	jle    1eed <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    22d1:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    22d5:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    22d9:	0f 8e 02 fc ff ff    	jle    1ee1 <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    22df:	8d 45 88             	lea    -0x78(%ebp),%eax
    22e2:	68 cd 00 00 00       	push   $0xcd
    22e7:	6a 74                	push   $0x74
    22e9:	6a 18                	push   $0x18
    22eb:	50                   	push   %eax
    22ec:	e8 d3 f4 ff ff       	call   17c4 <RGB>
    22f1:	83 c4 0c             	add    $0xc,%esp
    22f4:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    22f8:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    22fc:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2300:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    2303:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    230a:	8d 45 88             	lea    -0x78(%ebp),%eax
    230d:	68 cd 00 00 00       	push   $0xcd
    2312:	6a 74                	push   $0x74
    2314:	6a 18                	push   $0x18
    2316:	50                   	push   %eax
    2317:	e8 a8 f4 ff ff       	call   17c4 <RGB>
    231c:	83 c4 0c             	add    $0xc,%esp
    231f:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2323:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    2327:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    232b:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    232e:	8b 45 08             	mov    0x8(%ebp),%eax
    2331:	8d 50 58             	lea    0x58(%eax),%edx
    2334:	8d 45 88             	lea    -0x78(%ebp),%eax
    2337:	ff 75 bc             	pushl  -0x44(%ebp)
    233a:	ff 75 b8             	pushl  -0x48(%ebp)
    233d:	52                   	push   %edx
    233e:	50                   	push   %eax
    233f:	e8 6d eb ff ff       	call   eb1 <APSetPen>
    2344:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    2347:	8b 45 08             	mov    0x8(%ebp),%eax
    234a:	8d 58 58             	lea    0x58(%eax),%ebx
    234d:	8d 55 88             	lea    -0x78(%ebp),%edx
    2350:	83 ec 04             	sub    $0x4,%esp
    2353:	83 ec 04             	sub    $0x4,%esp
    2356:	89 e0                	mov    %esp,%eax
    2358:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    235c:	66 89 08             	mov    %cx,(%eax)
    235f:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    2363:	88 48 02             	mov    %cl,0x2(%eax)
    2366:	53                   	push   %ebx
    2367:	52                   	push   %edx
    2368:	e8 7d eb ff ff       	call   eea <APSetBrush>
    236d:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    2370:	8b 45 08             	mov    0x8(%ebp),%eax
    2373:	83 c0 58             	add    $0x58,%eax
    2376:	83 ec 0c             	sub    $0xc,%esp
    2379:	6a 32                	push   $0x32
    237b:	68 20 03 00 00       	push   $0x320
    2380:	6a 00                	push   $0x0
    2382:	6a 00                	push   $0x0
    2384:	50                   	push   %eax
    2385:	e8 8a ef ff ff       	call   1314 <APDrawRect>
    238a:	83 c4 20             	add    $0x20,%esp


    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    238d:	8d 45 88             	lea    -0x78(%ebp),%eax
    2390:	6a 08                	push   $0x8
    2392:	6a 08                	push   $0x8
    2394:	6a 08                	push   $0x8
    2396:	50                   	push   %eax
    2397:	e8 28 f4 ff ff       	call   17c4 <RGB>
    239c:	83 c4 0c             	add    $0xc,%esp
    239f:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    23a3:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    23a7:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    23ab:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    23bf:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    23c3:	66 89 08             	mov    %cx,(%eax)
    23c6:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    23ca:	88 48 02             	mov    %cl,0x2(%eax)
    23cd:	53                   	push   %ebx
    23ce:	52                   	push   %edx
    23cf:	e8 58 eb ff ff       	call   f2c <APSetFont>
    23d4:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    23d7:	8b 45 08             	mov    0x8(%ebp),%eax
    23da:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    23e0:	8b 45 08             	mov    0x8(%ebp),%eax
    23e3:	83 c0 58             	add    $0x58,%eax
    23e6:	6a 14                	push   $0x14
    23e8:	6a 14                	push   $0x14
    23ea:	52                   	push   %edx
    23eb:	50                   	push   %eax
    23ec:	e8 28 f1 ff ff       	call   1519 <APDrawText>
