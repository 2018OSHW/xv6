...
fmtname(char *path)
{
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      9a:	05 d8 6c 00 00       	add    $0x6cd8,%eax
  ...
  return buf;
      ae:	b8 d8 6c 00 00       	mov    $0x6cd8,%eax
}
...
ls(char *path)
{
  ...
  if(fstat(fd, &st) < 0){
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     116:	68 a4 28 00 00       	push   $0x28a4
     11b:	6a 02                	push   $0x2
  ...
  case T_FILE:
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
     ...
     177:	53                   	push   %ebx
     178:	50                   	push   %eax
     179:	68 b8 28 00 00       	push   $0x28b8
     17e:	6a 01                	push   $0x1
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1a8:	68 c5 28 00 00       	push   $0x28c5
     1ad:	6a 01                	push   $0x1
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     25b:	50                   	push   %eax
     25c:	68 a4 28 00 00       	push   $0x28a4
     261:	6a 01                	push   $0x1
     ...
     29a:	53                   	push   %ebx
     29b:	50                   	push   %eax
     29c:	68 b8 28 00 00       	push   $0x28b8
     2a1:	6a 01                	push   $0x1
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     2fe:	68 d8 28 00 00       	push   $0x28d8
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6f8:	0f b6 80 80 30 00 00 	movzbl 0x3080(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     834:	75 25                	jne    85b <printf+0xff>
          s = "(null)";
     836:	c7 45 f4 da 28 00 00 	movl   $0x28da,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     8fc:	a1 00 6d 00 00       	mov    0x6d00,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     9c7:	a3 00 6d 00 00       	mov    %eax,0x6d00
}
     9cc:	90                   	nop
     9cd:	c9                   	leave  
     9ce:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     a28:	a1 00 6d 00 00       	mov    0x6d00,%eax
}
     a2d:	c9                   	leave  
     a2e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     a44:	a1 00 6d 00 00       	mov    0x6d00,%eax
     a49:	89 45 f0             	mov    %eax,-0x10(%ebp)
     a4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     a50:	75 23                	jne    a75 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     a52:	c7 45 f0 f8 6c 00 00 	movl   $0x6cf8,-0x10(%ebp)
     a59:	8b 45 f0             	mov    -0x10(%ebp),%eax
     a5c:	a3 00 6d 00 00       	mov    %eax,0x6d00
     a61:	a1 00 6d 00 00       	mov    0x6d00,%eax
     a66:	a3 f8 6c 00 00       	mov    %eax,0x6cf8
    base.s.size = 0;
     a6b:	c7 05 fc 6c 00 00 00 	movl   $0x0,0x6cfc
     a72:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     ac8:	a3 00 6d 00 00       	mov    %eax,0x6d00
      return (void*)(p + 1);
    ...
    if(p == freep)
     ad5:	a1 00 6d 00 00       	mov    0x6d00,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     c13:	79 2e                	jns    c43 <APLoadBitmap+0x61>
    {
     ...
     c1b:	68 e1 28 00 00       	push   $0x28e1
     c20:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    15bf:	05 a0 30 00 00       	add    $0x30a0,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    184c:	68 f4 28 00 00       	push   $0x28f4
    1851:	6a 01                	push   $0x1
    ...
    18c1:	68 14 29 00 00       	push   $0x2914
    18c6:	6a 01                	push   $0x1
    ...
    1965:	68 38 29 00 00       	push   $0x2938
    196a:	6a 01                	push   $0x1
    ...
    1a4a:	68 60 29 00 00       	push   $0x2960
    1a4f:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    1b33:	e8 c5 08 00 00       	call   23fd <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    1f29:	8b 40 08             	mov    0x8(%eax),%eax
    1f2c:	85 c0                	test   %eax,%eax
    1f2e:	75 17                	jne    1f47 <APGridPaint+0x2ff>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1f30:	83 ec 08             	sub    $0x8,%esp
    1f33:	68 10 2a 00 00       	push   $0x2a10
    1f38:	6a 01                	push   $0x1
    1f3a:	e8 1d e8 ff ff       	call   75c <printf>
    1f3f:	83 c4 10             	add    $0x10,%esp
        return;
    1f42:	e9 ae 04 00 00       	jmp    23f5 <APGridPaint+0x7ad>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1f47:	8b 45 08             	mov    0x8(%ebp),%eax
    1f4a:	8b 40 10             	mov    0x10(%eax),%eax
    1f4d:	85 c0                	test   %eax,%eax
    1f4f:	7e 10                	jle    1f61 <APGridPaint+0x319>
    1f51:	8b 45 08             	mov    0x8(%ebp),%eax
    1f54:	8b 50 14             	mov    0x14(%eax),%edx
    1f57:	8b 45 08             	mov    0x8(%ebp),%eax
    1f5a:	8b 40 10             	mov    0x10(%eax),%eax
    1f5d:	39 c2                	cmp    %eax,%edx
    1f5f:	7c 17                	jl     1f78 <APGridPaint+0x330>
    {
        printf(1,"Grid mode page error!");
    1f61:	83 ec 08             	sub    $0x8,%esp
    1f64:	68 36 2a 00 00       	push   $0x2a36
    1f69:	6a 01                	push   $0x1
    1f6b:	e8 ec e7 ff ff       	call   75c <printf>
    1f70:	83 c4 10             	add    $0x10,%esp
        return;
    1f73:	e9 7d 04 00 00       	jmp    23f5 <APGridPaint+0x7ad>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1f78:	8b 45 08             	mov    0x8(%ebp),%eax
    1f7b:	8b 40 14             	mov    0x14(%eax),%eax
    1f7e:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1f84:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1f87:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1f8a:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1f8d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1f94:	e9 52 04 00 00       	jmp    23eb <APGridPaint+0x7a3>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1f99:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1fa0:	e9 38 04 00 00       	jmp    23dd <APGridPaint+0x795>
        {
            index = start + GRID_W_NUMBER * j + i;
    1fa5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fa8:	c1 e0 04             	shl    $0x4,%eax
    1fab:	89 c2                	mov    %eax,%edx
    1fad:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1fb0:	01 c2                	add    %eax,%edx
    1fb2:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fb5:	01 d0                	add    %edx,%eax
    1fb7:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1fba:	8b 45 08             	mov    0x8(%ebp),%eax
    1fbd:	8b 40 0c             	mov    0xc(%eax),%eax
    1fc0:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1fc3:	c1 e2 02             	shl    $0x2,%edx
    1fc6:	01 d0                	add    %edx,%eax
    1fc8:	8b 00                	mov    (%eax),%eax
    1fca:	83 f8 0b             	cmp    $0xb,%eax
    1fcd:	0f 87 05 04 00 00    	ja     23d8 <APGridPaint+0x790>
    1fd3:	8b 04 85 4c 2a 00 00 	mov    0x2a4c(,%eax,4),%eax
    1fda:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fdc:	8d 45 bd             	lea    -0x43(%ebp),%eax
    1fdf:	6a 0c                	push   $0xc
    1fe1:	6a 0c                	push   $0xc
    1fe3:	6a 0c                	push   $0xc
    1fe5:	50                   	push   %eax
    1fe6:	e8 d9 f7 ff ff       	call   17c4 <RGB>
    1feb:	83 c4 0c             	add    $0xc,%esp
    1fee:	8b 1d 40 6d 00 00    	mov    0x6d40,%ebx
    1ff4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ff7:	6b c8 32             	imul   $0x32,%eax,%ecx
    1ffa:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1ffd:	6b c0 32             	imul   $0x32,%eax,%eax
    2000:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2003:	8b 45 08             	mov    0x8(%ebp),%eax
    2006:	8d 78 3c             	lea    0x3c(%eax),%edi
    2009:	83 ec 0c             	sub    $0xc,%esp
    200c:	83 ec 04             	sub    $0x4,%esp
    200f:	89 e0                	mov    %esp,%eax
    2011:	0f b7 75 bd          	movzwl -0x43(%ebp),%esi
    2015:	66 89 30             	mov    %si,(%eax)
    2018:	0f b6 55 bf          	movzbl -0x41(%ebp),%edx
    201c:	88 50 02             	mov    %dl,0x2(%eax)
    201f:	6a 32                	push   $0x32
    2021:	6a 32                	push   $0x32
    2023:	6a 00                	push   $0x0
    2025:	6a 00                	push   $0x0
    2027:	53                   	push   %ebx
    2028:	51                   	push   %ecx
    2029:	ff 75 94             	pushl  -0x6c(%ebp)
    202c:	57                   	push   %edi
    202d:	e8 ee f5 ff ff       	call   1620 <APDcCopy>
    2032:	83 c4 30             	add    $0x30,%esp
                    break;
    2035:	e9 9f 03 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    203a:	8d 45 98             	lea    -0x68(%ebp),%eax
    203d:	6a 69                	push   $0x69
    203f:	6a 69                	push   $0x69
    2041:	6a 69                	push   $0x69
    2043:	50                   	push   %eax
    2044:	e8 7b f7 ff ff       	call   17c4 <RGB>
    2049:	83 c4 0c             	add    $0xc,%esp
    204c:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    2050:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    2054:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    2058:	88 45 b6             	mov    %al,-0x4a(%ebp)
                    pen.size = 1;
    205b:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    2062:	8d 45 98             	lea    -0x68(%ebp),%eax
    2065:	6a 69                	push   $0x69
    2067:	6a 69                	push   $0x69
    2069:	6a 69                	push   $0x69
    206b:	50                   	push   %eax
    206c:	e8 53 f7 ff ff       	call   17c4 <RGB>
    2071:	83 c4 0c             	add    $0xc,%esp
    2074:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    2078:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    207c:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    2080:	88 45 b3             	mov    %al,-0x4d(%ebp)
                    APSetPen(&wnd->Dc,pen);
    2083:	8b 45 08             	mov    0x8(%ebp),%eax
    2086:	8d 50 3c             	lea    0x3c(%eax),%edx
    2089:	8d 45 98             	lea    -0x68(%ebp),%eax
    208c:	ff 75 b8             	pushl  -0x48(%ebp)
    208f:	ff 75 b4             	pushl  -0x4c(%ebp)
    2092:	52                   	push   %edx
    2093:	50                   	push   %eax
    2094:	e8 18 ee ff ff       	call   eb1 <APSetPen>
    2099:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    209c:	8b 45 08             	mov    0x8(%ebp),%eax
    209f:	8d 58 3c             	lea    0x3c(%eax),%ebx
    20a2:	8d 55 98             	lea    -0x68(%ebp),%edx
    20a5:	83 ec 04             	sub    $0x4,%esp
    20a8:	83 ec 04             	sub    $0x4,%esp
    20ab:	89 e0                	mov    %esp,%eax
    20ad:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    20b1:	66 89 08             	mov    %cx,(%eax)
    20b4:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    20b8:	88 48 02             	mov    %cl,0x2(%eax)
    20bb:	53                   	push   %ebx
    20bc:	52                   	push   %edx
    20bd:	e8 28 ee ff ff       	call   eea <APSetBrush>
    20c2:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    20c5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20c8:	6b d0 32             	imul   $0x32,%eax,%edx
    20cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20ce:	6b c0 32             	imul   $0x32,%eax,%eax
    20d1:	8b 4d 08             	mov    0x8(%ebp),%ecx
    20d4:	83 c1 3c             	add    $0x3c,%ecx
    ...
    20df:	50                   	push   %eax
    20e0:	51                   	push   %ecx
    20e1:	e8 2e f2 ff ff       	call   1314 <APDrawRect>
    20e6:	83 c4 20             	add    $0x20,%esp
                    break;
    20e9:	e9 eb 02 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    20ee:	8d 45 c0             	lea    -0x40(%ebp),%eax
    20f1:	6a 0c                	push   $0xc
    20f3:	6a 0c                	push   $0xc
    20f5:	6a 0c                	push   $0xc
    20f7:	50                   	push   %eax
    20f8:	e8 c7 f6 ff ff       	call   17c4 <RGB>
    20fd:	83 c4 0c             	add    $0xc,%esp
    2100:	8b 1d 94 6d 00 00    	mov    0x6d94,%ebx
    2106:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2109:	6b c8 32             	imul   $0x32,%eax,%ecx
    210c:	8b 45 e0             	mov    -0x20(%ebp),%eax
    210f:	6b c0 32             	imul   $0x32,%eax,%eax
    2112:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2115:	8b 45 08             	mov    0x8(%ebp),%eax
    2118:	8d 78 3c             	lea    0x3c(%eax),%edi
    211b:	83 ec 0c             	sub    $0xc,%esp
    211e:	83 ec 04             	sub    $0x4,%esp
    2121:	89 e0                	mov    %esp,%eax
    2123:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    2127:	66 89 30             	mov    %si,(%eax)
    212a:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    212e:	88 50 02             	mov    %dl,0x2(%eax)
    2131:	6a 32                	push   $0x32
    2133:	6a 32                	push   $0x32
    2135:	6a 00                	push   $0x0
    2137:	6a 00                	push   $0x0
    2139:	53                   	push   %ebx
    213a:	51                   	push   %ecx
    213b:	ff 75 94             	pushl  -0x6c(%ebp)
    213e:	57                   	push   %edi
    213f:	e8 dc f4 ff ff       	call   1620 <APDcCopy>
    2144:	83 c4 30             	add    $0x30,%esp
                    break;
    2147:	e9 8d 02 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    214c:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    214f:	6a 0c                	push   $0xc
    2151:	6a 0c                	push   $0xc
    2153:	6a 0c                	push   $0xc
    2155:	50                   	push   %eax
    2156:	e8 69 f6 ff ff       	call   17c4 <RGB>
    215b:	83 c4 0c             	add    $0xc,%esp
    215e:	8b 1d 70 6d 00 00    	mov    0x6d70,%ebx
    2164:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2167:	6b c8 32             	imul   $0x32,%eax,%ecx
    216a:	8b 45 e0             	mov    -0x20(%ebp),%eax
    216d:	6b c0 32             	imul   $0x32,%eax,%eax
    2170:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2173:	8b 45 08             	mov    0x8(%ebp),%eax
    2176:	8d 78 3c             	lea    0x3c(%eax),%edi
    2179:	83 ec 0c             	sub    $0xc,%esp
    217c:	83 ec 04             	sub    $0x4,%esp
    217f:	89 e0                	mov    %esp,%eax
    2181:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    2185:	66 89 30             	mov    %si,(%eax)
    2188:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    218c:	88 50 02             	mov    %dl,0x2(%eax)
    218f:	6a 32                	push   $0x32
    2191:	6a 32                	push   $0x32
    2193:	6a 00                	push   $0x0
    2195:	6a 00                	push   $0x0
    2197:	53                   	push   %ebx
    2198:	51                   	push   %ecx
    2199:	ff 75 94             	pushl  -0x6c(%ebp)
    219c:	57                   	push   %edi
    219d:	e8 7e f4 ff ff       	call   1620 <APDcCopy>
    21a2:	83 c4 30             	add    $0x30,%esp
                    break;
    21a5:	e9 2f 02 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    21aa:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    21ad:	6a 0c                	push   $0xc
    21af:	6a 0c                	push   $0xc
    21b1:	6a 0c                	push   $0xc
    21b3:	50                   	push   %eax
    21b4:	e8 0b f6 ff ff       	call   17c4 <RGB>
    21b9:	83 c4 0c             	add    $0xc,%esp
    21bc:	8b 1d 44 6d 00 00    	mov    0x6d44,%ebx
    21c2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    21c5:	6b c8 32             	imul   $0x32,%eax,%ecx
    21c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
    21cb:	6b c0 32             	imul   $0x32,%eax,%eax
    21ce:	89 45 94             	mov    %eax,-0x6c(%ebp)
    21d1:	8b 45 08             	mov    0x8(%ebp),%eax
    21d4:	8d 78 3c             	lea    0x3c(%eax),%edi
    21d7:	83 ec 0c             	sub    $0xc,%esp
    21da:	83 ec 04             	sub    $0x4,%esp
    21dd:	89 e0                	mov    %esp,%eax
    21df:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    21e3:	66 89 30             	mov    %si,(%eax)
    21e6:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    21ea:	88 50 02             	mov    %dl,0x2(%eax)
    21ed:	6a 32                	push   $0x32
    21ef:	6a 32                	push   $0x32
    21f1:	6a 00                	push   $0x0
    21f3:	6a 00                	push   $0x0
    21f5:	53                   	push   %ebx
    21f6:	51                   	push   %ecx
    21f7:	ff 75 94             	pushl  -0x6c(%ebp)
    21fa:	57                   	push   %edi
    21fb:	e8 20 f4 ff ff       	call   1620 <APDcCopy>
    2200:	83 c4 30             	add    $0x30,%esp
                    break;
    2203:	e9 d1 01 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2208:	8d 45 c9             	lea    -0x37(%ebp),%eax
    220b:	6a 0c                	push   $0xc
    220d:	6a 0c                	push   $0xc
    220f:	6a 0c                	push   $0xc
    2211:	50                   	push   %eax
    2212:	e8 ad f5 ff ff       	call   17c4 <RGB>
    2217:	83 c4 0c             	add    $0xc,%esp
    221a:	8b 1d 90 6d 00 00    	mov    0x6d90,%ebx
    2220:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2223:	6b c8 32             	imul   $0x32,%eax,%ecx
    2226:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2229:	6b c0 32             	imul   $0x32,%eax,%eax
    222c:	89 45 94             	mov    %eax,-0x6c(%ebp)
    222f:	8b 45 08             	mov    0x8(%ebp),%eax
    2232:	8d 78 3c             	lea    0x3c(%eax),%edi
    2235:	83 ec 0c             	sub    $0xc,%esp
    2238:	83 ec 04             	sub    $0x4,%esp
    223b:	89 e0                	mov    %esp,%eax
    223d:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    2241:	66 89 30             	mov    %si,(%eax)
    2244:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    2248:	88 50 02             	mov    %dl,0x2(%eax)
    224b:	6a 32                	push   $0x32
    224d:	6a 32                	push   $0x32
    224f:	6a 00                	push   $0x0
    2251:	6a 00                	push   $0x0
    2253:	53                   	push   %ebx
    2254:	51                   	push   %ecx
    2255:	ff 75 94             	pushl  -0x6c(%ebp)
    2258:	57                   	push   %edi
    2259:	e8 c2 f3 ff ff       	call   1620 <APDcCopy>
    225e:	83 c4 30             	add    $0x30,%esp
                    break;
    2261:	e9 73 01 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2266:	8d 45 cc             	lea    -0x34(%ebp),%eax
    2269:	6a 0c                	push   $0xc
    226b:	6a 0c                	push   $0xc
    226d:	6a 0c                	push   $0xc
    226f:	50                   	push   %eax
    2270:	e8 4f f5 ff ff       	call   17c4 <RGB>
    2275:	83 c4 0c             	add    $0xc,%esp
    2278:	8b 1d 08 6d 00 00    	mov    0x6d08,%ebx
    227e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2281:	6b c8 32             	imul   $0x32,%eax,%ecx
    2284:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2287:	6b c0 32             	imul   $0x32,%eax,%eax
    228a:	89 45 94             	mov    %eax,-0x6c(%ebp)
    228d:	8b 45 08             	mov    0x8(%ebp),%eax
    2290:	8d 78 3c             	lea    0x3c(%eax),%edi
    2293:	83 ec 0c             	sub    $0xc,%esp
    2296:	83 ec 04             	sub    $0x4,%esp
    2299:	89 e0                	mov    %esp,%eax
    229b:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    229f:	66 89 30             	mov    %si,(%eax)
    22a2:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    22a6:	88 50 02             	mov    %dl,0x2(%eax)
    22a9:	6a 32                	push   $0x32
    22ab:	6a 32                	push   $0x32
    22ad:	6a 00                	push   $0x0
    22af:	6a 00                	push   $0x0
    22b1:	53                   	push   %ebx
    22b2:	51                   	push   %ecx
    22b3:	ff 75 94             	pushl  -0x6c(%ebp)
    22b6:	57                   	push   %edi
    22b7:	e8 64 f3 ff ff       	call   1620 <APDcCopy>
    22bc:	83 c4 30             	add    $0x30,%esp
                    break;
    22bf:	e9 15 01 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    22c4:	8d 45 cf             	lea    -0x31(%ebp),%eax
    22c7:	6a 0c                	push   $0xc
    22c9:	6a 0c                	push   $0xc
    22cb:	6a 0c                	push   $0xc
    22cd:	50                   	push   %eax
    22ce:	e8 f1 f4 ff ff       	call   17c4 <RGB>
    22d3:	83 c4 0c             	add    $0xc,%esp
    22d6:	8b 1d 30 6d 00 00    	mov    0x6d30,%ebx
    22dc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    22df:	6b c8 32             	imul   $0x32,%eax,%ecx
    22e2:	8b 45 e0             	mov    -0x20(%ebp),%eax
    22e5:	6b c0 32             	imul   $0x32,%eax,%eax
    22e8:	89 45 94             	mov    %eax,-0x6c(%ebp)
    22eb:	8b 45 08             	mov    0x8(%ebp),%eax
    22ee:	8d 78 3c             	lea    0x3c(%eax),%edi
    22f1:	83 ec 0c             	sub    $0xc,%esp
    22f4:	83 ec 04             	sub    $0x4,%esp
    22f7:	89 e0                	mov    %esp,%eax
    22f9:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    22fd:	66 89 30             	mov    %si,(%eax)
    2300:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2304:	88 50 02             	mov    %dl,0x2(%eax)
    2307:	6a 32                	push   $0x32
    2309:	6a 32                	push   $0x32
    230b:	6a 00                	push   $0x0
    230d:	6a 00                	push   $0x0
    230f:	53                   	push   %ebx
    2310:	51                   	push   %ecx
    2311:	ff 75 94             	pushl  -0x6c(%ebp)
    2314:	57                   	push   %edi
    2315:	e8 06 f3 ff ff       	call   1620 <APDcCopy>
    231a:	83 c4 30             	add    $0x30,%esp
                    break;
    231d:	e9 b7 00 00 00       	jmp    23d9 <APGridPaint+0x791>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2322:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2325:	6a 0c                	push   $0xc
    2327:	6a 0c                	push   $0xc
    2329:	6a 0c                	push   $0xc
    232b:	50                   	push   %eax
    232c:	e8 93 f4 ff ff       	call   17c4 <RGB>
    2331:	83 c4 0c             	add    $0xc,%esp
    2334:	8b 1d 8c 6d 00 00    	mov    0x6d8c,%ebx
    233a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    233d:	6b c8 32             	imul   $0x32,%eax,%ecx
    2340:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2343:	6b c0 32             	imul   $0x32,%eax,%eax
    2346:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2349:	8b 45 08             	mov    0x8(%ebp),%eax
    234c:	8d 78 3c             	lea    0x3c(%eax),%edi
    234f:	83 ec 0c             	sub    $0xc,%esp
    2352:	83 ec 04             	sub    $0x4,%esp
    2355:	89 e0                	mov    %esp,%eax
    2357:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    235b:	66 89 30             	mov    %si,(%eax)
    235e:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2362:	88 50 02             	mov    %dl,0x2(%eax)
    2365:	6a 32                	push   $0x32
    2367:	6a 32                	push   $0x32
    2369:	6a 00                	push   $0x0
    236b:	6a 00                	push   $0x0
    236d:	53                   	push   %ebx
    236e:	51                   	push   %ecx
    236f:	ff 75 94             	pushl  -0x6c(%ebp)
    2372:	57                   	push   %edi
    2373:	e8 a8 f2 ff ff       	call   1620 <APDcCopy>
    2378:	83 c4 30             	add    $0x30,%esp
                    break;
    237b:	eb 5c                	jmp    23d9 <APGridPaint+0x791>
                case GRID_PROGRAM_TOWER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_tower,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    237d:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    2380:	6a 0c                	push   $0xc
    2382:	6a 0c                	push   $0xc
    2384:	6a 0c                	push   $0xc
    2386:	50                   	push   %eax
    2387:	e8 38 f4 ff ff       	call   17c4 <RGB>
    238c:	83 c4 0c             	add    $0xc,%esp
    238f:	8b 1d 48 6d 00 00    	mov    0x6d48,%ebx
    2395:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2398:	6b c8 32             	imul   $0x32,%eax,%ecx
    239b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    239e:	6b c0 32             	imul   $0x32,%eax,%eax
    23a1:	89 45 94             	mov    %eax,-0x6c(%ebp)
    23a4:	8b 45 08             	mov    0x8(%ebp),%eax
    23a7:	8d 78 3c             	lea    0x3c(%eax),%edi
    23aa:	83 ec 0c             	sub    $0xc,%esp
    23ad:	83 ec 04             	sub    $0x4,%esp
    23b0:	89 e0                	mov    %esp,%eax
    23b2:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    23b6:	66 89 30             	mov    %si,(%eax)
    23b9:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    23bd:	88 50 02             	mov    %dl,0x2(%eax)
    23c0:	6a 32                	push   $0x32
    23c2:	6a 32                	push   $0x32
    23c4:	6a 00                	push   $0x0
    23c6:	6a 00                	push   $0x0
    23c8:	53                   	push   %ebx
    23c9:	51                   	push   %ecx
    23ca:	ff 75 94             	pushl  -0x6c(%ebp)
    23cd:	57                   	push   %edi
    23ce:	e8 4d f2 ff ff       	call   1620 <APDcCopy>
    23d3:	83 c4 30             	add    $0x30,%esp
                    break;
    23d6:	eb 01                	jmp    23d9 <APGridPaint+0x791>
                default: break;
    23d8:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    23d9:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    23dd:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    23e1:	0f 8e be fb ff ff    	jle    1fa5 <APGridPaint+0x35d>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    23e7:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    23eb:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    23ef:	0f 8e a4 fb ff ff    	jle    1f99 <APGridPaint+0x351>
                    break;
                default: break;
            }
        }
...
void updateword(AHwnd hwnd,char* str)
{
    ...
    2400:	53                   	push   %ebx
    2401:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    2404:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2407:	68 cd 00 00 00       	push   $0xcd
    240c:	6a 74                	push   $0x74
    240e:	6a 18                	push   $0x18
    2410:	50                   	push   %eax
    2411:	e8 ae f3 ff ff       	call   17c4 <RGB>
    2416:	83 c4 0c             	add    $0xc,%esp
    2419:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    241d:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    2421:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2425:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    2428:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    242f:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2432:	68 cd 00 00 00       	push   $0xcd
    2437:	6a 74                	push   $0x74
    2439:	6a 18                	push   $0x18
    243b:	50                   	push   %eax
    243c:	e8 83 f3 ff ff       	call   17c4 <RGB>
    2441:	83 c4 0c             	add    $0xc,%esp
    2444:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2448:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    244c:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2450:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    2453:	8b 45 08             	mov    0x8(%ebp),%eax
    2456:	8d 50 58             	lea    0x58(%eax),%edx
    2459:	8d 45 d8             	lea    -0x28(%ebp),%eax
    245c:	ff 75 f4             	pushl  -0xc(%ebp)
    245f:	ff 75 f0             	pushl  -0x10(%ebp)
    2462:	52                   	push   %edx
    2463:	50                   	push   %eax
    2464:	e8 48 ea ff ff       	call   eb1 <APSetPen>
    2469:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    246c:	8b 45 08             	mov    0x8(%ebp),%eax
    246f:	8d 58 58             	lea    0x58(%eax),%ebx
    2472:	8d 55 d8             	lea    -0x28(%ebp),%edx
    2475:	83 ec 04             	sub    $0x4,%esp
    2478:	83 ec 04             	sub    $0x4,%esp
    247b:	89 e0                	mov    %esp,%eax
    247d:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    2481:	66 89 08             	mov    %cx,(%eax)
    2484:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    2488:	88 48 02             	mov    %cl,0x2(%eax)
    248b:	53                   	push   %ebx
    248c:	52                   	push   %edx
    248d:	e8 58 ea ff ff       	call   eea <APSetBrush>
    2492:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    2495:	8b 45 08             	mov    0x8(%ebp),%eax
    2498:	83 c0 58             	add    $0x58,%eax
    249b:	83 ec 0c             	sub    $0xc,%esp
    249e:	6a 32                	push   $0x32
    24a0:	68 20 03 00 00       	push   $0x320
    24a5:	6a 00                	push   $0x0
    24a7:	6a 00                	push   $0x0
    24a9:	50                   	push   %eax
    24aa:	e8 65 ee ff ff       	call   1314 <APDrawRect>
    24af:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    24b2:	8d 45 d8             	lea    -0x28(%ebp),%eax
    24b5:	6a 08                	push   $0x8
    24b7:	6a 08                	push   $0x8
    24b9:	6a 08                	push   $0x8
    24bb:	50                   	push   %eax
    24bc:	e8 03 f3 ff ff       	call   17c4 <RGB>
    24c1:	83 c4 0c             	add    $0xc,%esp
    24c4:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    24c8:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    24cc:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    24d0:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    24d3:	8b 45 08             	mov    0x8(%ebp),%eax
    24d6:	8d 58 58             	lea    0x58(%eax),%ebx
    24d9:	8d 55 d8             	lea    -0x28(%ebp),%edx
    24dc:	83 ec 04             	sub    $0x4,%esp
    24df:	83 ec 04             	sub    $0x4,%esp
    24e2:	89 e0                	mov    %esp,%eax
    24e4:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    24e8:	66 89 08             	mov    %cx,(%eax)
    24eb:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    24ef:	88 48 02             	mov    %cl,0x2(%eax)
    24f2:	53                   	push   %ebx
    24f3:	52                   	push   %edx
    24f4:	e8 33 ea ff ff       	call   f2c <APSetFont>
    24f9:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    24fc:	8b 45 08             	mov    0x8(%ebp),%eax
    24ff:	83 c0 58             	add    $0x58,%eax
    2502:	6a 14                	push   $0x14
    2504:	6a 0a                	push   $0xa
    2506:	ff 75 0c             	pushl  0xc(%ebp)
    2509:	50                   	push   %eax
    250a:	e8 0a f0 ff ff       	call   1519 <APDrawText>
    250f:	83 c4 10             	add    $0x10,%esp
}
    2512:	90                   	nop
    2513:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2516:	c9                   	leave  
    2517:	c3                   	ret    
...
{
    2518:	55                   	push   %ebp
    2519:	89 e5                	mov    %esp,%ebp
static int rand_num = 3;
if (seed > 0)
    251b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    251f:	7e 08                	jle    2529 <random+0x11>
{
rand_num = seed;
    2521:	8b 45 08             	mov    0x8(%ebp),%eax
    2524:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
}
rand_num *= 3;
    2529:	8b 15 c0 6c 00 00    	mov    0x6cc0,%edx
    252f:	89 d0                	mov    %edx,%eax
    2531:	01 c0                	add    %eax,%eax
    2533:	01 d0                	add    %edx,%eax
    2535:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
if (rand_num < 0)
    253a:	a1 c0 6c 00 00       	mov    0x6cc0,%eax
    253f:	85 c0                	test   %eax,%eax
    2541:	79 0c                	jns    254f <random+0x37>
{
rand_num *= (-1);
    2543:	a1 c0 6c 00 00       	mov    0x6cc0,%eax
    2548:	f7 d8                	neg    %eax
    254a:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
}
return rand_num % 997;
    254f:	8b 0d c0 6c 00 00    	mov    0x6cc0,%ecx
    2555:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    255a:	89 c8                	mov    %ecx,%eax
    255c:	f7 ea                	imul   %edx
    255e:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    2561:	c1 f8 09             	sar    $0x9,%eax
    2564:	89 c2                	mov    %eax,%edx
    2566:	89 c8                	mov    %ecx,%eax
    2568:	c1 f8 1f             	sar    $0x1f,%eax
    256b:	29 c2                	sub    %eax,%edx
    256d:	89 d0                	mov    %edx,%eax
    256f:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    2575:	29 c1                	sub    %eax,%ecx
    2577:	89 c8                	mov    %ecx,%eax
}
    2579:	5d                   	pop    %ebp
    257a:	c3                   	ret    
...
{
    257b:	55                   	push   %ebp
    257c:	89 e5                	mov    %esp,%ebp
    257e:	53                   	push   %ebx
    257f:	83 ec 20             	sub    $0x20,%esp
    static char digits[] = "0123456789ABCDEF";
    char buf[16];
    int i, neg;
    uint x;
    ...
    if(sgn && xx < 0){
    2589:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    258d:	74 17                	je     25a6 <sprintint+0x2b>
    258f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    2593:	79 11                	jns    25a6 <sprintint+0x2b>
        neg = 1;
    2595:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    259c:	8b 45 10             	mov    0x10(%ebp),%eax
    259f:	f7 d8                	neg    %eax
    25a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    25a4:	eb 06                	jmp    25ac <sprintint+0x31>
    } else {
        x = xx;
    25a6:	8b 45 10             	mov    0x10(%ebp),%eax
    25a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    25ac:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    25b3:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    25b6:	8d 41 01             	lea    0x1(%ecx),%eax
    25b9:	89 45 f8             	mov    %eax,-0x8(%ebp)
    25bc:	8b 5d 14             	mov    0x14(%ebp),%ebx
    25bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    25c2:	ba 00 00 00 00       	mov    $0x0,%edx
    25c7:	f7 f3                	div    %ebx
    25c9:	89 d0                	mov    %edx,%eax
    25cb:	0f b6 80 c4 6c 00 00 	movzbl 0x6cc4(%eax),%eax
    25d2:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    25d6:	8b 5d 14             	mov    0x14(%ebp),%ebx
    25d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    25dc:	ba 00 00 00 00       	mov    $0x0,%edx
    25e1:	f7 f3                	div    %ebx
    25e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    25e6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    25ea:	75 c7                	jne    25b3 <sprintint+0x38>
    if(neg)
    25ec:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    25f0:	74 0e                	je     2600 <sprintint+0x85>
        buf[i++] = '-';
    25f2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    25f5:	8d 50 01             	lea    0x1(%eax),%edx
    25f8:	89 55 f8             	mov    %edx,-0x8(%ebp)
    25fb:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    2600:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2603:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2606:	eb 1b                	jmp    2623 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2608:	8b 45 0c             	mov    0xc(%ebp),%eax
    260b:	8b 00                	mov    (%eax),%eax
    260d:	8d 48 01             	lea    0x1(%eax),%ecx
    2610:	8b 55 0c             	mov    0xc(%ebp),%edx
    2613:	89 0a                	mov    %ecx,(%edx)
    2615:	89 c2                	mov    %eax,%edx
    2617:	8b 45 08             	mov    0x8(%ebp),%eax
    261a:	01 d0                	add    %edx,%eax
    261c:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    261f:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2623:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2627:	7f df                	jg     2608 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2629:	eb 21                	jmp    264c <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    262b:	8b 45 0c             	mov    0xc(%ebp),%eax
    262e:	8b 00                	mov    (%eax),%eax
    2630:	8d 48 01             	lea    0x1(%eax),%ecx
    2633:	8b 55 0c             	mov    0xc(%ebp),%edx
    2636:	89 0a                	mov    %ecx,(%edx)
    2638:	89 c2                	mov    %eax,%edx
    263a:	8b 45 08             	mov    0x8(%ebp),%eax
    263d:	01 c2                	add    %eax,%edx
    263f:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2642:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2645:	01 c8                	add    %ecx,%eax
    2647:	0f b6 00             	movzbl (%eax),%eax
    264a:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    264c:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2650:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2654:	79 d5                	jns    262b <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2656:	90                   	nop
    2657:	83 c4 20             	add    $0x20,%esp
    265a:	5b                   	pop    %ebx
    265b:	5d                   	pop    %ebp
    265c:	c3                   	ret    
...
{
    265d:	55                   	push   %ebp
    265e:	89 e5                	mov    %esp,%ebp
    2660:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    2663:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    266a:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2671:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    2678:	8d 45 0c             	lea    0xc(%ebp),%eax
    267b:	83 c0 04             	add    $0x4,%eax
    267e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2681:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    2688:	e9 d9 01 00 00       	jmp    2866 <sprintf+0x209>
        c = fmt[i] & 0xff;
    268d:	8b 55 0c             	mov    0xc(%ebp),%edx
    2690:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2693:	01 d0                	add    %edx,%eax
    2695:	0f b6 00             	movzbl (%eax),%eax
    2698:	0f be c0             	movsbl %al,%eax
    269b:	25 ff 00 00 00       	and    $0xff,%eax
    26a0:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    26a3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    26a7:	75 2c                	jne    26d5 <sprintf+0x78>
            if(c == '%'){
    26a9:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    26ad:	75 0c                	jne    26bb <sprintf+0x5e>
                state = '%';
    26af:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    26b6:	e9 a7 01 00 00       	jmp    2862 <sprintf+0x205>
            } else {
                dst[j++] = c;
    ...
    26cb:	8b 55 e0             	mov    -0x20(%ebp),%edx
    26ce:	88 10                	mov    %dl,(%eax)
    26d0:	e9 8d 01 00 00       	jmp    2862 <sprintf+0x205>
            }
        } else if(state == '%'){
    26d5:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    26d9:	0f 85 83 01 00 00    	jne    2862 <sprintf+0x205>
            if(c == 'd'){
    26df:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    26e3:	75 4c                	jne    2731 <sprintf+0xd4>
                buf[bi] = '\0';
    26e5:	8d 55 ce             	lea    -0x32(%ebp),%edx
    26e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    26eb:	01 d0                	add    %edx,%eax
    26ed:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    26f0:	83 ec 0c             	sub    $0xc,%esp
    26f3:	8d 45 ce             	lea    -0x32(%ebp),%eax
    26f6:	50                   	push   %eax
    26f7:	e8 0f de ff ff       	call   50b <atoi>
    26fc:	83 c4 10             	add    $0x10,%esp
    26ff:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2702:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2709:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    270c:	8b 00                	mov    (%eax),%eax
    270e:	83 ec 08             	sub    $0x8,%esp
    2711:	ff 75 d8             	pushl  -0x28(%ebp)
    2714:	6a 01                	push   $0x1
    2716:	6a 0a                	push   $0xa
    2718:	50                   	push   %eax
    2719:	8d 45 c8             	lea    -0x38(%ebp),%eax
    271c:	50                   	push   %eax
    271d:	ff 75 08             	pushl  0x8(%ebp)
    2720:	e8 56 fe ff ff       	call   257b <sprintint>
    2725:	83 c4 20             	add    $0x20,%esp
                ap++;
    2728:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    272c:	e9 2a 01 00 00       	jmp    285b <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2731:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2735:	74 06                	je     273d <sprintf+0xe0>
    2737:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    273b:	75 4c                	jne    2789 <sprintf+0x12c>
                buf[bi] = '\0';
    273d:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2740:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2743:	01 d0                	add    %edx,%eax
    2745:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2748:	83 ec 0c             	sub    $0xc,%esp
    274b:	8d 45 ce             	lea    -0x32(%ebp),%eax
    274e:	50                   	push   %eax
    274f:	e8 b7 dd ff ff       	call   50b <atoi>
    2754:	83 c4 10             	add    $0x10,%esp
    2757:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    275a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2761:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2764:	8b 00                	mov    (%eax),%eax
    2766:	83 ec 08             	sub    $0x8,%esp
    2769:	ff 75 dc             	pushl  -0x24(%ebp)
    276c:	6a 00                	push   $0x0
    276e:	6a 10                	push   $0x10
    2770:	50                   	push   %eax
    2771:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2774:	50                   	push   %eax
    2775:	ff 75 08             	pushl  0x8(%ebp)
    2778:	e8 fe fd ff ff       	call   257b <sprintint>
    277d:	83 c4 20             	add    $0x20,%esp
                ap++;
    2780:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2784:	e9 d2 00 00 00       	jmp    285b <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    2789:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    278d:	75 46                	jne    27d5 <sprintf+0x178>
                s = (char*)*ap;
    278f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2792:	8b 00                	mov    (%eax),%eax
    2794:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    2797:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    279b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    279f:	75 25                	jne    27c6 <sprintf+0x169>
                    s = "(null)";
    27a1:	c7 45 f4 7c 2a 00 00 	movl   $0x2a7c,-0xc(%ebp)
                while(*s != 0){
    27a8:	eb 1c                	jmp    27c6 <sprintf+0x169>
                    dst[j++] = *s;
    27aa:	8b 45 c8             	mov    -0x38(%ebp),%eax
    27ad:	8d 50 01             	lea    0x1(%eax),%edx
    27b0:	89 55 c8             	mov    %edx,-0x38(%ebp)
    27b3:	89 c2                	mov    %eax,%edx
    27b5:	8b 45 08             	mov    0x8(%ebp),%eax
    27b8:	01 c2                	add    %eax,%edx
    27ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    27bd:	0f b6 00             	movzbl (%eax),%eax
    27c0:	88 02                	mov    %al,(%edx)
                    s++;
    27c2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    27c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    27c9:	0f b6 00             	movzbl (%eax),%eax
    27cc:	84 c0                	test   %al,%al
    27ce:	75 da                	jne    27aa <sprintf+0x14d>
    27d0:	e9 86 00 00 00       	jmp    285b <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    27d5:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    27d9:	75 1d                	jne    27f8 <sprintf+0x19b>
                dst[j++] = *ap;
    27db:	8b 45 c8             	mov    -0x38(%ebp),%eax
    27de:	8d 50 01             	lea    0x1(%eax),%edx
    27e1:	89 55 c8             	mov    %edx,-0x38(%ebp)
    27e4:	89 c2                	mov    %eax,%edx
    27e6:	8b 45 08             	mov    0x8(%ebp),%eax
    27e9:	01 c2                	add    %eax,%edx
    27eb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    27ee:	8b 00                	mov    (%eax),%eax
    27f0:	88 02                	mov    %al,(%edx)
                ap++;
    27f2:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    27f6:	eb 63                	jmp    285b <sprintf+0x1fe>
            } else if(c == '%'){
    27f8:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    27fc:	75 17                	jne    2815 <sprintf+0x1b8>
                dst[j++] = c;
    27fe:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2801:	8d 50 01             	lea    0x1(%eax),%edx
    2804:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2807:	89 c2                	mov    %eax,%edx
    2809:	8b 45 08             	mov    0x8(%ebp),%eax
    280c:	01 d0                	add    %edx,%eax
    280e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2811:	88 10                	mov    %dl,(%eax)
    2813:	eb 46                	jmp    285b <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2815:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2819:	7e 18                	jle    2833 <sprintf+0x1d6>
    281b:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    281f:	7f 12                	jg     2833 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2821:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2824:	8d 50 01             	lea    0x1(%eax),%edx
    2827:	89 55 f0             	mov    %edx,-0x10(%ebp)
    282a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    282d:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2831:	eb 2f                	jmp    2862 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2833:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2836:	8d 50 01             	lea    0x1(%eax),%edx
    2839:	89 55 c8             	mov    %edx,-0x38(%ebp)
    283c:	89 c2                	mov    %eax,%edx
    283e:	8b 45 08             	mov    0x8(%ebp),%eax
    2841:	01 d0                	add    %edx,%eax
    2843:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    2846:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2849:	8d 50 01             	lea    0x1(%eax),%edx
    284c:	89 55 c8             	mov    %edx,-0x38(%ebp)
    284f:	89 c2                	mov    %eax,%edx
    2851:	8b 45 08             	mov    0x8(%ebp),%eax
    2854:	01 d0                	add    %edx,%eax
    2856:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2859:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    285b:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2862:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2866:	8b 55 0c             	mov    0xc(%ebp),%edx
    2869:	8b 45 ec             	mov    -0x14(%ebp),%eax
    286c:	01 d0                	add    %edx,%eax
    286e:	0f b6 00             	movzbl (%eax),%eax
    2871:	84 c0                	test   %al,%al
    2873:	0f 85 14 fe ff ff    	jne    268d <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    2879:	8b 45 c8             	mov    -0x38(%ebp),%eax
    287c:	8d 50 01             	lea    0x1(%eax),%edx
    287f:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2882:	89 c2                	mov    %eax,%edx
    2884:	8b 45 08             	mov    0x8(%ebp),%eax
    2887:	01 d0                	add    %edx,%eax
    2889:	c6 00 00             	movb   $0x0,(%eax)
}
    288c:	90                   	nop
    288d:	c9                   	leave  
    288e:	c3                   	ret    
