...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     504:	0f b6 80 60 2d 00 00 	movzbl 0x2d60(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     640:	75 25                	jne    667 <printf+0xff>
          s = "(null)";
     642:	c7 45 f4 13 26 00 00 	movl   $0x2613,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     708:	a1 c0 69 00 00       	mov    0x69c0,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     7d3:	a3 c0 69 00 00       	mov    %eax,0x69c0
}
     7d8:	90                   	nop
     7d9:	c9                   	leave  
     7da:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     834:	a1 c0 69 00 00       	mov    0x69c0,%eax
}
     839:	c9                   	leave  
     83a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     850:	a1 c0 69 00 00       	mov    0x69c0,%eax
     855:	89 45 f0             	mov    %eax,-0x10(%ebp)
     858:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     85c:	75 23                	jne    881 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     85e:	c7 45 f0 b8 69 00 00 	movl   $0x69b8,-0x10(%ebp)
     865:	8b 45 f0             	mov    -0x10(%ebp),%eax
     868:	a3 c0 69 00 00       	mov    %eax,0x69c0
     86d:	a1 c0 69 00 00       	mov    0x69c0,%eax
     872:	a3 b8 69 00 00       	mov    %eax,0x69b8
    base.s.size = 0;
     877:	c7 05 bc 69 00 00 00 	movl   $0x0,0x69bc
     87e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     8d4:	a3 c0 69 00 00       	mov    %eax,0x69c0
      return (void*)(p + 1);
    ...
    if(p == freep)
     8e1:	a1 c0 69 00 00       	mov    0x69c0,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     a1f:	79 2e                	jns    a4f <APLoadBitmap+0x61>
    {
     ...
     a27:	68 1a 26 00 00       	push   $0x261a
     a2c:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    13cb:	05 80 2d 00 00       	add    $0x2d80,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1658:	68 2c 26 00 00       	push   $0x262c
    165d:	6a 01                	push   $0x1
    ...
    16cd:	68 4c 26 00 00       	push   $0x264c
    16d2:	6a 01                	push   $0x1
    ...
    1771:	68 70 26 00 00       	push   $0x2670
    1776:	6a 01                	push   $0x1
    ...
    1856:	68 98 26 00 00       	push   $0x2698
    185b:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    193f:	e8 19 08 00 00       	call   215d <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    1da1:	6a 0c                	push   $0xc
    1da3:	50                   	push   %eax
    1da4:	e8 27 f8 ff ff       	call   15d0 <RGB>
    1da9:	83 c4 0c             	add    $0xc,%esp
    1dac:	8b 1d f4 69 00 00    	mov    0x69f4,%ebx
    1db2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1db5:	6b c8 32             	imul   $0x32,%eax,%ecx
    1db8:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1dbb:	6b c0 32             	imul   $0x32,%eax,%eax
    1dbe:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1dc1:	8b 45 08             	mov    0x8(%ebp),%eax
    1dc4:	8d 78 3c             	lea    0x3c(%eax),%edi
    1dc7:	83 ec 0c             	sub    $0xc,%esp
    1dca:	83 ec 04             	sub    $0x4,%esp
    1dcd:	89 e0                	mov    %esp,%eax
    1dcf:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1dd3:	66 89 30             	mov    %si,(%eax)
    1dd6:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1dda:	88 50 02             	mov    %dl,0x2(%eax)
    1ddd:	6a 32                	push   $0x32
    1ddf:	6a 32                	push   $0x32
    1de1:	6a 00                	push   $0x0
    1de3:	6a 00                	push   $0x0
    1de5:	53                   	push   %ebx
    1de6:	51                   	push   %ecx
    1de7:	ff 75 94             	pushl  -0x6c(%ebp)
    1dea:	57                   	push   %edi
    1deb:	e8 3c f6 ff ff       	call   142c <APDcCopy>
    1df0:	83 c4 30             	add    $0x30,%esp
                    break;
    1df3:	e9 41 03 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1df8:	8d 45 98             	lea    -0x68(%ebp),%eax
    1dfb:	6a 69                	push   $0x69
    1dfd:	6a 69                	push   $0x69
    1dff:	6a 69                	push   $0x69
    1e01:	50                   	push   %eax
    1e02:	e8 c9 f7 ff ff       	call   15d0 <RGB>
    1e07:	83 c4 0c             	add    $0xc,%esp
    1e0a:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    1e0e:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    1e12:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    1e16:	88 45 ba             	mov    %al,-0x46(%ebp)
                    pen.size = 1;
    1e19:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1e20:	8d 45 98             	lea    -0x68(%ebp),%eax
    1e23:	6a 69                	push   $0x69
    1e25:	6a 69                	push   $0x69
    1e27:	6a 69                	push   $0x69
    1e29:	50                   	push   %eax
    1e2a:	e8 a1 f7 ff ff       	call   15d0 <RGB>
    1e2f:	83 c4 0c             	add    $0xc,%esp
    1e32:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    1e36:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    1e3a:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    1e3e:	88 45 b7             	mov    %al,-0x49(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1e41:	8b 45 08             	mov    0x8(%ebp),%eax
    1e44:	8d 50 3c             	lea    0x3c(%eax),%edx
    1e47:	8d 45 98             	lea    -0x68(%ebp),%eax
    1e4a:	ff 75 bc             	pushl  -0x44(%ebp)
    1e4d:	ff 75 b8             	pushl  -0x48(%ebp)
    1e50:	52                   	push   %edx
    1e51:	50                   	push   %eax
    1e52:	e8 66 ee ff ff       	call   cbd <APSetPen>
    1e57:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1e5a:	8b 45 08             	mov    0x8(%ebp),%eax
    1e5d:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1e60:	8d 55 98             	lea    -0x68(%ebp),%edx
    1e63:	83 ec 04             	sub    $0x4,%esp
    1e66:	83 ec 04             	sub    $0x4,%esp
    1e69:	89 e0                	mov    %esp,%eax
    1e6b:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    1e6f:	66 89 08             	mov    %cx,(%eax)
    1e72:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    1e76:	88 48 02             	mov    %cl,0x2(%eax)
    1e79:	53                   	push   %ebx
    1e7a:	52                   	push   %edx
    1e7b:	e8 76 ee ff ff       	call   cf6 <APSetBrush>
    1e80:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1e83:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1e86:	6b d0 32             	imul   $0x32,%eax,%edx
    1e89:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1e8c:	6b c0 32             	imul   $0x32,%eax,%eax
    1e8f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1e92:	83 c1 3c             	add    $0x3c,%ecx
    ...
    1e9d:	50                   	push   %eax
    1e9e:	51                   	push   %ecx
    1e9f:	e8 7c f2 ff ff       	call   1120 <APDrawRect>
    1ea4:	83 c4 20             	add    $0x20,%esp
                    break;
    1ea7:	e9 8d 02 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1eac:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1eaf:	6a 0c                	push   $0xc
    1eb1:	6a 0c                	push   $0xc
    1eb3:	6a 0c                	push   $0xc
    1eb5:	50                   	push   %eax
    1eb6:	e8 15 f7 ff ff       	call   15d0 <RGB>
    1ebb:	83 c4 0c             	add    $0xc,%esp
    1ebe:	8b 1d 44 6a 00 00    	mov    0x6a44,%ebx
    1ec4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ec7:	6b c8 32             	imul   $0x32,%eax,%ecx
    1eca:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1ecd:	6b c0 32             	imul   $0x32,%eax,%eax
    1ed0:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1ed3:	8b 45 08             	mov    0x8(%ebp),%eax
    1ed6:	8d 78 3c             	lea    0x3c(%eax),%edi
    1ed9:	83 ec 0c             	sub    $0xc,%esp
    1edc:	83 ec 04             	sub    $0x4,%esp
    1edf:	89 e0                	mov    %esp,%eax
    1ee1:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1ee5:	66 89 30             	mov    %si,(%eax)
    1ee8:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    1eec:	88 50 02             	mov    %dl,0x2(%eax)
    1eef:	6a 32                	push   $0x32
    1ef1:	6a 32                	push   $0x32
    1ef3:	6a 00                	push   $0x0
    1ef5:	6a 00                	push   $0x0
    1ef7:	53                   	push   %ebx
    1ef8:	51                   	push   %ecx
    1ef9:	ff 75 94             	pushl  -0x6c(%ebp)
    1efc:	57                   	push   %edi
    1efd:	e8 2a f5 ff ff       	call   142c <APDcCopy>
    1f02:	83 c4 30             	add    $0x30,%esp
                    break;
    1f05:	e9 2f 02 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f0a:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1f0d:	6a 0c                	push   $0xc
    1f0f:	6a 0c                	push   $0xc
    1f11:	6a 0c                	push   $0xc
    1f13:	50                   	push   %eax
    1f14:	e8 b7 f6 ff ff       	call   15d0 <RGB>
    1f19:	83 c4 0c             	add    $0xc,%esp
    1f1c:	8b 1d 20 6a 00 00    	mov    0x6a20,%ebx
    1f22:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f25:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f28:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f2b:	6b c0 32             	imul   $0x32,%eax,%eax
    1f2e:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1f31:	8b 45 08             	mov    0x8(%ebp),%eax
    1f34:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f37:	83 ec 0c             	sub    $0xc,%esp
    1f3a:	83 ec 04             	sub    $0x4,%esp
    1f3d:	89 e0                	mov    %esp,%eax
    1f3f:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1f43:	66 89 30             	mov    %si,(%eax)
    1f46:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    1f4a:	88 50 02             	mov    %dl,0x2(%eax)
    1f4d:	6a 32                	push   $0x32
    1f4f:	6a 32                	push   $0x32
    1f51:	6a 00                	push   $0x0
    1f53:	6a 00                	push   $0x0
    1f55:	53                   	push   %ebx
    1f56:	51                   	push   %ecx
    1f57:	ff 75 94             	pushl  -0x6c(%ebp)
    1f5a:	57                   	push   %edi
    1f5b:	e8 cc f4 ff ff       	call   142c <APDcCopy>
    1f60:	83 c4 30             	add    $0x30,%esp
                    break;
    1f63:	e9 d1 01 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f68:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1f6b:	6a 0c                	push   $0xc
    1f6d:	6a 0c                	push   $0xc
    1f6f:	6a 0c                	push   $0xc
    1f71:	50                   	push   %eax
    1f72:	e8 59 f6 ff ff       	call   15d0 <RGB>
    1f77:	83 c4 0c             	add    $0xc,%esp
    1f7a:	8b 1d f8 69 00 00    	mov    0x69f8,%ebx
    1f80:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f83:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f86:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f89:	6b c0 32             	imul   $0x32,%eax,%eax
    1f8c:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1f8f:	8b 45 08             	mov    0x8(%ebp),%eax
    1f92:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f95:	83 ec 0c             	sub    $0xc,%esp
    1f98:	83 ec 04             	sub    $0x4,%esp
    1f9b:	89 e0                	mov    %esp,%eax
    1f9d:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1fa1:	66 89 30             	mov    %si,(%eax)
    1fa4:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    1fa8:	88 50 02             	mov    %dl,0x2(%eax)
    1fab:	6a 32                	push   $0x32
    1fad:	6a 32                	push   $0x32
    1faf:	6a 00                	push   $0x0
    1fb1:	6a 00                	push   $0x0
    1fb3:	53                   	push   %ebx
    1fb4:	51                   	push   %ecx
    1fb5:	ff 75 94             	pushl  -0x6c(%ebp)
    1fb8:	57                   	push   %edi
    1fb9:	e8 6e f4 ff ff       	call   142c <APDcCopy>
    1fbe:	83 c4 30             	add    $0x30,%esp
                    break;
    1fc1:	e9 73 01 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fc6:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1fc9:	6a 0c                	push   $0xc
    1fcb:	6a 0c                	push   $0xc
    1fcd:	6a 0c                	push   $0xc
    1fcf:	50                   	push   %eax
    1fd0:	e8 fb f5 ff ff       	call   15d0 <RGB>
    1fd5:	83 c4 0c             	add    $0xc,%esp
    1fd8:	8b 1d 40 6a 00 00    	mov    0x6a40,%ebx
    1fde:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fe1:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fe4:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fe7:	6b c0 32             	imul   $0x32,%eax,%eax
    1fea:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1fed:	8b 45 08             	mov    0x8(%ebp),%eax
    1ff0:	8d 78 3c             	lea    0x3c(%eax),%edi
    1ff3:	83 ec 0c             	sub    $0xc,%esp
    1ff6:	83 ec 04             	sub    $0x4,%esp
    1ff9:	89 e0                	mov    %esp,%eax
    1ffb:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1fff:	66 89 30             	mov    %si,(%eax)
    2002:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    2006:	88 50 02             	mov    %dl,0x2(%eax)
    2009:	6a 32                	push   $0x32
    200b:	6a 32                	push   $0x32
    200d:	6a 00                	push   $0x0
    200f:	6a 00                	push   $0x0
    2011:	53                   	push   %ebx
    2012:	51                   	push   %ecx
    2013:	ff 75 94             	pushl  -0x6c(%ebp)
    2016:	57                   	push   %edi
    2017:	e8 10 f4 ff ff       	call   142c <APDcCopy>
    201c:	83 c4 30             	add    $0x30,%esp
                    break;
    201f:	e9 15 01 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2024:	8d 45 cf             	lea    -0x31(%ebp),%eax
    2027:	6a 0c                	push   $0xc
    2029:	6a 0c                	push   $0xc
    202b:	6a 0c                	push   $0xc
    202d:	50                   	push   %eax
    202e:	e8 9d f5 ff ff       	call   15d0 <RGB>
    2033:	83 c4 0c             	add    $0xc,%esp
    2036:	8b 1d c8 69 00 00    	mov    0x69c8,%ebx
    203c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    203f:	6b c8 32             	imul   $0x32,%eax,%ecx
    2042:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2045:	6b c0 32             	imul   $0x32,%eax,%eax
    2048:	89 45 94             	mov    %eax,-0x6c(%ebp)
    204b:	8b 45 08             	mov    0x8(%ebp),%eax
    204e:	8d 78 3c             	lea    0x3c(%eax),%edi
    2051:	83 ec 0c             	sub    $0xc,%esp
    2054:	83 ec 04             	sub    $0x4,%esp
    2057:	89 e0                	mov    %esp,%eax
    2059:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    205d:	66 89 30             	mov    %si,(%eax)
    2060:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2064:	88 50 02             	mov    %dl,0x2(%eax)
    2067:	6a 32                	push   $0x32
    2069:	6a 32                	push   $0x32
    206b:	6a 00                	push   $0x0
    206d:	6a 00                	push   $0x0
    206f:	53                   	push   %ebx
    2070:	51                   	push   %ecx
    2071:	ff 75 94             	pushl  -0x6c(%ebp)
    2074:	57                   	push   %edi
    2075:	e8 b2 f3 ff ff       	call   142c <APDcCopy>
    207a:	83 c4 30             	add    $0x30,%esp
                    break;
    207d:	e9 b7 00 00 00       	jmp    2139 <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2082:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2085:	6a 0c                	push   $0xc
    2087:	6a 0c                	push   $0xc
    2089:	6a 0c                	push   $0xc
    208b:	50                   	push   %eax
    208c:	e8 3f f5 ff ff       	call   15d0 <RGB>
    2091:	83 c4 0c             	add    $0xc,%esp
    2094:	8b 1d e4 69 00 00    	mov    0x69e4,%ebx
    ...
    20a6:	89 45 94             	mov    %eax,-0x6c(%ebp)
    ...
    20b7:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    20bb:	66 89 30             	mov    %si,(%eax)
    20be:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    ...
    20cd:	53                   	push   %ebx
    20ce:	51                   	push   %ecx
    20cf:	ff 75 94             	pushl  -0x6c(%ebp)
    20d2:	57                   	push   %edi
    20d3:	e8 54 f3 ff ff       	call   142c <APDcCopy>
    20d8:	83 c4 30             	add    $0x30,%esp
                    break;
    20db:	eb 5c                	jmp    2139 <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    20dd:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    20e0:	6a 0c                	push   $0xc
    20e2:	6a 0c                	push   $0xc
    20e4:	6a 0c                	push   $0xc
    20e6:	50                   	push   %eax
    20e7:	e8 e4 f4 ff ff       	call   15d0 <RGB>
    20ec:	83 c4 0c             	add    $0xc,%esp
    20ef:	8b 1d 3c 6a 00 00    	mov    0x6a3c,%ebx
    ...
    2112:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    2116:	66 89 30             	mov    %si,(%eax)
    2119:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    ...
    212d:	57                   	push   %edi
    212e:	e8 f9 f2 ff ff       	call   142c <APDcCopy>
    2133:	83 c4 30             	add    $0x30,%esp
                    break;
    2136:	eb 01                	jmp    2139 <APGridPaint+0x6e5>
                default: break;
    2138:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    2139:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    213d:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2141:	0f 8e 1c fc ff ff    	jle    1d63 <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2147:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    214b:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    214f:	0f 8e 02 fc ff ff    	jle    1d57 <APGridPaint+0x303>
                default: break;
            }
        }
    }
...
{
    215d:	55                   	push   %ebp
    215e:	89 e5                	mov    %esp,%ebp
    2160:	53                   	push   %ebx
    2161:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    2164:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2167:	68 cd 00 00 00       	push   $0xcd
    216c:	6a 74                	push   $0x74
    216e:	6a 18                	push   $0x18
    2170:	50                   	push   %eax
    2171:	e8 5a f4 ff ff       	call   15d0 <RGB>
    2176:	83 c4 0c             	add    $0xc,%esp
    2179:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    217d:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    2181:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2185:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    2188:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    218f:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2192:	68 cd 00 00 00       	push   $0xcd
    2197:	6a 74                	push   $0x74
    2199:	6a 18                	push   $0x18
    219b:	50                   	push   %eax
    219c:	e8 2f f4 ff ff       	call   15d0 <RGB>
    21a1:	83 c4 0c             	add    $0xc,%esp
    21a4:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    21a8:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    21ac:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    21b0:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    21b3:	8b 45 08             	mov    0x8(%ebp),%eax
    21b6:	8d 50 58             	lea    0x58(%eax),%edx
    21b9:	8d 45 d8             	lea    -0x28(%ebp),%eax
    21bc:	ff 75 f4             	pushl  -0xc(%ebp)
    21bf:	ff 75 f0             	pushl  -0x10(%ebp)
    21c2:	52                   	push   %edx
    21c3:	50                   	push   %eax
    21c4:	e8 f4 ea ff ff       	call   cbd <APSetPen>
    21c9:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    21cc:	8b 45 08             	mov    0x8(%ebp),%eax
    21cf:	8d 58 58             	lea    0x58(%eax),%ebx
    21d2:	8d 55 d8             	lea    -0x28(%ebp),%edx
    21d5:	83 ec 04             	sub    $0x4,%esp
    21d8:	83 ec 04             	sub    $0x4,%esp
    21db:	89 e0                	mov    %esp,%eax
    21dd:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    21e1:	66 89 08             	mov    %cx,(%eax)
    21e4:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    21e8:	88 48 02             	mov    %cl,0x2(%eax)
    21eb:	53                   	push   %ebx
    21ec:	52                   	push   %edx
    21ed:	e8 04 eb ff ff       	call   cf6 <APSetBrush>
    21f2:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    21f5:	8b 45 08             	mov    0x8(%ebp),%eax
    21f8:	83 c0 58             	add    $0x58,%eax
    21fb:	83 ec 0c             	sub    $0xc,%esp
    21fe:	6a 32                	push   $0x32
    2200:	68 20 03 00 00       	push   $0x320
    2205:	6a 00                	push   $0x0
    2207:	6a 00                	push   $0x0
    2209:	50                   	push   %eax
    220a:	e8 11 ef ff ff       	call   1120 <APDrawRect>
    220f:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    2212:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2215:	6a 08                	push   $0x8
    2217:	6a 08                	push   $0x8
    2219:	6a 08                	push   $0x8
    221b:	50                   	push   %eax
    221c:	e8 af f3 ff ff       	call   15d0 <RGB>
    2221:	83 c4 0c             	add    $0xc,%esp
    2224:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2228:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    222c:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2230:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    2233:	8b 45 08             	mov    0x8(%ebp),%eax
    2236:	8d 58 58             	lea    0x58(%eax),%ebx
    2239:	8d 55 d8             	lea    -0x28(%ebp),%edx
    223c:	83 ec 04             	sub    $0x4,%esp
    223f:	83 ec 04             	sub    $0x4,%esp
    2242:	89 e0                	mov    %esp,%eax
    2244:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    2248:	66 89 08             	mov    %cx,(%eax)
    224b:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    224f:	88 48 02             	mov    %cl,0x2(%eax)
    2252:	53                   	push   %ebx
    2253:	52                   	push   %edx
    2254:	e8 df ea ff ff       	call   d38 <APSetFont>
    2259:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    225c:	8b 45 08             	mov    0x8(%ebp),%eax
    225f:	83 c0 58             	add    $0x58,%eax
    2262:	6a 14                	push   $0x14
    2264:	6a 0a                	push   $0xa
    2266:	ff 75 0c             	pushl  0xc(%ebp)
    2269:	50                   	push   %eax
    226a:	e8 b6 f0 ff ff       	call   1325 <APDrawText>
    226f:	83 c4 10             	add    $0x10,%esp
}
    2272:	90                   	nop
    2273:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2276:	c9                   	leave  
    2277:	c3                   	ret    
...
if (seed > 0)
    227b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    227f:	7e 08                	jle    2289 <random+0x11>
{
rand_num = seed;
    2281:	8b 45 08             	mov    0x8(%ebp),%eax
    2284:	a3 a0 69 00 00       	mov    %eax,0x69a0
}
rand_num *= 3;
    2289:	8b 15 a0 69 00 00    	mov    0x69a0,%edx
    228f:	89 d0                	mov    %edx,%eax
    2291:	01 c0                	add    %eax,%eax
    2293:	01 d0                	add    %edx,%eax
    2295:	a3 a0 69 00 00       	mov    %eax,0x69a0
if (rand_num < 0)
    229a:	a1 a0 69 00 00       	mov    0x69a0,%eax
    229f:	85 c0                	test   %eax,%eax
    22a1:	79 0c                	jns    22af <random+0x37>
{
rand_num *= (-1);
    22a3:	a1 a0 69 00 00       	mov    0x69a0,%eax
    22a8:	f7 d8                	neg    %eax
    22aa:	a3 a0 69 00 00       	mov    %eax,0x69a0
}
return rand_num % 997;
    22af:	8b 0d a0 69 00 00    	mov    0x69a0,%ecx
    22b5:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    22ba:	89 c8                	mov    %ecx,%eax
    22bc:	f7 ea                	imul   %edx
    22be:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    22c1:	c1 f8 09             	sar    $0x9,%eax
    22c4:	89 c2                	mov    %eax,%edx
    22c6:	89 c8                	mov    %ecx,%eax
    22c8:	c1 f8 1f             	sar    $0x1f,%eax
    22cb:	29 c2                	sub    %eax,%edx
    22cd:	89 d0                	mov    %edx,%eax
    22cf:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    22d5:	29 c1                	sub    %eax,%ecx
    22d7:	89 c8                	mov    %ecx,%eax
}
    22d9:	5d                   	pop    %ebp
    22da:	c3                   	ret    
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    22e2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    22e9:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    22ed:	74 17                	je     2306 <sprintint+0x2b>
    22ef:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    22f3:	79 11                	jns    2306 <sprintint+0x2b>
        neg = 1;
    22f5:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    22fc:	8b 45 10             	mov    0x10(%ebp),%eax
    22ff:	f7 d8                	neg    %eax
    2301:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2304:	eb 06                	jmp    230c <sprintint+0x31>
    } else {
        x = xx;
    2306:	8b 45 10             	mov    0x10(%ebp),%eax
    2309:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    230c:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    2313:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    2316:	8d 41 01             	lea    0x1(%ecx),%eax
    2319:	89 45 f8             	mov    %eax,-0x8(%ebp)
    231c:	8b 5d 14             	mov    0x14(%ebp),%ebx
    231f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2322:	ba 00 00 00 00       	mov    $0x0,%edx
    2327:	f7 f3                	div    %ebx
    2329:	89 d0                	mov    %edx,%eax
    232b:	0f b6 80 a4 69 00 00 	movzbl 0x69a4(%eax),%eax
    2332:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    2336:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2339:	8b 45 f0             	mov    -0x10(%ebp),%eax
    233c:	ba 00 00 00 00       	mov    $0x0,%edx
    2341:	f7 f3                	div    %ebx
    2343:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2346:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    234a:	75 c7                	jne    2313 <sprintint+0x38>
    if(neg)
    234c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2350:	74 0e                	je     2360 <sprintint+0x85>
        buf[i++] = '-';
    2352:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2355:	8d 50 01             	lea    0x1(%eax),%edx
    2358:	89 55 f8             	mov    %edx,-0x8(%ebp)
    235b:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    2360:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2363:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2366:	eb 1b                	jmp    2383 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2368:	8b 45 0c             	mov    0xc(%ebp),%eax
    236b:	8b 00                	mov    (%eax),%eax
    236d:	8d 48 01             	lea    0x1(%eax),%ecx
    2370:	8b 55 0c             	mov    0xc(%ebp),%edx
    2373:	89 0a                	mov    %ecx,(%edx)
    2375:	89 c2                	mov    %eax,%edx
    2377:	8b 45 08             	mov    0x8(%ebp),%eax
    237a:	01 d0                	add    %edx,%eax
    237c:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    237f:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2383:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2387:	7f df                	jg     2368 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2389:	eb 21                	jmp    23ac <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    238b:	8b 45 0c             	mov    0xc(%ebp),%eax
    238e:	8b 00                	mov    (%eax),%eax
    2390:	8d 48 01             	lea    0x1(%eax),%ecx
    2393:	8b 55 0c             	mov    0xc(%ebp),%edx
    2396:	89 0a                	mov    %ecx,(%edx)
    2398:	89 c2                	mov    %eax,%edx
    239a:	8b 45 08             	mov    0x8(%ebp),%eax
    239d:	01 c2                	add    %eax,%edx
    239f:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    23a2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    23a5:	01 c8                	add    %ecx,%eax
    23a7:	0f b6 00             	movzbl (%eax),%eax
    23aa:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    23ac:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    23b0:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    23b4:	79 d5                	jns    238b <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    23b6:	90                   	nop
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    23c0:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    23c3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    23ca:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    23d1:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    23d8:	8d 45 0c             	lea    0xc(%ebp),%eax
    23db:	83 c0 04             	add    $0x4,%eax
    23de:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    23e1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    23e8:	e9 d9 01 00 00       	jmp    25c6 <sprintf+0x209>
        c = fmt[i] & 0xff;
    23ed:	8b 55 0c             	mov    0xc(%ebp),%edx
    23f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
    23f3:	01 d0                	add    %edx,%eax
    23f5:	0f b6 00             	movzbl (%eax),%eax
    23f8:	0f be c0             	movsbl %al,%eax
    23fb:	25 ff 00 00 00       	and    $0xff,%eax
    2400:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    2403:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    2407:	75 2c                	jne    2435 <sprintf+0x78>
            if(c == '%'){
    2409:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    240d:	75 0c                	jne    241b <sprintf+0x5e>
                state = '%';
    240f:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    2416:	e9 a7 01 00 00       	jmp    25c2 <sprintf+0x205>
            } else {
                dst[j++] = c;
    241b:	8b 45 c8             	mov    -0x38(%ebp),%eax
    241e:	8d 50 01             	lea    0x1(%eax),%edx
    2421:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2424:	89 c2                	mov    %eax,%edx
    2426:	8b 45 08             	mov    0x8(%ebp),%eax
    2429:	01 d0                	add    %edx,%eax
    242b:	8b 55 e0             	mov    -0x20(%ebp),%edx
    242e:	88 10                	mov    %dl,(%eax)
    2430:	e9 8d 01 00 00       	jmp    25c2 <sprintf+0x205>
            }
        } else if(state == '%'){
    2435:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    2439:	0f 85 83 01 00 00    	jne    25c2 <sprintf+0x205>
            if(c == 'd'){
    243f:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2443:	75 4c                	jne    2491 <sprintf+0xd4>
                buf[bi] = '\0';
    2445:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2448:	8b 45 f0             	mov    -0x10(%ebp),%eax
    244b:	01 d0                	add    %edx,%eax
    244d:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2450:	83 ec 0c             	sub    $0xc,%esp
    2453:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2456:	50                   	push   %eax
    2457:	e8 bb de ff ff       	call   317 <atoi>
    245c:	83 c4 10             	add    $0x10,%esp
    245f:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2462:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2469:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    246c:	8b 00                	mov    (%eax),%eax
    246e:	83 ec 08             	sub    $0x8,%esp
    2471:	ff 75 d8             	pushl  -0x28(%ebp)
    2474:	6a 01                	push   $0x1
    2476:	6a 0a                	push   $0xa
    2478:	50                   	push   %eax
    2479:	8d 45 c8             	lea    -0x38(%ebp),%eax
    247c:	50                   	push   %eax
    247d:	ff 75 08             	pushl  0x8(%ebp)
    2480:	e8 56 fe ff ff       	call   22db <sprintint>
    2485:	83 c4 20             	add    $0x20,%esp
                ap++;
    2488:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    248c:	e9 2a 01 00 00       	jmp    25bb <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2491:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2495:	74 06                	je     249d <sprintf+0xe0>
    2497:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    249b:	75 4c                	jne    24e9 <sprintf+0x12c>
                buf[bi] = '\0';
    249d:	8d 55 ce             	lea    -0x32(%ebp),%edx
    24a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    24a3:	01 d0                	add    %edx,%eax
    24a5:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    24a8:	83 ec 0c             	sub    $0xc,%esp
    24ab:	8d 45 ce             	lea    -0x32(%ebp),%eax
    24ae:	50                   	push   %eax
    24af:	e8 63 de ff ff       	call   317 <atoi>
    24b4:	83 c4 10             	add    $0x10,%esp
    24b7:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    24ba:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    24c1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    24c4:	8b 00                	mov    (%eax),%eax
    24c6:	83 ec 08             	sub    $0x8,%esp
    24c9:	ff 75 dc             	pushl  -0x24(%ebp)
    24cc:	6a 00                	push   $0x0
    24ce:	6a 10                	push   $0x10
    24d0:	50                   	push   %eax
    24d1:	8d 45 c8             	lea    -0x38(%ebp),%eax
    24d4:	50                   	push   %eax
    24d5:	ff 75 08             	pushl  0x8(%ebp)
    24d8:	e8 fe fd ff ff       	call   22db <sprintint>
    24dd:	83 c4 20             	add    $0x20,%esp
                ap++;
    24e0:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    24e4:	e9 d2 00 00 00       	jmp    25bb <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    24e9:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    24ed:	75 46                	jne    2535 <sprintf+0x178>
                s = (char*)*ap;
    24ef:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    24f2:	8b 00                	mov    (%eax),%eax
    24f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    24f7:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    24fb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    24ff:	75 25                	jne    2526 <sprintf+0x169>
                    s = "(null)";
    2501:	c7 45 f4 a4 27 00 00 	movl   $0x27a4,-0xc(%ebp)
                while(*s != 0){
    2508:	eb 1c                	jmp    2526 <sprintf+0x169>
                    dst[j++] = *s;
    ...
    2518:	01 c2                	add    %eax,%edx
    251a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    251d:	0f b6 00             	movzbl (%eax),%eax
    2520:	88 02                	mov    %al,(%edx)
                    s++;
    2522:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    2526:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2529:	0f b6 00             	movzbl (%eax),%eax
    252c:	84 c0                	test   %al,%al
    252e:	75 da                	jne    250a <sprintf+0x14d>
    2530:	e9 86 00 00 00       	jmp    25bb <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    2535:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    2539:	75 1d                	jne    2558 <sprintf+0x19b>
                dst[j++] = *ap;
    253b:	8b 45 c8             	mov    -0x38(%ebp),%eax
    253e:	8d 50 01             	lea    0x1(%eax),%edx
    2541:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2544:	89 c2                	mov    %eax,%edx
    2546:	8b 45 08             	mov    0x8(%ebp),%eax
    2549:	01 c2                	add    %eax,%edx
    254b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    254e:	8b 00                	mov    (%eax),%eax
    2550:	88 02                	mov    %al,(%edx)
                ap++;
    2552:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2556:	eb 63                	jmp    25bb <sprintf+0x1fe>
            } else if(c == '%'){
    2558:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    255c:	75 17                	jne    2575 <sprintf+0x1b8>
                dst[j++] = c;
    255e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2561:	8d 50 01             	lea    0x1(%eax),%edx
    2564:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2567:	89 c2                	mov    %eax,%edx
    2569:	8b 45 08             	mov    0x8(%ebp),%eax
    256c:	01 d0                	add    %edx,%eax
    256e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2571:	88 10                	mov    %dl,(%eax)
    2573:	eb 46                	jmp    25bb <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2575:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2579:	7e 18                	jle    2593 <sprintf+0x1d6>
    257b:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    257f:	7f 12                	jg     2593 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2581:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2584:	8d 50 01             	lea    0x1(%eax),%edx
    2587:	89 55 f0             	mov    %edx,-0x10(%ebp)
    258a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    258d:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2591:	eb 2f                	jmp    25c2 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2593:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2596:	8d 50 01             	lea    0x1(%eax),%edx
    2599:	89 55 c8             	mov    %edx,-0x38(%ebp)
    259c:	89 c2                	mov    %eax,%edx
    259e:	8b 45 08             	mov    0x8(%ebp),%eax
    25a1:	01 d0                	add    %edx,%eax
    25a3:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    ...
    25b6:	8b 55 e0             	mov    -0x20(%ebp),%edx
    25b9:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    25bb:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    25dc:	8d 50 01             	lea    0x1(%eax),%edx
    25df:	89 55 c8             	mov    %edx,-0x38(%ebp)
    25e2:	89 c2                	mov    %eax,%edx
    25e4:	8b 45 08             	mov    0x8(%ebp),%eax
    25e7:	01 d0                	add    %edx,%eax
    25e9:	c6 00 00             	movb   $0x0,(%eax)
}
    25ec:	90                   	nop
    25ed:	c9                   	leave  
    25ee:	c3                   	ret    
