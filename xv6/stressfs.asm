...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     4ec:	0f b6 80 40 28 00 00 	movzbl 0x2840(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     628:	75 25                	jne    64f <printf+0xff>
          s = "(null)";
     62a:	c7 45 f4 b7 21 00 00 	movl   $0x21b7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     6f0:	a1 70 28 00 00       	mov    0x2870,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     7bb:	a3 70 28 00 00       	mov    %eax,0x2870
}
     7c0:	90                   	nop
     7c1:	c9                   	leave  
     7c2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     81c:	a1 70 28 00 00       	mov    0x2870,%eax
}
     821:	c9                   	leave  
     822:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     838:	a1 70 28 00 00       	mov    0x2870,%eax
     83d:	89 45 f0             	mov    %eax,-0x10(%ebp)
     840:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     844:	75 23                	jne    869 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     846:	c7 45 f0 68 28 00 00 	movl   $0x2868,-0x10(%ebp)
     84d:	8b 45 f0             	mov    -0x10(%ebp),%eax
     850:	a3 70 28 00 00       	mov    %eax,0x2870
     855:	a1 70 28 00 00       	mov    0x2870,%eax
     85a:	a3 68 28 00 00       	mov    %eax,0x2868
    base.s.size = 0;
     85f:	c7 05 6c 28 00 00 00 	movl   $0x0,0x286c
     866:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     8bc:	a3 70 28 00 00       	mov    %eax,0x2870
      return (void*)(p + 1);
    ...
    if(p == freep)
     8c9:	a1 70 28 00 00       	mov    0x2870,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     a07:	79 2e                	jns    a37 <APLoadBitmap+0x61>
    {
     ...
     a0f:	68 be 21 00 00       	push   $0x21be
     a14:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    14f7:	68 d0 21 00 00       	push   $0x21d0
    14fc:	6a 01                	push   $0x1
    ...
    156a:	68 f0 21 00 00       	push   $0x21f0
    156f:	6a 01                	push   $0x1
    ...
    160e:	68 14 22 00 00       	push   $0x2214
    1613:	6a 01                	push   $0x1
    ...
    16df:	68 3c 22 00 00       	push   $0x223c
    16e4:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1a71:	68 d0 22 00 00       	push   $0x22d0
    1a76:	6a 01                	push   $0x1
    ...
    1aa2:	68 f6 22 00 00       	push   $0x22f6
    1aa7:	6a 01                	push   $0x1
    ...
    1b11:	8b 04 85 0c 23 00 00 	mov    0x230c(,%eax,4),%eax
    1b18:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1b2c:	8b 1d a4 28 00 00    	mov    0x28a4,%ebx
    ...
    1c3e:	8b 1d e4 28 00 00    	mov    0x28e4,%ebx
    ...
    1c9c:	8b 1d c4 28 00 00    	mov    0x28c4,%ebx
    ...
    1cfa:	8b 1d a8 28 00 00    	mov    0x28a8,%ebx
    ...
    1d58:	8b 1d e0 28 00 00    	mov    0x28e0,%ebx
    ...
    1db6:	8b 1d 78 28 00 00    	mov    0x2878,%ebx
    ...
    1e11:	8b 1d 94 28 00 00    	mov    0x2894,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1e86:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1e8d:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1e91:	74 17                	je     1eaa <sprintint+0x2b>
    1e93:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1e97:	79 11                	jns    1eaa <sprintint+0x2b>
        neg = 1;
    1e99:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1ea0:	8b 45 10             	mov    0x10(%ebp),%eax
    1ea3:	f7 d8                	neg    %eax
    1ea5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1ea8:	eb 06                	jmp    1eb0 <sprintint+0x31>
    } else {
        x = xx;
    ...
    i = 0;
    1eb0:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1eb7:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1eba:	8d 41 01             	lea    0x1(%ecx),%eax
    1ebd:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1ec0:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1ec3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1ec6:	ba 00 00 00 00       	mov    $0x0,%edx
    1ecb:	f7 f3                	div    %ebx
    1ecd:	89 d0                	mov    %edx,%eax
    1ecf:	0f b6 80 54 28 00 00 	movzbl 0x2854(%eax),%eax
    1ed6:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1eda:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1edd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1ee0:	ba 00 00 00 00       	mov    $0x0,%edx
    1ee5:	f7 f3                	div    %ebx
    1ee7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1eea:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1eee:	75 c7                	jne    1eb7 <sprintint+0x38>
    if(neg)
    1ef0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1ef4:	74 0e                	je     1f04 <sprintint+0x85>
        buf[i++] = '-';
    1ef6:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1ef9:	8d 50 01             	lea    0x1(%eax),%edx
    1efc:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1eff:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1f04:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1f07:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1f0a:	eb 1b                	jmp    1f27 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1f0c:	8b 45 0c             	mov    0xc(%ebp),%eax
    1f0f:	8b 00                	mov    (%eax),%eax
    1f11:	8d 48 01             	lea    0x1(%eax),%ecx
    1f14:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f17:	89 0a                	mov    %ecx,(%edx)
    1f19:	89 c2                	mov    %eax,%edx
    1f1b:	8b 45 08             	mov    0x8(%ebp),%eax
    1f1e:	01 d0                	add    %edx,%eax
    1f20:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1f23:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1f27:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1f2b:	7f df                	jg     1f0c <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1f2d:	eb 21                	jmp    1f50 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1f2f:	8b 45 0c             	mov    0xc(%ebp),%eax
    1f32:	8b 00                	mov    (%eax),%eax
    1f34:	8d 48 01             	lea    0x1(%eax),%ecx
    1f37:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f3a:	89 0a                	mov    %ecx,(%edx)
    1f3c:	89 c2                	mov    %eax,%edx
    1f3e:	8b 45 08             	mov    0x8(%ebp),%eax
    1f41:	01 c2                	add    %eax,%edx
    1f43:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1f46:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1f49:	01 c8                	add    %ecx,%eax
    1f4b:	0f b6 00             	movzbl (%eax),%eax
    1f4e:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1f50:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1f54:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1f58:	79 d5                	jns    1f2f <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1f5a:	90                   	nop
    1f5b:	83 c4 20             	add    $0x20,%esp
    1f5e:	5b                   	pop    %ebx
    1f5f:	5d                   	pop    %ebp
    1f60:	c3                   	ret    
...
{
    1f61:	55                   	push   %ebp
    1f62:	89 e5                	mov    %esp,%ebp
    1f64:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1f67:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1f6e:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1f75:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1f7c:	8d 45 0c             	lea    0xc(%ebp),%eax
    1f7f:	83 c0 04             	add    $0x4,%eax
    1f82:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1f85:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1f8c:	e9 d9 01 00 00       	jmp    216a <sprintf+0x209>
        c = fmt[i] & 0xff;
    1f91:	8b 55 0c             	mov    0xc(%ebp),%edx
    1f94:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1f97:	01 d0                	add    %edx,%eax
    1f99:	0f b6 00             	movzbl (%eax),%eax
    1f9c:	0f be c0             	movsbl %al,%eax
    1f9f:	25 ff 00 00 00       	and    $0xff,%eax
    1fa4:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1fa7:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1fab:	75 2c                	jne    1fd9 <sprintf+0x78>
            if(c == '%'){
    1fad:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1fb1:	75 0c                	jne    1fbf <sprintf+0x5e>
                state = '%';
    1fb3:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1fba:	e9 a7 01 00 00       	jmp    2166 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1fbf:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1fc2:	8d 50 01             	lea    0x1(%eax),%edx
    1fc5:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1fc8:	89 c2                	mov    %eax,%edx
    1fca:	8b 45 08             	mov    0x8(%ebp),%eax
    1fcd:	01 d0                	add    %edx,%eax
    1fcf:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1fd2:	88 10                	mov    %dl,(%eax)
    1fd4:	e9 8d 01 00 00       	jmp    2166 <sprintf+0x205>
            }
        } else if(state == '%'){
    1fd9:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1fdd:	0f 85 83 01 00 00    	jne    2166 <sprintf+0x205>
            if(c == 'd'){
    1fe3:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1fe7:	75 4c                	jne    2035 <sprintf+0xd4>
                buf[bi] = '\0';
    1fe9:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1fec:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1fef:	01 d0                	add    %edx,%eax
    1ff1:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1ff4:	83 ec 0c             	sub    $0xc,%esp
    1ff7:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1ffa:	50                   	push   %eax
    1ffb:	e8 17 e3 ff ff       	call   317 <atoi>
    2000:	83 c4 10             	add    $0x10,%esp
    2003:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2006:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    200d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2010:	8b 00                	mov    (%eax),%eax
    2012:	83 ec 08             	sub    $0x8,%esp
    2015:	ff 75 d8             	pushl  -0x28(%ebp)
    2018:	6a 01                	push   $0x1
    201a:	6a 0a                	push   $0xa
    201c:	50                   	push   %eax
    201d:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2020:	50                   	push   %eax
    2021:	ff 75 08             	pushl  0x8(%ebp)
    2024:	e8 56 fe ff ff       	call   1e7f <sprintint>
    2029:	83 c4 20             	add    $0x20,%esp
                ap++;
    202c:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2030:	e9 2a 01 00 00       	jmp    215f <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2035:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2039:	74 06                	je     2041 <sprintf+0xe0>
    203b:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    203f:	75 4c                	jne    208d <sprintf+0x12c>
                buf[bi] = '\0';
    2041:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2044:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2047:	01 d0                	add    %edx,%eax
    2049:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    204c:	83 ec 0c             	sub    $0xc,%esp
    204f:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2052:	50                   	push   %eax
    2053:	e8 bf e2 ff ff       	call   317 <atoi>
    2058:	83 c4 10             	add    $0x10,%esp
    205b:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    205e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2065:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2068:	8b 00                	mov    (%eax),%eax
    206a:	83 ec 08             	sub    $0x8,%esp
    206d:	ff 75 dc             	pushl  -0x24(%ebp)
    2070:	6a 00                	push   $0x0
    2072:	6a 10                	push   $0x10
    2074:	50                   	push   %eax
    2075:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2078:	50                   	push   %eax
    2079:	ff 75 08             	pushl  0x8(%ebp)
    207c:	e8 fe fd ff ff       	call   1e7f <sprintint>
    2081:	83 c4 20             	add    $0x20,%esp
                ap++;
    2084:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2088:	e9 d2 00 00 00       	jmp    215f <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    208d:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2091:	75 46                	jne    20d9 <sprintf+0x178>
                s = (char*)*ap;
    2093:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2096:	8b 00                	mov    (%eax),%eax
    2098:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    209b:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    209f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20a3:	75 25                	jne    20ca <sprintf+0x169>
                    s = "(null)";
    20a5:	c7 45 f4 2c 23 00 00 	movl   $0x232c,-0xc(%ebp)
                while(*s != 0){
    20ac:	eb 1c                	jmp    20ca <sprintf+0x169>
                    dst[j++] = *s;
    20ae:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20b1:	8d 50 01             	lea    0x1(%eax),%edx
    20b4:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20b7:	89 c2                	mov    %eax,%edx
    20b9:	8b 45 08             	mov    0x8(%ebp),%eax
    20bc:	01 c2                	add    %eax,%edx
    20be:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20c1:	0f b6 00             	movzbl (%eax),%eax
    20c4:	88 02                	mov    %al,(%edx)
                    s++;
    20c6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    20ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20cd:	0f b6 00             	movzbl (%eax),%eax
    20d0:	84 c0                	test   %al,%al
    20d2:	75 da                	jne    20ae <sprintf+0x14d>
    20d4:	e9 86 00 00 00       	jmp    215f <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    20d9:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    20dd:	75 1d                	jne    20fc <sprintf+0x19b>
                dst[j++] = *ap;
    20df:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20e2:	8d 50 01             	lea    0x1(%eax),%edx
    20e5:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20e8:	89 c2                	mov    %eax,%edx
    20ea:	8b 45 08             	mov    0x8(%ebp),%eax
    20ed:	01 c2                	add    %eax,%edx
    20ef:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20f2:	8b 00                	mov    (%eax),%eax
    20f4:	88 02                	mov    %al,(%edx)
                ap++;
    20f6:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    20fa:	eb 63                	jmp    215f <sprintf+0x1fe>
            } else if(c == '%'){
    20fc:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2100:	75 17                	jne    2119 <sprintf+0x1b8>
                dst[j++] = c;
    ...
    2117:	eb 46                	jmp    215f <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2119:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    211d:	7e 18                	jle    2137 <sprintf+0x1d6>
    211f:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2123:	7f 12                	jg     2137 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2125:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2128:	8d 50 01             	lea    0x1(%eax),%edx
    212b:	89 55 f0             	mov    %edx,-0x10(%ebp)
    212e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2131:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2135:	eb 2f                	jmp    2166 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    ...
    2158:	01 d0                	add    %edx,%eax
    215a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    215d:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    215f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    dst[j++] = '\0';
    217d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2180:	8d 50 01             	lea    0x1(%eax),%edx
    2183:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2186:	89 c2                	mov    %eax,%edx
    2188:	8b 45 08             	mov    0x8(%ebp),%eax
    218b:	01 d0                	add    %edx,%eax
    218d:	c6 00 00             	movb   $0x0,(%eax)
}
    2190:	90                   	nop
    2191:	c9                   	leave  
    2192:	c3                   	ret    
