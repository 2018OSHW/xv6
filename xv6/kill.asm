...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    1913:	a1 44 68 00 00       	mov    0x6844,%eax
    1918:	85 c0                	test   %eax,%eax
    191a:	0f 85 7a 02 00 00    	jne    1b9a <APGridPaint+0x290>
    {
        iconReady = 1;
    1920:	c7 05 44 68 00 00 01 	movl   $0x1,0x6844
    1927:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    192a:	8d 45 88             	lea    -0x78(%ebp),%eax
    192d:	83 ec 08             	sub    $0x8,%esp
    1930:	68 5f 25 00 00       	push   $0x255f
    1935:	50                   	push   %eax
    1936:	e8 d3 ef ff ff       	call   90e <APLoadBitmap>
    193b:	83 c4 0c             	add    $0xc,%esp
    193e:	8b 45 88             	mov    -0x78(%ebp),%eax
    1941:	a3 68 68 00 00       	mov    %eax,0x6868
    1946:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1949:	a3 6c 68 00 00       	mov    %eax,0x686c
    194e:	8b 45 90             	mov    -0x70(%ebp),%eax
    1951:	a3 70 68 00 00       	mov    %eax,0x6870
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    1956:	83 ec 04             	sub    $0x4,%esp
    1959:	ff 35 70 68 00 00    	pushl  0x6870
    195f:	ff 35 6c 68 00 00    	pushl  0x686c
    1965:	ff 35 68 68 00 00    	pushl  0x6868
    196b:	e8 d8 f1 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1970:	83 c4 10             	add    $0x10,%esp
    1973:	a3 74 68 00 00       	mov    %eax,0x6874
        grid_river = APLoadBitmap ("grid_river.bmp");
    1978:	8d 45 88             	lea    -0x78(%ebp),%eax
    197b:	83 ec 08             	sub    $0x8,%esp
    197e:	68 6d 25 00 00       	push   $0x256d
    1983:	50                   	push   %eax
    1984:	e8 85 ef ff ff       	call   90e <APLoadBitmap>
    1989:	83 c4 0c             	add    $0xc,%esp
    198c:	8b 45 88             	mov    -0x78(%ebp),%eax
    198f:	a3 b0 68 00 00       	mov    %eax,0x68b0
    1994:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1997:	a3 b4 68 00 00       	mov    %eax,0x68b4
    199c:	8b 45 90             	mov    -0x70(%ebp),%eax
    199f:	a3 b8 68 00 00       	mov    %eax,0x68b8
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    19a4:	83 ec 04             	sub    $0x4,%esp
    19a7:	ff 35 b8 68 00 00    	pushl  0x68b8
    19ad:	ff 35 b4 68 00 00    	pushl  0x68b4
    19b3:	ff 35 b0 68 00 00    	pushl  0x68b0
    19b9:	e8 8a f1 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    19be:	83 c4 10             	add    $0x10,%esp
    19c1:	a3 a0 68 00 00       	mov    %eax,0x68a0
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    19c6:	8d 45 88             	lea    -0x78(%ebp),%eax
    19c9:	83 ec 08             	sub    $0x8,%esp
    19cc:	68 7c 25 00 00       	push   $0x257c
    19d1:	50                   	push   %eax
    19d2:	e8 37 ef ff ff       	call   90e <APLoadBitmap>
    19d7:	83 c4 0c             	add    $0xc,%esp
    19da:	8b 45 88             	mov    -0x78(%ebp),%eax
    19dd:	a3 a4 68 00 00       	mov    %eax,0x68a4
    19e2:	8b 45 8c             	mov    -0x74(%ebp),%eax
    19e5:	a3 a8 68 00 00       	mov    %eax,0x68a8
    19ea:	8b 45 90             	mov    -0x70(%ebp),%eax
    19ed:	a3 ac 68 00 00       	mov    %eax,0x68ac
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    19f2:	83 ec 04             	sub    $0x4,%esp
    19f5:	ff 35 ac 68 00 00    	pushl  0x68ac
    19fb:	ff 35 a8 68 00 00    	pushl  0x68a8
    1a01:	ff 35 a4 68 00 00    	pushl  0x68a4
    1a07:	e8 3c f1 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1a0c:	83 c4 10             	add    $0x10,%esp
    1a0f:	a3 48 68 00 00       	mov    %eax,0x6848
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1a14:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a17:	83 ec 08             	sub    $0x8,%esp
    1a1a:	68 8b 25 00 00       	push   $0x258b
    1a1f:	50                   	push   %eax
    1a20:	e8 e9 ee ff ff       	call   90e <APLoadBitmap>
    1a25:	83 c4 0c             	add    $0xc,%esp
    1a28:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a2b:	a3 7c 68 00 00       	mov    %eax,0x687c
    1a30:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a33:	a3 80 68 00 00       	mov    %eax,0x6880
    1a38:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a3b:	a3 84 68 00 00       	mov    %eax,0x6884
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1a40:	83 ec 04             	sub    $0x4,%esp
    1a43:	ff 35 84 68 00 00    	pushl  0x6884
    1a49:	ff 35 80 68 00 00    	pushl  0x6880
    1a4f:	ff 35 7c 68 00 00    	pushl  0x687c
    1a55:	e8 ee f0 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1a5a:	83 c4 10             	add    $0x10,%esp
    1a5d:	a3 c0 68 00 00       	mov    %eax,0x68c0
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1a62:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a65:	83 ec 08             	sub    $0x8,%esp
    1a68:	68 99 25 00 00       	push   $0x2599
    1a6d:	50                   	push   %eax
    1a6e:	e8 9b ee ff ff       	call   90e <APLoadBitmap>
    1a73:	83 c4 0c             	add    $0xc,%esp
    1a76:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a79:	a3 58 68 00 00       	mov    %eax,0x6858
    1a7e:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a81:	a3 5c 68 00 00       	mov    %eax,0x685c
    1a86:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a89:	a3 60 68 00 00       	mov    %eax,0x6860
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1a8e:	83 ec 04             	sub    $0x4,%esp
    1a91:	ff 35 60 68 00 00    	pushl  0x6860
    1a97:	ff 35 5c 68 00 00    	pushl  0x685c
    1a9d:	ff 35 58 68 00 00    	pushl  0x6858
    1aa3:	e8 a0 f0 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1aa8:	83 c4 10             	add    $0x10,%esp
    1aab:	a3 78 68 00 00       	mov    %eax,0x6878
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1ab0:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ab3:	83 ec 08             	sub    $0x8,%esp
    1ab6:	68 a9 25 00 00       	push   $0x25a9
    1abb:	50                   	push   %eax
    1abc:	e8 4d ee ff ff       	call   90e <APLoadBitmap>
    1ac1:	83 c4 0c             	add    $0xc,%esp
    1ac4:	8b 45 88             	mov    -0x78(%ebp),%eax
    1ac7:	a3 4c 68 00 00       	mov    %eax,0x684c
    1acc:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1acf:	a3 50 68 00 00       	mov    %eax,0x6850
    1ad4:	8b 45 90             	mov    -0x70(%ebp),%eax
    1ad7:	a3 54 68 00 00       	mov    %eax,0x6854
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1adc:	83 ec 04             	sub    $0x4,%esp
    1adf:	ff 35 54 68 00 00    	pushl  0x6854
    1ae5:	ff 35 50 68 00 00    	pushl  0x6850
    1aeb:	ff 35 4c 68 00 00    	pushl  0x684c
    1af1:	e8 52 f0 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1af6:	83 c4 10             	add    $0x10,%esp
    1af9:	a3 64 68 00 00       	mov    %eax,0x6864
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1afe:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b01:	83 ec 08             	sub    $0x8,%esp
    1b04:	68 bb 25 00 00       	push   $0x25bb
    1b09:	50                   	push   %eax
    1b0a:	e8 ff ed ff ff       	call   90e <APLoadBitmap>
    1b0f:	83 c4 0c             	add    $0xc,%esp
    1b12:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b15:	a3 94 68 00 00       	mov    %eax,0x6894
    1b1a:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b1d:	a3 98 68 00 00       	mov    %eax,0x6898
    1b22:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b25:	a3 9c 68 00 00       	mov    %eax,0x689c
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1b2a:	83 ec 04             	sub    $0x4,%esp
    1b2d:	ff 35 9c 68 00 00    	pushl  0x689c
    1b33:	ff 35 98 68 00 00    	pushl  0x6898
    1b39:	ff 35 94 68 00 00    	pushl  0x6894
    1b3f:	e8 04 f0 ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1b44:	83 c4 10             	add    $0x10,%esp
    1b47:	a3 c4 68 00 00       	mov    %eax,0x68c4
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1b4c:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b4f:	83 ec 08             	sub    $0x8,%esp
    1b52:	68 ca 25 00 00       	push   $0x25ca
    1b57:	50                   	push   %eax
    1b58:	e8 b1 ed ff ff       	call   90e <APLoadBitmap>
    1b5d:	83 c4 0c             	add    $0xc,%esp
    1b60:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b63:	a3 88 68 00 00       	mov    %eax,0x6888
    1b68:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b6b:	a3 8c 68 00 00       	mov    %eax,0x688c
    1b70:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b73:	a3 90 68 00 00       	mov    %eax,0x6890
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1b78:	83 ec 04             	sub    $0x4,%esp
    1b7b:	ff 35 90 68 00 00    	pushl  0x6890
    1b81:	ff 35 8c 68 00 00    	pushl  0x688c
    1b87:	ff 35 88 68 00 00    	pushl  0x6888
    1b8d:	e8 b6 ef ff ff       	call   b48 <APCreateCompatibleDCFromBitmap>
    1b92:	83 c4 10             	add    $0x10,%esp
    1b95:	a3 bc 68 00 00       	mov    %eax,0x68bc
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1b9a:	8b 45 08             	mov    0x8(%ebp),%eax
    1b9d:	8b 40 08             	mov    0x8(%eax),%eax
    1ba0:	85 c0                	test   %eax,%eax
    1ba2:	75 17                	jne    1bbb <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1ba4:	83 ec 08             	sub    $0x8,%esp
    1ba7:	68 dc 25 00 00       	push   $0x25dc
    1bac:	6a 01                	push   $0x1
    1bae:	e8 d5 e8 ff ff       	call   488 <printf>
    1bb3:	83 c4 10             	add    $0x10,%esp
        return;
    1bb6:	e9 65 05 00 00       	jmp    2120 <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1bbb:	8b 45 08             	mov    0x8(%ebp),%eax
    1bbe:	8b 40 10             	mov    0x10(%eax),%eax
    1bc1:	85 c0                	test   %eax,%eax
    1bc3:	7e 10                	jle    1bd5 <APGridPaint+0x2cb>
    1bc5:	8b 45 08             	mov    0x8(%ebp),%eax
    1bc8:	8b 50 14             	mov    0x14(%eax),%edx
    1bcb:	8b 45 08             	mov    0x8(%ebp),%eax
    1bce:	8b 40 10             	mov    0x10(%eax),%eax
    1bd1:	39 c2                	cmp    %eax,%edx
    1bd3:	7c 17                	jl     1bec <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1bd5:	83 ec 08             	sub    $0x8,%esp
    1bd8:	68 02 26 00 00       	push   $0x2602
    1bdd:	6a 01                	push   $0x1
    1bdf:	e8 a4 e8 ff ff       	call   488 <printf>
    1be4:	83 c4 10             	add    $0x10,%esp
        return;
    1be7:	e9 34 05 00 00       	jmp    2120 <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1bec:	8b 45 08             	mov    0x8(%ebp),%eax
    1bef:	8b 40 14             	mov    0x14(%eax),%eax
    1bf2:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1bf8:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1bfb:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1bfe:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1c01:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1c08:	e9 f4 03 00 00       	jmp    2001 <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1c0d:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1c14:	e9 da 03 00 00       	jmp    1ff3 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1c19:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1c1c:	c1 e0 04             	shl    $0x4,%eax
    1c1f:	89 c2                	mov    %eax,%edx
    1c21:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1c24:	01 c2                	add    %eax,%edx
    1c26:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1c29:	01 d0                	add    %edx,%eax
    1c2b:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1c2e:	8b 45 08             	mov    0x8(%ebp),%eax
    1c31:	8b 40 0c             	mov    0xc(%eax),%eax
    1c34:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1c37:	c1 e2 02             	shl    $0x2,%edx
    1c3a:	01 d0                	add    %edx,%eax
    1c3c:	8b 00                	mov    (%eax),%eax
    1c3e:	83 f8 0a             	cmp    $0xa,%eax
    1c41:	0f 87 a7 03 00 00    	ja     1fee <APGridPaint+0x6e4>
    1c47:	8b 04 85 18 26 00 00 	mov    0x2618(,%eax,4),%eax
    1c4e:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1c50:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1c53:	6a 0c                	push   $0xc
    1c55:	6a 0c                	push   $0xc
    1c57:	6a 0c                	push   $0xc
    1c59:	50                   	push   %eax
    1c5a:	e8 91 f8 ff ff       	call   14f0 <RGB>
    1c5f:	83 c4 0c             	add    $0xc,%esp
    1c62:	8b 1d 74 68 00 00    	mov    0x6874,%ebx
    ...
    1c74:	89 45 84             	mov    %eax,-0x7c(%ebp)
    ...
    1c85:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1c89:	66 89 30             	mov    %si,(%eax)
    1c8c:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    ...
    1c9b:	53                   	push   %ebx
    1c9c:	51                   	push   %ecx
    1c9d:	ff 75 84             	pushl  -0x7c(%ebp)
    1ca0:	57                   	push   %edi
    1ca1:	e8 a6 f6 ff ff       	call   134c <APDcCopy>
    1ca6:	83 c4 30             	add    $0x30,%esp
                    break;
    1ca9:	e9 41 03 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1cae:	8d 45 88             	lea    -0x78(%ebp),%eax
    1cb1:	6a 69                	push   $0x69
    1cb3:	6a 69                	push   $0x69
    1cb5:	6a 69                	push   $0x69
    1cb7:	50                   	push   %eax
    1cb8:	e8 33 f8 ff ff       	call   14f0 <RGB>
    1cbd:	83 c4 0c             	add    $0xc,%esp
    1cc0:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1cc4:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1cc8:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1ccc:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1ccf:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1cd6:	8d 45 88             	lea    -0x78(%ebp),%eax
    1cd9:	6a 69                	push   $0x69
    1cdb:	6a 69                	push   $0x69
    1cdd:	6a 69                	push   $0x69
    1cdf:	50                   	push   %eax
    1ce0:	e8 0b f8 ff ff       	call   14f0 <RGB>
    1ce5:	83 c4 0c             	add    $0xc,%esp
    1ce8:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1cec:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1cf0:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1cf4:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1cf7:	8b 45 08             	mov    0x8(%ebp),%eax
    1cfa:	8d 50 3c             	lea    0x3c(%eax),%edx
    1cfd:	8d 45 88             	lea    -0x78(%ebp),%eax
    1d00:	ff 75 ac             	pushl  -0x54(%ebp)
    1d03:	ff 75 a8             	pushl  -0x58(%ebp)
    1d06:	52                   	push   %edx
    1d07:	50                   	push   %eax
    1d08:	e8 d0 ee ff ff       	call   bdd <APSetPen>
    1d0d:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1d10:	8b 45 08             	mov    0x8(%ebp),%eax
    1d13:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1d16:	8d 55 88             	lea    -0x78(%ebp),%edx
    1d19:	83 ec 04             	sub    $0x4,%esp
    1d1c:	83 ec 04             	sub    $0x4,%esp
    1d1f:	89 e0                	mov    %esp,%eax
    1d21:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1d25:	66 89 08             	mov    %cx,(%eax)
    1d28:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    1d2c:	88 48 02             	mov    %cl,0x2(%eax)
    1d2f:	53                   	push   %ebx
    1d30:	52                   	push   %edx
    1d31:	e8 e0 ee ff ff       	call   c16 <APSetBrush>
    1d36:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1d39:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1d3c:	6b d0 32             	imul   $0x32,%eax,%edx
    1d3f:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1d42:	6b c0 32             	imul   $0x32,%eax,%eax
    1d45:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1d48:	83 c1 3c             	add    $0x3c,%ecx
    1d4b:	83 ec 0c             	sub    $0xc,%esp
    1d4e:	6a 32                	push   $0x32
    1d50:	6a 32                	push   $0x32
    1d52:	52                   	push   %edx
    1d53:	50                   	push   %eax
    1d54:	51                   	push   %ecx
    1d55:	e8 e6 f2 ff ff       	call   1040 <APDrawRect>
    1d5a:	83 c4 20             	add    $0x20,%esp
                    break;
    1d5d:	e9 8d 02 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1d62:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1d65:	6a 0c                	push   $0xc
    1d67:	6a 0c                	push   $0xc
    1d69:	6a 0c                	push   $0xc
    1d6b:	50                   	push   %eax
    1d6c:	e8 7f f7 ff ff       	call   14f0 <RGB>
    1d71:	83 c4 0c             	add    $0xc,%esp
    1d74:	8b 1d c4 68 00 00    	mov    0x68c4,%ebx
    ...
    1d97:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1d9b:	66 89 30             	mov    %si,(%eax)
    1d9e:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    1db2:	57                   	push   %edi
    1db3:	e8 94 f5 ff ff       	call   134c <APDcCopy>
    1db8:	83 c4 30             	add    $0x30,%esp
                    break;
    1dbb:	e9 2f 02 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1dc0:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1dc3:	6a 0c                	push   $0xc
    1dc5:	6a 0c                	push   $0xc
    1dc7:	6a 0c                	push   $0xc
    1dc9:	50                   	push   %eax
    1dca:	e8 21 f7 ff ff       	call   14f0 <RGB>
    1dcf:	83 c4 0c             	add    $0xc,%esp
    1dd2:	8b 1d a0 68 00 00    	mov    0x68a0,%ebx
    ...
    1df5:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1df9:	66 89 30             	mov    %si,(%eax)
    1dfc:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    1e10:	57                   	push   %edi
    1e11:	e8 36 f5 ff ff       	call   134c <APDcCopy>
    1e16:	83 c4 30             	add    $0x30,%esp
                    break;
    1e19:	e9 d1 01 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e1e:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1e21:	6a 0c                	push   $0xc
    1e23:	6a 0c                	push   $0xc
    1e25:	6a 0c                	push   $0xc
    1e27:	50                   	push   %eax
    1e28:	e8 c3 f6 ff ff       	call   14f0 <RGB>
    1e2d:	83 c4 0c             	add    $0xc,%esp
    1e30:	8b 1d 78 68 00 00    	mov    0x6878,%ebx
    ...
    1e53:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1e57:	66 89 30             	mov    %si,(%eax)
    1e5a:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    1e6e:	57                   	push   %edi
    1e6f:	e8 d8 f4 ff ff       	call   134c <APDcCopy>
    1e74:	83 c4 30             	add    $0x30,%esp
                    break;
    1e77:	e9 73 01 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e7c:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1e7f:	6a 0c                	push   $0xc
    1e81:	6a 0c                	push   $0xc
    1e83:	6a 0c                	push   $0xc
    1e85:	50                   	push   %eax
    1e86:	e8 65 f6 ff ff       	call   14f0 <RGB>
    1e8b:	83 c4 0c             	add    $0xc,%esp
    1e8e:	8b 1d c0 68 00 00    	mov    0x68c0,%ebx
    ...
    1eb1:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1eb5:	66 89 30             	mov    %si,(%eax)
    1eb8:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    1ecc:	57                   	push   %edi
    1ecd:	e8 7a f4 ff ff       	call   134c <APDcCopy>
    1ed2:	83 c4 30             	add    $0x30,%esp
                    break;
    1ed5:	e9 15 01 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1eda:	8d 45 cf             	lea    -0x31(%ebp),%eax
    1edd:	6a 0c                	push   $0xc
    1edf:	6a 0c                	push   $0xc
    1ee1:	6a 0c                	push   $0xc
    1ee3:	50                   	push   %eax
    1ee4:	e8 07 f6 ff ff       	call   14f0 <RGB>
    1ee9:	83 c4 0c             	add    $0xc,%esp
    1eec:	8b 1d 48 68 00 00    	mov    0x6848,%ebx
    1ef2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ef5:	6b c8 32             	imul   $0x32,%eax,%ecx
    1ef8:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1efb:	6b c0 32             	imul   $0x32,%eax,%eax
    1efe:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f01:	8b 45 08             	mov    0x8(%ebp),%eax
    1f04:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f07:	83 ec 0c             	sub    $0xc,%esp
    1f0a:	83 ec 04             	sub    $0x4,%esp
    1f0d:	89 e0                	mov    %esp,%eax
    1f0f:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    1f13:	66 89 30             	mov    %si,(%eax)
    1f16:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    1f1a:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    1f25:	53                   	push   %ebx
    1f26:	51                   	push   %ecx
    1f27:	ff 75 84             	pushl  -0x7c(%ebp)
    1f2a:	57                   	push   %edi
    1f2b:	e8 1c f4 ff ff       	call   134c <APDcCopy>
    1f30:	83 c4 30             	add    $0x30,%esp
                    break;
    1f33:	e9 b7 00 00 00       	jmp    1fef <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f38:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    1f3b:	6a 0c                	push   $0xc
    1f3d:	6a 0c                	push   $0xc
    1f3f:	6a 0c                	push   $0xc
    1f41:	50                   	push   %eax
    1f42:	e8 a9 f5 ff ff       	call   14f0 <RGB>
    1f47:	83 c4 0c             	add    $0xc,%esp
    1f4a:	8b 1d 64 68 00 00    	mov    0x6864,%ebx
    1f50:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f53:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f56:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f59:	6b c0 32             	imul   $0x32,%eax,%eax
    1f5c:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f5f:	8b 45 08             	mov    0x8(%ebp),%eax
    1f62:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f65:	83 ec 0c             	sub    $0xc,%esp
    1f68:	83 ec 04             	sub    $0x4,%esp
    1f6b:	89 e0                	mov    %esp,%eax
    1f6d:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    1f71:	66 89 30             	mov    %si,(%eax)
    1f74:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    1f78:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    1f83:	53                   	push   %ebx
    1f84:	51                   	push   %ecx
    1f85:	ff 75 84             	pushl  -0x7c(%ebp)
    1f88:	57                   	push   %edi
    1f89:	e8 be f3 ff ff       	call   134c <APDcCopy>
    1f8e:	83 c4 30             	add    $0x30,%esp
                    break;
    1f91:	eb 5c                	jmp    1fef <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f93:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    1f96:	6a 0c                	push   $0xc
    1f98:	6a 0c                	push   $0xc
    1f9a:	6a 0c                	push   $0xc
    1f9c:	50                   	push   %eax
    1f9d:	e8 4e f5 ff ff       	call   14f0 <RGB>
    1fa2:	83 c4 0c             	add    $0xc,%esp
    1fa5:	8b 1d bc 68 00 00    	mov    0x68bc,%ebx
    1fab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fae:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fb1:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fb4:	6b c0 32             	imul   $0x32,%eax,%eax
    1fb7:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1fba:	8b 45 08             	mov    0x8(%ebp),%eax
    1fbd:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fc0:	83 ec 0c             	sub    $0xc,%esp
    1fc3:	83 ec 04             	sub    $0x4,%esp
    1fc6:	89 e0                	mov    %esp,%eax
    1fc8:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    1fcc:	66 89 30             	mov    %si,(%eax)
    1fcf:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    1fd3:	88 50 02             	mov    %dl,0x2(%eax)
    1fd6:	6a 32                	push   $0x32
    1fd8:	6a 32                	push   $0x32
    1fda:	6a 00                	push   $0x0
    1fdc:	6a 00                	push   $0x0
    1fde:	53                   	push   %ebx
    1fdf:	51                   	push   %ecx
    1fe0:	ff 75 84             	pushl  -0x7c(%ebp)
    1fe3:	57                   	push   %edi
    1fe4:	e8 63 f3 ff ff       	call   134c <APDcCopy>
    1fe9:	83 c4 30             	add    $0x30,%esp
                    break;
    1fec:	eb 01                	jmp    1fef <APGridPaint+0x6e5>
                default: break;
    1fee:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1fef:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    1ff3:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    1ff7:	0f 8e 1c fc ff ff    	jle    1c19 <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1ffd:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    2001:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    2005:	0f 8e 02 fc ff ff    	jle    1c0d <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    200b:	8d 45 88             	lea    -0x78(%ebp),%eax
    200e:	68 cd 00 00 00       	push   $0xcd
    2013:	6a 74                	push   $0x74
    2015:	6a 18                	push   $0x18
    2017:	50                   	push   %eax
    2018:	e8 d3 f4 ff ff       	call   14f0 <RGB>
    201d:	83 c4 0c             	add    $0xc,%esp
    2020:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2024:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    2028:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    202c:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    202f:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2036:	8d 45 88             	lea    -0x78(%ebp),%eax
    2039:	68 cd 00 00 00       	push   $0xcd
    203e:	6a 74                	push   $0x74
    2040:	6a 18                	push   $0x18
    2042:	50                   	push   %eax
    2043:	e8 a8 f4 ff ff       	call   14f0 <RGB>
    2048:	83 c4 0c             	add    $0xc,%esp
    204b:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    204f:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    2053:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2057:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    205a:	8b 45 08             	mov    0x8(%ebp),%eax
    205d:	8d 50 58             	lea    0x58(%eax),%edx
    2060:	8d 45 88             	lea    -0x78(%ebp),%eax
    2063:	ff 75 bc             	pushl  -0x44(%ebp)
    2066:	ff 75 b8             	pushl  -0x48(%ebp)
    2069:	52                   	push   %edx
    206a:	50                   	push   %eax
    206b:	e8 6d eb ff ff       	call   bdd <APSetPen>
    2070:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    2073:	8b 45 08             	mov    0x8(%ebp),%eax
    2076:	8d 58 58             	lea    0x58(%eax),%ebx
    2079:	8d 55 88             	lea    -0x78(%ebp),%edx
    207c:	83 ec 04             	sub    $0x4,%esp
    207f:	83 ec 04             	sub    $0x4,%esp
    2082:	89 e0                	mov    %esp,%eax
    2084:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    2088:	66 89 08             	mov    %cx,(%eax)
    208b:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    208f:	88 48 02             	mov    %cl,0x2(%eax)
    2092:	53                   	push   %ebx
    2093:	52                   	push   %edx
    2094:	e8 7d eb ff ff       	call   c16 <APSetBrush>
    2099:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    209c:	8b 45 08             	mov    0x8(%ebp),%eax
    209f:	83 c0 58             	add    $0x58,%eax
    20a2:	83 ec 0c             	sub    $0xc,%esp
    20a5:	6a 32                	push   $0x32
    20a7:	68 20 03 00 00       	push   $0x320
    20ac:	6a 00                	push   $0x0
    20ae:	6a 00                	push   $0x0
    20b0:	50                   	push   %eax
    20b1:	e8 8a ef ff ff       	call   1040 <APDrawRect>
    20b6:	83 c4 20             	add    $0x20,%esp


    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    20b9:	8d 45 88             	lea    -0x78(%ebp),%eax
    20bc:	6a 08                	push   $0x8
    20be:	6a 08                	push   $0x8
    20c0:	6a 08                	push   $0x8
    20c2:	50                   	push   %eax
    20c3:	e8 28 f4 ff ff       	call   14f0 <RGB>
    20c8:	83 c4 0c             	add    $0xc,%esp
    20cb:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    20cf:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    20d3:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    20d7:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    20eb:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    20ef:	66 89 08             	mov    %cx,(%eax)
    20f2:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    20f6:	88 48 02             	mov    %cl,0x2(%eax)
    20f9:	53                   	push   %ebx
    20fa:	52                   	push   %edx
    20fb:	e8 58 eb ff ff       	call   c58 <APSetFont>
    2100:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    2103:	8b 45 08             	mov    0x8(%ebp),%eax
    2106:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    210c:	8b 45 08             	mov    0x8(%ebp),%eax
    210f:	83 c0 58             	add    $0x58,%eax
    2112:	6a 14                	push   $0x14
    2114:	6a 14                	push   $0x14
    2116:	52                   	push   %edx
    2117:	50                   	push   %eax
    2118:	e8 28 f1 ff ff       	call   1245 <APDrawText>
