...
00000422 <registWindow>:
SYSCALL(registWindow)
 422:	b8 18 00 00 00       	mov    $0x18,%eax
 427:	cd 40                	int    $0x40
 429:	c3                   	ret    

0000042a <changePosition>:
