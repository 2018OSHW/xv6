...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 50 2d 00 00 	mov    0x2d50(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 24 2d 00 00       	push   $0x2d24
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 4b 2d 00 00       	push   $0x2d4b
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 68 2d 00 00       	push   $0x2d68
     259:	6a 02                	push   $0x2
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 6b 2d 00 00       	push   $0x2d6b
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2e9:	0f b6 05 40 37 00 00 	movzbl 0x3740,%eax
     2f0:	3c 63                	cmp    $0x63,%al
     2f2:	75 5f                	jne    353 <main+0xb3>
     2f4:	0f b6 05 41 37 00 00 	movzbl 0x3741,%eax
     2fb:	3c 64                	cmp    $0x64,%al
     2fd:	75 54                	jne    353 <main+0xb3>
     2ff:	0f b6 05 42 37 00 00 	movzbl 0x3742,%eax
     ...
     30d:	68 40 37 00 00       	push   $0x3740
     312:	e8 fc 09 00 00       	call   d13 <strlen>
     317:	83 c4 10             	add    $0x10,%esp
     31a:	83 e8 01             	sub    $0x1,%eax
     31d:	c6 80 40 37 00 00 00 	movb   $0x0,0x3740(%eax)
      if(chdir(buf+3) < 0)
     324:	b8 43 37 00 00       	mov    $0x3743,%eax
     ...
     339:	b8 43 37 00 00       	mov    $0x3743,%eax
     33e:	83 ec 04             	sub    $0x4,%esp
     341:	50                   	push   %eax
     342:	68 73 2d 00 00       	push   $0x2d73
     347:	6a 02                	push   $0x2
    ...
    if(fork1() == 0)
     ...
     35f:	68 40 37 00 00       	push   $0x3740
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     380:	6a 64                	push   $0x64
     382:	68 40 37 00 00       	push   $0x3740
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 81 2d 00 00       	push   $0x2d81
     3ad:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 85 2d 00 00       	push   $0x2d85
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 f8 36 00 00       	push   $0x36f8
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 f8 36 00 00       	push   $0x36f8
     ...
     63c:	50                   	push   %eax
     63d:	68 00 37 00 00       	push   $0x3700
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 f8 36 00 00       	push   $0x36f8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 f8 36 00 00       	push   $0x36f8
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 8a 2d 00 00       	push   $0x2d8a
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 a1 2d 00 00       	push   $0x2da1
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 a3 2d 00 00       	push   $0x2da3
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 a5 2d 00 00       	push   $0x2da5
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 a7 2d 00 00       	push   $0x2da7
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 c4 2d 00 00       	push   $0x2dc4
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 c7 2d 00 00       	push   $0x2dc7
    ...
    panic("parseblock");
     ...
     9c4:	68 c9 2d 00 00       	push   $0x2dc9
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 d4 2d 00 00       	push   $0x2dd4
    ...
    panic("syntax - missing )");
     ...
     a14:	68 d6 2d 00 00       	push   $0x2dd6
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 c7 2d 00 00       	push   $0x2dc7
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 9a 2d 00 00       	push   $0x2d9a
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 e9 2d 00 00       	push   $0x2de9
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 f7 2d 00 00       	push   $0x2df7
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 fc 2d 00 00 	mov    0x2dfc(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1018:	0f b6 80 08 37 00 00 	movzbl 0x3708(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1154:	75 25                	jne    117b <printf+0xff>
          s = "(null)";
    1156:	c7 45 f4 14 2e 00 00 	movl   $0x2e14,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    121c:	a1 ac 37 00 00       	mov    0x37ac,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    12e7:	a3 ac 37 00 00       	mov    %eax,0x37ac
}
    12ec:	90                   	nop
    12ed:	c9                   	leave  
    12ee:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1348:	a1 ac 37 00 00       	mov    0x37ac,%eax
}
    134d:	c9                   	leave  
    134e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1364:	a1 ac 37 00 00       	mov    0x37ac,%eax
    1369:	89 45 f0             	mov    %eax,-0x10(%ebp)
    136c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1370:	75 23                	jne    1395 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1372:	c7 45 f0 a4 37 00 00 	movl   $0x37a4,-0x10(%ebp)
    1379:	8b 45 f0             	mov    -0x10(%ebp),%eax
    137c:	a3 ac 37 00 00       	mov    %eax,0x37ac
    1381:	a1 ac 37 00 00       	mov    0x37ac,%eax
    1386:	a3 a4 37 00 00       	mov    %eax,0x37a4
    base.s.size = 0;
    138b:	c7 05 a8 37 00 00 00 	movl   $0x0,0x37a8
    1392:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13e8:	a3 ac 37 00 00       	mov    %eax,0x37ac
      return (void*)(p + 1);
    ...
    if(p == freep)
    13f5:	a1 ac 37 00 00       	mov    0x37ac,%eax
...
ABitmap APLoadBitmap(char * filename)
{
    ...
    153b:	68 1b 2e 00 00       	push   $0x2e1b
    1540:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    2023:	68 2c 2e 00 00       	push   $0x2e2c
    2028:	6a 01                	push   $0x1
    ...
    2096:	68 4c 2e 00 00       	push   $0x2e4c
    209b:	6a 01                	push   $0x1
    ...
    213a:	68 70 2e 00 00       	push   $0x2e70
    213f:	6a 01                	push   $0x1
    ...
    220b:	68 98 2e 00 00       	push   $0x2e98
    2210:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    259d:	68 2c 2f 00 00       	push   $0x2f2c
    25a2:	6a 01                	push   $0x1
    ...
    25ce:	68 52 2f 00 00       	push   $0x2f52
    25d3:	6a 01                	push   $0x1
    ...
    263d:	8b 04 85 68 2f 00 00 	mov    0x2f68(,%eax,4),%eax
    2644:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    2658:	8b 1d e0 37 00 00    	mov    0x37e0,%ebx
    ...
    276a:	8b 1d 20 38 00 00    	mov    0x3820,%ebx
    ...
    27c8:	8b 1d 00 38 00 00    	mov    0x3800,%ebx
    ...
    2826:	8b 1d e4 37 00 00    	mov    0x37e4,%ebx
    ...
    2884:	8b 1d 1c 38 00 00    	mov    0x381c,%ebx
    ...
    28e2:	8b 1d b4 37 00 00    	mov    0x37b4,%ebx
    ...
    293d:	8b 1d d0 37 00 00    	mov    0x37d0,%ebx
...
if (seed > 0)
    29ae:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    29b2:	7e 08                	jle    29bc <random+0x11>
{
rand_num = seed;
    29b4:	8b 45 08             	mov    0x8(%ebp),%eax
    29b7:	a3 1c 37 00 00       	mov    %eax,0x371c
}
rand_num *= 3;
    29bc:	8b 15 1c 37 00 00    	mov    0x371c,%edx
    29c2:	89 d0                	mov    %edx,%eax
    29c4:	01 c0                	add    %eax,%eax
    29c6:	01 d0                	add    %edx,%eax
    29c8:	a3 1c 37 00 00       	mov    %eax,0x371c
if (rand_num < 0)
    29cd:	a1 1c 37 00 00       	mov    0x371c,%eax
    29d2:	85 c0                	test   %eax,%eax
    29d4:	79 0c                	jns    29e2 <random+0x37>
{
rand_num *= (-1);
    29d6:	a1 1c 37 00 00       	mov    0x371c,%eax
    29db:	f7 d8                	neg    %eax
    29dd:	a3 1c 37 00 00       	mov    %eax,0x371c
}
return rand_num % 997;
    29e2:	8b 0d 1c 37 00 00    	mov    0x371c,%ecx
    29e8:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    29ed:	89 c8                	mov    %ecx,%eax
    29ef:	f7 ea                	imul   %edx
    29f1:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    29f4:	c1 f8 09             	sar    $0x9,%eax
    29f7:	89 c2                	mov    %eax,%edx
    29f9:	89 c8                	mov    %ecx,%eax
    29fb:	c1 f8 1f             	sar    $0x1f,%eax
    29fe:	29 c2                	sub    %eax,%edx
    2a00:	89 d0                	mov    %edx,%eax
    2a02:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    2a08:	29 c1                	sub    %eax,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    2a15:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    2a1c:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    2a20:	74 17                	je     2a39 <sprintint+0x2b>
    2a22:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    2a26:	79 11                	jns    2a39 <sprintint+0x2b>
        neg = 1;
    2a28:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    2a2f:	8b 45 10             	mov    0x10(%ebp),%eax
    2a32:	f7 d8                	neg    %eax
    2a34:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2a37:	eb 06                	jmp    2a3f <sprintint+0x31>
    } else {
        x = xx;
    2a39:	8b 45 10             	mov    0x10(%ebp),%eax
    2a3c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    2a3f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    2a46:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    2a49:	8d 41 01             	lea    0x1(%ecx),%eax
    2a4c:	89 45 f8             	mov    %eax,-0x8(%ebp)
    2a4f:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2a52:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2a55:	ba 00 00 00 00       	mov    $0x0,%edx
    2a5a:	f7 f3                	div    %ebx
    2a5c:	89 d0                	mov    %edx,%eax
    2a5e:	0f b6 80 20 37 00 00 	movzbl 0x3720(%eax),%eax
    2a65:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    2a69:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2a6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2a6f:	ba 00 00 00 00       	mov    $0x0,%edx
    2a74:	f7 f3                	div    %ebx
    2a76:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2a79:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    2a7d:	75 c7                	jne    2a46 <sprintint+0x38>
    if(neg)
    2a7f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2a83:	74 0e                	je     2a93 <sprintint+0x85>
        buf[i++] = '-';
    2a85:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2a88:	8d 50 01             	lea    0x1(%eax),%edx
    2a8b:	89 55 f8             	mov    %edx,-0x8(%ebp)
    2a8e:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    2a93:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2a96:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2a99:	eb 1b                	jmp    2ab6 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2a9b:	8b 45 0c             	mov    0xc(%ebp),%eax
    2a9e:	8b 00                	mov    (%eax),%eax
    2aa0:	8d 48 01             	lea    0x1(%eax),%ecx
    2aa3:	8b 55 0c             	mov    0xc(%ebp),%edx
    2aa6:	89 0a                	mov    %ecx,(%edx)
    2aa8:	89 c2                	mov    %eax,%edx
    2aaa:	8b 45 08             	mov    0x8(%ebp),%eax
    2aad:	01 d0                	add    %edx,%eax
    2aaf:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    2ab2:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2ab6:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2aba:	7f df                	jg     2a9b <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2abc:	eb 21                	jmp    2adf <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    2abe:	8b 45 0c             	mov    0xc(%ebp),%eax
    2ac1:	8b 00                	mov    (%eax),%eax
    2ac3:	8d 48 01             	lea    0x1(%eax),%ecx
    2ac6:	8b 55 0c             	mov    0xc(%ebp),%edx
    2ac9:	89 0a                	mov    %ecx,(%edx)
    2acb:	89 c2                	mov    %eax,%edx
    2acd:	8b 45 08             	mov    0x8(%ebp),%eax
    2ad0:	01 c2                	add    %eax,%edx
    2ad2:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2ad5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2ad8:	01 c8                	add    %ecx,%eax
    2ada:	0f b6 00             	movzbl (%eax),%eax
    2add:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2adf:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2ae3:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2ae7:	79 d5                	jns    2abe <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2ae9:	90                   	nop
    2aea:	83 c4 20             	add    $0x20,%esp
    2aed:	5b                   	pop    %ebx
    2aee:	5d                   	pop    %ebp
    2aef:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2af3:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    2af6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    2afd:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2b04:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    2b0b:	8d 45 0c             	lea    0xc(%ebp),%eax
    2b0e:	83 c0 04             	add    $0x4,%eax
    2b11:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2b14:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    2b1b:	e9 d9 01 00 00       	jmp    2cf9 <sprintf+0x209>
        c = fmt[i] & 0xff;
    2b20:	8b 55 0c             	mov    0xc(%ebp),%edx
    2b23:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2b26:	01 d0                	add    %edx,%eax
    2b28:	0f b6 00             	movzbl (%eax),%eax
    2b2b:	0f be c0             	movsbl %al,%eax
    2b2e:	25 ff 00 00 00       	and    $0xff,%eax
    2b33:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    2b36:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    2b3a:	75 2c                	jne    2b68 <sprintf+0x78>
            if(c == '%'){
    2b3c:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2b40:	75 0c                	jne    2b4e <sprintf+0x5e>
                state = '%';
    2b42:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    2b49:	e9 a7 01 00 00       	jmp    2cf5 <sprintf+0x205>
            } else {
                dst[j++] = c;
    2b4e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2b51:	8d 50 01             	lea    0x1(%eax),%edx
    2b54:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2b57:	89 c2                	mov    %eax,%edx
    2b59:	8b 45 08             	mov    0x8(%ebp),%eax
    2b5c:	01 d0                	add    %edx,%eax
    2b5e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2b61:	88 10                	mov    %dl,(%eax)
    2b63:	e9 8d 01 00 00       	jmp    2cf5 <sprintf+0x205>
            }
        } else if(state == '%'){
    2b68:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    2b6c:	0f 85 83 01 00 00    	jne    2cf5 <sprintf+0x205>
            if(c == 'd'){
    2b72:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2b76:	75 4c                	jne    2bc4 <sprintf+0xd4>
                buf[bi] = '\0';
    2b78:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2b7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2b7e:	01 d0                	add    %edx,%eax
    2b80:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2b83:	83 ec 0c             	sub    $0xc,%esp
    2b86:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2b89:	50                   	push   %eax
    2b8a:	e8 b4 e2 ff ff       	call   e43 <atoi>
    2b8f:	83 c4 10             	add    $0x10,%esp
    2b92:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2b95:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2b9c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2b9f:	8b 00                	mov    (%eax),%eax
    2ba1:	83 ec 08             	sub    $0x8,%esp
    2ba4:	ff 75 d8             	pushl  -0x28(%ebp)
    2ba7:	6a 01                	push   $0x1
    2ba9:	6a 0a                	push   $0xa
    2bab:	50                   	push   %eax
    2bac:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2baf:	50                   	push   %eax
    2bb0:	ff 75 08             	pushl  0x8(%ebp)
    2bb3:	e8 56 fe ff ff       	call   2a0e <sprintint>
    2bb8:	83 c4 20             	add    $0x20,%esp
                ap++;
    2bbb:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2bbf:	e9 2a 01 00 00       	jmp    2cee <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2bc4:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2bc8:	74 06                	je     2bd0 <sprintf+0xe0>
    2bca:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    2bce:	75 4c                	jne    2c1c <sprintf+0x12c>
                buf[bi] = '\0';
    2bd0:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2bd3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2bd6:	01 d0                	add    %edx,%eax
    2bd8:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2bdb:	83 ec 0c             	sub    $0xc,%esp
    2bde:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2be1:	50                   	push   %eax
    2be2:	e8 5c e2 ff ff       	call   e43 <atoi>
    2be7:	83 c4 10             	add    $0x10,%esp
    2bea:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    2bed:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2bf4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2bf7:	8b 00                	mov    (%eax),%eax
    2bf9:	83 ec 08             	sub    $0x8,%esp
    2bfc:	ff 75 dc             	pushl  -0x24(%ebp)
    2bff:	6a 00                	push   $0x0
    2c01:	6a 10                	push   $0x10
    2c03:	50                   	push   %eax
    2c04:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2c07:	50                   	push   %eax
    2c08:	ff 75 08             	pushl  0x8(%ebp)
    2c0b:	e8 fe fd ff ff       	call   2a0e <sprintint>
    2c10:	83 c4 20             	add    $0x20,%esp
                ap++;
    2c13:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2c17:	e9 d2 00 00 00       	jmp    2cee <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    2c1c:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2c20:	75 46                	jne    2c68 <sprintf+0x178>
                s = (char*)*ap;
    2c22:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2c25:	8b 00                	mov    (%eax),%eax
    2c27:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    2c2a:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    2c2e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2c32:	75 25                	jne    2c59 <sprintf+0x169>
                    s = "(null)";
    2c34:	c7 45 f4 88 2f 00 00 	movl   $0x2f88,-0xc(%ebp)
                while(*s != 0){
    2c3b:	eb 1c                	jmp    2c59 <sprintf+0x169>
                    dst[j++] = *s;
    2c3d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2c40:	8d 50 01             	lea    0x1(%eax),%edx
    2c43:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2c46:	89 c2                	mov    %eax,%edx
    2c48:	8b 45 08             	mov    0x8(%ebp),%eax
    2c4b:	01 c2                	add    %eax,%edx
    2c4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2c50:	0f b6 00             	movzbl (%eax),%eax
    2c53:	88 02                	mov    %al,(%edx)
                    s++;
    2c55:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    2c59:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2c5c:	0f b6 00             	movzbl (%eax),%eax
    2c5f:	84 c0                	test   %al,%al
    2c61:	75 da                	jne    2c3d <sprintf+0x14d>
    2c63:	e9 86 00 00 00       	jmp    2cee <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    2c68:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    2c6c:	75 1d                	jne    2c8b <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    2c7c:	01 c2                	add    %eax,%edx
    2c7e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2c81:	8b 00                	mov    (%eax),%eax
    2c83:	88 02                	mov    %al,(%edx)
                ap++;
    2c85:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2c89:	eb 63                	jmp    2cee <sprintf+0x1fe>
            } else if(c == '%'){
    2c8b:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2c8f:	75 17                	jne    2ca8 <sprintf+0x1b8>
                dst[j++] = c;
    2c91:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2c94:	8d 50 01             	lea    0x1(%eax),%edx
    2c97:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2c9a:	89 c2                	mov    %eax,%edx
    2c9c:	8b 45 08             	mov    0x8(%ebp),%eax
    2c9f:	01 d0                	add    %edx,%eax
    2ca1:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2ca4:	88 10                	mov    %dl,(%eax)
    2ca6:	eb 46                	jmp    2cee <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2ca8:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2cac:	7e 18                	jle    2cc6 <sprintf+0x1d6>
    2cae:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2cb2:	7f 12                	jg     2cc6 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2cb4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2cb7:	8d 50 01             	lea    0x1(%eax),%edx
    2cba:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2cbd:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2cc0:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2cc4:	eb 2f                	jmp    2cf5 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2cc6:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2cc9:	8d 50 01             	lea    0x1(%eax),%edx
    2ccc:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2ccf:	89 c2                	mov    %eax,%edx
    2cd1:	8b 45 08             	mov    0x8(%ebp),%eax
    2cd4:	01 d0                	add    %edx,%eax
    2cd6:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    2cd9:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2cdc:	8d 50 01             	lea    0x1(%eax),%edx
    2cdf:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2ce2:	89 c2                	mov    %eax,%edx
    2ce4:	8b 45 08             	mov    0x8(%ebp),%eax
    2ce7:	01 d0                	add    %edx,%eax
    2ce9:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2cec:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    2cee:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2cf5:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2cf9:	8b 55 0c             	mov    0xc(%ebp),%edx
    2cfc:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2cff:	01 d0                	add    %edx,%eax
    2d01:	0f b6 00             	movzbl (%eax),%eax
    2d04:	84 c0                	test   %al,%al
    2d06:	0f 85 14 fe ff ff    	jne    2b20 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    2d0c:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2d0f:	8d 50 01             	lea    0x1(%eax),%edx
    2d12:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2d15:	89 c2                	mov    %eax,%edx
    2d17:	8b 45 08             	mov    0x8(%ebp),%eax
    2d1a:	01 d0                	add    %edx,%eax
    2d1c:	c6 00 00             	movb   $0x0,(%eax)
}
    2d1f:	90                   	nop
    2d20:	c9                   	leave  
    2d21:	c3                   	ret    
