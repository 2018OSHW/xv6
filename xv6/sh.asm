...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 48 31 00 00 	mov    0x3148(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 1c 31 00 00       	push   $0x311c
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 43 31 00 00       	push   $0x3143
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 60 31 00 00       	push   $0x3160
     259:	6a 02                	push   $0x2
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 63 31 00 00       	push   $0x3163
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2e9:	0f b6 05 00 78 00 00 	movzbl 0x7800,%eax
     2f0:	3c 63                	cmp    $0x63,%al
     2f2:	75 5f                	jne    353 <main+0xb3>
     2f4:	0f b6 05 01 78 00 00 	movzbl 0x7801,%eax
     2fb:	3c 64                	cmp    $0x64,%al
     2fd:	75 54                	jne    353 <main+0xb3>
     2ff:	0f b6 05 02 78 00 00 	movzbl 0x7802,%eax
     ...
     30d:	68 00 78 00 00       	push   $0x7800
     312:	e8 fc 09 00 00       	call   d13 <strlen>
     317:	83 c4 10             	add    $0x10,%esp
     31a:	83 e8 01             	sub    $0x1,%eax
     31d:	c6 80 00 78 00 00 00 	movb   $0x0,0x7800(%eax)
      if(chdir(buf+3) < 0)
     324:	b8 03 78 00 00       	mov    $0x7803,%eax
     ...
     339:	b8 03 78 00 00       	mov    $0x7803,%eax
     33e:	83 ec 04             	sub    $0x4,%esp
     341:	50                   	push   %eax
     342:	68 6b 31 00 00       	push   $0x316b
     347:	6a 02                	push   $0x2
    ...
    if(fork1() == 0)
     ...
     35f:	68 00 78 00 00       	push   $0x7800
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     380:	6a 64                	push   $0x64
     382:	68 00 78 00 00       	push   $0x7800
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 79 31 00 00       	push   $0x3179
     3ad:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 7d 31 00 00       	push   $0x317d
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 80 3b 00 00       	push   $0x3b80
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 80 3b 00 00       	push   $0x3b80
     ...
     63c:	50                   	push   %eax
     63d:	68 88 3b 00 00       	push   $0x3b88
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 80 3b 00 00       	push   $0x3b80
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 80 3b 00 00       	push   $0x3b80
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 82 31 00 00       	push   $0x3182
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 99 31 00 00       	push   $0x3199
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 9b 31 00 00       	push   $0x319b
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 9d 31 00 00       	push   $0x319d
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 9f 31 00 00       	push   $0x319f
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 bc 31 00 00       	push   $0x31bc
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 bf 31 00 00       	push   $0x31bf
    ...
    panic("parseblock");
     ...
     9c4:	68 c1 31 00 00       	push   $0x31c1
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 cc 31 00 00       	push   $0x31cc
    ...
    panic("syntax - missing )");
     ...
     a14:	68 ce 31 00 00       	push   $0x31ce
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 bf 31 00 00       	push   $0x31bf
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 92 31 00 00       	push   $0x3192
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 e1 31 00 00       	push   $0x31e1
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 ef 31 00 00       	push   $0x31ef
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 f4 31 00 00 	mov    0x31f4(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1030:	0f b6 80 90 3b 00 00 	movzbl 0x3b90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    116c:	75 25                	jne    1193 <printf+0xff>
          s = "(null)";
    116e:	c7 45 f4 0c 32 00 00 	movl   $0x320c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1234:	a1 6c 78 00 00       	mov    0x786c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    12ff:	a3 6c 78 00 00       	mov    %eax,0x786c
}
    1304:	90                   	nop
    1305:	c9                   	leave  
    1306:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1360:	a1 6c 78 00 00       	mov    0x786c,%eax
}
    1365:	c9                   	leave  
    1366:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    137c:	a1 6c 78 00 00       	mov    0x786c,%eax
    1381:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1384:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1388:	75 23                	jne    13ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    138a:	c7 45 f0 64 78 00 00 	movl   $0x7864,-0x10(%ebp)
    1391:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1394:	a3 6c 78 00 00       	mov    %eax,0x786c
    1399:	a1 6c 78 00 00       	mov    0x786c,%eax
    139e:	a3 64 78 00 00       	mov    %eax,0x7864
    base.s.size = 0;
    13a3:	c7 05 68 78 00 00 00 	movl   $0x0,0x7868
    13aa:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1400:	a3 6c 78 00 00       	mov    %eax,0x786c
      return (void*)(p + 1);
    ...
    if(p == freep)
    140d:	a1 6c 78 00 00       	mov    0x786c,%eax
...
ABitmap APLoadBitmap(char * filename)
{
    ...
    1553:	68 13 32 00 00       	push   $0x3213
    1558:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    1ef7:	05 c0 3b 00 00       	add    $0x3bc0,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    2184:	68 24 32 00 00       	push   $0x3224
    2189:	6a 01                	push   $0x1
    ...
    21f9:	68 44 32 00 00       	push   $0x3244
    21fe:	6a 01                	push   $0x1
    ...
    229d:	68 68 32 00 00       	push   $0x3268
    22a2:	6a 01                	push   $0x1
    ...
    2382:	68 90 32 00 00       	push   $0x3290
    2387:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    246b:	e8 19 08 00 00       	call   2c89 <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    2868:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    286e:	89 45 dc             	mov    %eax,-0x24(%ebp)
    2871:	8b 45 dc             	mov    -0x24(%ebp),%eax
    2874:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2877:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    287e:	e9 f4 03 00 00       	jmp    2c77 <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    2883:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    288a:	e9 da 03 00 00       	jmp    2c69 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    288f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2892:	c1 e0 04             	shl    $0x4,%eax
    2895:	89 c2                	mov    %eax,%edx
    2897:	8b 45 d8             	mov    -0x28(%ebp),%eax
    289a:	01 c2                	add    %eax,%edx
    289c:	8b 45 e0             	mov    -0x20(%ebp),%eax
    289f:	01 d0                	add    %edx,%eax
    28a1:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    28a4:	8b 45 08             	mov    0x8(%ebp),%eax
    28a7:	8b 40 0c             	mov    0xc(%eax),%eax
    28aa:	8b 55 dc             	mov    -0x24(%ebp),%edx
    28ad:	c1 e2 02             	shl    $0x2,%edx
    28b0:	01 d0                	add    %edx,%eax
    28b2:	8b 00                	mov    (%eax),%eax
    28b4:	83 f8 0a             	cmp    $0xa,%eax
    28b7:	0f 87 a7 03 00 00    	ja     2c64 <APGridPaint+0x6e4>
    28bd:	8b 04 85 70 33 00 00 	mov    0x3370(,%eax,4),%eax
    28c4:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    28c6:	8d 45 c0             	lea    -0x40(%ebp),%eax
    28c9:	6a 0c                	push   $0xc
    28cb:	6a 0c                	push   $0xc
    28cd:	6a 0c                	push   $0xc
    28cf:	50                   	push   %eax
    28d0:	e8 27 f8 ff ff       	call   20fc <RGB>
    28d5:	83 c4 0c             	add    $0xc,%esp
    28d8:	8b 1d a0 78 00 00    	mov    0x78a0,%ebx
    28de:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    28e1:	6b c8 32             	imul   $0x32,%eax,%ecx
    28e4:	8b 45 e0             	mov    -0x20(%ebp),%eax
    28e7:	6b c0 32             	imul   $0x32,%eax,%eax
    28ea:	89 45 94             	mov    %eax,-0x6c(%ebp)
    28ed:	8b 45 08             	mov    0x8(%ebp),%eax
    28f0:	8d 78 3c             	lea    0x3c(%eax),%edi
    28f3:	83 ec 0c             	sub    $0xc,%esp
    28f6:	83 ec 04             	sub    $0x4,%esp
    28f9:	89 e0                	mov    %esp,%eax
    28fb:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    28ff:	66 89 30             	mov    %si,(%eax)
    2902:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    2906:	88 50 02             	mov    %dl,0x2(%eax)
    2909:	6a 32                	push   $0x32
    290b:	6a 32                	push   $0x32
    290d:	6a 00                	push   $0x0
    290f:	6a 00                	push   $0x0
    2911:	53                   	push   %ebx
    2912:	51                   	push   %ecx
    2913:	ff 75 94             	pushl  -0x6c(%ebp)
    2916:	57                   	push   %edi
    2917:	e8 3c f6 ff ff       	call   1f58 <APDcCopy>
    291c:	83 c4 30             	add    $0x30,%esp
                    break;
    291f:	e9 41 03 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    2924:	8d 45 98             	lea    -0x68(%ebp),%eax
    2927:	6a 69                	push   $0x69
    2929:	6a 69                	push   $0x69
    292b:	6a 69                	push   $0x69
    292d:	50                   	push   %eax
    292e:	e8 c9 f7 ff ff       	call   20fc <RGB>
    2933:	83 c4 0c             	add    $0xc,%esp
    2936:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    293a:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    293e:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    2942:	88 45 ba             	mov    %al,-0x46(%ebp)
                    pen.size = 1;
    2945:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    294c:	8d 45 98             	lea    -0x68(%ebp),%eax
    294f:	6a 69                	push   $0x69
    2951:	6a 69                	push   $0x69
    2953:	6a 69                	push   $0x69
    2955:	50                   	push   %eax
    2956:	e8 a1 f7 ff ff       	call   20fc <RGB>
    295b:	83 c4 0c             	add    $0xc,%esp
    295e:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    2962:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    2966:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    296a:	88 45 b7             	mov    %al,-0x49(%ebp)
                    APSetPen(&wnd->Dc,pen);
    296d:	8b 45 08             	mov    0x8(%ebp),%eax
    2970:	8d 50 3c             	lea    0x3c(%eax),%edx
    2973:	8d 45 98             	lea    -0x68(%ebp),%eax
    2976:	ff 75 bc             	pushl  -0x44(%ebp)
    2979:	ff 75 b8             	pushl  -0x48(%ebp)
    297c:	52                   	push   %edx
    297d:	50                   	push   %eax
    297e:	e8 66 ee ff ff       	call   17e9 <APSetPen>
    2983:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    2986:	8b 45 08             	mov    0x8(%ebp),%eax
    2989:	8d 58 3c             	lea    0x3c(%eax),%ebx
    298c:	8d 55 98             	lea    -0x68(%ebp),%edx
    298f:	83 ec 04             	sub    $0x4,%esp
    2992:	83 ec 04             	sub    $0x4,%esp
    2995:	89 e0                	mov    %esp,%eax
    2997:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    299b:	66 89 08             	mov    %cx,(%eax)
    299e:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    29a2:	88 48 02             	mov    %cl,0x2(%eax)
    29a5:	53                   	push   %ebx
    29a6:	52                   	push   %edx
    29a7:	e8 76 ee ff ff       	call   1822 <APSetBrush>
    29ac:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    29af:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    29b2:	6b d0 32             	imul   $0x32,%eax,%edx
    29b5:	8b 45 e0             	mov    -0x20(%ebp),%eax
    29b8:	6b c0 32             	imul   $0x32,%eax,%eax
    29bb:	8b 4d 08             	mov    0x8(%ebp),%ecx
    29be:	83 c1 3c             	add    $0x3c,%ecx
    29c1:	83 ec 0c             	sub    $0xc,%esp
    29c4:	6a 32                	push   $0x32
    29c6:	6a 32                	push   $0x32
    29c8:	52                   	push   %edx
    29c9:	50                   	push   %eax
    29ca:	51                   	push   %ecx
    29cb:	e8 7c f2 ff ff       	call   1c4c <APDrawRect>
    29d0:	83 c4 20             	add    $0x20,%esp
                    break;
    29d3:	e9 8d 02 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    29d8:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    29db:	6a 0c                	push   $0xc
    29dd:	6a 0c                	push   $0xc
    29df:	6a 0c                	push   $0xc
    29e1:	50                   	push   %eax
    29e2:	e8 15 f7 ff ff       	call   20fc <RGB>
    29e7:	83 c4 0c             	add    $0xc,%esp
    29ea:	8b 1d f0 78 00 00    	mov    0x78f0,%ebx
    29f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    29f3:	6b c8 32             	imul   $0x32,%eax,%ecx
    29f6:	8b 45 e0             	mov    -0x20(%ebp),%eax
    29f9:	6b c0 32             	imul   $0x32,%eax,%eax
    29fc:	89 45 94             	mov    %eax,-0x6c(%ebp)
    29ff:	8b 45 08             	mov    0x8(%ebp),%eax
    2a02:	8d 78 3c             	lea    0x3c(%eax),%edi
    2a05:	83 ec 0c             	sub    $0xc,%esp
    2a08:	83 ec 04             	sub    $0x4,%esp
    2a0b:	89 e0                	mov    %esp,%eax
    2a0d:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    2a11:	66 89 30             	mov    %si,(%eax)
    2a14:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    2a18:	88 50 02             	mov    %dl,0x2(%eax)
    2a1b:	6a 32                	push   $0x32
    2a1d:	6a 32                	push   $0x32
    2a1f:	6a 00                	push   $0x0
    2a21:	6a 00                	push   $0x0
    2a23:	53                   	push   %ebx
    2a24:	51                   	push   %ecx
    2a25:	ff 75 94             	pushl  -0x6c(%ebp)
    2a28:	57                   	push   %edi
    2a29:	e8 2a f5 ff ff       	call   1f58 <APDcCopy>
    2a2e:	83 c4 30             	add    $0x30,%esp
                    break;
    2a31:	e9 2f 02 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2a36:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    2a39:	6a 0c                	push   $0xc
    2a3b:	6a 0c                	push   $0xc
    2a3d:	6a 0c                	push   $0xc
    2a3f:	50                   	push   %eax
    2a40:	e8 b7 f6 ff ff       	call   20fc <RGB>
    2a45:	83 c4 0c             	add    $0xc,%esp
    2a48:	8b 1d cc 78 00 00    	mov    0x78cc,%ebx
    2a4e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2a51:	6b c8 32             	imul   $0x32,%eax,%ecx
    2a54:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2a57:	6b c0 32             	imul   $0x32,%eax,%eax
    2a5a:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2a5d:	8b 45 08             	mov    0x8(%ebp),%eax
    2a60:	8d 78 3c             	lea    0x3c(%eax),%edi
    2a63:	83 ec 0c             	sub    $0xc,%esp
    2a66:	83 ec 04             	sub    $0x4,%esp
    2a69:	89 e0                	mov    %esp,%eax
    2a6b:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    2a6f:	66 89 30             	mov    %si,(%eax)
    2a72:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    2a76:	88 50 02             	mov    %dl,0x2(%eax)
    2a79:	6a 32                	push   $0x32
    2a7b:	6a 32                	push   $0x32
    2a7d:	6a 00                	push   $0x0
    2a7f:	6a 00                	push   $0x0
    2a81:	53                   	push   %ebx
    2a82:	51                   	push   %ecx
    2a83:	ff 75 94             	pushl  -0x6c(%ebp)
    2a86:	57                   	push   %edi
    2a87:	e8 cc f4 ff ff       	call   1f58 <APDcCopy>
    2a8c:	83 c4 30             	add    $0x30,%esp
                    break;
    2a8f:	e9 d1 01 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2a94:	8d 45 c9             	lea    -0x37(%ebp),%eax
    2a97:	6a 0c                	push   $0xc
    2a99:	6a 0c                	push   $0xc
    2a9b:	6a 0c                	push   $0xc
    2a9d:	50                   	push   %eax
    2a9e:	e8 59 f6 ff ff       	call   20fc <RGB>
    2aa3:	83 c4 0c             	add    $0xc,%esp
    2aa6:	8b 1d a4 78 00 00    	mov    0x78a4,%ebx
    2aac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2aaf:	6b c8 32             	imul   $0x32,%eax,%ecx
    2ab2:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2ab5:	6b c0 32             	imul   $0x32,%eax,%eax
    2ab8:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2abb:	8b 45 08             	mov    0x8(%ebp),%eax
    2abe:	8d 78 3c             	lea    0x3c(%eax),%edi
    2ac1:	83 ec 0c             	sub    $0xc,%esp
    2ac4:	83 ec 04             	sub    $0x4,%esp
    2ac7:	89 e0                	mov    %esp,%eax
    2ac9:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    2acd:	66 89 30             	mov    %si,(%eax)
    2ad0:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    2ad4:	88 50 02             	mov    %dl,0x2(%eax)
    2ad7:	6a 32                	push   $0x32
    2ad9:	6a 32                	push   $0x32
    2adb:	6a 00                	push   $0x0
    2add:	6a 00                	push   $0x0
    2adf:	53                   	push   %ebx
    2ae0:	51                   	push   %ecx
    2ae1:	ff 75 94             	pushl  -0x6c(%ebp)
    2ae4:	57                   	push   %edi
    2ae5:	e8 6e f4 ff ff       	call   1f58 <APDcCopy>
    2aea:	83 c4 30             	add    $0x30,%esp
                    break;
    2aed:	e9 73 01 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2af2:	8d 45 cc             	lea    -0x34(%ebp),%eax
    2af5:	6a 0c                	push   $0xc
    2af7:	6a 0c                	push   $0xc
    2af9:	6a 0c                	push   $0xc
    2afb:	50                   	push   %eax
    2afc:	e8 fb f5 ff ff       	call   20fc <RGB>
    2b01:	83 c4 0c             	add    $0xc,%esp
    2b04:	8b 1d ec 78 00 00    	mov    0x78ec,%ebx
    2b0a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2b0d:	6b c8 32             	imul   $0x32,%eax,%ecx
    2b10:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2b13:	6b c0 32             	imul   $0x32,%eax,%eax
    2b16:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2b19:	8b 45 08             	mov    0x8(%ebp),%eax
    2b1c:	8d 78 3c             	lea    0x3c(%eax),%edi
    2b1f:	83 ec 0c             	sub    $0xc,%esp
    2b22:	83 ec 04             	sub    $0x4,%esp
    2b25:	89 e0                	mov    %esp,%eax
    2b27:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    2b2b:	66 89 30             	mov    %si,(%eax)
    2b2e:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    2b32:	88 50 02             	mov    %dl,0x2(%eax)
    2b35:	6a 32                	push   $0x32
    2b37:	6a 32                	push   $0x32
    2b39:	6a 00                	push   $0x0
    2b3b:	6a 00                	push   $0x0
    2b3d:	53                   	push   %ebx
    2b3e:	51                   	push   %ecx
    2b3f:	ff 75 94             	pushl  -0x6c(%ebp)
    2b42:	57                   	push   %edi
    2b43:	e8 10 f4 ff ff       	call   1f58 <APDcCopy>
    2b48:	83 c4 30             	add    $0x30,%esp
                    break;
    2b4b:	e9 15 01 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2b50:	8d 45 cf             	lea    -0x31(%ebp),%eax
    2b53:	6a 0c                	push   $0xc
    2b55:	6a 0c                	push   $0xc
    2b57:	6a 0c                	push   $0xc
    2b59:	50                   	push   %eax
    2b5a:	e8 9d f5 ff ff       	call   20fc <RGB>
    2b5f:	83 c4 0c             	add    $0xc,%esp
    2b62:	8b 1d 74 78 00 00    	mov    0x7874,%ebx
    2b68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2b6b:	6b c8 32             	imul   $0x32,%eax,%ecx
    2b6e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2b71:	6b c0 32             	imul   $0x32,%eax,%eax
    2b74:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2b77:	8b 45 08             	mov    0x8(%ebp),%eax
    2b7a:	8d 78 3c             	lea    0x3c(%eax),%edi
    2b7d:	83 ec 0c             	sub    $0xc,%esp
    2b80:	83 ec 04             	sub    $0x4,%esp
    2b83:	89 e0                	mov    %esp,%eax
    2b85:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    2b89:	66 89 30             	mov    %si,(%eax)
    2b8c:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2b90:	88 50 02             	mov    %dl,0x2(%eax)
    2b93:	6a 32                	push   $0x32
    2b95:	6a 32                	push   $0x32
    2b97:	6a 00                	push   $0x0
    2b99:	6a 00                	push   $0x0
    2b9b:	53                   	push   %ebx
    2b9c:	51                   	push   %ecx
    2b9d:	ff 75 94             	pushl  -0x6c(%ebp)
    2ba0:	57                   	push   %edi
    2ba1:	e8 b2 f3 ff ff       	call   1f58 <APDcCopy>
    2ba6:	83 c4 30             	add    $0x30,%esp
                    break;
    2ba9:	e9 b7 00 00 00       	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2bae:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2bb1:	6a 0c                	push   $0xc
    2bb3:	6a 0c                	push   $0xc
    2bb5:	6a 0c                	push   $0xc
    2bb7:	50                   	push   %eax
    2bb8:	e8 3f f5 ff ff       	call   20fc <RGB>
    2bbd:	83 c4 0c             	add    $0xc,%esp
    2bc0:	8b 1d 90 78 00 00    	mov    0x7890,%ebx
    2bc6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2bc9:	6b c8 32             	imul   $0x32,%eax,%ecx
    2bcc:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2bcf:	6b c0 32             	imul   $0x32,%eax,%eax
    2bd2:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2bd5:	8b 45 08             	mov    0x8(%ebp),%eax
    2bd8:	8d 78 3c             	lea    0x3c(%eax),%edi
    2bdb:	83 ec 0c             	sub    $0xc,%esp
    2bde:	83 ec 04             	sub    $0x4,%esp
    2be1:	89 e0                	mov    %esp,%eax
    2be3:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    2be7:	66 89 30             	mov    %si,(%eax)
    2bea:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2bee:	88 50 02             	mov    %dl,0x2(%eax)
    2bf1:	6a 32                	push   $0x32
    2bf3:	6a 32                	push   $0x32
    2bf5:	6a 00                	push   $0x0
    2bf7:	6a 00                	push   $0x0
    2bf9:	53                   	push   %ebx
    2bfa:	51                   	push   %ecx
    2bfb:	ff 75 94             	pushl  -0x6c(%ebp)
    2bfe:	57                   	push   %edi
    2bff:	e8 54 f3 ff ff       	call   1f58 <APDcCopy>
    2c04:	83 c4 30             	add    $0x30,%esp
                    break;
    2c07:	eb 5c                	jmp    2c65 <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2c09:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    2c0c:	6a 0c                	push   $0xc
    2c0e:	6a 0c                	push   $0xc
    2c10:	6a 0c                	push   $0xc
    2c12:	50                   	push   %eax
    2c13:	e8 e4 f4 ff ff       	call   20fc <RGB>
    2c18:	83 c4 0c             	add    $0xc,%esp
    2c1b:	8b 1d e8 78 00 00    	mov    0x78e8,%ebx
    2c21:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2c24:	6b c8 32             	imul   $0x32,%eax,%ecx
    2c27:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2c2a:	6b c0 32             	imul   $0x32,%eax,%eax
    2c2d:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2c30:	8b 45 08             	mov    0x8(%ebp),%eax
    2c33:	8d 78 3c             	lea    0x3c(%eax),%edi
    2c36:	83 ec 0c             	sub    $0xc,%esp
    2c39:	83 ec 04             	sub    $0x4,%esp
    2c3c:	89 e0                	mov    %esp,%eax
    2c3e:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    2c42:	66 89 30             	mov    %si,(%eax)
    2c45:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    2c49:	88 50 02             	mov    %dl,0x2(%eax)
    2c4c:	6a 32                	push   $0x32
    2c4e:	6a 32                	push   $0x32
    2c50:	6a 00                	push   $0x0
    2c52:	6a 00                	push   $0x0
    2c54:	53                   	push   %ebx
    2c55:	51                   	push   %ecx
    2c56:	ff 75 94             	pushl  -0x6c(%ebp)
    2c59:	57                   	push   %edi
    2c5a:	e8 f9 f2 ff ff       	call   1f58 <APDcCopy>
    2c5f:	83 c4 30             	add    $0x30,%esp
                    break;
    2c62:	eb 01                	jmp    2c65 <APGridPaint+0x6e5>
                default: break;
    2c64:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    2c65:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    2c69:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2c6d:	0f 8e 1c fc ff ff    	jle    288f <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2c73:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    2c77:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    2c7b:	0f 8e 02 fc ff ff    	jle    2883 <APGridPaint+0x303>
                default: break;
            }
        }
    }
...
void updateword(AHwnd hwnd,char* str)
{
    ...
    2c8c:	53                   	push   %ebx
    2c8d:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    2c90:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2c93:	68 cd 00 00 00       	push   $0xcd
    2c98:	6a 74                	push   $0x74
    2c9a:	6a 18                	push   $0x18
    2c9c:	50                   	push   %eax
    2c9d:	e8 5a f4 ff ff       	call   20fc <RGB>
    2ca2:	83 c4 0c             	add    $0xc,%esp
    2ca5:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2ca9:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    2cad:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2cb1:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    2cb4:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2cbb:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2cbe:	68 cd 00 00 00       	push   $0xcd
    2cc3:	6a 74                	push   $0x74
    2cc5:	6a 18                	push   $0x18
    2cc7:	50                   	push   %eax
    2cc8:	e8 2f f4 ff ff       	call   20fc <RGB>
    2ccd:	83 c4 0c             	add    $0xc,%esp
    2cd0:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2cd4:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    2cd8:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2cdc:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    2cdf:	8b 45 08             	mov    0x8(%ebp),%eax
    2ce2:	8d 50 58             	lea    0x58(%eax),%edx
    2ce5:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2ce8:	ff 75 f4             	pushl  -0xc(%ebp)
    2ceb:	ff 75 f0             	pushl  -0x10(%ebp)
    2cee:	52                   	push   %edx
    2cef:	50                   	push   %eax
    2cf0:	e8 f4 ea ff ff       	call   17e9 <APSetPen>
    2cf5:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    2cf8:	8b 45 08             	mov    0x8(%ebp),%eax
    2cfb:	8d 58 58             	lea    0x58(%eax),%ebx
    2cfe:	8d 55 d8             	lea    -0x28(%ebp),%edx
    2d01:	83 ec 04             	sub    $0x4,%esp
    2d04:	83 ec 04             	sub    $0x4,%esp
    2d07:	89 e0                	mov    %esp,%eax
    2d09:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    2d0d:	66 89 08             	mov    %cx,(%eax)
    2d10:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    2d14:	88 48 02             	mov    %cl,0x2(%eax)
    2d17:	53                   	push   %ebx
    2d18:	52                   	push   %edx
    2d19:	e8 04 eb ff ff       	call   1822 <APSetBrush>
    2d1e:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    2d21:	8b 45 08             	mov    0x8(%ebp),%eax
    2d24:	83 c0 58             	add    $0x58,%eax
    2d27:	83 ec 0c             	sub    $0xc,%esp
    2d2a:	6a 32                	push   $0x32
    2d2c:	68 20 03 00 00       	push   $0x320
    2d31:	6a 00                	push   $0x0
    2d33:	6a 00                	push   $0x0
    2d35:	50                   	push   %eax
    2d36:	e8 11 ef ff ff       	call   1c4c <APDrawRect>
    2d3b:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    2d3e:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2d41:	6a 08                	push   $0x8
    2d43:	6a 08                	push   $0x8
    2d45:	6a 08                	push   $0x8
    2d47:	50                   	push   %eax
    2d48:	e8 af f3 ff ff       	call   20fc <RGB>
    2d4d:	83 c4 0c             	add    $0xc,%esp
    2d50:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2d54:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    2d58:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2d5c:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    2d5f:	8b 45 08             	mov    0x8(%ebp),%eax
    2d62:	8d 58 58             	lea    0x58(%eax),%ebx
    2d65:	8d 55 d8             	lea    -0x28(%ebp),%edx
    2d68:	83 ec 04             	sub    $0x4,%esp
    2d6b:	83 ec 04             	sub    $0x4,%esp
    2d6e:	89 e0                	mov    %esp,%eax
    2d70:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    2d74:	66 89 08             	mov    %cx,(%eax)
    2d77:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    2d7b:	88 48 02             	mov    %cl,0x2(%eax)
    2d7e:	53                   	push   %ebx
    2d7f:	52                   	push   %edx
    2d80:	e8 df ea ff ff       	call   1864 <APSetFont>
    2d85:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    2d88:	8b 45 08             	mov    0x8(%ebp),%eax
    2d8b:	83 c0 58             	add    $0x58,%eax
    2d8e:	6a 14                	push   $0x14
    2d90:	6a 0a                	push   $0xa
    2d92:	ff 75 0c             	pushl  0xc(%ebp)
    2d95:	50                   	push   %eax
    2d96:	e8 b6 f0 ff ff       	call   1e51 <APDrawText>
    2d9b:	83 c4 10             	add    $0x10,%esp
}
    2d9e:	90                   	nop
    2d9f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2da2:	c9                   	leave  
    2da3:	c3                   	ret    
...
if (seed > 0)
    2da7:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    2dab:	7e 08                	jle    2db5 <random+0x11>
{
rand_num = seed;
    2dad:	8b 45 08             	mov    0x8(%ebp),%eax
    2db0:	a3 e0 77 00 00       	mov    %eax,0x77e0
}
rand_num *= 3;
    2db5:	8b 15 e0 77 00 00    	mov    0x77e0,%edx
    2dbb:	89 d0                	mov    %edx,%eax
    2dbd:	01 c0                	add    %eax,%eax
    2dbf:	01 d0                	add    %edx,%eax
    2dc1:	a3 e0 77 00 00       	mov    %eax,0x77e0
if (rand_num < 0)
    2dc6:	a1 e0 77 00 00       	mov    0x77e0,%eax
    2dcb:	85 c0                	test   %eax,%eax
    2dcd:	79 0c                	jns    2ddb <random+0x37>
{
rand_num *= (-1);
    2dcf:	a1 e0 77 00 00       	mov    0x77e0,%eax
    2dd4:	f7 d8                	neg    %eax
    2dd6:	a3 e0 77 00 00       	mov    %eax,0x77e0
}
return rand_num % 997;
    2ddb:	8b 0d e0 77 00 00    	mov    0x77e0,%ecx
    2de1:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    2de6:	89 c8                	mov    %ecx,%eax
    2de8:	f7 ea                	imul   %edx
    2dea:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    2ded:	c1 f8 09             	sar    $0x9,%eax
    2df0:	89 c2                	mov    %eax,%edx
    2df2:	89 c8                	mov    %ecx,%eax
    2df4:	c1 f8 1f             	sar    $0x1f,%eax
    2df7:	29 c2                	sub    %eax,%edx
    2df9:	89 d0                	mov    %edx,%eax
    2dfb:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    2e01:	29 c1                	sub    %eax,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    2e0e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    2e15:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    2e19:	74 17                	je     2e32 <sprintint+0x2b>
    2e1b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    2e1f:	79 11                	jns    2e32 <sprintint+0x2b>
        neg = 1;
    2e21:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    2e28:	8b 45 10             	mov    0x10(%ebp),%eax
    2e2b:	f7 d8                	neg    %eax
    2e2d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2e30:	eb 06                	jmp    2e38 <sprintint+0x31>
    } else {
        x = xx;
    2e32:	8b 45 10             	mov    0x10(%ebp),%eax
    2e35:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    2e38:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    2e3f:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    2e42:	8d 41 01             	lea    0x1(%ecx),%eax
    2e45:	89 45 f8             	mov    %eax,-0x8(%ebp)
    2e48:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2e4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2e4e:	ba 00 00 00 00       	mov    $0x0,%edx
    2e53:	f7 f3                	div    %ebx
    2e55:	89 d0                	mov    %edx,%eax
    2e57:	0f b6 80 e4 77 00 00 	movzbl 0x77e4(%eax),%eax
    2e5e:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    2e62:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2e65:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2e68:	ba 00 00 00 00       	mov    $0x0,%edx
    2e6d:	f7 f3                	div    %ebx
    2e6f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2e72:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    2e76:	75 c7                	jne    2e3f <sprintint+0x38>
    if(neg)
    2e78:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2e7c:	74 0e                	je     2e8c <sprintint+0x85>
        buf[i++] = '-';
    2e7e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2e81:	8d 50 01             	lea    0x1(%eax),%edx
    2e84:	89 55 f8             	mov    %edx,-0x8(%ebp)
    2e87:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    2e8c:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2e8f:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2e92:	eb 1b                	jmp    2eaf <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2e94:	8b 45 0c             	mov    0xc(%ebp),%eax
    2e97:	8b 00                	mov    (%eax),%eax
    2e99:	8d 48 01             	lea    0x1(%eax),%ecx
    2e9c:	8b 55 0c             	mov    0xc(%ebp),%edx
    2e9f:	89 0a                	mov    %ecx,(%edx)
    2ea1:	89 c2                	mov    %eax,%edx
    2ea3:	8b 45 08             	mov    0x8(%ebp),%eax
    2ea6:	01 d0                	add    %edx,%eax
    2ea8:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    2eab:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2eaf:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2eb3:	7f df                	jg     2e94 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2eb5:	eb 21                	jmp    2ed8 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    2eb7:	8b 45 0c             	mov    0xc(%ebp),%eax
    2eba:	8b 00                	mov    (%eax),%eax
    2ebc:	8d 48 01             	lea    0x1(%eax),%ecx
    2ebf:	8b 55 0c             	mov    0xc(%ebp),%edx
    2ec2:	89 0a                	mov    %ecx,(%edx)
    2ec4:	89 c2                	mov    %eax,%edx
    2ec6:	8b 45 08             	mov    0x8(%ebp),%eax
    2ec9:	01 c2                	add    %eax,%edx
    2ecb:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2ece:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2ed1:	01 c8                	add    %ecx,%eax
    2ed3:	0f b6 00             	movzbl (%eax),%eax
    2ed6:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2ed8:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2edc:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2ee0:	79 d5                	jns    2eb7 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2ee2:	90                   	nop
    2ee3:	83 c4 20             	add    $0x20,%esp
    2ee6:	5b                   	pop    %ebx
    2ee7:	5d                   	pop    %ebp
    2ee8:	c3                   	ret    
...
{
    2ee9:	55                   	push   %ebp
    2eea:	89 e5                	mov    %esp,%ebp
    2eec:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    2eef:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    2ef6:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2efd:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    2f04:	8d 45 0c             	lea    0xc(%ebp),%eax
    2f07:	83 c0 04             	add    $0x4,%eax
    2f0a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2f0d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    2f14:	e9 d9 01 00 00       	jmp    30f2 <sprintf+0x209>
        c = fmt[i] & 0xff;
    2f19:	8b 55 0c             	mov    0xc(%ebp),%edx
    2f1c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2f1f:	01 d0                	add    %edx,%eax
    2f21:	0f b6 00             	movzbl (%eax),%eax
    2f24:	0f be c0             	movsbl %al,%eax
    2f27:	25 ff 00 00 00       	and    $0xff,%eax
    2f2c:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    2f2f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    2f33:	75 2c                	jne    2f61 <sprintf+0x78>
            if(c == '%'){
    2f35:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2f39:	75 0c                	jne    2f47 <sprintf+0x5e>
                state = '%';
    2f3b:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    2f42:	e9 a7 01 00 00       	jmp    30ee <sprintf+0x205>
            } else {
                dst[j++] = c;
    2f47:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2f4a:	8d 50 01             	lea    0x1(%eax),%edx
    2f4d:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2f50:	89 c2                	mov    %eax,%edx
    2f52:	8b 45 08             	mov    0x8(%ebp),%eax
    2f55:	01 d0                	add    %edx,%eax
    2f57:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2f5a:	88 10                	mov    %dl,(%eax)
    2f5c:	e9 8d 01 00 00       	jmp    30ee <sprintf+0x205>
            }
        } else if(state == '%'){
    2f61:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    2f65:	0f 85 83 01 00 00    	jne    30ee <sprintf+0x205>
            if(c == 'd'){
    2f6b:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2f6f:	75 4c                	jne    2fbd <sprintf+0xd4>
                buf[bi] = '\0';
    2f71:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2f74:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2f77:	01 d0                	add    %edx,%eax
    2f79:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2f7c:	83 ec 0c             	sub    $0xc,%esp
    2f7f:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2f82:	50                   	push   %eax
    2f83:	e8 bb de ff ff       	call   e43 <atoi>
    2f88:	83 c4 10             	add    $0x10,%esp
    2f8b:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2f8e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2f95:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2f98:	8b 00                	mov    (%eax),%eax
    2f9a:	83 ec 08             	sub    $0x8,%esp
    2f9d:	ff 75 d8             	pushl  -0x28(%ebp)
    2fa0:	6a 01                	push   $0x1
    2fa2:	6a 0a                	push   $0xa
    2fa4:	50                   	push   %eax
    2fa5:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2fa8:	50                   	push   %eax
    2fa9:	ff 75 08             	pushl  0x8(%ebp)
    2fac:	e8 56 fe ff ff       	call   2e07 <sprintint>
    2fb1:	83 c4 20             	add    $0x20,%esp
                ap++;
    2fb4:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2fb8:	e9 2a 01 00 00       	jmp    30e7 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2fbd:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2fc1:	74 06                	je     2fc9 <sprintf+0xe0>
    2fc3:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    2fc7:	75 4c                	jne    3015 <sprintf+0x12c>
                buf[bi] = '\0';
    2fc9:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2fcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2fcf:	01 d0                	add    %edx,%eax
    2fd1:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2fd4:	83 ec 0c             	sub    $0xc,%esp
    2fd7:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2fda:	50                   	push   %eax
    2fdb:	e8 63 de ff ff       	call   e43 <atoi>
    2fe0:	83 c4 10             	add    $0x10,%esp
    2fe3:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    2fe6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2fed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2ff0:	8b 00                	mov    (%eax),%eax
    2ff2:	83 ec 08             	sub    $0x8,%esp
    2ff5:	ff 75 dc             	pushl  -0x24(%ebp)
    2ff8:	6a 00                	push   $0x0
    2ffa:	6a 10                	push   $0x10
    2ffc:	50                   	push   %eax
    2ffd:	8d 45 c8             	lea    -0x38(%ebp),%eax
    3000:	50                   	push   %eax
    3001:	ff 75 08             	pushl  0x8(%ebp)
    3004:	e8 fe fd ff ff       	call   2e07 <sprintint>
    3009:	83 c4 20             	add    $0x20,%esp
                ap++;
    300c:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    3010:	e9 d2 00 00 00       	jmp    30e7 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    3015:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    3019:	75 46                	jne    3061 <sprintf+0x178>
                s = (char*)*ap;
    301b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    301e:	8b 00                	mov    (%eax),%eax
    3020:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    3023:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    3027:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    302b:	75 25                	jne    3052 <sprintf+0x169>
                    s = "(null)";
    302d:	c7 45 f4 9c 33 00 00 	movl   $0x339c,-0xc(%ebp)
                while(*s != 0){
    3034:	eb 1c                	jmp    3052 <sprintf+0x169>
                    dst[j++] = *s;
    3036:	8b 45 c8             	mov    -0x38(%ebp),%eax
    3039:	8d 50 01             	lea    0x1(%eax),%edx
    303c:	89 55 c8             	mov    %edx,-0x38(%ebp)
    303f:	89 c2                	mov    %eax,%edx
    3041:	8b 45 08             	mov    0x8(%ebp),%eax
    3044:	01 c2                	add    %eax,%edx
    3046:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3049:	0f b6 00             	movzbl (%eax),%eax
    304c:	88 02                	mov    %al,(%edx)
                    s++;
    304e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
    ...
    3055:	0f b6 00             	movzbl (%eax),%eax
    3058:	84 c0                	test   %al,%al
    305a:	75 da                	jne    3036 <sprintf+0x14d>
    305c:	e9 86 00 00 00       	jmp    30e7 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    3061:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    3065:	75 1d                	jne    3084 <sprintf+0x19b>
                dst[j++] = *ap;
    3067:	8b 45 c8             	mov    -0x38(%ebp),%eax
    306a:	8d 50 01             	lea    0x1(%eax),%edx
    306d:	89 55 c8             	mov    %edx,-0x38(%ebp)
    3070:	89 c2                	mov    %eax,%edx
    3072:	8b 45 08             	mov    0x8(%ebp),%eax
    3075:	01 c2                	add    %eax,%edx
    3077:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    307a:	8b 00                	mov    (%eax),%eax
    307c:	88 02                	mov    %al,(%edx)
                ap++;
    307e:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    3082:	eb 63                	jmp    30e7 <sprintf+0x1fe>
            } else if(c == '%'){
    3084:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    3088:	75 17                	jne    30a1 <sprintf+0x1b8>
                dst[j++] = c;
    308a:	8b 45 c8             	mov    -0x38(%ebp),%eax
    308d:	8d 50 01             	lea    0x1(%eax),%edx
    3090:	89 55 c8             	mov    %edx,-0x38(%ebp)
    3093:	89 c2                	mov    %eax,%edx
    3095:	8b 45 08             	mov    0x8(%ebp),%eax
    3098:	01 d0                	add    %edx,%eax
    309a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    309d:	88 10                	mov    %dl,(%eax)
    309f:	eb 46                	jmp    30e7 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    30a1:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    30a5:	7e 18                	jle    30bf <sprintf+0x1d6>
    30a7:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    30ab:	7f 12                	jg     30bf <sprintf+0x1d6>
            {
                buf[bi++] = c;
    30ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
    30b0:	8d 50 01             	lea    0x1(%eax),%edx
    30b3:	89 55 f0             	mov    %edx,-0x10(%ebp)
    30b6:	8b 55 e0             	mov    -0x20(%ebp),%edx
    30b9:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    30bd:	eb 2f                	jmp    30ee <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    30bf:	8b 45 c8             	mov    -0x38(%ebp),%eax
    30c2:	8d 50 01             	lea    0x1(%eax),%edx
    30c5:	89 55 c8             	mov    %edx,-0x38(%ebp)
    30c8:	89 c2                	mov    %eax,%edx
    30ca:	8b 45 08             	mov    0x8(%ebp),%eax
    30cd:	01 d0                	add    %edx,%eax
    30cf:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    30d2:	8b 45 c8             	mov    -0x38(%ebp),%eax
    30d5:	8d 50 01             	lea    0x1(%eax),%edx
    30d8:	89 55 c8             	mov    %edx,-0x38(%ebp)
    30db:	89 c2                	mov    %eax,%edx
    30dd:	8b 45 08             	mov    0x8(%ebp),%eax
    30e0:	01 d0                	add    %edx,%eax
    30e2:	8b 55 e0             	mov    -0x20(%ebp),%edx
    30e5:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    30e7:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    30ee:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    30f2:	8b 55 0c             	mov    0xc(%ebp),%edx
    30f5:	8b 45 ec             	mov    -0x14(%ebp),%eax
    30f8:	01 d0                	add    %edx,%eax
    30fa:	0f b6 00             	movzbl (%eax),%eax
    30fd:	84 c0                	test   %al,%al
    30ff:	0f 85 14 fe ff ff    	jne    2f19 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    3105:	8b 45 c8             	mov    -0x38(%ebp),%eax
    3108:	8d 50 01             	lea    0x1(%eax),%edx
    310b:	89 55 c8             	mov    %edx,-0x38(%ebp)
    310e:	89 c2                	mov    %eax,%edx
    3110:	8b 45 08             	mov    0x8(%ebp),%eax
    3113:	01 d0                	add    %edx,%eax
    3115:	c6 00 00             	movb   $0x0,(%eax)
}
    3118:	90                   	nop
    3119:	c9                   	leave  
    311a:	c3                   	ret    
