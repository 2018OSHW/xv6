...
void APGridPaint(AHwnd wnd)
{
    ...
    251f:	8d 45 88             	lea    -0x78(%ebp),%eax
    2522:	6a 08                	push   $0x8
    2524:	6a 08                	push   $0x8
    2526:	6a 08                	push   $0x8
    2528:	50                   	push   %eax
    2529:	e8 ce fb ff ff       	call   20fc <RGB>
    252e:	83 c4 0c             	add    $0xc,%esp
    2531:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2535:	66 89 45 bd          	mov    %ax,-0x43(%ebp)
    2539:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    253d:	88 45 bf             	mov    %al,-0x41(%ebp)
    APSetFont(&wnd->TitleDc,font);
    2540:	8b 45 08             	mov    0x8(%ebp),%eax
    2543:	8d 58 58             	lea    0x58(%eax),%ebx
    2546:	8d 55 88             	lea    -0x78(%ebp),%edx
    2549:	83 ec 04             	sub    $0x4,%esp
    254c:	83 ec 04             	sub    $0x4,%esp
    254f:	89 e0                	mov    %esp,%eax
    2551:	0f b7 4d bd          	movzwl -0x43(%ebp),%ecx
    2555:	66 89 08             	mov    %cx,(%eax)
    2558:	0f b6 4d bf          	movzbl -0x41(%ebp),%ecx
    255c:	88 48 02             	mov    %cl,0x2(%eax)
    255f:	53                   	push   %ebx
    2560:	52                   	push   %edx
    2561:	e8 fe f2 ff ff       	call   1864 <APSetFont>
    2566:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    2569:	8b 45 08             	mov    0x8(%ebp),%eax
    256c:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    2572:	8b 45 08             	mov    0x8(%ebp),%eax
    2575:	83 c0 58             	add    $0x58,%eax
    2578:	6a 14                	push   $0x14
    257a:	6a 14                	push   $0x14
    257c:	52                   	push   %edx
    257d:	50                   	push   %eax
    257e:	e8 ce f8 ff ff       	call   1e51 <APDrawText>
    2583:	83 c4 10             	add    $0x10,%esp
    
    if (!iconReady)
    2586:	a1 f0 77 00 00       	mov    0x77f0,%eax
    258b:	85 c0                	test   %eax,%eax
    258d:	0f 85 7a 02 00 00    	jne    280d <APGridPaint+0x2f7>
    {
        iconReady = 1;
    2593:	c7 05 f0 77 00 00 01 	movl   $0x1,0x77f0
    259a:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    259d:	8d 45 88             	lea    -0x78(%ebp),%eax
    25a0:	83 ec 08             	sub    $0x8,%esp
    25a3:	68 47 32 00 00       	push   $0x3247
    25a8:	50                   	push   %eax
    25a9:	e8 6c ef ff ff       	call   151a <APLoadBitmap>
    25ae:	83 c4 0c             	add    $0xc,%esp
    25b1:	8b 45 88             	mov    -0x78(%ebp),%eax
    25b4:	a3 14 78 00 00       	mov    %eax,0x7814
    25b9:	8b 45 8c             	mov    -0x74(%ebp),%eax
    25bc:	a3 18 78 00 00       	mov    %eax,0x7818
    25c1:	8b 45 90             	mov    -0x70(%ebp),%eax
    25c4:	a3 1c 78 00 00       	mov    %eax,0x781c
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    25c9:	83 ec 04             	sub    $0x4,%esp
    25cc:	ff 35 1c 78 00 00    	pushl  0x781c
    25d2:	ff 35 18 78 00 00    	pushl  0x7818
    25d8:	ff 35 14 78 00 00    	pushl  0x7814
    25de:	e8 71 f1 ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    25e3:	83 c4 10             	add    $0x10,%esp
    25e6:	a3 20 78 00 00       	mov    %eax,0x7820
        grid_river = APLoadBitmap ("grid_river.bmp");
    25eb:	8d 45 88             	lea    -0x78(%ebp),%eax
    25ee:	83 ec 08             	sub    $0x8,%esp
    25f1:	68 55 32 00 00       	push   $0x3255
    25f6:	50                   	push   %eax
    25f7:	e8 1e ef ff ff       	call   151a <APLoadBitmap>
    25fc:	83 c4 0c             	add    $0xc,%esp
    25ff:	8b 45 88             	mov    -0x78(%ebp),%eax
    2602:	a3 5c 78 00 00       	mov    %eax,0x785c
    2607:	8b 45 8c             	mov    -0x74(%ebp),%eax
    260a:	a3 60 78 00 00       	mov    %eax,0x7860
    260f:	8b 45 90             	mov    -0x70(%ebp),%eax
    2612:	a3 64 78 00 00       	mov    %eax,0x7864
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    2617:	83 ec 04             	sub    $0x4,%esp
    261a:	ff 35 64 78 00 00    	pushl  0x7864
    2620:	ff 35 60 78 00 00    	pushl  0x7860
    2626:	ff 35 5c 78 00 00    	pushl  0x785c
    262c:	e8 23 f1 ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    2631:	83 c4 10             	add    $0x10,%esp
    2634:	a3 4c 78 00 00       	mov    %eax,0x784c
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    2639:	8d 45 88             	lea    -0x78(%ebp),%eax
    263c:	83 ec 08             	sub    $0x8,%esp
    263f:	68 64 32 00 00       	push   $0x3264
    2644:	50                   	push   %eax
    2645:	e8 d0 ee ff ff       	call   151a <APLoadBitmap>
    264a:	83 c4 0c             	add    $0xc,%esp
    264d:	8b 45 88             	mov    -0x78(%ebp),%eax
    2650:	a3 50 78 00 00       	mov    %eax,0x7850
    2655:	8b 45 8c             	mov    -0x74(%ebp),%eax
    2658:	a3 54 78 00 00       	mov    %eax,0x7854
    265d:	8b 45 90             	mov    -0x70(%ebp),%eax
    2660:	a3 58 78 00 00       	mov    %eax,0x7858
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    2665:	83 ec 04             	sub    $0x4,%esp
    2668:	ff 35 58 78 00 00    	pushl  0x7858
    266e:	ff 35 54 78 00 00    	pushl  0x7854
    2674:	ff 35 50 78 00 00    	pushl  0x7850
    267a:	e8 d5 f0 ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    267f:	83 c4 10             	add    $0x10,%esp
    2682:	a3 f4 77 00 00       	mov    %eax,0x77f4
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    2687:	8d 45 88             	lea    -0x78(%ebp),%eax
    268a:	83 ec 08             	sub    $0x8,%esp
    268d:	68 73 32 00 00       	push   $0x3273
    2692:	50                   	push   %eax
    2693:	e8 82 ee ff ff       	call   151a <APLoadBitmap>
    2698:	83 c4 0c             	add    $0xc,%esp
    269b:	8b 45 88             	mov    -0x78(%ebp),%eax
    269e:	a3 28 78 00 00       	mov    %eax,0x7828
    26a3:	8b 45 8c             	mov    -0x74(%ebp),%eax
    26a6:	a3 2c 78 00 00       	mov    %eax,0x782c
    26ab:	8b 45 90             	mov    -0x70(%ebp),%eax
    26ae:	a3 30 78 00 00       	mov    %eax,0x7830
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    26b3:	83 ec 04             	sub    $0x4,%esp
    26b6:	ff 35 30 78 00 00    	pushl  0x7830
    26bc:	ff 35 2c 78 00 00    	pushl  0x782c
    26c2:	ff 35 28 78 00 00    	pushl  0x7828
    26c8:	e8 87 f0 ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    26cd:	83 c4 10             	add    $0x10,%esp
    26d0:	a3 6c 78 00 00       	mov    %eax,0x786c
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    26d5:	8d 45 88             	lea    -0x78(%ebp),%eax
    26d8:	83 ec 08             	sub    $0x8,%esp
    26db:	68 81 32 00 00       	push   $0x3281
    26e0:	50                   	push   %eax
    26e1:	e8 34 ee ff ff       	call   151a <APLoadBitmap>
    26e6:	83 c4 0c             	add    $0xc,%esp
    26e9:	8b 45 88             	mov    -0x78(%ebp),%eax
    26ec:	a3 04 78 00 00       	mov    %eax,0x7804
    26f1:	8b 45 8c             	mov    -0x74(%ebp),%eax
    26f4:	a3 08 78 00 00       	mov    %eax,0x7808
    26f9:	8b 45 90             	mov    -0x70(%ebp),%eax
    26fc:	a3 0c 78 00 00       	mov    %eax,0x780c
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    2701:	83 ec 04             	sub    $0x4,%esp
    2704:	ff 35 0c 78 00 00    	pushl  0x780c
    270a:	ff 35 08 78 00 00    	pushl  0x7808
    2710:	ff 35 04 78 00 00    	pushl  0x7804
    2716:	e8 39 f0 ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    271b:	83 c4 10             	add    $0x10,%esp
    271e:	a3 24 78 00 00       	mov    %eax,0x7824
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    2723:	8d 45 88             	lea    -0x78(%ebp),%eax
    2726:	83 ec 08             	sub    $0x8,%esp
    2729:	68 91 32 00 00       	push   $0x3291
    272e:	50                   	push   %eax
    272f:	e8 e6 ed ff ff       	call   151a <APLoadBitmap>
    2734:	83 c4 0c             	add    $0xc,%esp
    2737:	8b 45 88             	mov    -0x78(%ebp),%eax
    273a:	a3 f8 77 00 00       	mov    %eax,0x77f8
    273f:	8b 45 8c             	mov    -0x74(%ebp),%eax
    2742:	a3 fc 77 00 00       	mov    %eax,0x77fc
    2747:	8b 45 90             	mov    -0x70(%ebp),%eax
    274a:	a3 00 78 00 00       	mov    %eax,0x7800
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    274f:	83 ec 04             	sub    $0x4,%esp
    2752:	ff 35 00 78 00 00    	pushl  0x7800
    2758:	ff 35 fc 77 00 00    	pushl  0x77fc
    275e:	ff 35 f8 77 00 00    	pushl  0x77f8
    2764:	e8 eb ef ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    2769:	83 c4 10             	add    $0x10,%esp
    276c:	a3 10 78 00 00       	mov    %eax,0x7810
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    2771:	8d 45 88             	lea    -0x78(%ebp),%eax
    2774:	83 ec 08             	sub    $0x8,%esp
    2777:	68 a3 32 00 00       	push   $0x32a3
    277c:	50                   	push   %eax
    277d:	e8 98 ed ff ff       	call   151a <APLoadBitmap>
    2782:	83 c4 0c             	add    $0xc,%esp
    2785:	8b 45 88             	mov    -0x78(%ebp),%eax
    2788:	a3 40 78 00 00       	mov    %eax,0x7840
    278d:	8b 45 8c             	mov    -0x74(%ebp),%eax
    2790:	a3 44 78 00 00       	mov    %eax,0x7844
    2795:	8b 45 90             	mov    -0x70(%ebp),%eax
    2798:	a3 48 78 00 00       	mov    %eax,0x7848
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    279d:	83 ec 04             	sub    $0x4,%esp
    27a0:	ff 35 48 78 00 00    	pushl  0x7848
    27a6:	ff 35 44 78 00 00    	pushl  0x7844
    27ac:	ff 35 40 78 00 00    	pushl  0x7840
    27b2:	e8 9d ef ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    27b7:	83 c4 10             	add    $0x10,%esp
    27ba:	a3 70 78 00 00       	mov    %eax,0x7870
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    27bf:	8d 45 88             	lea    -0x78(%ebp),%eax
    27c2:	83 ec 08             	sub    $0x8,%esp
    27c5:	68 b2 32 00 00       	push   $0x32b2
    27ca:	50                   	push   %eax
    27cb:	e8 4a ed ff ff       	call   151a <APLoadBitmap>
    27d0:	83 c4 0c             	add    $0xc,%esp
    27d3:	8b 45 88             	mov    -0x78(%ebp),%eax
    27d6:	a3 34 78 00 00       	mov    %eax,0x7834
    27db:	8b 45 8c             	mov    -0x74(%ebp),%eax
    27de:	a3 38 78 00 00       	mov    %eax,0x7838
    27e3:	8b 45 90             	mov    -0x70(%ebp),%eax
    27e6:	a3 3c 78 00 00       	mov    %eax,0x783c
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    27eb:	83 ec 04             	sub    $0x4,%esp
    27ee:	ff 35 3c 78 00 00    	pushl  0x783c
    27f4:	ff 35 38 78 00 00    	pushl  0x7838
    27fa:	ff 35 34 78 00 00    	pushl  0x7834
    2800:	e8 4f ef ff ff       	call   1754 <APCreateCompatibleDCFromBitmap>
    2805:	83 c4 10             	add    $0x10,%esp
    2808:	a3 68 78 00 00       	mov    %eax,0x7868
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    280d:	8b 45 08             	mov    0x8(%ebp),%eax
    2810:	8b 40 08             	mov    0x8(%eax),%eax
    2813:	85 c0                	test   %eax,%eax
    2815:	75 17                	jne    282e <APGridPaint+0x318>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    2817:	83 ec 08             	sub    $0x8,%esp
    281a:	68 c4 32 00 00       	push   $0x32c4
    281f:	6a 01                	push   $0x1
    2821:	e8 6e e8 ff ff       	call   1094 <printf>
    2826:	83 c4 10             	add    $0x10,%esp
        return;
    2829:	e9 fe 04 00 00       	jmp    2d2c <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    282e:	8b 45 08             	mov    0x8(%ebp),%eax
    2831:	8b 40 10             	mov    0x10(%eax),%eax
    2834:	85 c0                	test   %eax,%eax
    2836:	7e 10                	jle    2848 <APGridPaint+0x332>
    2838:	8b 45 08             	mov    0x8(%ebp),%eax
    283b:	8b 50 14             	mov    0x14(%eax),%edx
    283e:	8b 45 08             	mov    0x8(%ebp),%eax
    2841:	8b 40 10             	mov    0x10(%eax),%eax
    2844:	39 c2                	cmp    %eax,%edx
    2846:	7c 17                	jl     285f <APGridPaint+0x349>
    {
        printf(1,"Grid mode page error!");
    2848:	83 ec 08             	sub    $0x8,%esp
    284b:	68 ea 32 00 00       	push   $0x32ea
    2850:	6a 01                	push   $0x1
    2852:	e8 3d e8 ff ff       	call   1094 <printf>
    2857:	83 c4 10             	add    $0x10,%esp
        return;
    285a:	e9 cd 04 00 00       	jmp    2d2c <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    285f:	8b 45 08             	mov    0x8(%ebp),%eax
    2862:	8b 40 14             	mov    0x14(%eax),%eax
    2865:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    286b:	89 45 dc             	mov    %eax,-0x24(%ebp)
    286e:	8b 45 dc             	mov    -0x24(%ebp),%eax
    2871:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2874:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    287b:	e9 f4 03 00 00       	jmp    2c74 <APGridPaint+0x75e>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    2880:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    2887:	e9 da 03 00 00       	jmp    2c66 <APGridPaint+0x750>
        {
            index = start + GRID_W_NUMBER * j + i;
    288c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    288f:	c1 e0 04             	shl    $0x4,%eax
    2892:	89 c2                	mov    %eax,%edx
    2894:	8b 45 d8             	mov    -0x28(%ebp),%eax
    2897:	01 c2                	add    %eax,%edx
    2899:	8b 45 e0             	mov    -0x20(%ebp),%eax
    289c:	01 d0                	add    %edx,%eax
    289e:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    28a1:	8b 45 08             	mov    0x8(%ebp),%eax
    28a4:	8b 40 0c             	mov    0xc(%eax),%eax
    28a7:	8b 55 dc             	mov    -0x24(%ebp),%edx
    28aa:	c1 e2 02             	shl    $0x2,%edx
    28ad:	01 d0                	add    %edx,%eax
    28af:	8b 00                	mov    (%eax),%eax
    28b1:	83 f8 0a             	cmp    $0xa,%eax
    28b4:	0f 87 a7 03 00 00    	ja     2c61 <APGridPaint+0x74b>
    28ba:	8b 04 85 00 33 00 00 	mov    0x3300(,%eax,4),%eax
    28c1:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    28c3:	8d 45 c0             	lea    -0x40(%ebp),%eax
    28c6:	6a 0c                	push   $0xc
    28c8:	6a 0c                	push   $0xc
    28ca:	6a 0c                	push   $0xc
    28cc:	50                   	push   %eax
    28cd:	e8 2a f8 ff ff       	call   20fc <RGB>
    28d2:	83 c4 0c             	add    $0xc,%esp
    28d5:	8b 1d 20 78 00 00    	mov    0x7820,%ebx
    28db:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    28de:	6b c8 32             	imul   $0x32,%eax,%ecx
    28e1:	8b 45 e0             	mov    -0x20(%ebp),%eax
    28e4:	6b c0 32             	imul   $0x32,%eax,%eax
    28e7:	89 45 84             	mov    %eax,-0x7c(%ebp)
    28ea:	8b 45 08             	mov    0x8(%ebp),%eax
    28ed:	8d 78 3c             	lea    0x3c(%eax),%edi
    28f0:	83 ec 0c             	sub    $0xc,%esp
    28f3:	83 ec 04             	sub    $0x4,%esp
    28f6:	89 e0                	mov    %esp,%eax
    28f8:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    28fc:	66 89 30             	mov    %si,(%eax)
    28ff:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    2903:	88 50 02             	mov    %dl,0x2(%eax)
    2906:	6a 32                	push   $0x32
    2908:	6a 32                	push   $0x32
    290a:	6a 00                	push   $0x0
    290c:	6a 00                	push   $0x0
    290e:	53                   	push   %ebx
    290f:	51                   	push   %ecx
    2910:	ff 75 84             	pushl  -0x7c(%ebp)
    2913:	57                   	push   %edi
    2914:	e8 3f f6 ff ff       	call   1f58 <APDcCopy>
    2919:	83 c4 30             	add    $0x30,%esp
                    break;
    291c:	e9 41 03 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    2921:	8d 45 88             	lea    -0x78(%ebp),%eax
    2924:	6a 69                	push   $0x69
    2926:	6a 69                	push   $0x69
    2928:	6a 69                	push   $0x69
    292a:	50                   	push   %eax
    292b:	e8 cc f7 ff ff       	call   20fc <RGB>
    2930:	83 c4 0c             	add    $0xc,%esp
    2933:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2937:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    293b:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    293f:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    2942:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    2949:	8d 45 88             	lea    -0x78(%ebp),%eax
    294c:	6a 69                	push   $0x69
    294e:	6a 69                	push   $0x69
    2950:	6a 69                	push   $0x69
    2952:	50                   	push   %eax
    2953:	e8 a4 f7 ff ff       	call   20fc <RGB>
    2958:	83 c4 0c             	add    $0xc,%esp
    295b:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    295f:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    2963:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2967:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    296a:	8b 45 08             	mov    0x8(%ebp),%eax
    296d:	8d 50 3c             	lea    0x3c(%eax),%edx
    2970:	8d 45 88             	lea    -0x78(%ebp),%eax
    2973:	ff 75 ac             	pushl  -0x54(%ebp)
    2976:	ff 75 a8             	pushl  -0x58(%ebp)
    2979:	52                   	push   %edx
    297a:	50                   	push   %eax
    297b:	e8 69 ee ff ff       	call   17e9 <APSetPen>
    2980:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    2983:	8b 45 08             	mov    0x8(%ebp),%eax
    2986:	8d 58 3c             	lea    0x3c(%eax),%ebx
    2989:	8d 55 88             	lea    -0x78(%ebp),%edx
    298c:	83 ec 04             	sub    $0x4,%esp
    298f:	83 ec 04             	sub    $0x4,%esp
    2992:	89 e0                	mov    %esp,%eax
    2994:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    2998:	66 89 08             	mov    %cx,(%eax)
    299b:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    299f:	88 48 02             	mov    %cl,0x2(%eax)
    29a2:	53                   	push   %ebx
    29a3:	52                   	push   %edx
    29a4:	e8 79 ee ff ff       	call   1822 <APSetBrush>
    29a9:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    29ac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    29af:	6b d0 32             	imul   $0x32,%eax,%edx
    29b2:	8b 45 e0             	mov    -0x20(%ebp),%eax
    29b5:	6b c0 32             	imul   $0x32,%eax,%eax
    29b8:	8b 4d 08             	mov    0x8(%ebp),%ecx
    29bb:	83 c1 3c             	add    $0x3c,%ecx
    29be:	83 ec 0c             	sub    $0xc,%esp
    29c1:	6a 32                	push   $0x32
    29c3:	6a 32                	push   $0x32
    29c5:	52                   	push   %edx
    29c6:	50                   	push   %eax
    29c7:	51                   	push   %ecx
    29c8:	e8 7f f2 ff ff       	call   1c4c <APDrawRect>
    29cd:	83 c4 20             	add    $0x20,%esp
                    break;
    29d0:	e9 8d 02 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    29d5:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    29d8:	6a 0c                	push   $0xc
    29da:	6a 0c                	push   $0xc
    29dc:	6a 0c                	push   $0xc
    29de:	50                   	push   %eax
    29df:	e8 18 f7 ff ff       	call   20fc <RGB>
    29e4:	83 c4 0c             	add    $0xc,%esp
    29e7:	8b 1d 70 78 00 00    	mov    0x7870,%ebx
    29ed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    29f0:	6b c8 32             	imul   $0x32,%eax,%ecx
    29f3:	8b 45 e0             	mov    -0x20(%ebp),%eax
    29f6:	6b c0 32             	imul   $0x32,%eax,%eax
    29f9:	89 45 84             	mov    %eax,-0x7c(%ebp)
    29fc:	8b 45 08             	mov    0x8(%ebp),%eax
    29ff:	8d 78 3c             	lea    0x3c(%eax),%edi
    2a02:	83 ec 0c             	sub    $0xc,%esp
    2a05:	83 ec 04             	sub    $0x4,%esp
    2a08:	89 e0                	mov    %esp,%eax
    2a0a:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    2a0e:	66 89 30             	mov    %si,(%eax)
    2a11:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    2a15:	88 50 02             	mov    %dl,0x2(%eax)
    2a18:	6a 32                	push   $0x32
    2a1a:	6a 32                	push   $0x32
    2a1c:	6a 00                	push   $0x0
    2a1e:	6a 00                	push   $0x0
    2a20:	53                   	push   %ebx
    2a21:	51                   	push   %ecx
    2a22:	ff 75 84             	pushl  -0x7c(%ebp)
    2a25:	57                   	push   %edi
    2a26:	e8 2d f5 ff ff       	call   1f58 <APDcCopy>
    2a2b:	83 c4 30             	add    $0x30,%esp
                    break;
    2a2e:	e9 2f 02 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2a33:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    2a36:	6a 0c                	push   $0xc
    2a38:	6a 0c                	push   $0xc
    2a3a:	6a 0c                	push   $0xc
    2a3c:	50                   	push   %eax
    2a3d:	e8 ba f6 ff ff       	call   20fc <RGB>
    2a42:	83 c4 0c             	add    $0xc,%esp
    2a45:	8b 1d 4c 78 00 00    	mov    0x784c,%ebx
    2a4b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2a4e:	6b c8 32             	imul   $0x32,%eax,%ecx
    2a51:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2a54:	6b c0 32             	imul   $0x32,%eax,%eax
    2a57:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2a5a:	8b 45 08             	mov    0x8(%ebp),%eax
    2a5d:	8d 78 3c             	lea    0x3c(%eax),%edi
    2a60:	83 ec 0c             	sub    $0xc,%esp
    2a63:	83 ec 04             	sub    $0x4,%esp
    2a66:	89 e0                	mov    %esp,%eax
    2a68:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    2a6c:	66 89 30             	mov    %si,(%eax)
    2a6f:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    2a73:	88 50 02             	mov    %dl,0x2(%eax)
    2a76:	6a 32                	push   $0x32
    2a78:	6a 32                	push   $0x32
    2a7a:	6a 00                	push   $0x0
    2a7c:	6a 00                	push   $0x0
    2a7e:	53                   	push   %ebx
    2a7f:	51                   	push   %ecx
    2a80:	ff 75 84             	pushl  -0x7c(%ebp)
    2a83:	57                   	push   %edi
    2a84:	e8 cf f4 ff ff       	call   1f58 <APDcCopy>
    2a89:	83 c4 30             	add    $0x30,%esp
                    break;
    2a8c:	e9 d1 01 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2a91:	8d 45 c9             	lea    -0x37(%ebp),%eax
    2a94:	6a 0c                	push   $0xc
    2a96:	6a 0c                	push   $0xc
    2a98:	6a 0c                	push   $0xc
    2a9a:	50                   	push   %eax
    2a9b:	e8 5c f6 ff ff       	call   20fc <RGB>
    2aa0:	83 c4 0c             	add    $0xc,%esp
    2aa3:	8b 1d 24 78 00 00    	mov    0x7824,%ebx
    2aa9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2aac:	6b c8 32             	imul   $0x32,%eax,%ecx
    2aaf:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2ab2:	6b c0 32             	imul   $0x32,%eax,%eax
    2ab5:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2ab8:	8b 45 08             	mov    0x8(%ebp),%eax
    2abb:	8d 78 3c             	lea    0x3c(%eax),%edi
    2abe:	83 ec 0c             	sub    $0xc,%esp
    2ac1:	83 ec 04             	sub    $0x4,%esp
    2ac4:	89 e0                	mov    %esp,%eax
    2ac6:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    2aca:	66 89 30             	mov    %si,(%eax)
    2acd:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    2ad1:	88 50 02             	mov    %dl,0x2(%eax)
    2ad4:	6a 32                	push   $0x32
    2ad6:	6a 32                	push   $0x32
    2ad8:	6a 00                	push   $0x0
    2ada:	6a 00                	push   $0x0
    2adc:	53                   	push   %ebx
    2add:	51                   	push   %ecx
    2ade:	ff 75 84             	pushl  -0x7c(%ebp)
    2ae1:	57                   	push   %edi
    2ae2:	e8 71 f4 ff ff       	call   1f58 <APDcCopy>
    2ae7:	83 c4 30             	add    $0x30,%esp
                    break;
    2aea:	e9 73 01 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2aef:	8d 45 cc             	lea    -0x34(%ebp),%eax
    2af2:	6a 0c                	push   $0xc
    2af4:	6a 0c                	push   $0xc
    2af6:	6a 0c                	push   $0xc
    2af8:	50                   	push   %eax
    2af9:	e8 fe f5 ff ff       	call   20fc <RGB>
    2afe:	83 c4 0c             	add    $0xc,%esp
    2b01:	8b 1d 6c 78 00 00    	mov    0x786c,%ebx
    2b07:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2b0a:	6b c8 32             	imul   $0x32,%eax,%ecx
    2b0d:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2b10:	6b c0 32             	imul   $0x32,%eax,%eax
    2b13:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2b16:	8b 45 08             	mov    0x8(%ebp),%eax
    2b19:	8d 78 3c             	lea    0x3c(%eax),%edi
    2b1c:	83 ec 0c             	sub    $0xc,%esp
    2b1f:	83 ec 04             	sub    $0x4,%esp
    2b22:	89 e0                	mov    %esp,%eax
    2b24:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    2b28:	66 89 30             	mov    %si,(%eax)
    2b2b:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    2b2f:	88 50 02             	mov    %dl,0x2(%eax)
    2b32:	6a 32                	push   $0x32
    2b34:	6a 32                	push   $0x32
    2b36:	6a 00                	push   $0x0
    2b38:	6a 00                	push   $0x0
    2b3a:	53                   	push   %ebx
    2b3b:	51                   	push   %ecx
    2b3c:	ff 75 84             	pushl  -0x7c(%ebp)
    2b3f:	57                   	push   %edi
    2b40:	e8 13 f4 ff ff       	call   1f58 <APDcCopy>
    2b45:	83 c4 30             	add    $0x30,%esp
                    break;
    2b48:	e9 15 01 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2b4d:	8d 45 cf             	lea    -0x31(%ebp),%eax
    2b50:	6a 0c                	push   $0xc
    2b52:	6a 0c                	push   $0xc
    2b54:	6a 0c                	push   $0xc
    2b56:	50                   	push   %eax
    2b57:	e8 a0 f5 ff ff       	call   20fc <RGB>
    2b5c:	83 c4 0c             	add    $0xc,%esp
    2b5f:	8b 1d f4 77 00 00    	mov    0x77f4,%ebx
    2b65:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2b68:	6b c8 32             	imul   $0x32,%eax,%ecx
    2b6b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2b6e:	6b c0 32             	imul   $0x32,%eax,%eax
    2b71:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2b74:	8b 45 08             	mov    0x8(%ebp),%eax
    2b77:	8d 78 3c             	lea    0x3c(%eax),%edi
    2b7a:	83 ec 0c             	sub    $0xc,%esp
    2b7d:	83 ec 04             	sub    $0x4,%esp
    2b80:	89 e0                	mov    %esp,%eax
    2b82:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    2b86:	66 89 30             	mov    %si,(%eax)
    2b89:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2b8d:	88 50 02             	mov    %dl,0x2(%eax)
    2b90:	6a 32                	push   $0x32
    2b92:	6a 32                	push   $0x32
    2b94:	6a 00                	push   $0x0
    2b96:	6a 00                	push   $0x0
    2b98:	53                   	push   %ebx
    2b99:	51                   	push   %ecx
    2b9a:	ff 75 84             	pushl  -0x7c(%ebp)
    2b9d:	57                   	push   %edi
    2b9e:	e8 b5 f3 ff ff       	call   1f58 <APDcCopy>
    2ba3:	83 c4 30             	add    $0x30,%esp
                    break;
    2ba6:	e9 b7 00 00 00       	jmp    2c62 <APGridPaint+0x74c>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2bab:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2bae:	6a 0c                	push   $0xc
    2bb0:	6a 0c                	push   $0xc
    2bb2:	6a 0c                	push   $0xc
    2bb4:	50                   	push   %eax
    2bb5:	e8 42 f5 ff ff       	call   20fc <RGB>
    2bba:	83 c4 0c             	add    $0xc,%esp
    2bbd:	8b 1d 10 78 00 00    	mov    0x7810,%ebx
    2bc3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2bc6:	6b c8 32             	imul   $0x32,%eax,%ecx
    2bc9:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2bcc:	6b c0 32             	imul   $0x32,%eax,%eax
    2bcf:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2bd2:	8b 45 08             	mov    0x8(%ebp),%eax
    2bd5:	8d 78 3c             	lea    0x3c(%eax),%edi
    2bd8:	83 ec 0c             	sub    $0xc,%esp
    2bdb:	83 ec 04             	sub    $0x4,%esp
    2bde:	89 e0                	mov    %esp,%eax
    2be0:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    2be4:	66 89 30             	mov    %si,(%eax)
    2be7:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2beb:	88 50 02             	mov    %dl,0x2(%eax)
    2bee:	6a 32                	push   $0x32
    2bf0:	6a 32                	push   $0x32
    2bf2:	6a 00                	push   $0x0
    2bf4:	6a 00                	push   $0x0
    2bf6:	53                   	push   %ebx
    2bf7:	51                   	push   %ecx
    2bf8:	ff 75 84             	pushl  -0x7c(%ebp)
    2bfb:	57                   	push   %edi
    2bfc:	e8 57 f3 ff ff       	call   1f58 <APDcCopy>
    2c01:	83 c4 30             	add    $0x30,%esp
                    break;
    2c04:	eb 5c                	jmp    2c62 <APGridPaint+0x74c>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2c06:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    2c09:	6a 0c                	push   $0xc
    2c0b:	6a 0c                	push   $0xc
    2c0d:	6a 0c                	push   $0xc
    2c0f:	50                   	push   %eax
    2c10:	e8 e7 f4 ff ff       	call   20fc <RGB>
    2c15:	83 c4 0c             	add    $0xc,%esp
    2c18:	8b 1d 68 78 00 00    	mov    0x7868,%ebx
    2c1e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2c21:	6b c8 32             	imul   $0x32,%eax,%ecx
    2c24:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2c27:	6b c0 32             	imul   $0x32,%eax,%eax
    2c2a:	89 45 84             	mov    %eax,-0x7c(%ebp)
    2c2d:	8b 45 08             	mov    0x8(%ebp),%eax
    2c30:	8d 78 3c             	lea    0x3c(%eax),%edi
    2c33:	83 ec 0c             	sub    $0xc,%esp
    2c36:	83 ec 04             	sub    $0x4,%esp
    2c39:	89 e0                	mov    %esp,%eax
    2c3b:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    2c3f:	66 89 30             	mov    %si,(%eax)
    2c42:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    2c46:	88 50 02             	mov    %dl,0x2(%eax)
    2c49:	6a 32                	push   $0x32
    2c4b:	6a 32                	push   $0x32
    2c4d:	6a 00                	push   $0x0
    2c4f:	6a 00                	push   $0x0
    2c51:	53                   	push   %ebx
    2c52:	51                   	push   %ecx
    2c53:	ff 75 84             	pushl  -0x7c(%ebp)
    2c56:	57                   	push   %edi
    2c57:	e8 fc f2 ff ff       	call   1f58 <APDcCopy>
    2c5c:	83 c4 30             	add    $0x30,%esp
                    break;
    2c5f:	eb 01                	jmp    2c62 <APGridPaint+0x74c>
                default: break;
    2c61:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    2c62:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    2c66:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2c6a:	0f 8e 1c fc ff ff    	jle    288c <APGridPaint+0x376>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2c70:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    2c74:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    2c78:	0f 8e 02 fc ff ff    	jle    2880 <APGridPaint+0x36a>
        }
    }
    //Title Part
    APen pen;
    ...
    2c7e:	8d 45 88             	lea    -0x78(%ebp),%eax
    2c81:	68 cd 00 00 00       	push   $0xcd
    2c86:	6a 74                	push   $0x74
    2c88:	6a 18                	push   $0x18
    2c8a:	50                   	push   %eax
    2c8b:	e8 6c f4 ff ff       	call   20fc <RGB>
    2c90:	83 c4 0c             	add    $0xc,%esp
    2c93:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2c97:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    2c9b:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2c9f:	88 45 b6             	mov    %al,-0x4a(%ebp)
    pen.size = 1;
    2ca2:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2ca9:	8d 45 88             	lea    -0x78(%ebp),%eax
    2cac:	68 cd 00 00 00       	push   $0xcd
    2cb1:	6a 74                	push   $0x74
    2cb3:	6a 18                	push   $0x18
    2cb5:	50                   	push   %eax
    2cb6:	e8 41 f4 ff ff       	call   20fc <RGB>
    2cbb:	83 c4 0c             	add    $0xc,%esp
    2cbe:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2cc2:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    2cc6:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    2cca:	88 45 b3             	mov    %al,-0x4d(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    2ccd:	8b 45 08             	mov    0x8(%ebp),%eax
    2cd0:	8d 50 58             	lea    0x58(%eax),%edx
    2cd3:	8d 45 88             	lea    -0x78(%ebp),%eax
    2cd6:	ff 75 b8             	pushl  -0x48(%ebp)
    2cd9:	ff 75 b4             	pushl  -0x4c(%ebp)
    2cdc:	52                   	push   %edx
    2cdd:	50                   	push   %eax
    2cde:	e8 06 eb ff ff       	call   17e9 <APSetPen>
    2ce3:	83 c4 0c             	add    $0xc,%esp
    ...
    2cf7:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    2cfb:	66 89 08             	mov    %cx,(%eax)
    2cfe:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    2d02:	88 48 02             	mov    %cl,0x2(%eax)
    2d05:	53                   	push   %ebx
    2d06:	52                   	push   %edx
    2d07:	e8 16 eb ff ff       	call   1822 <APSetBrush>
    2d0c:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    2d0f:	8b 45 08             	mov    0x8(%ebp),%eax
    2d12:	83 c0 58             	add    $0x58,%eax
    2d15:	83 ec 0c             	sub    $0xc,%esp
    2d18:	6a 32                	push   $0x32
    2d1a:	68 20 03 00 00       	push   $0x320
    2d1f:	6a 00                	push   $0x0
    2d21:	6a 00                	push   $0x0
    2d23:	50                   	push   %eax
    2d24:	e8 23 ef ff ff       	call   1c4c <APDrawRect>
    2d29:	83 c4 20             	add    $0x20,%esp
