...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    p = buf;
      18:	c7 45 f0 00 6d 00 00 	movl   $0x6d00,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    if(p == buf)
      84:	81 7d f0 00 6d 00 00 	cmpl   $0x6d00,-0x10(%ebp)
    ...
    if(m > 0){
      ...
      9d:	ba 00 6d 00 00       	mov    $0x6d00,%edx
      ...
      ba:	83 c4 10             	add    $0x10,%esp
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
      ...
      ce:	05 00 6d 00 00       	add    $0x6d00,%eax
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    printf(2, "usage: grep pattern [file ...]\n");
     ...
     10f:	68 74 28 00 00       	push   $0x2874
     114:	6a 02                	push   $0x2
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     18b:	50                   	push   %eax
     18c:	68 94 28 00 00       	push   $0x2894
     191:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6dd:	0f b6 80 80 30 00 00 	movzbl 0x3080(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     819:	75 25                	jne    840 <printf+0xff>
          s = "(null)";
     81b:	c7 45 f4 aa 28 00 00 	movl   $0x28aa,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     8e1:	a1 e8 6c 00 00       	mov    0x6ce8,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     9ac:	a3 e8 6c 00 00       	mov    %eax,0x6ce8
}
     9b1:	90                   	nop
     9b2:	c9                   	leave  
     9b3:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     a0d:	a1 e8 6c 00 00       	mov    0x6ce8,%eax
}
     a12:	c9                   	leave  
     a13:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     a29:	a1 e8 6c 00 00       	mov    0x6ce8,%eax
     a2e:	89 45 f0             	mov    %eax,-0x10(%ebp)
     a31:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     a35:	75 23                	jne    a5a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     a37:	c7 45 f0 e0 6c 00 00 	movl   $0x6ce0,-0x10(%ebp)
     a3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
     a41:	a3 e8 6c 00 00       	mov    %eax,0x6ce8
     a46:	a1 e8 6c 00 00       	mov    0x6ce8,%eax
     a4b:	a3 e0 6c 00 00       	mov    %eax,0x6ce0
    base.s.size = 0;
     a50:	c7 05 e4 6c 00 00 00 	movl   $0x0,0x6ce4
     a57:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     aad:	a3 e8 6c 00 00       	mov    %eax,0x6ce8
      return (void*)(p + 1);
    ...
    if(p == freep)
     aba:	a1 e8 6c 00 00       	mov    0x6ce8,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     bf8:	79 2e                	jns    c28 <APLoadBitmap+0x61>
    {
     ...
     c00:	68 b1 28 00 00       	push   $0x28b1
     c05:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    15a4:	05 a0 30 00 00       	add    $0x30a0,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1831:	68 c4 28 00 00       	push   $0x28c4
    1836:	6a 01                	push   $0x1
    ...
    18a6:	68 e4 28 00 00       	push   $0x28e4
    18ab:	6a 01                	push   $0x1
    ...
    194a:	68 08 29 00 00       	push   $0x2908
    194f:	6a 01                	push   $0x1
    ...
    1a2f:	68 30 29 00 00       	push   $0x2930
    1a34:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    1b18:	e8 c5 08 00 00       	call   23e2 <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    1f0e:	8b 40 08             	mov    0x8(%eax),%eax
    1f11:	85 c0                	test   %eax,%eax
    1f13:	75 17                	jne    1f2c <APGridPaint+0x2ff>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1f15:	83 ec 08             	sub    $0x8,%esp
    1f18:	68 e0 29 00 00       	push   $0x29e0
    1f1d:	6a 01                	push   $0x1
    1f1f:	e8 1d e8 ff ff       	call   741 <printf>
    1f24:	83 c4 10             	add    $0x10,%esp
        return;
    1f27:	e9 ae 04 00 00       	jmp    23da <APGridPaint+0x7ad>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1f2c:	8b 45 08             	mov    0x8(%ebp),%eax
    1f2f:	8b 40 10             	mov    0x10(%eax),%eax
    1f32:	85 c0                	test   %eax,%eax
    1f34:	7e 10                	jle    1f46 <APGridPaint+0x319>
    1f36:	8b 45 08             	mov    0x8(%ebp),%eax
    1f39:	8b 50 14             	mov    0x14(%eax),%edx
    1f3c:	8b 45 08             	mov    0x8(%ebp),%eax
    1f3f:	8b 40 10             	mov    0x10(%eax),%eax
    1f42:	39 c2                	cmp    %eax,%edx
    1f44:	7c 17                	jl     1f5d <APGridPaint+0x330>
    {
        printf(1,"Grid mode page error!");
    1f46:	83 ec 08             	sub    $0x8,%esp
    1f49:	68 06 2a 00 00       	push   $0x2a06
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 ec e7 ff ff       	call   741 <printf>
    1f55:	83 c4 10             	add    $0x10,%esp
        return;
    1f58:	e9 7d 04 00 00       	jmp    23da <APGridPaint+0x7ad>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1f5d:	8b 45 08             	mov    0x8(%ebp),%eax
    1f60:	8b 40 14             	mov    0x14(%eax),%eax
    1f63:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1f69:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1f6c:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1f6f:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1f72:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1f79:	e9 52 04 00 00       	jmp    23d0 <APGridPaint+0x7a3>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1f7e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1f85:	e9 38 04 00 00       	jmp    23c2 <APGridPaint+0x795>
        {
            index = start + GRID_W_NUMBER * j + i;
    1f8a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f8d:	c1 e0 04             	shl    $0x4,%eax
    1f90:	89 c2                	mov    %eax,%edx
    1f92:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1f95:	01 c2                	add    %eax,%edx
    1f97:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f9a:	01 d0                	add    %edx,%eax
    1f9c:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1f9f:	8b 45 08             	mov    0x8(%ebp),%eax
    1fa2:	8b 40 0c             	mov    0xc(%eax),%eax
    1fa5:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1fa8:	c1 e2 02             	shl    $0x2,%edx
    1fab:	01 d0                	add    %edx,%eax
    1fad:	8b 00                	mov    (%eax),%eax
    1faf:	83 f8 0b             	cmp    $0xb,%eax
    1fb2:	0f 87 05 04 00 00    	ja     23bd <APGridPaint+0x790>
    1fb8:	8b 04 85 1c 2a 00 00 	mov    0x2a1c(,%eax,4),%eax
    1fbf:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fc1:	8d 45 bd             	lea    -0x43(%ebp),%eax
    1fc4:	6a 0c                	push   $0xc
    1fc6:	6a 0c                	push   $0xc
    1fc8:	6a 0c                	push   $0xc
    1fca:	50                   	push   %eax
    1fcb:	e8 d9 f7 ff ff       	call   17a9 <RGB>
    1fd0:	83 c4 0c             	add    $0xc,%esp
    1fd3:	8b 1d 38 71 00 00    	mov    0x7138,%ebx
    1fd9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fdc:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fdf:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fe2:	6b c0 32             	imul   $0x32,%eax,%eax
    1fe5:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1fe8:	8b 45 08             	mov    0x8(%ebp),%eax
    1feb:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fee:	83 ec 0c             	sub    $0xc,%esp
    1ff1:	83 ec 04             	sub    $0x4,%esp
    1ff4:	89 e0                	mov    %esp,%eax
    1ff6:	0f b7 75 bd          	movzwl -0x43(%ebp),%esi
    1ffa:	66 89 30             	mov    %si,(%eax)
    1ffd:	0f b6 55 bf          	movzbl -0x41(%ebp),%edx
    2001:	88 50 02             	mov    %dl,0x2(%eax)
    2004:	6a 32                	push   $0x32
    2006:	6a 32                	push   $0x32
    2008:	6a 00                	push   $0x0
    200a:	6a 00                	push   $0x0
    200c:	53                   	push   %ebx
    200d:	51                   	push   %ecx
    200e:	ff 75 94             	pushl  -0x6c(%ebp)
    2011:	57                   	push   %edi
    2012:	e8 ee f5 ff ff       	call   1605 <APDcCopy>
    2017:	83 c4 30             	add    $0x30,%esp
                    break;
    201a:	e9 9f 03 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    201f:	8d 45 98             	lea    -0x68(%ebp),%eax
    2022:	6a 69                	push   $0x69
    2024:	6a 69                	push   $0x69
    2026:	6a 69                	push   $0x69
    2028:	50                   	push   %eax
    2029:	e8 7b f7 ff ff       	call   17a9 <RGB>
    202e:	83 c4 0c             	add    $0xc,%esp
    2031:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    2035:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    2039:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    203d:	88 45 b6             	mov    %al,-0x4a(%ebp)
                    pen.size = 1;
    2040:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    2047:	8d 45 98             	lea    -0x68(%ebp),%eax
    204a:	6a 69                	push   $0x69
    204c:	6a 69                	push   $0x69
    204e:	6a 69                	push   $0x69
    2050:	50                   	push   %eax
    2051:	e8 53 f7 ff ff       	call   17a9 <RGB>
    2056:	83 c4 0c             	add    $0xc,%esp
    2059:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    205d:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    2061:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    2065:	88 45 b3             	mov    %al,-0x4d(%ebp)
                    APSetPen(&wnd->Dc,pen);
    2068:	8b 45 08             	mov    0x8(%ebp),%eax
    206b:	8d 50 3c             	lea    0x3c(%eax),%edx
    206e:	8d 45 98             	lea    -0x68(%ebp),%eax
    2071:	ff 75 b8             	pushl  -0x48(%ebp)
    2074:	ff 75 b4             	pushl  -0x4c(%ebp)
    2077:	52                   	push   %edx
    2078:	50                   	push   %eax
    2079:	e8 18 ee ff ff       	call   e96 <APSetPen>
    207e:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    2081:	8b 45 08             	mov    0x8(%ebp),%eax
    2084:	8d 58 3c             	lea    0x3c(%eax),%ebx
    2087:	8d 55 98             	lea    -0x68(%ebp),%edx
    208a:	83 ec 04             	sub    $0x4,%esp
    208d:	83 ec 04             	sub    $0x4,%esp
    2090:	89 e0                	mov    %esp,%eax
    2092:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    2096:	66 89 08             	mov    %cx,(%eax)
    2099:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    209d:	88 48 02             	mov    %cl,0x2(%eax)
    20a0:	53                   	push   %ebx
    20a1:	52                   	push   %edx
    20a2:	e8 28 ee ff ff       	call   ecf <APSetBrush>
    20a7:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    20aa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20ad:	6b d0 32             	imul   $0x32,%eax,%edx
    20b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20b3:	6b c0 32             	imul   $0x32,%eax,%eax
    20b6:	8b 4d 08             	mov    0x8(%ebp),%ecx
    20b9:	83 c1 3c             	add    $0x3c,%ecx
    20bc:	83 ec 0c             	sub    $0xc,%esp
    20bf:	6a 32                	push   $0x32
    20c1:	6a 32                	push   $0x32
    20c3:	52                   	push   %edx
    20c4:	50                   	push   %eax
    20c5:	51                   	push   %ecx
    20c6:	e8 2e f2 ff ff       	call   12f9 <APDrawRect>
    20cb:	83 c4 20             	add    $0x20,%esp
                    break;
    20ce:	e9 eb 02 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    20d3:	8d 45 c0             	lea    -0x40(%ebp),%eax
    20d6:	6a 0c                	push   $0xc
    20d8:	6a 0c                	push   $0xc
    20da:	6a 0c                	push   $0xc
    20dc:	50                   	push   %eax
    20dd:	e8 c7 f6 ff ff       	call   17a9 <RGB>
    20e2:	83 c4 0c             	add    $0xc,%esp
    20e5:	8b 1d 8c 71 00 00    	mov    0x718c,%ebx
    20eb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20ee:	6b c8 32             	imul   $0x32,%eax,%ecx
    20f1:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20f4:	6b c0 32             	imul   $0x32,%eax,%eax
    20f7:	89 45 94             	mov    %eax,-0x6c(%ebp)
    20fa:	8b 45 08             	mov    0x8(%ebp),%eax
    20fd:	8d 78 3c             	lea    0x3c(%eax),%edi
    2100:	83 ec 0c             	sub    $0xc,%esp
    2103:	83 ec 04             	sub    $0x4,%esp
    2106:	89 e0                	mov    %esp,%eax
    2108:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    210c:	66 89 30             	mov    %si,(%eax)
    210f:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    2113:	88 50 02             	mov    %dl,0x2(%eax)
    2116:	6a 32                	push   $0x32
    2118:	6a 32                	push   $0x32
    211a:	6a 00                	push   $0x0
    211c:	6a 00                	push   $0x0
    211e:	53                   	push   %ebx
    211f:	51                   	push   %ecx
    2120:	ff 75 94             	pushl  -0x6c(%ebp)
    2123:	57                   	push   %edi
    2124:	e8 dc f4 ff ff       	call   1605 <APDcCopy>
    2129:	83 c4 30             	add    $0x30,%esp
                    break;
    212c:	e9 8d 02 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2131:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    2134:	6a 0c                	push   $0xc
    2136:	6a 0c                	push   $0xc
    2138:	6a 0c                	push   $0xc
    213a:	50                   	push   %eax
    213b:	e8 69 f6 ff ff       	call   17a9 <RGB>
    2140:	83 c4 0c             	add    $0xc,%esp
    2143:	8b 1d 68 71 00 00    	mov    0x7168,%ebx
    2149:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    214c:	6b c8 32             	imul   $0x32,%eax,%ecx
    214f:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2152:	6b c0 32             	imul   $0x32,%eax,%eax
    2155:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2158:	8b 45 08             	mov    0x8(%ebp),%eax
    215b:	8d 78 3c             	lea    0x3c(%eax),%edi
    215e:	83 ec 0c             	sub    $0xc,%esp
    2161:	83 ec 04             	sub    $0x4,%esp
    2164:	89 e0                	mov    %esp,%eax
    2166:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    216a:	66 89 30             	mov    %si,(%eax)
    216d:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    2171:	88 50 02             	mov    %dl,0x2(%eax)
    2174:	6a 32                	push   $0x32
    2176:	6a 32                	push   $0x32
    2178:	6a 00                	push   $0x0
    217a:	6a 00                	push   $0x0
    217c:	53                   	push   %ebx
    217d:	51                   	push   %ecx
    217e:	ff 75 94             	pushl  -0x6c(%ebp)
    2181:	57                   	push   %edi
    2182:	e8 7e f4 ff ff       	call   1605 <APDcCopy>
    2187:	83 c4 30             	add    $0x30,%esp
                    break;
    218a:	e9 2f 02 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    218f:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    2192:	6a 0c                	push   $0xc
    2194:	6a 0c                	push   $0xc
    2196:	6a 0c                	push   $0xc
    2198:	50                   	push   %eax
    2199:	e8 0b f6 ff ff       	call   17a9 <RGB>
    219e:	83 c4 0c             	add    $0xc,%esp
    21a1:	8b 1d 3c 71 00 00    	mov    0x713c,%ebx
    21a7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    21aa:	6b c8 32             	imul   $0x32,%eax,%ecx
    21ad:	8b 45 e0             	mov    -0x20(%ebp),%eax
    21b0:	6b c0 32             	imul   $0x32,%eax,%eax
    21b3:	89 45 94             	mov    %eax,-0x6c(%ebp)
    21b6:	8b 45 08             	mov    0x8(%ebp),%eax
    21b9:	8d 78 3c             	lea    0x3c(%eax),%edi
    21bc:	83 ec 0c             	sub    $0xc,%esp
    21bf:	83 ec 04             	sub    $0x4,%esp
    21c2:	89 e0                	mov    %esp,%eax
    21c4:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    21c8:	66 89 30             	mov    %si,(%eax)
    21cb:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    21cf:	88 50 02             	mov    %dl,0x2(%eax)
    21d2:	6a 32                	push   $0x32
    21d4:	6a 32                	push   $0x32
    21d6:	6a 00                	push   $0x0
    21d8:	6a 00                	push   $0x0
    21da:	53                   	push   %ebx
    21db:	51                   	push   %ecx
    21dc:	ff 75 94             	pushl  -0x6c(%ebp)
    21df:	57                   	push   %edi
    21e0:	e8 20 f4 ff ff       	call   1605 <APDcCopy>
    21e5:	83 c4 30             	add    $0x30,%esp
                    break;
    21e8:	e9 d1 01 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    21ed:	8d 45 c9             	lea    -0x37(%ebp),%eax
    21f0:	6a 0c                	push   $0xc
    21f2:	6a 0c                	push   $0xc
    21f4:	6a 0c                	push   $0xc
    21f6:	50                   	push   %eax
    21f7:	e8 ad f5 ff ff       	call   17a9 <RGB>
    21fc:	83 c4 0c             	add    $0xc,%esp
    21ff:	8b 1d 88 71 00 00    	mov    0x7188,%ebx
    2205:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2208:	6b c8 32             	imul   $0x32,%eax,%ecx
    220b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    220e:	6b c0 32             	imul   $0x32,%eax,%eax
    2211:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2214:	8b 45 08             	mov    0x8(%ebp),%eax
    2217:	8d 78 3c             	lea    0x3c(%eax),%edi
    221a:	83 ec 0c             	sub    $0xc,%esp
    221d:	83 ec 04             	sub    $0x4,%esp
    2220:	89 e0                	mov    %esp,%eax
    2222:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    2226:	66 89 30             	mov    %si,(%eax)
    2229:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    222d:	88 50 02             	mov    %dl,0x2(%eax)
    2230:	6a 32                	push   $0x32
    2232:	6a 32                	push   $0x32
    2234:	6a 00                	push   $0x0
    2236:	6a 00                	push   $0x0
    2238:	53                   	push   %ebx
    2239:	51                   	push   %ecx
    223a:	ff 75 94             	pushl  -0x6c(%ebp)
    223d:	57                   	push   %edi
    223e:	e8 c2 f3 ff ff       	call   1605 <APDcCopy>
    2243:	83 c4 30             	add    $0x30,%esp
                    break;
    2246:	e9 73 01 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    224b:	8d 45 cc             	lea    -0x34(%ebp),%eax
    224e:	6a 0c                	push   $0xc
    2250:	6a 0c                	push   $0xc
    2252:	6a 0c                	push   $0xc
    2254:	50                   	push   %eax
    2255:	e8 4f f5 ff ff       	call   17a9 <RGB>
    225a:	83 c4 0c             	add    $0xc,%esp
    225d:	8b 1d 00 71 00 00    	mov    0x7100,%ebx
    2263:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2266:	6b c8 32             	imul   $0x32,%eax,%ecx
    2269:	8b 45 e0             	mov    -0x20(%ebp),%eax
    226c:	6b c0 32             	imul   $0x32,%eax,%eax
    226f:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2272:	8b 45 08             	mov    0x8(%ebp),%eax
    2275:	8d 78 3c             	lea    0x3c(%eax),%edi
    2278:	83 ec 0c             	sub    $0xc,%esp
    227b:	83 ec 04             	sub    $0x4,%esp
    227e:	89 e0                	mov    %esp,%eax
    2280:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    2284:	66 89 30             	mov    %si,(%eax)
    2287:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    228b:	88 50 02             	mov    %dl,0x2(%eax)
    228e:	6a 32                	push   $0x32
    2290:	6a 32                	push   $0x32
    2292:	6a 00                	push   $0x0
    2294:	6a 00                	push   $0x0
    2296:	53                   	push   %ebx
    2297:	51                   	push   %ecx
    2298:	ff 75 94             	pushl  -0x6c(%ebp)
    229b:	57                   	push   %edi
    229c:	e8 64 f3 ff ff       	call   1605 <APDcCopy>
    22a1:	83 c4 30             	add    $0x30,%esp
                    break;
    22a4:	e9 15 01 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    22a9:	8d 45 cf             	lea    -0x31(%ebp),%eax
    22ac:	6a 0c                	push   $0xc
    22ae:	6a 0c                	push   $0xc
    22b0:	6a 0c                	push   $0xc
    22b2:	50                   	push   %eax
    22b3:	e8 f1 f4 ff ff       	call   17a9 <RGB>
    22b8:	83 c4 0c             	add    $0xc,%esp
    22bb:	8b 1d 28 71 00 00    	mov    0x7128,%ebx
    22c1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    22c4:	6b c8 32             	imul   $0x32,%eax,%ecx
    22c7:	8b 45 e0             	mov    -0x20(%ebp),%eax
    22ca:	6b c0 32             	imul   $0x32,%eax,%eax
    22cd:	89 45 94             	mov    %eax,-0x6c(%ebp)
    22d0:	8b 45 08             	mov    0x8(%ebp),%eax
    22d3:	8d 78 3c             	lea    0x3c(%eax),%edi
    22d6:	83 ec 0c             	sub    $0xc,%esp
    22d9:	83 ec 04             	sub    $0x4,%esp
    22dc:	89 e0                	mov    %esp,%eax
    22de:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    22e2:	66 89 30             	mov    %si,(%eax)
    22e5:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    22e9:	88 50 02             	mov    %dl,0x2(%eax)
    22ec:	6a 32                	push   $0x32
    22ee:	6a 32                	push   $0x32
    22f0:	6a 00                	push   $0x0
    22f2:	6a 00                	push   $0x0
    22f4:	53                   	push   %ebx
    22f5:	51                   	push   %ecx
    22f6:	ff 75 94             	pushl  -0x6c(%ebp)
    22f9:	57                   	push   %edi
    22fa:	e8 06 f3 ff ff       	call   1605 <APDcCopy>
    22ff:	83 c4 30             	add    $0x30,%esp
                    break;
    2302:	e9 b7 00 00 00       	jmp    23be <APGridPaint+0x791>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2307:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    230a:	6a 0c                	push   $0xc
    230c:	6a 0c                	push   $0xc
    230e:	6a 0c                	push   $0xc
    2310:	50                   	push   %eax
    2311:	e8 93 f4 ff ff       	call   17a9 <RGB>
    2316:	83 c4 0c             	add    $0xc,%esp
    2319:	8b 1d 84 71 00 00    	mov    0x7184,%ebx
    231f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2322:	6b c8 32             	imul   $0x32,%eax,%ecx
    2325:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2328:	6b c0 32             	imul   $0x32,%eax,%eax
    232b:	89 45 94             	mov    %eax,-0x6c(%ebp)
    232e:	8b 45 08             	mov    0x8(%ebp),%eax
    2331:	8d 78 3c             	lea    0x3c(%eax),%edi
    2334:	83 ec 0c             	sub    $0xc,%esp
    2337:	83 ec 04             	sub    $0x4,%esp
    233a:	89 e0                	mov    %esp,%eax
    233c:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    2340:	66 89 30             	mov    %si,(%eax)
    2343:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2347:	88 50 02             	mov    %dl,0x2(%eax)
    234a:	6a 32                	push   $0x32
    234c:	6a 32                	push   $0x32
    234e:	6a 00                	push   $0x0
    2350:	6a 00                	push   $0x0
    2352:	53                   	push   %ebx
    2353:	51                   	push   %ecx
    2354:	ff 75 94             	pushl  -0x6c(%ebp)
    2357:	57                   	push   %edi
    2358:	e8 a8 f2 ff ff       	call   1605 <APDcCopy>
    235d:	83 c4 30             	add    $0x30,%esp
                    break;
    2360:	eb 5c                	jmp    23be <APGridPaint+0x791>
                case GRID_PROGRAM_TOWER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_tower,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2362:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    2365:	6a 0c                	push   $0xc
    2367:	6a 0c                	push   $0xc
    2369:	6a 0c                	push   $0xc
    236b:	50                   	push   %eax
    236c:	e8 38 f4 ff ff       	call   17a9 <RGB>
    2371:	83 c4 0c             	add    $0xc,%esp
    2374:	8b 1d 40 71 00 00    	mov    0x7140,%ebx
    237a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    237d:	6b c8 32             	imul   $0x32,%eax,%ecx
    2380:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2383:	6b c0 32             	imul   $0x32,%eax,%eax
    2386:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2389:	8b 45 08             	mov    0x8(%ebp),%eax
    238c:	8d 78 3c             	lea    0x3c(%eax),%edi
    238f:	83 ec 0c             	sub    $0xc,%esp
    2392:	83 ec 04             	sub    $0x4,%esp
    2395:	89 e0                	mov    %esp,%eax
    2397:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    239b:	66 89 30             	mov    %si,(%eax)
    239e:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    23a2:	88 50 02             	mov    %dl,0x2(%eax)
    23a5:	6a 32                	push   $0x32
    23a7:	6a 32                	push   $0x32
    23a9:	6a 00                	push   $0x0
    23ab:	6a 00                	push   $0x0
    23ad:	53                   	push   %ebx
    23ae:	51                   	push   %ecx
    23af:	ff 75 94             	pushl  -0x6c(%ebp)
    23b2:	57                   	push   %edi
    23b3:	e8 4d f2 ff ff       	call   1605 <APDcCopy>
    23b8:	83 c4 30             	add    $0x30,%esp
                    break;
    23bb:	eb 01                	jmp    23be <APGridPaint+0x791>
                default: break;
    23bd:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    23be:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    23c2:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    23c6:	0f 8e be fb ff ff    	jle    1f8a <APGridPaint+0x35d>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    23cc:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    23d0:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    23d4:	0f 8e a4 fb ff ff    	jle    1f7e <APGridPaint+0x351>
                    break;
                default: break;
            }
        }
...
{
    23e2:	55                   	push   %ebp
    23e3:	89 e5                	mov    %esp,%ebp
    23e5:	53                   	push   %ebx
    23e6:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    23e9:	8d 45 d8             	lea    -0x28(%ebp),%eax
    23ec:	68 cd 00 00 00       	push   $0xcd
    23f1:	6a 74                	push   $0x74
    23f3:	6a 18                	push   $0x18
    23f5:	50                   	push   %eax
    23f6:	e8 ae f3 ff ff       	call   17a9 <RGB>
    23fb:	83 c4 0c             	add    $0xc,%esp
    23fe:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2402:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    2406:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    240a:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    240d:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    brush.color = RGB(0x18,0x74,0xcd);
    2414:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2417:	68 cd 00 00 00       	push   $0xcd
    241c:	6a 74                	push   $0x74
    241e:	6a 18                	push   $0x18
    2420:	50                   	push   %eax
    2421:	e8 83 f3 ff ff       	call   17a9 <RGB>
    2426:	83 c4 0c             	add    $0xc,%esp
    2429:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    242d:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    2431:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2435:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    2438:	8b 45 08             	mov    0x8(%ebp),%eax
    243b:	8d 50 58             	lea    0x58(%eax),%edx
    243e:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2441:	ff 75 f4             	pushl  -0xc(%ebp)
    2444:	ff 75 f0             	pushl  -0x10(%ebp)
    2447:	52                   	push   %edx
    2448:	50                   	push   %eax
    2449:	e8 48 ea ff ff       	call   e96 <APSetPen>
    244e:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    2451:	8b 45 08             	mov    0x8(%ebp),%eax
    2454:	8d 58 58             	lea    0x58(%eax),%ebx
    2457:	8d 55 d8             	lea    -0x28(%ebp),%edx
    245a:	83 ec 04             	sub    $0x4,%esp
    245d:	83 ec 04             	sub    $0x4,%esp
    2460:	89 e0                	mov    %esp,%eax
    2462:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    2466:	66 89 08             	mov    %cx,(%eax)
    2469:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    246d:	88 48 02             	mov    %cl,0x2(%eax)
    2470:	53                   	push   %ebx
    2471:	52                   	push   %edx
    2472:	e8 58 ea ff ff       	call   ecf <APSetBrush>
    2477:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    247a:	8b 45 08             	mov    0x8(%ebp),%eax
    247d:	83 c0 58             	add    $0x58,%eax
    2480:	83 ec 0c             	sub    $0xc,%esp
    2483:	6a 32                	push   $0x32
    2485:	68 20 03 00 00       	push   $0x320
    248a:	6a 00                	push   $0x0
    248c:	6a 00                	push   $0x0
    248e:	50                   	push   %eax
    248f:	e8 65 ee ff ff       	call   12f9 <APDrawRect>
    2494:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    2497:	8d 45 d8             	lea    -0x28(%ebp),%eax
    249a:	6a 08                	push   $0x8
    249c:	6a 08                	push   $0x8
    249e:	6a 08                	push   $0x8
    24a0:	50                   	push   %eax
    24a1:	e8 03 f3 ff ff       	call   17a9 <RGB>
    24a6:	83 c4 0c             	add    $0xc,%esp
    24a9:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    24ad:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    24b1:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    24b5:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    24b8:	8b 45 08             	mov    0x8(%ebp),%eax
    24bb:	8d 58 58             	lea    0x58(%eax),%ebx
    24be:	8d 55 d8             	lea    -0x28(%ebp),%edx
    24c1:	83 ec 04             	sub    $0x4,%esp
    24c4:	83 ec 04             	sub    $0x4,%esp
    24c7:	89 e0                	mov    %esp,%eax
    24c9:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    24cd:	66 89 08             	mov    %cx,(%eax)
    24d0:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    24d4:	88 48 02             	mov    %cl,0x2(%eax)
    24d7:	53                   	push   %ebx
    24d8:	52                   	push   %edx
    24d9:	e8 33 ea ff ff       	call   f11 <APSetFont>
    24de:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    24e1:	8b 45 08             	mov    0x8(%ebp),%eax
    24e4:	83 c0 58             	add    $0x58,%eax
    24e7:	6a 14                	push   $0x14
    24e9:	6a 0a                	push   $0xa
    24eb:	ff 75 0c             	pushl  0xc(%ebp)
    24ee:	50                   	push   %eax
    24ef:	e8 0a f0 ff ff       	call   14fe <APDrawText>
...
if (seed > 0)
    2500:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    2504:	7e 08                	jle    250e <random+0x11>
{
rand_num = seed;
    2506:	8b 45 08             	mov    0x8(%ebp),%eax
    2509:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
}
rand_num *= 3;
    250e:	8b 15 c0 6c 00 00    	mov    0x6cc0,%edx
    2514:	89 d0                	mov    %edx,%eax
    2516:	01 c0                	add    %eax,%eax
    2518:	01 d0                	add    %edx,%eax
    251a:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
if (rand_num < 0)
    251f:	a1 c0 6c 00 00       	mov    0x6cc0,%eax
    2524:	85 c0                	test   %eax,%eax
    2526:	79 0c                	jns    2534 <random+0x37>
{
rand_num *= (-1);
    2528:	a1 c0 6c 00 00       	mov    0x6cc0,%eax
    252d:	f7 d8                	neg    %eax
    252f:	a3 c0 6c 00 00       	mov    %eax,0x6cc0
}
return rand_num % 997;
    2534:	8b 0d c0 6c 00 00    	mov    0x6cc0,%ecx
    253a:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    253f:	89 c8                	mov    %ecx,%eax
    2541:	f7 ea                	imul   %edx
    2543:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    2546:	c1 f8 09             	sar    $0x9,%eax
    2549:	89 c2                	mov    %eax,%edx
    254b:	89 c8                	mov    %ecx,%eax
    254d:	c1 f8 1f             	sar    $0x1f,%eax
    2550:	29 c2                	sub    %eax,%edx
    2552:	89 d0                	mov    %edx,%eax
    2554:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    255a:	29 c1                	sub    %eax,%ecx
    255c:	89 c8                	mov    %ecx,%eax
}
    255e:	5d                   	pop    %ebp
    255f:	c3                   	ret    
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    if(sgn && xx < 0){
    256e:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    2572:	74 17                	je     258b <sprintint+0x2b>
    2574:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    2578:	79 11                	jns    258b <sprintint+0x2b>
        neg = 1;
    257a:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    2581:	8b 45 10             	mov    0x10(%ebp),%eax
    2584:	f7 d8                	neg    %eax
    2586:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2589:	eb 06                	jmp    2591 <sprintint+0x31>
    } else {
        x = xx;
    ...
    i = 0;
    2591:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    2598:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    259b:	8d 41 01             	lea    0x1(%ecx),%eax
    259e:	89 45 f8             	mov    %eax,-0x8(%ebp)
    25a1:	8b 5d 14             	mov    0x14(%ebp),%ebx
    25a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    25a7:	ba 00 00 00 00       	mov    $0x0,%edx
    25ac:	f7 f3                	div    %ebx
    25ae:	89 d0                	mov    %edx,%eax
    25b0:	0f b6 80 c4 6c 00 00 	movzbl 0x6cc4(%eax),%eax
    25b7:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    25bb:	8b 5d 14             	mov    0x14(%ebp),%ebx
    25be:	8b 45 f0             	mov    -0x10(%ebp),%eax
    25c1:	ba 00 00 00 00       	mov    $0x0,%edx
    25c6:	f7 f3                	div    %ebx
    25c8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    25cb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    25cf:	75 c7                	jne    2598 <sprintint+0x38>
    if(neg)
    25d1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    25d5:	74 0e                	je     25e5 <sprintint+0x85>
        buf[i++] = '-';
    25d7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    25da:	8d 50 01             	lea    0x1(%eax),%edx
    25dd:	89 55 f8             	mov    %edx,-0x8(%ebp)
    25e0:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    25e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    25e8:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    25eb:	eb 1b                	jmp    2608 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    25ed:	8b 45 0c             	mov    0xc(%ebp),%eax
    25f0:	8b 00                	mov    (%eax),%eax
    25f2:	8d 48 01             	lea    0x1(%eax),%ecx
    25f5:	8b 55 0c             	mov    0xc(%ebp),%edx
    25f8:	89 0a                	mov    %ecx,(%edx)
    25fa:	89 c2                	mov    %eax,%edx
    25fc:	8b 45 08             	mov    0x8(%ebp),%eax
    25ff:	01 d0                	add    %edx,%eax
    2601:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    2604:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2608:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    260c:	7f df                	jg     25ed <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    260e:	eb 21                	jmp    2631 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    2610:	8b 45 0c             	mov    0xc(%ebp),%eax
    2613:	8b 00                	mov    (%eax),%eax
    2615:	8d 48 01             	lea    0x1(%eax),%ecx
    2618:	8b 55 0c             	mov    0xc(%ebp),%edx
    261b:	89 0a                	mov    %ecx,(%edx)
    261d:	89 c2                	mov    %eax,%edx
    261f:	8b 45 08             	mov    0x8(%ebp),%eax
    2622:	01 c2                	add    %eax,%edx
    2624:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2627:	8b 45 f8             	mov    -0x8(%ebp),%eax
    262a:	01 c8                	add    %ecx,%eax
    262c:	0f b6 00             	movzbl (%eax),%eax
    262f:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2631:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2635:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2639:	79 d5                	jns    2610 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    263b:	90                   	nop
    263c:	83 c4 20             	add    $0x20,%esp
    263f:	5b                   	pop    %ebx
    2640:	5d                   	pop    %ebp
    2641:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2645:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    2648:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    264f:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2656:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    265d:	8d 45 0c             	lea    0xc(%ebp),%eax
    2660:	83 c0 04             	add    $0x4,%eax
    2663:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    2666:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    266d:	e9 d9 01 00 00       	jmp    284b <sprintf+0x209>
        c = fmt[i] & 0xff;
    2672:	8b 55 0c             	mov    0xc(%ebp),%edx
    2675:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2678:	01 d0                	add    %edx,%eax
    267a:	0f b6 00             	movzbl (%eax),%eax
    267d:	0f be c0             	movsbl %al,%eax
    2680:	25 ff 00 00 00       	and    $0xff,%eax
    2685:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    2688:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    268c:	75 2c                	jne    26ba <sprintf+0x78>
            if(c == '%'){
    268e:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2692:	75 0c                	jne    26a0 <sprintf+0x5e>
                state = '%';
    2694:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    269b:	e9 a7 01 00 00       	jmp    2847 <sprintf+0x205>
            } else {
                dst[j++] = c;
    26a0:	8b 45 c8             	mov    -0x38(%ebp),%eax
    26a3:	8d 50 01             	lea    0x1(%eax),%edx
    26a6:	89 55 c8             	mov    %edx,-0x38(%ebp)
    26a9:	89 c2                	mov    %eax,%edx
    26ab:	8b 45 08             	mov    0x8(%ebp),%eax
    26ae:	01 d0                	add    %edx,%eax
    26b0:	8b 55 e0             	mov    -0x20(%ebp),%edx
    26b3:	88 10                	mov    %dl,(%eax)
    26b5:	e9 8d 01 00 00       	jmp    2847 <sprintf+0x205>
            }
        } else if(state == '%'){
    26ba:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    26be:	0f 85 83 01 00 00    	jne    2847 <sprintf+0x205>
            if(c == 'd'){
    26c4:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    26c8:	75 4c                	jne    2716 <sprintf+0xd4>
                buf[bi] = '\0';
    26ca:	8d 55 ce             	lea    -0x32(%ebp),%edx
    26cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    26d0:	01 d0                	add    %edx,%eax
    26d2:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    26d5:	83 ec 0c             	sub    $0xc,%esp
    26d8:	8d 45 ce             	lea    -0x32(%ebp),%eax
    26db:	50                   	push   %eax
    26dc:	e8 0f de ff ff       	call   4f0 <atoi>
    26e1:	83 c4 10             	add    $0x10,%esp
    26e4:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    26e7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    26ee:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    26f1:	8b 00                	mov    (%eax),%eax
    26f3:	83 ec 08             	sub    $0x8,%esp
    26f6:	ff 75 d8             	pushl  -0x28(%ebp)
    26f9:	6a 01                	push   $0x1
    26fb:	6a 0a                	push   $0xa
    26fd:	50                   	push   %eax
    26fe:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2701:	50                   	push   %eax
    2702:	ff 75 08             	pushl  0x8(%ebp)
    2705:	e8 56 fe ff ff       	call   2560 <sprintint>
    270a:	83 c4 20             	add    $0x20,%esp
                ap++;
    270d:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2711:	e9 2a 01 00 00       	jmp    2840 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2716:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    271a:	74 06                	je     2722 <sprintf+0xe0>
    271c:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    2720:	75 4c                	jne    276e <sprintf+0x12c>
                buf[bi] = '\0';
    2722:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2725:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2728:	01 d0                	add    %edx,%eax
    272a:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    272d:	83 ec 0c             	sub    $0xc,%esp
    2730:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2733:	50                   	push   %eax
    2734:	e8 b7 dd ff ff       	call   4f0 <atoi>
    2739:	83 c4 10             	add    $0x10,%esp
    273c:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    273f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2746:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2749:	8b 00                	mov    (%eax),%eax
    274b:	83 ec 08             	sub    $0x8,%esp
    274e:	ff 75 dc             	pushl  -0x24(%ebp)
    2751:	6a 00                	push   $0x0
    2753:	6a 10                	push   $0x10
    2755:	50                   	push   %eax
    2756:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2759:	50                   	push   %eax
    275a:	ff 75 08             	pushl  0x8(%ebp)
    275d:	e8 fe fd ff ff       	call   2560 <sprintint>
    2762:	83 c4 20             	add    $0x20,%esp
                ap++;
    2765:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    2769:	e9 d2 00 00 00       	jmp    2840 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    276e:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    2772:	75 46                	jne    27ba <sprintf+0x178>
                s = (char*)*ap;
    2774:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2777:	8b 00                	mov    (%eax),%eax
    2779:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    277c:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    2780:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2784:	75 25                	jne    27ab <sprintf+0x169>
                    s = "(null)";
    2786:	c7 45 f4 4c 2a 00 00 	movl   $0x2a4c,-0xc(%ebp)
                while(*s != 0){
    278d:	eb 1c                	jmp    27ab <sprintf+0x169>
                    dst[j++] = *s;
    278f:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2792:	8d 50 01             	lea    0x1(%eax),%edx
    2795:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2798:	89 c2                	mov    %eax,%edx
    279a:	8b 45 08             	mov    0x8(%ebp),%eax
    279d:	01 c2                	add    %eax,%edx
    279f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    27a2:	0f b6 00             	movzbl (%eax),%eax
    27a5:	88 02                	mov    %al,(%edx)
                    s++;
    27a7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    27ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
    27ae:	0f b6 00             	movzbl (%eax),%eax
    27b1:	84 c0                	test   %al,%al
    27b3:	75 da                	jne    278f <sprintf+0x14d>
    27b5:	e9 86 00 00 00       	jmp    2840 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    27ba:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    27be:	75 1d                	jne    27dd <sprintf+0x19b>
                dst[j++] = *ap;
    27c0:	8b 45 c8             	mov    -0x38(%ebp),%eax
    27c3:	8d 50 01             	lea    0x1(%eax),%edx
    27c6:	89 55 c8             	mov    %edx,-0x38(%ebp)
    27c9:	89 c2                	mov    %eax,%edx
    27cb:	8b 45 08             	mov    0x8(%ebp),%eax
    27ce:	01 c2                	add    %eax,%edx
    27d0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    27d3:	8b 00                	mov    (%eax),%eax
    27d5:	88 02                	mov    %al,(%edx)
                ap++;
    27d7:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    27db:	eb 63                	jmp    2840 <sprintf+0x1fe>
            } else if(c == '%'){
    27dd:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    27e1:	75 17                	jne    27fa <sprintf+0x1b8>
                dst[j++] = c;
    27e3:	8b 45 c8             	mov    -0x38(%ebp),%eax
    27e6:	8d 50 01             	lea    0x1(%eax),%edx
    27e9:	89 55 c8             	mov    %edx,-0x38(%ebp)
    27ec:	89 c2                	mov    %eax,%edx
    27ee:	8b 45 08             	mov    0x8(%ebp),%eax
    27f1:	01 d0                	add    %edx,%eax
    27f3:	8b 55 e0             	mov    -0x20(%ebp),%edx
    27f6:	88 10                	mov    %dl,(%eax)
    27f8:	eb 46                	jmp    2840 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    27fa:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    27fe:	7e 18                	jle    2818 <sprintf+0x1d6>
    2800:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2804:	7f 12                	jg     2818 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2806:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2809:	8d 50 01             	lea    0x1(%eax),%edx
    280c:	89 55 f0             	mov    %edx,-0x10(%ebp)
    280f:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2812:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2816:	eb 2f                	jmp    2847 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2818:	8b 45 c8             	mov    -0x38(%ebp),%eax
    281b:	8d 50 01             	lea    0x1(%eax),%edx
    281e:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2821:	89 c2                	mov    %eax,%edx
    2823:	8b 45 08             	mov    0x8(%ebp),%eax
    2826:	01 d0                	add    %edx,%eax
    2828:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    282b:	8b 45 c8             	mov    -0x38(%ebp),%eax
    282e:	8d 50 01             	lea    0x1(%eax),%edx
    2831:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2834:	89 c2                	mov    %eax,%edx
    2836:	8b 45 08             	mov    0x8(%ebp),%eax
    2839:	01 d0                	add    %edx,%eax
    283b:	8b 55 e0             	mov    -0x20(%ebp),%edx
    283e:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    2840:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2847:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    284b:	8b 55 0c             	mov    0xc(%ebp),%edx
    284e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2851:	01 d0                	add    %edx,%eax
    2853:	0f b6 00             	movzbl (%eax),%eax
    2856:	84 c0                	test   %al,%al
    2858:	0f 85 14 fe ff ff    	jne    2672 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    285e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2861:	8d 50 01             	lea    0x1(%eax),%edx
    2864:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2867:	89 c2                	mov    %eax,%edx
    2869:	8b 45 08             	mov    0x8(%ebp),%eax
    286c:	01 d0                	add    %edx,%eax
    286e:	c6 00 00             	movb   $0x0,(%eax)
}
    2871:	90                   	nop
    2872:	c9                   	leave  
    2873:	c3                   	ret    
