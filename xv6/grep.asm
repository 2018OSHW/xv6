...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    p = buf;
      18:	c7 45 f0 80 2b 00 00 	movl   $0x2b80,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    if(p == buf)
      84:	81 7d f0 80 2b 00 00 	cmpl   $0x2b80,-0x10(%ebp)
    ...
    if(m > 0){
      ...
      9d:	ba 80 2b 00 00       	mov    $0x2b80,%edx
      ...
      ba:	83 c4 10             	add    $0x10,%esp
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
      ...
      ce:	05 80 2b 00 00       	add    $0x2b80,%eax
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    printf(2, "usage: grep pattern [file ...]\n");
     ...
     10f:	68 d0 23 00 00       	push   $0x23d0
     114:	6a 02                	push   $0x2
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     18b:	50                   	push   %eax
     18c:	68 f0 23 00 00       	push   $0x23f0
     191:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6c5:	0f b6 80 34 2b 00 00 	movzbl 0x2b34(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     801:	75 25                	jne    828 <printf+0xff>
          s = "(null)";
     803:	c7 45 f4 06 24 00 00 	movl   $0x2406,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     8c9:	a1 68 2b 00 00       	mov    0x2b68,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     994:	a3 68 2b 00 00       	mov    %eax,0x2b68
}
     999:	90                   	nop
     99a:	c9                   	leave  
     99b:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     9f5:	a1 68 2b 00 00       	mov    0x2b68,%eax
}
     9fa:	c9                   	leave  
     9fb:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     a11:	a1 68 2b 00 00       	mov    0x2b68,%eax
     a16:	89 45 f0             	mov    %eax,-0x10(%ebp)
     a19:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     a1d:	75 23                	jne    a42 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     a1f:	c7 45 f0 60 2b 00 00 	movl   $0x2b60,-0x10(%ebp)
     a26:	8b 45 f0             	mov    -0x10(%ebp),%eax
     a29:	a3 68 2b 00 00       	mov    %eax,0x2b68
     a2e:	a1 68 2b 00 00       	mov    0x2b68,%eax
     a33:	a3 60 2b 00 00       	mov    %eax,0x2b60
    base.s.size = 0;
     a38:	c7 05 64 2b 00 00 00 	movl   $0x0,0x2b64
     a3f:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     a95:	a3 68 2b 00 00       	mov    %eax,0x2b68
      return (void*)(p + 1);
    ...
    if(p == freep)
     aa2:	a1 68 2b 00 00       	mov    0x2b68,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     be0:	79 2e                	jns    c10 <APLoadBitmap+0x61>
    {
     ...
     be8:	68 0d 24 00 00       	push   $0x240d
     bed:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    16d0:	68 20 24 00 00       	push   $0x2420
    16d5:	6a 01                	push   $0x1
    ...
    1743:	68 40 24 00 00       	push   $0x2440
    1748:	6a 01                	push   $0x1
    ...
    17e7:	68 64 24 00 00       	push   $0x2464
    17ec:	6a 01                	push   $0x1
    ...
    18b8:	68 8c 24 00 00       	push   $0x248c
    18bd:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1c4a:	68 20 25 00 00       	push   $0x2520
    1c4f:	6a 01                	push   $0x1
    ...
    1c7b:	68 46 25 00 00       	push   $0x2546
    1c80:	6a 01                	push   $0x1
    ...
    1cea:	8b 04 85 5c 25 00 00 	mov    0x255c(,%eax,4),%eax
    1cf1:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1d05:	8b 1d ac 2f 00 00    	mov    0x2fac,%ebx
    ...
    1e17:	8b 1d ec 2f 00 00    	mov    0x2fec,%ebx
    ...
    1e75:	8b 1d cc 2f 00 00    	mov    0x2fcc,%ebx
    ...
    1ed3:	8b 1d b0 2f 00 00    	mov    0x2fb0,%ebx
    ...
    1f31:	8b 1d e8 2f 00 00    	mov    0x2fe8,%ebx
    ...
    1f8f:	8b 1d 80 2f 00 00    	mov    0x2f80,%ebx
    ...
    1fea:	8b 1d 9c 2f 00 00    	mov    0x2f9c,%ebx
...
if (seed > 0)
    205b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    205f:	7e 08                	jle    2069 <random+0x11>
{
rand_num = seed;
    2061:	8b 45 08             	mov    0x8(%ebp),%eax
    2064:	a3 48 2b 00 00       	mov    %eax,0x2b48
}
rand_num *= 3;
    2069:	8b 15 48 2b 00 00    	mov    0x2b48,%edx
    206f:	89 d0                	mov    %edx,%eax
    2071:	01 c0                	add    %eax,%eax
    2073:	01 d0                	add    %edx,%eax
    2075:	a3 48 2b 00 00       	mov    %eax,0x2b48
if (rand_num < 0)
    207a:	a1 48 2b 00 00       	mov    0x2b48,%eax
    207f:	85 c0                	test   %eax,%eax
    2081:	79 0c                	jns    208f <random+0x37>
{
rand_num *= (-1);
    2083:	a1 48 2b 00 00       	mov    0x2b48,%eax
    2088:	f7 d8                	neg    %eax
    208a:	a3 48 2b 00 00       	mov    %eax,0x2b48
}
return rand_num % 997;
    208f:	8b 0d 48 2b 00 00    	mov    0x2b48,%ecx
    2095:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    209a:	89 c8                	mov    %ecx,%eax
    209c:	f7 ea                	imul   %edx
    209e:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    20a1:	c1 f8 09             	sar    $0x9,%eax
    20a4:	89 c2                	mov    %eax,%edx
    20a6:	89 c8                	mov    %ecx,%eax
    20a8:	c1 f8 1f             	sar    $0x1f,%eax
    20ab:	29 c2                	sub    %eax,%edx
    20ad:	89 d0                	mov    %edx,%eax
    20af:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    20b5:	29 c1                	sub    %eax,%ecx
    20b7:	89 c8                	mov    %ecx,%eax
}
    20b9:	5d                   	pop    %ebp
    20ba:	c3                   	ret    
...
{
    20bb:	55                   	push   %ebp
    20bc:	89 e5                	mov    %esp,%ebp
    20be:	53                   	push   %ebx
    20bf:	83 ec 20             	sub    $0x20,%esp
    static char digits[] = "0123456789ABCDEF";
    char buf[16];
    int i, neg;
    uint x;
    ...
    if(sgn && xx < 0){
    20c9:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    20cd:	74 17                	je     20e6 <sprintint+0x2b>
    20cf:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    20d3:	79 11                	jns    20e6 <sprintint+0x2b>
        neg = 1;
    20d5:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    20dc:	8b 45 10             	mov    0x10(%ebp),%eax
    20df:	f7 d8                	neg    %eax
    20e1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    20e4:	eb 06                	jmp    20ec <sprintint+0x31>
    } else {
        x = xx;
    20e6:	8b 45 10             	mov    0x10(%ebp),%eax
    20e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    20ec:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    20f3:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    20f6:	8d 41 01             	lea    0x1(%ecx),%eax
    20f9:	89 45 f8             	mov    %eax,-0x8(%ebp)
    20fc:	8b 5d 14             	mov    0x14(%ebp),%ebx
    20ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2102:	ba 00 00 00 00       	mov    $0x0,%edx
    2107:	f7 f3                	div    %ebx
    2109:	89 d0                	mov    %edx,%eax
    210b:	0f b6 80 4c 2b 00 00 	movzbl 0x2b4c(%eax),%eax
    2112:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    2116:	8b 5d 14             	mov    0x14(%ebp),%ebx
    2119:	8b 45 f0             	mov    -0x10(%ebp),%eax
    211c:	ba 00 00 00 00       	mov    $0x0,%edx
    2121:	f7 f3                	div    %ebx
    2123:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2126:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    212a:	75 c7                	jne    20f3 <sprintint+0x38>
    if(neg)
    212c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2130:	74 0e                	je     2140 <sprintint+0x85>
        buf[i++] = '-';
    2132:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2135:	8d 50 01             	lea    0x1(%eax),%edx
    2138:	89 55 f8             	mov    %edx,-0x8(%ebp)
    213b:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    2140:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2143:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2146:	eb 1b                	jmp    2163 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2148:	8b 45 0c             	mov    0xc(%ebp),%eax
    214b:	8b 00                	mov    (%eax),%eax
    214d:	8d 48 01             	lea    0x1(%eax),%ecx
    2150:	8b 55 0c             	mov    0xc(%ebp),%edx
    2153:	89 0a                	mov    %ecx,(%edx)
    2155:	89 c2                	mov    %eax,%edx
    2157:	8b 45 08             	mov    0x8(%ebp),%eax
    215a:	01 d0                	add    %edx,%eax
    215c:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    215f:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2163:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2167:	7f df                	jg     2148 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2169:	eb 21                	jmp    218c <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    216b:	8b 45 0c             	mov    0xc(%ebp),%eax
    216e:	8b 00                	mov    (%eax),%eax
    2170:	8d 48 01             	lea    0x1(%eax),%ecx
    2173:	8b 55 0c             	mov    0xc(%ebp),%edx
    2176:	89 0a                	mov    %ecx,(%edx)
    2178:	89 c2                	mov    %eax,%edx
    217a:	8b 45 08             	mov    0x8(%ebp),%eax
    217d:	01 c2                	add    %eax,%edx
    217f:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2182:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2185:	01 c8                	add    %ecx,%eax
    2187:	0f b6 00             	movzbl (%eax),%eax
    ...
    while(--i >= 0)
    218c:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    2190:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2194:	79 d5                	jns    216b <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2196:	90                   	nop
    2197:	83 c4 20             	add    $0x20,%esp
    219a:	5b                   	pop    %ebx
    219b:	5d                   	pop    %ebp
    219c:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    21a0:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    21a3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    21aa:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    21b1:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    21b8:	8d 45 0c             	lea    0xc(%ebp),%eax
    21bb:	83 c0 04             	add    $0x4,%eax
    21be:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    21c1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    21c8:	e9 d9 01 00 00       	jmp    23a6 <sprintf+0x209>
        c = fmt[i] & 0xff;
    21cd:	8b 55 0c             	mov    0xc(%ebp),%edx
    21d0:	8b 45 ec             	mov    -0x14(%ebp),%eax
    21d3:	01 d0                	add    %edx,%eax
    21d5:	0f b6 00             	movzbl (%eax),%eax
    21d8:	0f be c0             	movsbl %al,%eax
    21db:	25 ff 00 00 00       	and    $0xff,%eax
    21e0:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    21e3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    21e7:	75 2c                	jne    2215 <sprintf+0x78>
            if(c == '%'){
    21e9:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    21ed:	75 0c                	jne    21fb <sprintf+0x5e>
                state = '%';
    21ef:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    21f6:	e9 a7 01 00 00       	jmp    23a2 <sprintf+0x205>
            } else {
                dst[j++] = c;
    ...
    220b:	8b 55 e0             	mov    -0x20(%ebp),%edx
    220e:	88 10                	mov    %dl,(%eax)
    2210:	e9 8d 01 00 00       	jmp    23a2 <sprintf+0x205>
            }
        } else if(state == '%'){
    2215:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    2219:	0f 85 83 01 00 00    	jne    23a2 <sprintf+0x205>
            if(c == 'd'){
    221f:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2223:	75 4c                	jne    2271 <sprintf+0xd4>
                buf[bi] = '\0';
    2225:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2228:	8b 45 f0             	mov    -0x10(%ebp),%eax
    222b:	01 d0                	add    %edx,%eax
    222d:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2230:	83 ec 0c             	sub    $0xc,%esp
    2233:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2236:	50                   	push   %eax
    2237:	e8 b4 e2 ff ff       	call   4f0 <atoi>
    223c:	83 c4 10             	add    $0x10,%esp
    223f:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2242:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2249:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    224c:	8b 00                	mov    (%eax),%eax
    224e:	83 ec 08             	sub    $0x8,%esp
    2251:	ff 75 d8             	pushl  -0x28(%ebp)
    2254:	6a 01                	push   $0x1
    2256:	6a 0a                	push   $0xa
    2258:	50                   	push   %eax
    2259:	8d 45 c8             	lea    -0x38(%ebp),%eax
    225c:	50                   	push   %eax
    225d:	ff 75 08             	pushl  0x8(%ebp)
    2260:	e8 56 fe ff ff       	call   20bb <sprintint>
    2265:	83 c4 20             	add    $0x20,%esp
                ap++;
    2268:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    226c:	e9 2a 01 00 00       	jmp    239b <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2271:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2275:	74 06                	je     227d <sprintf+0xe0>
    2277:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    227b:	75 4c                	jne    22c9 <sprintf+0x12c>
                buf[bi] = '\0';
    227d:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2280:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2283:	01 d0                	add    %edx,%eax
    2285:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2288:	83 ec 0c             	sub    $0xc,%esp
    228b:	8d 45 ce             	lea    -0x32(%ebp),%eax
    228e:	50                   	push   %eax
    228f:	e8 5c e2 ff ff       	call   4f0 <atoi>
    2294:	83 c4 10             	add    $0x10,%esp
    2297:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    229a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    22a1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    22a4:	8b 00                	mov    (%eax),%eax
    22a6:	83 ec 08             	sub    $0x8,%esp
    22a9:	ff 75 dc             	pushl  -0x24(%ebp)
    22ac:	6a 00                	push   $0x0
    22ae:	6a 10                	push   $0x10
    22b0:	50                   	push   %eax
    22b1:	8d 45 c8             	lea    -0x38(%ebp),%eax
    22b4:	50                   	push   %eax
    22b5:	ff 75 08             	pushl  0x8(%ebp)
    22b8:	e8 fe fd ff ff       	call   20bb <sprintint>
    22bd:	83 c4 20             	add    $0x20,%esp
                ap++;
    22c0:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    22c4:	e9 d2 00 00 00       	jmp    239b <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    22c9:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    22cd:	75 46                	jne    2315 <sprintf+0x178>
                s = (char*)*ap;
    22cf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    22d2:	8b 00                	mov    (%eax),%eax
    22d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    22d7:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    22db:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    22df:	75 25                	jne    2306 <sprintf+0x169>
                    s = "(null)";
    22e1:	c7 45 f4 7c 25 00 00 	movl   $0x257c,-0xc(%ebp)
                while(*s != 0){
    22e8:	eb 1c                	jmp    2306 <sprintf+0x169>
                    dst[j++] = *s;
    22ea:	8b 45 c8             	mov    -0x38(%ebp),%eax
    22ed:	8d 50 01             	lea    0x1(%eax),%edx
    22f0:	89 55 c8             	mov    %edx,-0x38(%ebp)
    22f3:	89 c2                	mov    %eax,%edx
    22f5:	8b 45 08             	mov    0x8(%ebp),%eax
    22f8:	01 c2                	add    %eax,%edx
    22fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22fd:	0f b6 00             	movzbl (%eax),%eax
    2300:	88 02                	mov    %al,(%edx)
                    s++;
    2302:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    2306:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2309:	0f b6 00             	movzbl (%eax),%eax
    230c:	84 c0                	test   %al,%al
    230e:	75 da                	jne    22ea <sprintf+0x14d>
    2310:	e9 86 00 00 00       	jmp    239b <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    2315:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    2319:	75 1d                	jne    2338 <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    2329:	01 c2                	add    %eax,%edx
    232b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    232e:	8b 00                	mov    (%eax),%eax
    2330:	88 02                	mov    %al,(%edx)
                ap++;
    2332:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2336:	eb 63                	jmp    239b <sprintf+0x1fe>
            } else if(c == '%'){
    2338:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    233c:	75 17                	jne    2355 <sprintf+0x1b8>
                dst[j++] = c;
    233e:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2341:	8d 50 01             	lea    0x1(%eax),%edx
    2344:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2347:	89 c2                	mov    %eax,%edx
    2349:	8b 45 08             	mov    0x8(%ebp),%eax
    234c:	01 d0                	add    %edx,%eax
    234e:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2351:	88 10                	mov    %dl,(%eax)
    2353:	eb 46                	jmp    239b <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2355:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2359:	7e 18                	jle    2373 <sprintf+0x1d6>
    235b:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    235f:	7f 12                	jg     2373 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2361:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2364:	8d 50 01             	lea    0x1(%eax),%edx
    2367:	89 55 f0             	mov    %edx,-0x10(%ebp)
    236a:	8b 55 e0             	mov    -0x20(%ebp),%edx
    236d:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2371:	eb 2f                	jmp    23a2 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2373:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2376:	8d 50 01             	lea    0x1(%eax),%edx
    2379:	89 55 c8             	mov    %edx,-0x38(%ebp)
    237c:	89 c2                	mov    %eax,%edx
    237e:	8b 45 08             	mov    0x8(%ebp),%eax
    2381:	01 d0                	add    %edx,%eax
    2383:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    2386:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2389:	8d 50 01             	lea    0x1(%eax),%edx
    238c:	89 55 c8             	mov    %edx,-0x38(%ebp)
    238f:	89 c2                	mov    %eax,%edx
    2391:	8b 45 08             	mov    0x8(%ebp),%eax
    2394:	01 d0                	add    %edx,%eax
    2396:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2399:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    239b:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    23a2:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    23a6:	8b 55 0c             	mov    0xc(%ebp),%edx
    23a9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    23ac:	01 d0                	add    %edx,%eax
    23ae:	0f b6 00             	movzbl (%eax),%eax
    23b1:	84 c0                	test   %al,%al
    23b3:	0f 85 14 fe ff ff    	jne    21cd <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    23b9:	8b 45 c8             	mov    -0x38(%ebp),%eax
    23bc:	8d 50 01             	lea    0x1(%eax),%edx
    23bf:	89 55 c8             	mov    %edx,-0x38(%ebp)
    23c2:	89 c2                	mov    %eax,%edx
    23c4:	8b 45 08             	mov    0x8(%ebp),%eax
    23c7:	01 d0                	add    %edx,%eax
    23c9:	c6 00 00             	movb   $0x0,(%eax)
}
    23cc:	90                   	nop
    23cd:	c9                   	leave  
    23ce:	c3                   	ret    
