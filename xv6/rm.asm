...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     42a:	0f b6 80 0c 28 00 00 	movzbl 0x280c(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     566:	75 25                	jne    58d <printf+0xff>
          s = "(null)";
     568:	c7 45 f4 61 21 00 00 	movl   $0x2161,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     62e:	a1 40 28 00 00       	mov    0x2840,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6f9:	a3 40 28 00 00       	mov    %eax,0x2840
}
     6fe:	90                   	nop
     6ff:	c9                   	leave  
     700:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     75a:	a1 40 28 00 00       	mov    0x2840,%eax
}
     75f:	c9                   	leave  
     760:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     776:	a1 40 28 00 00       	mov    0x2840,%eax
     77b:	89 45 f0             	mov    %eax,-0x10(%ebp)
     77e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     782:	75 23                	jne    7a7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     784:	c7 45 f0 38 28 00 00 	movl   $0x2838,-0x10(%ebp)
     78b:	8b 45 f0             	mov    -0x10(%ebp),%eax
     78e:	a3 40 28 00 00       	mov    %eax,0x2840
     793:	a1 40 28 00 00       	mov    0x2840,%eax
     798:	a3 38 28 00 00       	mov    %eax,0x2838
    base.s.size = 0;
     79d:	c7 05 3c 28 00 00 00 	movl   $0x0,0x283c
     7a4:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7fa:	a3 40 28 00 00       	mov    %eax,0x2840
      return (void*)(p + 1);
    ...
    if(p == freep)
     807:	a1 40 28 00 00       	mov    0x2840,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     945:	79 2e                	jns    975 <APLoadBitmap+0x61>
    {
     ...
     94d:	68 68 21 00 00       	push   $0x2168
     952:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1435:	68 78 21 00 00       	push   $0x2178
    143a:	6a 01                	push   $0x1
    ...
    14a8:	68 98 21 00 00       	push   $0x2198
    14ad:	6a 01                	push   $0x1
    ...
    154c:	68 bc 21 00 00       	push   $0x21bc
    1551:	6a 01                	push   $0x1
    ...
    161d:	68 e4 21 00 00       	push   $0x21e4
    1622:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    19af:	68 78 22 00 00       	push   $0x2278
    19b4:	6a 01                	push   $0x1
    ...
    19e0:	68 9e 22 00 00       	push   $0x229e
    19e5:	6a 01                	push   $0x1
    ...
    1a4f:	8b 04 85 b4 22 00 00 	mov    0x22b4(,%eax,4),%eax
    1a56:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a6a:	8b 1d 74 28 00 00    	mov    0x2874,%ebx
    ...
    1b7c:	8b 1d b4 28 00 00    	mov    0x28b4,%ebx
    ...
    1bda:	8b 1d 94 28 00 00    	mov    0x2894,%ebx
    ...
    1c38:	8b 1d 78 28 00 00    	mov    0x2878,%ebx
    ...
    1c96:	8b 1d b0 28 00 00    	mov    0x28b0,%ebx
    ...
    1cf4:	8b 1d 48 28 00 00    	mov    0x2848,%ebx
    ...
    1d4f:	8b 1d 64 28 00 00    	mov    0x2864,%ebx
...
rand_num = seed;
    ...
    1dc9:	a3 20 28 00 00       	mov    %eax,0x2820
}
rand_num *= 3;
    1dce:	8b 15 20 28 00 00    	mov    0x2820,%edx
    1dd4:	89 d0                	mov    %edx,%eax
    1dd6:	01 c0                	add    %eax,%eax
    1dd8:	01 d0                	add    %edx,%eax
    1dda:	a3 20 28 00 00       	mov    %eax,0x2820
if (rand_num < 0)
    1ddf:	a1 20 28 00 00       	mov    0x2820,%eax
    1de4:	85 c0                	test   %eax,%eax
    1de6:	79 0c                	jns    1df4 <random+0x37>
{
rand_num *= (-1);
    1de8:	a1 20 28 00 00       	mov    0x2820,%eax
    1ded:	f7 d8                	neg    %eax
    1def:	a3 20 28 00 00       	mov    %eax,0x2820
}
return rand_num % 997;
    1df4:	8b 0d 20 28 00 00    	mov    0x2820,%ecx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    1e70:	0f b6 80 24 28 00 00 	movzbl 0x2824(%eax),%eax
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    2044:	75 25                	jne    206b <sprintf+0x169>
                    s = "(null)";
    2046:	c7 45 f4 d4 22 00 00 	movl   $0x22d4,-0xc(%ebp)
                while(*s != 0){
