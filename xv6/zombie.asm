...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     3c6:	0f b6 80 f8 26 00 00 	movzbl 0x26f8(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     502:	75 25                	jne    529 <printf+0xff>
          s = "(null)";
     504:	c7 45 f4 70 20 00 00 	movl   $0x2070,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     5ca:	a1 28 27 00 00       	mov    0x2728,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     695:	a3 28 27 00 00       	mov    %eax,0x2728
}
     69a:	90                   	nop
     69b:	c9                   	leave  
     69c:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     6f6:	a1 28 27 00 00       	mov    0x2728,%eax
}
     6fb:	c9                   	leave  
     6fc:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     712:	a1 28 27 00 00       	mov    0x2728,%eax
     717:	89 45 f0             	mov    %eax,-0x10(%ebp)
     71a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     71e:	75 23                	jne    743 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     720:	c7 45 f0 20 27 00 00 	movl   $0x2720,-0x10(%ebp)
     727:	8b 45 f0             	mov    -0x10(%ebp),%eax
     72a:	a3 28 27 00 00       	mov    %eax,0x2728
     72f:	a1 28 27 00 00       	mov    0x2728,%eax
     734:	a3 20 27 00 00       	mov    %eax,0x2720
    base.s.size = 0;
     739:	c7 05 24 27 00 00 00 	movl   $0x0,0x2724
     740:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     796:	a3 28 27 00 00       	mov    %eax,0x2728
      return (void*)(p + 1);
    ...
    if(p == freep)
     7a3:	a1 28 27 00 00       	mov    0x2728,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     8e1:	79 2e                	jns    911 <APLoadBitmap+0x61>
    {
     ...
     8e9:	68 77 20 00 00       	push   $0x2077
     8ee:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    13d1:	68 88 20 00 00       	push   $0x2088
    13d6:	6a 01                	push   $0x1
    ...
    1444:	68 a8 20 00 00       	push   $0x20a8
    1449:	6a 01                	push   $0x1
    ...
    14e8:	68 cc 20 00 00       	push   $0x20cc
    14ed:	6a 01                	push   $0x1
    ...
    15b9:	68 f4 20 00 00       	push   $0x20f4
    15be:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    194b:	68 88 21 00 00       	push   $0x2188
    1950:	6a 01                	push   $0x1
    ...
    197c:	68 ae 21 00 00       	push   $0x21ae
    1981:	6a 01                	push   $0x1
    ...
    19eb:	8b 04 85 c4 21 00 00 	mov    0x21c4(,%eax,4),%eax
    19f2:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a06:	8b 1d 5c 27 00 00    	mov    0x275c,%ebx
    ...
    1b18:	8b 1d 9c 27 00 00    	mov    0x279c,%ebx
    ...
    1b76:	8b 1d 7c 27 00 00    	mov    0x277c,%ebx
    ...
    1bd4:	8b 1d 60 27 00 00    	mov    0x2760,%ebx
    ...
    1c32:	8b 1d 98 27 00 00    	mov    0x2798,%ebx
    ...
    1c90:	8b 1d 30 27 00 00    	mov    0x2730,%ebx
    ...
    1ceb:	8b 1d 4c 27 00 00    	mov    0x274c,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1d60:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1d67:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1d6b:	74 17                	je     1d84 <sprintint+0x2b>
    1d6d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1d71:	79 11                	jns    1d84 <sprintint+0x2b>
        neg = 1;
    1d73:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1d7a:	8b 45 10             	mov    0x10(%ebp),%eax
    1d7d:	f7 d8                	neg    %eax
    1d7f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1d82:	eb 06                	jmp    1d8a <sprintint+0x31>
    } else {
        x = xx;
    1d84:	8b 45 10             	mov    0x10(%ebp),%eax
    1d87:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    1d8a:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1d91:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1d94:	8d 41 01             	lea    0x1(%ecx),%eax
    1d97:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1d9a:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1d9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1da0:	ba 00 00 00 00       	mov    $0x0,%edx
    1da5:	f7 f3                	div    %ebx
    1da7:	89 d0                	mov    %edx,%eax
    1da9:	0f b6 80 0c 27 00 00 	movzbl 0x270c(%eax),%eax
    1db0:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1db4:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1db7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1dba:	ba 00 00 00 00       	mov    $0x0,%edx
    1dbf:	f7 f3                	div    %ebx
    1dc1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1dc4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1dc8:	75 c7                	jne    1d91 <sprintint+0x38>
    if(neg)
    1dca:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1dce:	74 0e                	je     1dde <sprintint+0x85>
        buf[i++] = '-';
    1dd0:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1dd3:	8d 50 01             	lea    0x1(%eax),%edx
    1dd6:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1dd9:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1dde:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1de1:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1de4:	eb 1b                	jmp    1e01 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1de6:	8b 45 0c             	mov    0xc(%ebp),%eax
    1de9:	8b 00                	mov    (%eax),%eax
    1deb:	8d 48 01             	lea    0x1(%eax),%ecx
    1dee:	8b 55 0c             	mov    0xc(%ebp),%edx
    1df1:	89 0a                	mov    %ecx,(%edx)
    1df3:	89 c2                	mov    %eax,%edx
    1df5:	8b 45 08             	mov    0x8(%ebp),%eax
    1df8:	01 d0                	add    %edx,%eax
    1dfa:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1dfd:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1e01:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1e05:	7f df                	jg     1de6 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e07:	eb 21                	jmp    1e2a <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1e09:	8b 45 0c             	mov    0xc(%ebp),%eax
    1e0c:	8b 00                	mov    (%eax),%eax
    1e0e:	8d 48 01             	lea    0x1(%eax),%ecx
    1e11:	8b 55 0c             	mov    0xc(%ebp),%edx
    1e14:	89 0a                	mov    %ecx,(%edx)
    1e16:	89 c2                	mov    %eax,%edx
    1e18:	8b 45 08             	mov    0x8(%ebp),%eax
    1e1b:	01 c2                	add    %eax,%edx
    1e1d:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1e20:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e23:	01 c8                	add    %ecx,%eax
    1e25:	0f b6 00             	movzbl (%eax),%eax
    1e28:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e2a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1e2e:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1e32:	79 d5                	jns    1e09 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1e34:	90                   	nop
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1e3e:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1e41:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1e48:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1e4f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1e56:	8d 45 0c             	lea    0xc(%ebp),%eax
    1e59:	83 c0 04             	add    $0x4,%eax
    1e5c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1e5f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1e66:	e9 d9 01 00 00       	jmp    2044 <sprintf+0x209>
        c = fmt[i] & 0xff;
    1e6b:	8b 55 0c             	mov    0xc(%ebp),%edx
    1e6e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1e71:	01 d0                	add    %edx,%eax
    1e73:	0f b6 00             	movzbl (%eax),%eax
    1e76:	0f be c0             	movsbl %al,%eax
    1e79:	25 ff 00 00 00       	and    $0xff,%eax
    1e7e:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1e81:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1e85:	75 2c                	jne    1eb3 <sprintf+0x78>
            if(c == '%'){
    1e87:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1e8b:	75 0c                	jne    1e99 <sprintf+0x5e>
                state = '%';
    1e8d:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1e94:	e9 a7 01 00 00       	jmp    2040 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1e99:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1e9c:	8d 50 01             	lea    0x1(%eax),%edx
    1e9f:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1ea2:	89 c2                	mov    %eax,%edx
    1ea4:	8b 45 08             	mov    0x8(%ebp),%eax
    1ea7:	01 d0                	add    %edx,%eax
    1ea9:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1eac:	88 10                	mov    %dl,(%eax)
    1eae:	e9 8d 01 00 00       	jmp    2040 <sprintf+0x205>
            }
        } else if(state == '%'){
    1eb3:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1eb7:	0f 85 83 01 00 00    	jne    2040 <sprintf+0x205>
            if(c == 'd'){
    1ebd:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1ec1:	75 4c                	jne    1f0f <sprintf+0xd4>
                buf[bi] = '\0';
    1ec3:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1ec6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1ec9:	01 d0                	add    %edx,%eax
    1ecb:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1ece:	83 ec 0c             	sub    $0xc,%esp
    1ed1:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1ed4:	50                   	push   %eax
    1ed5:	e8 17 e3 ff ff       	call   1f1 <atoi>
    1eda:	83 c4 10             	add    $0x10,%esp
    1edd:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    1ee0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    1ee7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1eea:	8b 00                	mov    (%eax),%eax
    1eec:	83 ec 08             	sub    $0x8,%esp
    1eef:	ff 75 d8             	pushl  -0x28(%ebp)
    1ef2:	6a 01                	push   $0x1
    1ef4:	6a 0a                	push   $0xa
    1ef6:	50                   	push   %eax
    1ef7:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1efa:	50                   	push   %eax
    1efb:	ff 75 08             	pushl  0x8(%ebp)
    1efe:	e8 56 fe ff ff       	call   1d59 <sprintint>
    1f03:	83 c4 20             	add    $0x20,%esp
                ap++;
    1f06:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1f0a:	e9 2a 01 00 00       	jmp    2039 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    1f0f:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    1f13:	74 06                	je     1f1b <sprintf+0xe0>
    1f15:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    1f19:	75 4c                	jne    1f67 <sprintf+0x12c>
                buf[bi] = '\0';
    1f1b:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f21:	01 d0                	add    %edx,%eax
    1f23:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f26:	83 ec 0c             	sub    $0xc,%esp
    1f29:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f2c:	50                   	push   %eax
    1f2d:	e8 bf e2 ff ff       	call   1f1 <atoi>
    1f32:	83 c4 10             	add    $0x10,%esp
    1f35:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    1f38:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    1f3f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f42:	8b 00                	mov    (%eax),%eax
    1f44:	83 ec 08             	sub    $0x8,%esp
    1f47:	ff 75 dc             	pushl  -0x24(%ebp)
    1f4a:	6a 00                	push   $0x0
    1f4c:	6a 10                	push   $0x10
    1f4e:	50                   	push   %eax
    1f4f:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1f52:	50                   	push   %eax
    1f53:	ff 75 08             	pushl  0x8(%ebp)
    1f56:	e8 fe fd ff ff       	call   1d59 <sprintint>
    1f5b:	83 c4 20             	add    $0x20,%esp
                ap++;
    1f5e:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    1f62:	e9 d2 00 00 00       	jmp    2039 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    1f67:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    1f6b:	75 46                	jne    1fb3 <sprintf+0x178>
                s = (char*)*ap;
    1f6d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f70:	8b 00                	mov    (%eax),%eax
    1f72:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    1f75:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    1f79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1f7d:	75 25                	jne    1fa4 <sprintf+0x169>
                    s = "(null)";
    1f7f:	c7 45 f4 e4 21 00 00 	movl   $0x21e4,-0xc(%ebp)
                while(*s != 0){
    1f86:	eb 1c                	jmp    1fa4 <sprintf+0x169>
                    dst[j++] = *s;
    1f88:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1f8b:	8d 50 01             	lea    0x1(%eax),%edx
    1f8e:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1f91:	89 c2                	mov    %eax,%edx
    1f93:	8b 45 08             	mov    0x8(%ebp),%eax
    1f96:	01 c2                	add    %eax,%edx
    1f98:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1f9b:	0f b6 00             	movzbl (%eax),%eax
    1f9e:	88 02                	mov    %al,(%edx)
                    s++;
    1fa0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    1fa4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1fa7:	0f b6 00             	movzbl (%eax),%eax
    1faa:	84 c0                	test   %al,%al
    1fac:	75 da                	jne    1f88 <sprintf+0x14d>
    1fae:	e9 86 00 00 00       	jmp    2039 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    1fb3:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    1fb7:	75 1d                	jne    1fd6 <sprintf+0x19b>
                dst[j++] = *ap;
    ...
    1fce:	88 02                	mov    %al,(%edx)
                ap++;
    1fd0:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1fd4:	eb 63                	jmp    2039 <sprintf+0x1fe>
            } else if(c == '%'){
    1fd6:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1fda:	75 17                	jne    1ff3 <sprintf+0x1b8>
                dst[j++] = c;
    1fdc:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1fdf:	8d 50 01             	lea    0x1(%eax),%edx
    1fe2:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1fe5:	89 c2                	mov    %eax,%edx
    1fe7:	8b 45 08             	mov    0x8(%ebp),%eax
    1fea:	01 d0                	add    %edx,%eax
    1fec:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1fef:	88 10                	mov    %dl,(%eax)
    1ff1:	eb 46                	jmp    2039 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    1ff3:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    1ff7:	7e 18                	jle    2011 <sprintf+0x1d6>
    1ff9:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    1ffd:	7f 12                	jg     2011 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    1fff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2002:	8d 50 01             	lea    0x1(%eax),%edx
    2005:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2008:	8b 55 e0             	mov    -0x20(%ebp),%edx
    200b:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    200f:	eb 2f                	jmp    2040 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2011:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2014:	8d 50 01             	lea    0x1(%eax),%edx
    2017:	89 55 c8             	mov    %edx,-0x38(%ebp)
    201a:	89 c2                	mov    %eax,%edx
    201c:	8b 45 08             	mov    0x8(%ebp),%eax
    201f:	01 d0                	add    %edx,%eax
    2021:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2040:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2044:	8b 55 0c             	mov    0xc(%ebp),%edx
    2047:	8b 45 ec             	mov    -0x14(%ebp),%eax
    204a:	01 d0                	add    %edx,%eax
    204c:	0f b6 00             	movzbl (%eax),%eax
    204f:	84 c0                	test   %al,%al
    2051:	0f 85 14 fe ff ff    	jne    1e6b <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
