...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
      ...
      27:	ba b0 25 00 00       	mov    $0x25b0,%edx
      2c:	eb 05                	jmp    33 <main+0x33>
      2e:	ba b2 25 00 00       	mov    $0x25b2,%edx
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     417:	0f b6 80 00 2d 00 00 	movzbl 0x2d00(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     553:	75 25                	jne    57a <printf+0xff>
          s = "(null)";
     555:	c7 45 f4 b9 25 00 00 	movl   $0x25b9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     61b:	a1 60 69 00 00       	mov    0x6960,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6e6:	a3 60 69 00 00       	mov    %eax,0x6960
}
     6eb:	90                   	nop
     6ec:	c9                   	leave  
     6ed:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     747:	a1 60 69 00 00       	mov    0x6960,%eax
}
     74c:	c9                   	leave  
     74d:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     763:	a1 60 69 00 00       	mov    0x6960,%eax
     768:	89 45 f0             	mov    %eax,-0x10(%ebp)
     76b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     76f:	75 23                	jne    794 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     771:	c7 45 f0 58 69 00 00 	movl   $0x6958,-0x10(%ebp)
     778:	8b 45 f0             	mov    -0x10(%ebp),%eax
     77b:	a3 60 69 00 00       	mov    %eax,0x6960
     780:	a1 60 69 00 00       	mov    0x6960,%eax
     785:	a3 58 69 00 00       	mov    %eax,0x6958
    base.s.size = 0;
     78a:	c7 05 5c 69 00 00 00 	movl   $0x0,0x695c
     791:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7e7:	a3 60 69 00 00       	mov    %eax,0x6960
      return (void*)(p + 1);
    ...
    if(p == freep)
     7f4:	a1 60 69 00 00       	mov    0x6960,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     932:	79 2e                	jns    962 <APLoadBitmap+0x61>
    {
     ...
     93a:	68 c0 25 00 00       	push   $0x25c0
     93f:	6a 01                	push   $0x1
...
void APDrawText(AHdc hdc, char * str, int x, int y)
{
    ...
    12de:	05 20 2d 00 00       	add    $0x2d20,%eax
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    156b:	68 d0 25 00 00       	push   $0x25d0
    1570:	6a 01                	push   $0x1
    ...
    15e0:	68 f0 25 00 00       	push   $0x25f0
    15e5:	6a 01                	push   $0x1
    ...
    1684:	68 14 26 00 00       	push   $0x2614
    1689:	6a 01                	push   $0x1
    ...
    1769:	68 3c 26 00 00       	push   $0x263c
    176e:	6a 01                	push   $0x1
...
bool APWndProc(AHwnd hwnd, AMessage msg)
{
    ...
    1852:	e8 c5 08 00 00       	call   211c <updateword>
...
void APGridPaint(AHwnd wnd)
{
    ...
    1c48:	8b 40 08             	mov    0x8(%eax),%eax
    1c4b:	85 c0                	test   %eax,%eax
    1c4d:	75 17                	jne    1c66 <APGridPaint+0x2ff>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1c4f:	83 ec 08             	sub    $0x8,%esp
    1c52:	68 ec 26 00 00       	push   $0x26ec
    1c57:	6a 01                	push   $0x1
    1c59:	e8 1d e8 ff ff       	call   47b <printf>
    1c5e:	83 c4 10             	add    $0x10,%esp
        return;
    1c61:	e9 ae 04 00 00       	jmp    2114 <APGridPaint+0x7ad>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1c66:	8b 45 08             	mov    0x8(%ebp),%eax
    1c69:	8b 40 10             	mov    0x10(%eax),%eax
    1c6c:	85 c0                	test   %eax,%eax
    1c6e:	7e 10                	jle    1c80 <APGridPaint+0x319>
    1c70:	8b 45 08             	mov    0x8(%ebp),%eax
    1c73:	8b 50 14             	mov    0x14(%eax),%edx
    1c76:	8b 45 08             	mov    0x8(%ebp),%eax
    1c79:	8b 40 10             	mov    0x10(%eax),%eax
    1c7c:	39 c2                	cmp    %eax,%edx
    1c7e:	7c 17                	jl     1c97 <APGridPaint+0x330>
    {
        printf(1,"Grid mode page error!");
    1c80:	83 ec 08             	sub    $0x8,%esp
    1c83:	68 12 27 00 00       	push   $0x2712
    1c88:	6a 01                	push   $0x1
    1c8a:	e8 ec e7 ff ff       	call   47b <printf>
    1c8f:	83 c4 10             	add    $0x10,%esp
        return;
    1c92:	e9 7d 04 00 00       	jmp    2114 <APGridPaint+0x7ad>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1c97:	8b 45 08             	mov    0x8(%ebp),%eax
    1c9a:	8b 40 14             	mov    0x14(%eax),%eax
    1c9d:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1ca3:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1ca6:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1ca9:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1cac:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1cb3:	e9 52 04 00 00       	jmp    210a <APGridPaint+0x7a3>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1cb8:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1cbf:	e9 38 04 00 00       	jmp    20fc <APGridPaint+0x795>
        {
            index = start + GRID_W_NUMBER * j + i;
    1cc4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1cc7:	c1 e0 04             	shl    $0x4,%eax
    1cca:	89 c2                	mov    %eax,%edx
    1ccc:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1ccf:	01 c2                	add    %eax,%edx
    1cd1:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1cd4:	01 d0                	add    %edx,%eax
    1cd6:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1cd9:	8b 45 08             	mov    0x8(%ebp),%eax
    1cdc:	8b 40 0c             	mov    0xc(%eax),%eax
    1cdf:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1ce2:	c1 e2 02             	shl    $0x2,%edx
    1ce5:	01 d0                	add    %edx,%eax
    1ce7:	8b 00                	mov    (%eax),%eax
    1ce9:	83 f8 0b             	cmp    $0xb,%eax
    1cec:	0f 87 05 04 00 00    	ja     20f7 <APGridPaint+0x790>
    1cf2:	8b 04 85 28 27 00 00 	mov    0x2728(,%eax,4),%eax
    1cf9:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1cfb:	8d 45 bd             	lea    -0x43(%ebp),%eax
    1cfe:	6a 0c                	push   $0xc
    1d00:	6a 0c                	push   $0xc
    1d02:	6a 0c                	push   $0xc
    1d04:	50                   	push   %eax
    1d05:	e8 d9 f7 ff ff       	call   14e3 <RGB>
    1d0a:	83 c4 0c             	add    $0xc,%esp
    1d0d:	8b 1d a0 69 00 00    	mov    0x69a0,%ebx
    ...
    1d25:	8d 78 3c             	lea    0x3c(%eax),%edi
    1d28:	83 ec 0c             	sub    $0xc,%esp
    1d2b:	83 ec 04             	sub    $0x4,%esp
    1d2e:	89 e0                	mov    %esp,%eax
    1d30:	0f b7 75 bd          	movzwl -0x43(%ebp),%esi
    1d34:	66 89 30             	mov    %si,(%eax)
    1d37:	0f b6 55 bf          	movzbl -0x41(%ebp),%edx
    ...
    1d4b:	57                   	push   %edi
    1d4c:	e8 ee f5 ff ff       	call   133f <APDcCopy>
    1d51:	83 c4 30             	add    $0x30,%esp
                    break;
    1d54:	e9 9f 03 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1d59:	8d 45 98             	lea    -0x68(%ebp),%eax
    1d5c:	6a 69                	push   $0x69
    1d5e:	6a 69                	push   $0x69
    1d60:	6a 69                	push   $0x69
    1d62:	50                   	push   %eax
    1d63:	e8 7b f7 ff ff       	call   14e3 <RGB>
    1d68:	83 c4 0c             	add    $0xc,%esp
    1d6b:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    1d6f:	66 89 45 b4          	mov    %ax,-0x4c(%ebp)
    1d73:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    1d77:	88 45 b6             	mov    %al,-0x4a(%ebp)
                    pen.size = 1;
    1d7a:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1d81:	8d 45 98             	lea    -0x68(%ebp),%eax
    1d84:	6a 69                	push   $0x69
    1d86:	6a 69                	push   $0x69
    1d88:	6a 69                	push   $0x69
    1d8a:	50                   	push   %eax
    1d8b:	e8 53 f7 ff ff       	call   14e3 <RGB>
    1d90:	83 c4 0c             	add    $0xc,%esp
    1d93:	0f b7 45 98          	movzwl -0x68(%ebp),%eax
    1d97:	66 89 45 b1          	mov    %ax,-0x4f(%ebp)
    1d9b:	0f b6 45 9a          	movzbl -0x66(%ebp),%eax
    1d9f:	88 45 b3             	mov    %al,-0x4d(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1da2:	8b 45 08             	mov    0x8(%ebp),%eax
    1da5:	8d 50 3c             	lea    0x3c(%eax),%edx
    1da8:	8d 45 98             	lea    -0x68(%ebp),%eax
    1dab:	ff 75 b8             	pushl  -0x48(%ebp)
    1dae:	ff 75 b4             	pushl  -0x4c(%ebp)
    1db1:	52                   	push   %edx
    1db2:	50                   	push   %eax
    1db3:	e8 18 ee ff ff       	call   bd0 <APSetPen>
    1db8:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1dbb:	8b 45 08             	mov    0x8(%ebp),%eax
    1dbe:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1dc1:	8d 55 98             	lea    -0x68(%ebp),%edx
    1dc4:	83 ec 04             	sub    $0x4,%esp
    1dc7:	83 ec 04             	sub    $0x4,%esp
    1dca:	89 e0                	mov    %esp,%eax
    1dcc:	0f b7 4d b1          	movzwl -0x4f(%ebp),%ecx
    1dd0:	66 89 08             	mov    %cx,(%eax)
    1dd3:	0f b6 4d b3          	movzbl -0x4d(%ebp),%ecx
    1dd7:	88 48 02             	mov    %cl,0x2(%eax)
    1dda:	53                   	push   %ebx
    1ddb:	52                   	push   %edx
    1ddc:	e8 28 ee ff ff       	call   c09 <APSetBrush>
    1de1:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1de4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1de7:	6b d0 32             	imul   $0x32,%eax,%edx
    1dea:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1ded:	6b c0 32             	imul   $0x32,%eax,%eax
    1df0:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1df3:	83 c1 3c             	add    $0x3c,%ecx
    ...
    1dfe:	50                   	push   %eax
    1dff:	51                   	push   %ecx
    1e00:	e8 2e f2 ff ff       	call   1033 <APDrawRect>
    1e05:	83 c4 20             	add    $0x20,%esp
                    break;
    1e08:	e9 eb 02 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e0d:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1e10:	6a 0c                	push   $0xc
    1e12:	6a 0c                	push   $0xc
    1e14:	6a 0c                	push   $0xc
    1e16:	50                   	push   %eax
    1e17:	e8 c7 f6 ff ff       	call   14e3 <RGB>
    1e1c:	83 c4 0c             	add    $0xc,%esp
    1e1f:	8b 1d f4 69 00 00    	mov    0x69f4,%ebx
    1e25:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1e28:	6b c8 32             	imul   $0x32,%eax,%ecx
    1e2b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1e2e:	6b c0 32             	imul   $0x32,%eax,%eax
    1e31:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1e34:	8b 45 08             	mov    0x8(%ebp),%eax
    1e37:	8d 78 3c             	lea    0x3c(%eax),%edi
    1e3a:	83 ec 0c             	sub    $0xc,%esp
    1e3d:	83 ec 04             	sub    $0x4,%esp
    1e40:	89 e0                	mov    %esp,%eax
    1e42:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1e46:	66 89 30             	mov    %si,(%eax)
    1e49:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1e4d:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    1e58:	53                   	push   %ebx
    1e59:	51                   	push   %ecx
    1e5a:	ff 75 94             	pushl  -0x6c(%ebp)
    1e5d:	57                   	push   %edi
    1e5e:	e8 dc f4 ff ff       	call   133f <APDcCopy>
    1e63:	83 c4 30             	add    $0x30,%esp
                    break;
    1e66:	e9 8d 02 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e6b:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1e6e:	6a 0c                	push   $0xc
    1e70:	6a 0c                	push   $0xc
    1e72:	6a 0c                	push   $0xc
    1e74:	50                   	push   %eax
    1e75:	e8 69 f6 ff ff       	call   14e3 <RGB>
    1e7a:	83 c4 0c             	add    $0xc,%esp
    1e7d:	8b 1d d0 69 00 00    	mov    0x69d0,%ebx
    1e83:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1e86:	6b c8 32             	imul   $0x32,%eax,%ecx
    1e89:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1e8c:	6b c0 32             	imul   $0x32,%eax,%eax
    1e8f:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1e92:	8b 45 08             	mov    0x8(%ebp),%eax
    1e95:	8d 78 3c             	lea    0x3c(%eax),%edi
    1e98:	83 ec 0c             	sub    $0xc,%esp
    1e9b:	83 ec 04             	sub    $0x4,%esp
    1e9e:	89 e0                	mov    %esp,%eax
    1ea0:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1ea4:	66 89 30             	mov    %si,(%eax)
    1ea7:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    1eab:	88 50 02             	mov    %dl,0x2(%eax)
    1eae:	6a 32                	push   $0x32
    1eb0:	6a 32                	push   $0x32
    1eb2:	6a 00                	push   $0x0
    1eb4:	6a 00                	push   $0x0
    1eb6:	53                   	push   %ebx
    1eb7:	51                   	push   %ecx
    1eb8:	ff 75 94             	pushl  -0x6c(%ebp)
    1ebb:	57                   	push   %edi
    1ebc:	e8 7e f4 ff ff       	call   133f <APDcCopy>
    1ec1:	83 c4 30             	add    $0x30,%esp
                    break;
    1ec4:	e9 2f 02 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ec9:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1ecc:	6a 0c                	push   $0xc
    1ece:	6a 0c                	push   $0xc
    1ed0:	6a 0c                	push   $0xc
    1ed2:	50                   	push   %eax
    1ed3:	e8 0b f6 ff ff       	call   14e3 <RGB>
    1ed8:	83 c4 0c             	add    $0xc,%esp
    1edb:	8b 1d a4 69 00 00    	mov    0x69a4,%ebx
    1ee1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ee4:	6b c8 32             	imul   $0x32,%eax,%ecx
    1ee7:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1eea:	6b c0 32             	imul   $0x32,%eax,%eax
    1eed:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1ef0:	8b 45 08             	mov    0x8(%ebp),%eax
    1ef3:	8d 78 3c             	lea    0x3c(%eax),%edi
    1ef6:	83 ec 0c             	sub    $0xc,%esp
    1ef9:	83 ec 04             	sub    $0x4,%esp
    1efc:	89 e0                	mov    %esp,%eax
    1efe:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1f02:	66 89 30             	mov    %si,(%eax)
    1f05:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    1f09:	88 50 02             	mov    %dl,0x2(%eax)
    1f0c:	6a 32                	push   $0x32
    1f0e:	6a 32                	push   $0x32
    1f10:	6a 00                	push   $0x0
    1f12:	6a 00                	push   $0x0
    1f14:	53                   	push   %ebx
    1f15:	51                   	push   %ecx
    1f16:	ff 75 94             	pushl  -0x6c(%ebp)
    1f19:	57                   	push   %edi
    1f1a:	e8 20 f4 ff ff       	call   133f <APDcCopy>
    1f1f:	83 c4 30             	add    $0x30,%esp
                    break;
    1f22:	e9 d1 01 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f27:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1f2a:	6a 0c                	push   $0xc
    1f2c:	6a 0c                	push   $0xc
    1f2e:	6a 0c                	push   $0xc
    1f30:	50                   	push   %eax
    1f31:	e8 ad f5 ff ff       	call   14e3 <RGB>
    1f36:	83 c4 0c             	add    $0xc,%esp
    1f39:	8b 1d f0 69 00 00    	mov    0x69f0,%ebx
    1f3f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f42:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f45:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f48:	6b c0 32             	imul   $0x32,%eax,%eax
    1f4b:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1f4e:	8b 45 08             	mov    0x8(%ebp),%eax
    1f51:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f54:	83 ec 0c             	sub    $0xc,%esp
    1f57:	83 ec 04             	sub    $0x4,%esp
    1f5a:	89 e0                	mov    %esp,%eax
    1f5c:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1f60:	66 89 30             	mov    %si,(%eax)
    1f63:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    1f67:	88 50 02             	mov    %dl,0x2(%eax)
    1f6a:	6a 32                	push   $0x32
    1f6c:	6a 32                	push   $0x32
    1f6e:	6a 00                	push   $0x0
    1f70:	6a 00                	push   $0x0
    1f72:	53                   	push   %ebx
    1f73:	51                   	push   %ecx
    1f74:	ff 75 94             	pushl  -0x6c(%ebp)
    1f77:	57                   	push   %edi
    1f78:	e8 c2 f3 ff ff       	call   133f <APDcCopy>
    1f7d:	83 c4 30             	add    $0x30,%esp
                    break;
    1f80:	e9 73 01 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f85:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1f88:	6a 0c                	push   $0xc
    1f8a:	6a 0c                	push   $0xc
    1f8c:	6a 0c                	push   $0xc
    1f8e:	50                   	push   %eax
    1f8f:	e8 4f f5 ff ff       	call   14e3 <RGB>
    1f94:	83 c4 0c             	add    $0xc,%esp
    1f97:	8b 1d 68 69 00 00    	mov    0x6968,%ebx
    1f9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fa0:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fa3:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fa6:	6b c0 32             	imul   $0x32,%eax,%eax
    1fa9:	89 45 94             	mov    %eax,-0x6c(%ebp)
    1fac:	8b 45 08             	mov    0x8(%ebp),%eax
    1faf:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fb2:	83 ec 0c             	sub    $0xc,%esp
    1fb5:	83 ec 04             	sub    $0x4,%esp
    1fb8:	89 e0                	mov    %esp,%eax
    1fba:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1fbe:	66 89 30             	mov    %si,(%eax)
    1fc1:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    1fc5:	88 50 02             	mov    %dl,0x2(%eax)
    1fc8:	6a 32                	push   $0x32
    1fca:	6a 32                	push   $0x32
    1fcc:	6a 00                	push   $0x0
    1fce:	6a 00                	push   $0x0
    1fd0:	53                   	push   %ebx
    1fd1:	51                   	push   %ecx
    1fd2:	ff 75 94             	pushl  -0x6c(%ebp)
    1fd5:	57                   	push   %edi
    1fd6:	e8 64 f3 ff ff       	call   133f <APDcCopy>
    1fdb:	83 c4 30             	add    $0x30,%esp
                    break;
    1fde:	e9 15 01 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1fe3:	8d 45 cf             	lea    -0x31(%ebp),%eax
    1fe6:	6a 0c                	push   $0xc
    1fe8:	6a 0c                	push   $0xc
    1fea:	6a 0c                	push   $0xc
    1fec:	50                   	push   %eax
    1fed:	e8 f1 f4 ff ff       	call   14e3 <RGB>
    1ff2:	83 c4 0c             	add    $0xc,%esp
    1ff5:	8b 1d 90 69 00 00    	mov    0x6990,%ebx
    1ffb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ffe:	6b c8 32             	imul   $0x32,%eax,%ecx
    2001:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2004:	6b c0 32             	imul   $0x32,%eax,%eax
    2007:	89 45 94             	mov    %eax,-0x6c(%ebp)
    200a:	8b 45 08             	mov    0x8(%ebp),%eax
    200d:	8d 78 3c             	lea    0x3c(%eax),%edi
    2010:	83 ec 0c             	sub    $0xc,%esp
    2013:	83 ec 04             	sub    $0x4,%esp
    2016:	89 e0                	mov    %esp,%eax
    2018:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    201c:	66 89 30             	mov    %si,(%eax)
    201f:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    2023:	88 50 02             	mov    %dl,0x2(%eax)
    2026:	6a 32                	push   $0x32
    2028:	6a 32                	push   $0x32
    202a:	6a 00                	push   $0x0
    202c:	6a 00                	push   $0x0
    202e:	53                   	push   %ebx
    202f:	51                   	push   %ecx
    2030:	ff 75 94             	pushl  -0x6c(%ebp)
    2033:	57                   	push   %edi
    2034:	e8 06 f3 ff ff       	call   133f <APDcCopy>
    2039:	83 c4 30             	add    $0x30,%esp
                    break;
    203c:	e9 b7 00 00 00       	jmp    20f8 <APGridPaint+0x791>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    2041:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    2044:	6a 0c                	push   $0xc
    2046:	6a 0c                	push   $0xc
    2048:	6a 0c                	push   $0xc
    204a:	50                   	push   %eax
    204b:	e8 93 f4 ff ff       	call   14e3 <RGB>
    2050:	83 c4 0c             	add    $0xc,%esp
    2053:	8b 1d ec 69 00 00    	mov    0x69ec,%ebx
    2059:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    205c:	6b c8 32             	imul   $0x32,%eax,%ecx
    205f:	8b 45 e0             	mov    -0x20(%ebp),%eax
    2062:	6b c0 32             	imul   $0x32,%eax,%eax
    2065:	89 45 94             	mov    %eax,-0x6c(%ebp)
    2068:	8b 45 08             	mov    0x8(%ebp),%eax
    206b:	8d 78 3c             	lea    0x3c(%eax),%edi
    206e:	83 ec 0c             	sub    $0xc,%esp
    2071:	83 ec 04             	sub    $0x4,%esp
    2074:	89 e0                	mov    %esp,%eax
    2076:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    207a:	66 89 30             	mov    %si,(%eax)
    207d:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    2081:	88 50 02             	mov    %dl,0x2(%eax)
    ...
    208c:	53                   	push   %ebx
    208d:	51                   	push   %ecx
    208e:	ff 75 94             	pushl  -0x6c(%ebp)
    2091:	57                   	push   %edi
    2092:	e8 a8 f2 ff ff       	call   133f <APDcCopy>
    2097:	83 c4 30             	add    $0x30,%esp
                    break;
    209a:	eb 5c                	jmp    20f8 <APGridPaint+0x791>
                case GRID_PROGRAM_TOWER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_tower,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    209c:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    209f:	6a 0c                	push   $0xc
    20a1:	6a 0c                	push   $0xc
    20a3:	6a 0c                	push   $0xc
    20a5:	50                   	push   %eax
    20a6:	e8 38 f4 ff ff       	call   14e3 <RGB>
    20ab:	83 c4 0c             	add    $0xc,%esp
    20ae:	8b 1d a8 69 00 00    	mov    0x69a8,%ebx
    20b4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    20b7:	6b c8 32             	imul   $0x32,%eax,%ecx
    20ba:	8b 45 e0             	mov    -0x20(%ebp),%eax
    20bd:	6b c0 32             	imul   $0x32,%eax,%eax
    20c0:	89 45 94             	mov    %eax,-0x6c(%ebp)
    20c3:	8b 45 08             	mov    0x8(%ebp),%eax
    20c6:	8d 78 3c             	lea    0x3c(%eax),%edi
    20c9:	83 ec 0c             	sub    $0xc,%esp
    20cc:	83 ec 04             	sub    $0x4,%esp
    20cf:	89 e0                	mov    %esp,%eax
    20d1:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    20d5:	66 89 30             	mov    %si,(%eax)
    20d8:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    20dc:	88 50 02             	mov    %dl,0x2(%eax)
    20df:	6a 32                	push   $0x32
    20e1:	6a 32                	push   $0x32
    20e3:	6a 00                	push   $0x0
    20e5:	6a 00                	push   $0x0
    20e7:	53                   	push   %ebx
    20e8:	51                   	push   %ecx
    20e9:	ff 75 94             	pushl  -0x6c(%ebp)
    20ec:	57                   	push   %edi
    20ed:	e8 4d f2 ff ff       	call   133f <APDcCopy>
    20f2:	83 c4 30             	add    $0x30,%esp
                    break;
    20f5:	eb 01                	jmp    20f8 <APGridPaint+0x791>
                default: break;
    20f7:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    20f8:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    20fc:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    2100:	0f 8e be fb ff ff    	jle    1cc4 <APGridPaint+0x35d>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    2106:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    210a:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    210e:	0f 8e a4 fb ff ff    	jle    1cb8 <APGridPaint+0x351>
                    break;
                default: break;
            }
        }
...
void updateword(AHwnd hwnd,char* str)
{
    ...
    211f:	53                   	push   %ebx
    2120:	83 ec 24             	sub    $0x24,%esp
    APen pen;
    ABrush brush;
    pen.color = RGB(0x18,0x74,0xcd);
    2123:	8d 45 d8             	lea    -0x28(%ebp),%eax
    2126:	68 cd 00 00 00       	push   $0xcd
    212b:	6a 74                	push   $0x74
    212d:	6a 18                	push   $0x18
    212f:	50                   	push   %eax
    2130:	e8 ae f3 ff ff       	call   14e3 <RGB>
    2135:	83 c4 0c             	add    $0xc,%esp
    2138:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    213c:	66 89 45 f0          	mov    %ax,-0x10(%ebp)
    2140:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    2144:	88 45 f2             	mov    %al,-0xe(%ebp)
    pen.size = 1;
    2147:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    ...
    215a:	50                   	push   %eax
    215b:	e8 83 f3 ff ff       	call   14e3 <RGB>
    2160:	83 c4 0c             	add    $0xc,%esp
    2163:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    2167:	66 89 45 ed          	mov    %ax,-0x13(%ebp)
    216b:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    216f:	88 45 ef             	mov    %al,-0x11(%ebp)
    APSetPen(&hwnd->TitleDc,pen);
    2172:	8b 45 08             	mov    0x8(%ebp),%eax
    2175:	8d 50 58             	lea    0x58(%eax),%edx
    2178:	8d 45 d8             	lea    -0x28(%ebp),%eax
    217b:	ff 75 f4             	pushl  -0xc(%ebp)
    217e:	ff 75 f0             	pushl  -0x10(%ebp)
    2181:	52                   	push   %edx
    2182:	50                   	push   %eax
    2183:	e8 48 ea ff ff       	call   bd0 <APSetPen>
    2188:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&hwnd->TitleDc,brush);
    218b:	8b 45 08             	mov    0x8(%ebp),%eax
    218e:	8d 58 58             	lea    0x58(%eax),%ebx
    2191:	8d 55 d8             	lea    -0x28(%ebp),%edx
    2194:	83 ec 04             	sub    $0x4,%esp
    2197:	83 ec 04             	sub    $0x4,%esp
    219a:	89 e0                	mov    %esp,%eax
    219c:	0f b7 4d ed          	movzwl -0x13(%ebp),%ecx
    21a0:	66 89 08             	mov    %cx,(%eax)
    21a3:	0f b6 4d ef          	movzbl -0x11(%ebp),%ecx
    21a7:	88 48 02             	mov    %cl,0x2(%eax)
    21aa:	53                   	push   %ebx
    21ab:	52                   	push   %edx
    21ac:	e8 58 ea ff ff       	call   c09 <APSetBrush>
    21b1:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&hwnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    21b4:	8b 45 08             	mov    0x8(%ebp),%eax
    21b7:	83 c0 58             	add    $0x58,%eax
    21ba:	83 ec 0c             	sub    $0xc,%esp
    21bd:	6a 32                	push   $0x32
    21bf:	68 20 03 00 00       	push   $0x320
    21c4:	6a 00                	push   $0x0
    21c6:	6a 00                	push   $0x0
    21c8:	50                   	push   %eax
    21c9:	e8 65 ee ff ff       	call   1033 <APDrawRect>
    21ce:	83 c4 20             	add    $0x20,%esp
    
    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    21d1:	8d 45 d8             	lea    -0x28(%ebp),%eax
    21d4:	6a 08                	push   $0x8
    21d6:	6a 08                	push   $0x8
    21d8:	6a 08                	push   $0x8
    21da:	50                   	push   %eax
    21db:	e8 03 f3 ff ff       	call   14e3 <RGB>
    21e0:	83 c4 0c             	add    $0xc,%esp
    21e3:	0f b7 45 d8          	movzwl -0x28(%ebp),%eax
    21e7:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
    21eb:	0f b6 45 da          	movzbl -0x26(%ebp),%eax
    21ef:	88 45 ec             	mov    %al,-0x14(%ebp)
    APSetFont(&hwnd->TitleDc,font);
    21f2:	8b 45 08             	mov    0x8(%ebp),%eax
    21f5:	8d 58 58             	lea    0x58(%eax),%ebx
    21f8:	8d 55 d8             	lea    -0x28(%ebp),%edx
    21fb:	83 ec 04             	sub    $0x4,%esp
    21fe:	83 ec 04             	sub    $0x4,%esp
    2201:	89 e0                	mov    %esp,%eax
    2203:	0f b7 4d ea          	movzwl -0x16(%ebp),%ecx
    2207:	66 89 08             	mov    %cx,(%eax)
    220a:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
    220e:	88 48 02             	mov    %cl,0x2(%eax)
    2211:	53                   	push   %ebx
    2212:	52                   	push   %edx
    2213:	e8 33 ea ff ff       	call   c4b <APSetFont>
    2218:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&hwnd->TitleDc,str,10,20);
    221b:	8b 45 08             	mov    0x8(%ebp),%eax
    221e:	83 c0 58             	add    $0x58,%eax
    2221:	6a 14                	push   $0x14
    2223:	6a 0a                	push   $0xa
    2225:	ff 75 0c             	pushl  0xc(%ebp)
    2228:	50                   	push   %eax
    2229:	e8 0a f0 ff ff       	call   1238 <APDrawText>
    222e:	83 c4 10             	add    $0x10,%esp
}
    2231:	90                   	nop
    2232:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2235:	c9                   	leave  
    2236:	c3                   	ret    
...
{
    2237:	55                   	push   %ebp
    2238:	89 e5                	mov    %esp,%ebp
static int rand_num = 3;
if (seed > 0)
    223a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    223e:	7e 08                	jle    2248 <random+0x11>
{
rand_num = seed;
    2240:	8b 45 08             	mov    0x8(%ebp),%eax
    2243:	a3 40 69 00 00       	mov    %eax,0x6940
}
rand_num *= 3;
    2248:	8b 15 40 69 00 00    	mov    0x6940,%edx
    224e:	89 d0                	mov    %edx,%eax
    2250:	01 c0                	add    %eax,%eax
    2252:	01 d0                	add    %edx,%eax
    2254:	a3 40 69 00 00       	mov    %eax,0x6940
if (rand_num < 0)
    2259:	a1 40 69 00 00       	mov    0x6940,%eax
    225e:	85 c0                	test   %eax,%eax
    2260:	79 0c                	jns    226e <random+0x37>
{
rand_num *= (-1);
    2262:	a1 40 69 00 00       	mov    0x6940,%eax
    2267:	f7 d8                	neg    %eax
    2269:	a3 40 69 00 00       	mov    %eax,0x6940
}
return rand_num % 997;
    226e:	8b 0d 40 69 00 00    	mov    0x6940,%ecx
    2274:	ba f1 65 77 83       	mov    $0x837765f1,%edx
    2279:	89 c8                	mov    %ecx,%eax
    227b:	f7 ea                	imul   %edx
    227d:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    2280:	c1 f8 09             	sar    $0x9,%eax
    2283:	89 c2                	mov    %eax,%edx
    2285:	89 c8                	mov    %ecx,%eax
    2287:	c1 f8 1f             	sar    $0x1f,%eax
    228a:	29 c2                	sub    %eax,%edx
    228c:	89 d0                	mov    %edx,%eax
    228e:	69 c0 e5 03 00 00    	imul   $0x3e5,%eax,%eax
    2294:	29 c1                	sub    %eax,%ecx
    2296:	89 c8                	mov    %ecx,%eax
}
    2298:	5d                   	pop    %ebp
    2299:	c3                   	ret    
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    22a1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    22a8:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    22ac:	74 17                	je     22c5 <sprintint+0x2b>
    22ae:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    22b2:	79 11                	jns    22c5 <sprintint+0x2b>
        neg = 1;
    22b4:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    22bb:	8b 45 10             	mov    0x10(%ebp),%eax
    22be:	f7 d8                	neg    %eax
    22c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    22c3:	eb 06                	jmp    22cb <sprintint+0x31>
    } else {
        x = xx;
    22c5:	8b 45 10             	mov    0x10(%ebp),%eax
    22c8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    22cb:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    22d2:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    22d5:	8d 41 01             	lea    0x1(%ecx),%eax
    22d8:	89 45 f8             	mov    %eax,-0x8(%ebp)
    22db:	8b 5d 14             	mov    0x14(%ebp),%ebx
    22de:	8b 45 f0             	mov    -0x10(%ebp),%eax
    22e1:	ba 00 00 00 00       	mov    $0x0,%edx
    22e6:	f7 f3                	div    %ebx
    22e8:	89 d0                	mov    %edx,%eax
    22ea:	0f b6 80 44 69 00 00 	movzbl 0x6944(%eax),%eax
    22f1:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    22f5:	8b 5d 14             	mov    0x14(%ebp),%ebx
    22f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    22fb:	ba 00 00 00 00       	mov    $0x0,%edx
    2300:	f7 f3                	div    %ebx
    2302:	89 45 f0             	mov    %eax,-0x10(%ebp)
    2305:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    2309:	75 c7                	jne    22d2 <sprintint+0x38>
    if(neg)
    230b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    230f:	74 0e                	je     231f <sprintint+0x85>
        buf[i++] = '-';
    2311:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2314:	8d 50 01             	lea    0x1(%eax),%edx
    2317:	89 55 f8             	mov    %edx,-0x8(%ebp)
    231a:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    231f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2322:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    2325:	eb 1b                	jmp    2342 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    2327:	8b 45 0c             	mov    0xc(%ebp),%eax
    232a:	8b 00                	mov    (%eax),%eax
    232c:	8d 48 01             	lea    0x1(%eax),%ecx
    232f:	8b 55 0c             	mov    0xc(%ebp),%edx
    2332:	89 0a                	mov    %ecx,(%edx)
    2334:	89 c2                	mov    %eax,%edx
    2336:	8b 45 08             	mov    0x8(%ebp),%eax
    2339:	01 d0                	add    %edx,%eax
    233b:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    233e:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    2342:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    2346:	7f df                	jg     2327 <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    2348:	eb 21                	jmp    236b <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    234a:	8b 45 0c             	mov    0xc(%ebp),%eax
    234d:	8b 00                	mov    (%eax),%eax
    234f:	8d 48 01             	lea    0x1(%eax),%ecx
    2352:	8b 55 0c             	mov    0xc(%ebp),%edx
    2355:	89 0a                	mov    %ecx,(%edx)
    2357:	89 c2                	mov    %eax,%edx
    2359:	8b 45 08             	mov    0x8(%ebp),%eax
    235c:	01 c2                	add    %eax,%edx
    235e:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    2361:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2364:	01 c8                	add    %ecx,%eax
    2366:	0f b6 00             	movzbl (%eax),%eax
    2369:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    236b:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    236f:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    2373:	79 d5                	jns    234a <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    2375:	90                   	nop
    2376:	83 c4 20             	add    $0x20,%esp
    2379:	5b                   	pop    %ebx
    237a:	5d                   	pop    %ebp
    237b:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    uint *ap;
    j = 0;
    2389:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    2390:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    2397:	8d 45 0c             	lea    0xc(%ebp),%eax
    239a:	83 c0 04             	add    $0x4,%eax
    239d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    23a0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    23a7:	e9 d9 01 00 00       	jmp    2585 <sprintf+0x209>
        c = fmt[i] & 0xff;
    23ac:	8b 55 0c             	mov    0xc(%ebp),%edx
    23af:	8b 45 ec             	mov    -0x14(%ebp),%eax
    23b2:	01 d0                	add    %edx,%eax
    23b4:	0f b6 00             	movzbl (%eax),%eax
    23b7:	0f be c0             	movsbl %al,%eax
    23ba:	25 ff 00 00 00       	and    $0xff,%eax
    23bf:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    23c2:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    23c6:	75 2c                	jne    23f4 <sprintf+0x78>
            if(c == '%'){
    23c8:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    23cc:	75 0c                	jne    23da <sprintf+0x5e>
                state = '%';
    23ce:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    23d5:	e9 a7 01 00 00       	jmp    2581 <sprintf+0x205>
            } else {
                dst[j++] = c;
    23da:	8b 45 c8             	mov    -0x38(%ebp),%eax
    23dd:	8d 50 01             	lea    0x1(%eax),%edx
    23e0:	89 55 c8             	mov    %edx,-0x38(%ebp)
    23e3:	89 c2                	mov    %eax,%edx
    23e5:	8b 45 08             	mov    0x8(%ebp),%eax
    23e8:	01 d0                	add    %edx,%eax
    23ea:	8b 55 e0             	mov    -0x20(%ebp),%edx
    23ed:	88 10                	mov    %dl,(%eax)
    23ef:	e9 8d 01 00 00       	jmp    2581 <sprintf+0x205>
            }
        } else if(state == '%'){
    23f4:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    23f8:	0f 85 83 01 00 00    	jne    2581 <sprintf+0x205>
            if(c == 'd'){
    23fe:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    2402:	75 4c                	jne    2450 <sprintf+0xd4>
                buf[bi] = '\0';
    2404:	8d 55 ce             	lea    -0x32(%ebp),%edx
    2407:	8b 45 f0             	mov    -0x10(%ebp),%eax
    240a:	01 d0                	add    %edx,%eax
    240c:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    240f:	83 ec 0c             	sub    $0xc,%esp
    2412:	8d 45 ce             	lea    -0x32(%ebp),%eax
    2415:	50                   	push   %eax
    2416:	e8 0f de ff ff       	call   22a <atoi>
    241b:	83 c4 10             	add    $0x10,%esp
    241e:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    2421:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    2428:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    242b:	8b 00                	mov    (%eax),%eax
    242d:	83 ec 08             	sub    $0x8,%esp
    2430:	ff 75 d8             	pushl  -0x28(%ebp)
    2433:	6a 01                	push   $0x1
    2435:	6a 0a                	push   $0xa
    2437:	50                   	push   %eax
    2438:	8d 45 c8             	lea    -0x38(%ebp),%eax
    243b:	50                   	push   %eax
    243c:	ff 75 08             	pushl  0x8(%ebp)
    243f:	e8 56 fe ff ff       	call   229a <sprintint>
    2444:	83 c4 20             	add    $0x20,%esp
                ap++;
    2447:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    244b:	e9 2a 01 00 00       	jmp    257a <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    2450:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    2454:	74 06                	je     245c <sprintf+0xe0>
    2456:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    245a:	75 4c                	jne    24a8 <sprintf+0x12c>
                buf[bi] = '\0';
    245c:	8d 55 ce             	lea    -0x32(%ebp),%edx
    245f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2462:	01 d0                	add    %edx,%eax
    2464:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    2467:	83 ec 0c             	sub    $0xc,%esp
    246a:	8d 45 ce             	lea    -0x32(%ebp),%eax
    246d:	50                   	push   %eax
    246e:	e8 b7 dd ff ff       	call   22a <atoi>
    2473:	83 c4 10             	add    $0x10,%esp
    2476:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    2479:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    2480:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2483:	8b 00                	mov    (%eax),%eax
    2485:	83 ec 08             	sub    $0x8,%esp
    2488:	ff 75 dc             	pushl  -0x24(%ebp)
    248b:	6a 00                	push   $0x0
    248d:	6a 10                	push   $0x10
    248f:	50                   	push   %eax
    2490:	8d 45 c8             	lea    -0x38(%ebp),%eax
    2493:	50                   	push   %eax
    2494:	ff 75 08             	pushl  0x8(%ebp)
    2497:	e8 fe fd ff ff       	call   229a <sprintint>
    249c:	83 c4 20             	add    $0x20,%esp
                ap++;
    ...
    24a3:	e9 d2 00 00 00       	jmp    257a <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    24a8:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    24ac:	75 46                	jne    24f4 <sprintf+0x178>
                s = (char*)*ap;
    ...
    24b6:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    24ba:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    24be:	75 25                	jne    24e5 <sprintf+0x169>
                    s = "(null)";
    24c0:	c7 45 f4 58 27 00 00 	movl   $0x2758,-0xc(%ebp)
                while(*s != 0){
    24c7:	eb 1c                	jmp    24e5 <sprintf+0x169>
                    dst[j++] = *s;
    24c9:	8b 45 c8             	mov    -0x38(%ebp),%eax
    24cc:	8d 50 01             	lea    0x1(%eax),%edx
    24cf:	89 55 c8             	mov    %edx,-0x38(%ebp)
    24d2:	89 c2                	mov    %eax,%edx
    24d4:	8b 45 08             	mov    0x8(%ebp),%eax
    24d7:	01 c2                	add    %eax,%edx
    24d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    24dc:	0f b6 00             	movzbl (%eax),%eax
    24df:	88 02                	mov    %al,(%edx)
                    s++;
    24e1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    24e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    24e8:	0f b6 00             	movzbl (%eax),%eax
    24eb:	84 c0                	test   %al,%al
    24ed:	75 da                	jne    24c9 <sprintf+0x14d>
    24ef:	e9 86 00 00 00       	jmp    257a <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    24f4:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    24f8:	75 1d                	jne    2517 <sprintf+0x19b>
                dst[j++] = *ap;
    24fa:	8b 45 c8             	mov    -0x38(%ebp),%eax
    24fd:	8d 50 01             	lea    0x1(%eax),%edx
    2500:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2503:	89 c2                	mov    %eax,%edx
    2505:	8b 45 08             	mov    0x8(%ebp),%eax
    2508:	01 c2                	add    %eax,%edx
    250a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    250d:	8b 00                	mov    (%eax),%eax
    250f:	88 02                	mov    %al,(%edx)
                ap++;
    2511:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    2515:	eb 63                	jmp    257a <sprintf+0x1fe>
            } else if(c == '%'){
    2517:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    251b:	75 17                	jne    2534 <sprintf+0x1b8>
                dst[j++] = c;
    251d:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2520:	8d 50 01             	lea    0x1(%eax),%edx
    2523:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2526:	89 c2                	mov    %eax,%edx
    2528:	8b 45 08             	mov    0x8(%ebp),%eax
    252b:	01 d0                	add    %edx,%eax
    252d:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2530:	88 10                	mov    %dl,(%eax)
    2532:	eb 46                	jmp    257a <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    2534:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2538:	7e 18                	jle    2552 <sprintf+0x1d6>
    253a:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    253e:	7f 12                	jg     2552 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2540:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2543:	8d 50 01             	lea    0x1(%eax),%edx
    2546:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2549:	8b 55 e0             	mov    -0x20(%ebp),%edx
    254c:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2550:	eb 2f                	jmp    2581 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2552:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2555:	8d 50 01             	lea    0x1(%eax),%edx
    2558:	89 55 c8             	mov    %edx,-0x38(%ebp)
    255b:	89 c2                	mov    %eax,%edx
    255d:	8b 45 08             	mov    0x8(%ebp),%eax
    2560:	01 d0                	add    %edx,%eax
    2562:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    ...
    2575:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2578:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    257a:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2581:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    2585:	8b 55 0c             	mov    0xc(%ebp),%edx
    2588:	8b 45 ec             	mov    -0x14(%ebp),%eax
    258b:	01 d0                	add    %edx,%eax
    258d:	0f b6 00             	movzbl (%eax),%eax
    2590:	84 c0                	test   %al,%al
    2592:	0f 85 14 fe ff ff    	jne    23ac <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    2598:	8b 45 c8             	mov    -0x38(%ebp),%eax
    259b:	8d 50 01             	lea    0x1(%eax),%edx
    259e:	89 55 c8             	mov    %edx,-0x38(%ebp)
    25a1:	89 c2                	mov    %eax,%edx
    25a3:	8b 45 08             	mov    0x8(%ebp),%eax
    25a6:	01 d0                	add    %edx,%eax
    25a8:	c6 00 00             	movb   $0x0,(%eax)
}
    25ab:	90                   	nop
    25ac:	c9                   	leave  
    25ad:	c3                   	ret    
