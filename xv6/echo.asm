...
void APGridPaint(AHwnd wnd)
{
    ...
    if (!iconReady)
    1906:	a1 24 68 00 00       	mov    0x6824,%eax
    190b:	85 c0                	test   %eax,%eax
    190d:	0f 85 7a 02 00 00    	jne    1b8d <APGridPaint+0x290>
    {
        iconReady = 1;
    1913:	c7 05 24 68 00 00 01 	movl   $0x1,0x6824
    191a:	00 00 00 
        //load icon bitmap
        grid_wall = APLoadBitmap ("grid_wall.bmp");
    191d:	8d 45 88             	lea    -0x78(%ebp),%eax
    1920:	83 ec 08             	sub    $0x8,%esp
    1923:	68 47 25 00 00       	push   $0x2547
    1928:	50                   	push   %eax
    1929:	e8 d3 ef ff ff       	call   901 <APLoadBitmap>
    192e:	83 c4 0c             	add    $0xc,%esp
    1931:	8b 45 88             	mov    -0x78(%ebp),%eax
    1934:	a3 48 68 00 00       	mov    %eax,0x6848
    1939:	8b 45 8c             	mov    -0x74(%ebp),%eax
    193c:	a3 4c 68 00 00       	mov    %eax,0x684c
    1941:	8b 45 90             	mov    -0x70(%ebp),%eax
    1944:	a3 50 68 00 00       	mov    %eax,0x6850
        g_wall = APCreateCompatibleDCFromBitmap(grid_wall);
    1949:	83 ec 04             	sub    $0x4,%esp
    194c:	ff 35 50 68 00 00    	pushl  0x6850
    1952:	ff 35 4c 68 00 00    	pushl  0x684c
    1958:	ff 35 48 68 00 00    	pushl  0x6848
    195e:	e8 d8 f1 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1963:	83 c4 10             	add    $0x10,%esp
    1966:	a3 54 68 00 00       	mov    %eax,0x6854
        grid_river = APLoadBitmap ("grid_river.bmp");
    196b:	8d 45 88             	lea    -0x78(%ebp),%eax
    196e:	83 ec 08             	sub    $0x8,%esp
    1971:	68 55 25 00 00       	push   $0x2555
    1976:	50                   	push   %eax
    1977:	e8 85 ef ff ff       	call   901 <APLoadBitmap>
    197c:	83 c4 0c             	add    $0xc,%esp
    197f:	8b 45 88             	mov    -0x78(%ebp),%eax
    1982:	a3 90 68 00 00       	mov    %eax,0x6890
    1987:	8b 45 8c             	mov    -0x74(%ebp),%eax
    198a:	a3 94 68 00 00       	mov    %eax,0x6894
    198f:	8b 45 90             	mov    -0x70(%ebp),%eax
    1992:	a3 98 68 00 00       	mov    %eax,0x6898
        g_river = APCreateCompatibleDCFromBitmap(grid_river);
    1997:	83 ec 04             	sub    $0x4,%esp
    199a:	ff 35 98 68 00 00    	pushl  0x6898
    19a0:	ff 35 94 68 00 00    	pushl  0x6894
    19a6:	ff 35 90 68 00 00    	pushl  0x6890
    19ac:	e8 8a f1 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    19b1:	83 c4 10             	add    $0x10,%esp
    19b4:	a3 80 68 00 00       	mov    %eax,0x6880
        grid_stone = APLoadBitmap ("grid_stone.bmp");
    19b9:	8d 45 88             	lea    -0x78(%ebp),%eax
    19bc:	83 ec 08             	sub    $0x8,%esp
    19bf:	68 64 25 00 00       	push   $0x2564
    19c4:	50                   	push   %eax
    19c5:	e8 37 ef ff ff       	call   901 <APLoadBitmap>
    19ca:	83 c4 0c             	add    $0xc,%esp
    19cd:	8b 45 88             	mov    -0x78(%ebp),%eax
    19d0:	a3 84 68 00 00       	mov    %eax,0x6884
    19d5:	8b 45 8c             	mov    -0x74(%ebp),%eax
    19d8:	a3 88 68 00 00       	mov    %eax,0x6888
    19dd:	8b 45 90             	mov    -0x70(%ebp),%eax
    19e0:	a3 8c 68 00 00       	mov    %eax,0x688c
        g_stone = APCreateCompatibleDCFromBitmap(grid_stone);
    19e5:	83 ec 04             	sub    $0x4,%esp
    19e8:	ff 35 8c 68 00 00    	pushl  0x688c
    19ee:	ff 35 88 68 00 00    	pushl  0x6888
    19f4:	ff 35 84 68 00 00    	pushl  0x6884
    19fa:	e8 3c f1 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    19ff:	83 c4 10             	add    $0x10,%esp
    1a02:	a3 28 68 00 00       	mov    %eax,0x6828
        grid_lake = APLoadBitmap ("grid_lake.bmp");
    1a07:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a0a:	83 ec 08             	sub    $0x8,%esp
    1a0d:	68 73 25 00 00       	push   $0x2573
    1a12:	50                   	push   %eax
    1a13:	e8 e9 ee ff ff       	call   901 <APLoadBitmap>
    1a18:	83 c4 0c             	add    $0xc,%esp
    1a1b:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a1e:	a3 5c 68 00 00       	mov    %eax,0x685c
    1a23:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a26:	a3 60 68 00 00       	mov    %eax,0x6860
    1a2b:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a2e:	a3 64 68 00 00       	mov    %eax,0x6864
        g_lake = APCreateCompatibleDCFromBitmap(grid_lake);
    1a33:	83 ec 04             	sub    $0x4,%esp
    1a36:	ff 35 64 68 00 00    	pushl  0x6864
    1a3c:	ff 35 60 68 00 00    	pushl  0x6860
    1a42:	ff 35 5c 68 00 00    	pushl  0x685c
    1a48:	e8 ee f0 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1a4d:	83 c4 10             	add    $0x10,%esp
    1a50:	a3 a0 68 00 00       	mov    %eax,0x68a0
        grid_forest = APLoadBitmap ("grid_forest.bmp");
    1a55:	8d 45 88             	lea    -0x78(%ebp),%eax
    1a58:	83 ec 08             	sub    $0x8,%esp
    1a5b:	68 81 25 00 00       	push   $0x2581
    1a60:	50                   	push   %eax
    1a61:	e8 9b ee ff ff       	call   901 <APLoadBitmap>
    1a66:	83 c4 0c             	add    $0xc,%esp
    1a69:	8b 45 88             	mov    -0x78(%ebp),%eax
    1a6c:	a3 38 68 00 00       	mov    %eax,0x6838
    1a71:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1a74:	a3 3c 68 00 00       	mov    %eax,0x683c
    1a79:	8b 45 90             	mov    -0x70(%ebp),%eax
    1a7c:	a3 40 68 00 00       	mov    %eax,0x6840
        g_forest = APCreateCompatibleDCFromBitmap(grid_forest);
    1a81:	83 ec 04             	sub    $0x4,%esp
    1a84:	ff 35 40 68 00 00    	pushl  0x6840
    1a8a:	ff 35 3c 68 00 00    	pushl  0x683c
    1a90:	ff 35 38 68 00 00    	pushl  0x6838
    1a96:	e8 a0 f0 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1a9b:	83 c4 10             	add    $0x10,%esp
    1a9e:	a3 58 68 00 00       	mov    %eax,0x6858
        grid_mountain = APLoadBitmap ("grid_mountain.bmp");
    1aa3:	8d 45 88             	lea    -0x78(%ebp),%eax
    1aa6:	83 ec 08             	sub    $0x8,%esp
    1aa9:	68 91 25 00 00       	push   $0x2591
    1aae:	50                   	push   %eax
    1aaf:	e8 4d ee ff ff       	call   901 <APLoadBitmap>
    1ab4:	83 c4 0c             	add    $0xc,%esp
    1ab7:	8b 45 88             	mov    -0x78(%ebp),%eax
    1aba:	a3 2c 68 00 00       	mov    %eax,0x682c
    1abf:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1ac2:	a3 30 68 00 00       	mov    %eax,0x6830
    1ac7:	8b 45 90             	mov    -0x70(%ebp),%eax
    1aca:	a3 34 68 00 00       	mov    %eax,0x6834
        g_mountain = APCreateCompatibleDCFromBitmap(grid_mountain);
    1acf:	83 ec 04             	sub    $0x4,%esp
    1ad2:	ff 35 34 68 00 00    	pushl  0x6834
    1ad8:	ff 35 30 68 00 00    	pushl  0x6830
    1ade:	ff 35 2c 68 00 00    	pushl  0x682c
    1ae4:	e8 52 f0 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1ae9:	83 c4 10             	add    $0x10,%esp
    1aec:	a3 44 68 00 00       	mov    %eax,0x6844
        grid_grass = APLoadBitmap ("grid_grass.bmp");
    1af1:	8d 45 88             	lea    -0x78(%ebp),%eax
    1af4:	83 ec 08             	sub    $0x8,%esp
    1af7:	68 a3 25 00 00       	push   $0x25a3
    1afc:	50                   	push   %eax
    1afd:	e8 ff ed ff ff       	call   901 <APLoadBitmap>
    1b02:	83 c4 0c             	add    $0xc,%esp
    1b05:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b08:	a3 74 68 00 00       	mov    %eax,0x6874
    1b0d:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b10:	a3 78 68 00 00       	mov    %eax,0x6878
    1b15:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b18:	a3 7c 68 00 00       	mov    %eax,0x687c
        g_grass = APCreateCompatibleDCFromBitmap(grid_grass);
    1b1d:	83 ec 04             	sub    $0x4,%esp
    1b20:	ff 35 7c 68 00 00    	pushl  0x687c
    1b26:	ff 35 78 68 00 00    	pushl  0x6878
    1b2c:	ff 35 74 68 00 00    	pushl  0x6874
    1b32:	e8 04 f0 ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1b37:	83 c4 10             	add    $0x10,%esp
    1b3a:	a3 a4 68 00 00       	mov    %eax,0x68a4
        grid_snake = APLoadBitmap ("grid_snake.bmp");
    1b3f:	8d 45 88             	lea    -0x78(%ebp),%eax
    1b42:	83 ec 08             	sub    $0x8,%esp
    1b45:	68 b2 25 00 00       	push   $0x25b2
    1b4a:	50                   	push   %eax
    1b4b:	e8 b1 ed ff ff       	call   901 <APLoadBitmap>
    1b50:	83 c4 0c             	add    $0xc,%esp
    1b53:	8b 45 88             	mov    -0x78(%ebp),%eax
    1b56:	a3 68 68 00 00       	mov    %eax,0x6868
    1b5b:	8b 45 8c             	mov    -0x74(%ebp),%eax
    1b5e:	a3 6c 68 00 00       	mov    %eax,0x686c
    1b63:	8b 45 90             	mov    -0x70(%ebp),%eax
    1b66:	a3 70 68 00 00       	mov    %eax,0x6870
        g_snake = APCreateCompatibleDCFromBitmap(grid_snake);
    1b6b:	83 ec 04             	sub    $0x4,%esp
    1b6e:	ff 35 70 68 00 00    	pushl  0x6870
    1b74:	ff 35 6c 68 00 00    	pushl  0x686c
    1b7a:	ff 35 68 68 00 00    	pushl  0x6868
    1b80:	e8 b6 ef ff ff       	call   b3b <APCreateCompatibleDCFromBitmap>
    1b85:	83 c4 10             	add    $0x10,%esp
    1b88:	a3 9c 68 00 00       	mov    %eax,0x689c
        //printf(1,"bitmap DC created!\n");
    }
    
    if (!wnd->is_grid)
    1b8d:	8b 45 08             	mov    0x8(%ebp),%eax
    1b90:	8b 40 08             	mov    0x8(%eax),%eax
    1b93:	85 c0                	test   %eax,%eax
    1b95:	75 17                	jne    1bae <APGridPaint+0x2b1>
    {
        printf(1,"error! paint non-Grid Mode program! \n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 c4 25 00 00       	push   $0x25c4
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 d5 e8 ff ff       	call   47b <printf>
    1ba6:	83 c4 10             	add    $0x10,%esp
        return;
    1ba9:	e9 65 05 00 00       	jmp    2113 <APGridPaint+0x816>
    }
    if (wnd->total_page <= 0 || wnd->cur_page >= wnd->total_page)
    1bae:	8b 45 08             	mov    0x8(%ebp),%eax
    1bb1:	8b 40 10             	mov    0x10(%eax),%eax
    1bb4:	85 c0                	test   %eax,%eax
    1bb6:	7e 10                	jle    1bc8 <APGridPaint+0x2cb>
    1bb8:	8b 45 08             	mov    0x8(%ebp),%eax
    1bbb:	8b 50 14             	mov    0x14(%eax),%edx
    1bbe:	8b 45 08             	mov    0x8(%ebp),%eax
    1bc1:	8b 40 10             	mov    0x10(%eax),%eax
    1bc4:	39 c2                	cmp    %eax,%edx
    1bc6:	7c 17                	jl     1bdf <APGridPaint+0x2e2>
    {
        printf(1,"Grid mode page error!");
    1bc8:	83 ec 08             	sub    $0x8,%esp
    1bcb:	68 ea 25 00 00       	push   $0x25ea
    1bd0:	6a 01                	push   $0x1
    1bd2:	e8 a4 e8 ff ff       	call   47b <printf>
    1bd7:	83 c4 10             	add    $0x10,%esp
        return;
    1bda:	e9 34 05 00 00       	jmp    2113 <APGridPaint+0x816>
    }
    
    //Grid part
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    1bdf:	8b 45 08             	mov    0x8(%ebp),%eax
    1be2:	8b 40 14             	mov    0x14(%eax),%eax
    1be5:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
    1beb:	89 45 dc             	mov    %eax,-0x24(%ebp)
    1bee:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1bf1:	89 45 d8             	mov    %eax,-0x28(%ebp)
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1bf4:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    1bfb:	e9 f4 03 00 00       	jmp    1ff4 <APGridPaint+0x6f7>
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1c00:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    1c07:	e9 da 03 00 00       	jmp    1fe6 <APGridPaint+0x6e9>
        {
            index = start + GRID_W_NUMBER * j + i;
    1c0c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1c0f:	c1 e0 04             	shl    $0x4,%eax
    1c12:	89 c2                	mov    %eax,%edx
    1c14:	8b 45 d8             	mov    -0x28(%ebp),%eax
    1c17:	01 c2                	add    %eax,%edx
    1c19:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1c1c:	01 d0                	add    %edx,%eax
    1c1e:	89 45 dc             	mov    %eax,-0x24(%ebp)
            APen pen;
            ABrush brush;
            switch (wnd->Grid[index])
    1c21:	8b 45 08             	mov    0x8(%ebp),%eax
    1c24:	8b 40 0c             	mov    0xc(%eax),%eax
    1c27:	8b 55 dc             	mov    -0x24(%ebp),%edx
    1c2a:	c1 e2 02             	shl    $0x2,%edx
    1c2d:	01 d0                	add    %edx,%eax
    1c2f:	8b 00                	mov    (%eax),%eax
    1c31:	83 f8 0a             	cmp    $0xa,%eax
    1c34:	0f 87 a7 03 00 00    	ja     1fe1 <APGridPaint+0x6e4>
    1c3a:	8b 04 85 00 26 00 00 	mov    0x2600(,%eax,4),%eax
    1c41:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_wall,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1c43:	8d 45 c0             	lea    -0x40(%ebp),%eax
    1c46:	6a 0c                	push   $0xc
    1c48:	6a 0c                	push   $0xc
    1c4a:	6a 0c                	push   $0xc
    1c4c:	50                   	push   %eax
    1c4d:	e8 91 f8 ff ff       	call   14e3 <RGB>
    1c52:	83 c4 0c             	add    $0xc,%esp
    1c55:	8b 1d 54 68 00 00    	mov    0x6854,%ebx
    1c5b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1c5e:	6b c8 32             	imul   $0x32,%eax,%ecx
    1c61:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1c64:	6b c0 32             	imul   $0x32,%eax,%eax
    1c67:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1c6a:	8b 45 08             	mov    0x8(%ebp),%eax
    1c6d:	8d 78 3c             	lea    0x3c(%eax),%edi
    1c70:	83 ec 0c             	sub    $0xc,%esp
    1c73:	83 ec 04             	sub    $0x4,%esp
    1c76:	89 e0                	mov    %esp,%eax
    1c78:	0f b7 75 c0          	movzwl -0x40(%ebp),%esi
    1c7c:	66 89 30             	mov    %si,(%eax)
    1c7f:	0f b6 55 c2          	movzbl -0x3e(%ebp),%edx
    1c83:	88 50 02             	mov    %dl,0x2(%eax)
    1c86:	6a 32                	push   $0x32
    1c88:	6a 32                	push   $0x32
    1c8a:	6a 00                	push   $0x0
    1c8c:	6a 00                	push   $0x0
    1c8e:	53                   	push   %ebx
    1c8f:	51                   	push   %ecx
    1c90:	ff 75 84             	pushl  -0x7c(%ebp)
    1c93:	57                   	push   %edi
    1c94:	e8 a6 f6 ff ff       	call   133f <APDcCopy>
    1c99:	83 c4 30             	add    $0x30,%esp
                    break;
    1c9c:	e9 41 03 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_ROAD:
                    //printf(1,"Grid_Road");
                    pen.color = RGB(0x69,0x69,0x69);
    1ca1:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ca4:	6a 69                	push   $0x69
    1ca6:	6a 69                	push   $0x69
    1ca8:	6a 69                	push   $0x69
    1caa:	50                   	push   %eax
    1cab:	e8 33 f8 ff ff       	call   14e3 <RGB>
    1cb0:	83 c4 0c             	add    $0xc,%esp
    1cb3:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1cb7:	66 89 45 a8          	mov    %ax,-0x58(%ebp)
    1cbb:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1cbf:	88 45 aa             	mov    %al,-0x56(%ebp)
                    pen.size = 1;
    1cc2:	c7 45 ac 01 00 00 00 	movl   $0x1,-0x54(%ebp)
                    brush.color = RGB(0x69,0x69,0x69);
    1cc9:	8d 45 88             	lea    -0x78(%ebp),%eax
    1ccc:	6a 69                	push   $0x69
    1cce:	6a 69                	push   $0x69
    1cd0:	6a 69                	push   $0x69
    1cd2:	50                   	push   %eax
    1cd3:	e8 0b f8 ff ff       	call   14e3 <RGB>
    1cd8:	83 c4 0c             	add    $0xc,%esp
    1cdb:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    1cdf:	66 89 45 a5          	mov    %ax,-0x5b(%ebp)
    1ce3:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    1ce7:	88 45 a7             	mov    %al,-0x59(%ebp)
                    APSetPen(&wnd->Dc,pen);
    1cea:	8b 45 08             	mov    0x8(%ebp),%eax
    1ced:	8d 50 3c             	lea    0x3c(%eax),%edx
    1cf0:	8d 45 88             	lea    -0x78(%ebp),%eax
    1cf3:	ff 75 ac             	pushl  -0x54(%ebp)
    1cf6:	ff 75 a8             	pushl  -0x58(%ebp)
    1cf9:	52                   	push   %edx
    1cfa:	50                   	push   %eax
    1cfb:	e8 d0 ee ff ff       	call   bd0 <APSetPen>
    1d00:	83 c4 0c             	add    $0xc,%esp
                    APSetBrush(&wnd->Dc,brush);
    1d03:	8b 45 08             	mov    0x8(%ebp),%eax
    1d06:	8d 58 3c             	lea    0x3c(%eax),%ebx
    1d09:	8d 55 88             	lea    -0x78(%ebp),%edx
    1d0c:	83 ec 04             	sub    $0x4,%esp
    1d0f:	83 ec 04             	sub    $0x4,%esp
    1d12:	89 e0                	mov    %esp,%eax
    1d14:	0f b7 4d a5          	movzwl -0x5b(%ebp),%ecx
    1d18:	66 89 08             	mov    %cx,(%eax)
    1d1b:	0f b6 4d a7          	movzbl -0x59(%ebp),%ecx
    1d1f:	88 48 02             	mov    %cl,0x2(%eax)
    1d22:	53                   	push   %ebx
    1d23:	52                   	push   %edx
    1d24:	e8 e0 ee ff ff       	call   c09 <APSetBrush>
    1d29:	83 c4 0c             	add    $0xc,%esp
                    APDrawRect(&wnd->Dc,i * GRID_WIDTH,j * GRID_WIDTH,GRID_WIDTH,GRID_WIDTH);
    1d2c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1d2f:	6b d0 32             	imul   $0x32,%eax,%edx
    1d32:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1d35:	6b c0 32             	imul   $0x32,%eax,%eax
    1d38:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1d3b:	83 c1 3c             	add    $0x3c,%ecx
    1d3e:	83 ec 0c             	sub    $0xc,%esp
    1d41:	6a 32                	push   $0x32
    1d43:	6a 32                	push   $0x32
    1d45:	52                   	push   %edx
    1d46:	50                   	push   %eax
    1d47:	51                   	push   %ecx
    1d48:	e8 e6 f2 ff ff       	call   1033 <APDrawRect>
    1d4d:	83 c4 20             	add    $0x20,%esp
                    break;
    1d50:	e9 8d 02 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_GRASS:
                    //printf(1,"Grid_Grass");
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_grass,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1d55:	8d 45 c3             	lea    -0x3d(%ebp),%eax
    1d58:	6a 0c                	push   $0xc
    1d5a:	6a 0c                	push   $0xc
    1d5c:	6a 0c                	push   $0xc
    1d5e:	50                   	push   %eax
    1d5f:	e8 7f f7 ff ff       	call   14e3 <RGB>
    1d64:	83 c4 0c             	add    $0xc,%esp
    1d67:	8b 1d a4 68 00 00    	mov    0x68a4,%ebx
    ...
    1d8a:	0f b7 75 c3          	movzwl -0x3d(%ebp),%esi
    1d8e:	66 89 30             	mov    %si,(%eax)
    1d91:	0f b6 55 c5          	movzbl -0x3b(%ebp),%edx
    ...
    1da5:	57                   	push   %edi
    1da6:	e8 94 f5 ff ff       	call   133f <APDcCopy>
    1dab:	83 c4 30             	add    $0x30,%esp
                    break;
    1dae:	e9 2f 02 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_RIVER:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_river,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1db3:	8d 45 c6             	lea    -0x3a(%ebp),%eax
    1db6:	6a 0c                	push   $0xc
    1db8:	6a 0c                	push   $0xc
    1dba:	6a 0c                	push   $0xc
    1dbc:	50                   	push   %eax
    1dbd:	e8 21 f7 ff ff       	call   14e3 <RGB>
    1dc2:	83 c4 0c             	add    $0xc,%esp
    1dc5:	8b 1d 80 68 00 00    	mov    0x6880,%ebx
    ...
    1de8:	0f b7 75 c6          	movzwl -0x3a(%ebp),%esi
    1dec:	66 89 30             	mov    %si,(%eax)
    1def:	0f b6 55 c8          	movzbl -0x38(%ebp),%edx
    ...
    1e03:	57                   	push   %edi
    1e04:	e8 36 f5 ff ff       	call   133f <APDcCopy>
    1e09:	83 c4 30             	add    $0x30,%esp
                    break;
    1e0c:	e9 d1 01 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_FOREST:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_forest,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e11:	8d 45 c9             	lea    -0x37(%ebp),%eax
    1e14:	6a 0c                	push   $0xc
    1e16:	6a 0c                	push   $0xc
    1e18:	6a 0c                	push   $0xc
    1e1a:	50                   	push   %eax
    1e1b:	e8 c3 f6 ff ff       	call   14e3 <RGB>
    1e20:	83 c4 0c             	add    $0xc,%esp
    1e23:	8b 1d 58 68 00 00    	mov    0x6858,%ebx
    ...
    1e46:	0f b7 75 c9          	movzwl -0x37(%ebp),%esi
    1e4a:	66 89 30             	mov    %si,(%eax)
    1e4d:	0f b6 55 cb          	movzbl -0x35(%ebp),%edx
    ...
    1e61:	57                   	push   %edi
    1e62:	e8 d8 f4 ff ff       	call   133f <APDcCopy>
    1e67:	83 c4 30             	add    $0x30,%esp
                    break;
    1e6a:	e9 73 01 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_LAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_lake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1e6f:	8d 45 cc             	lea    -0x34(%ebp),%eax
    1e72:	6a 0c                	push   $0xc
    1e74:	6a 0c                	push   $0xc
    1e76:	6a 0c                	push   $0xc
    1e78:	50                   	push   %eax
    1e79:	e8 65 f6 ff ff       	call   14e3 <RGB>
    1e7e:	83 c4 0c             	add    $0xc,%esp
    1e81:	8b 1d a0 68 00 00    	mov    0x68a0,%ebx
    ...
    1ea4:	0f b7 75 cc          	movzwl -0x34(%ebp),%esi
    1ea8:	66 89 30             	mov    %si,(%eax)
    1eab:	0f b6 55 ce          	movzbl -0x32(%ebp),%edx
    ...
    1ebf:	57                   	push   %edi
    1ec0:	e8 7a f4 ff ff       	call   133f <APDcCopy>
    1ec5:	83 c4 30             	add    $0x30,%esp
                    break;
    1ec8:	e9 15 01 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_STONE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_stone,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1ecd:	8d 45 cf             	lea    -0x31(%ebp),%eax
    1ed0:	6a 0c                	push   $0xc
    1ed2:	6a 0c                	push   $0xc
    1ed4:	6a 0c                	push   $0xc
    1ed6:	50                   	push   %eax
    1ed7:	e8 07 f6 ff ff       	call   14e3 <RGB>
    1edc:	83 c4 0c             	add    $0xc,%esp
    1edf:	8b 1d 28 68 00 00    	mov    0x6828,%ebx
    1ee5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1ee8:	6b c8 32             	imul   $0x32,%eax,%ecx
    1eeb:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1eee:	6b c0 32             	imul   $0x32,%eax,%eax
    1ef1:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1ef4:	8b 45 08             	mov    0x8(%ebp),%eax
    1ef7:	8d 78 3c             	lea    0x3c(%eax),%edi
    1efa:	83 ec 0c             	sub    $0xc,%esp
    1efd:	83 ec 04             	sub    $0x4,%esp
    1f00:	89 e0                	mov    %esp,%eax
    1f02:	0f b7 75 cf          	movzwl -0x31(%ebp),%esi
    1f06:	66 89 30             	mov    %si,(%eax)
    1f09:	0f b6 55 d1          	movzbl -0x2f(%ebp),%edx
    1f0d:	88 50 02             	mov    %dl,0x2(%eax)
    1f10:	6a 32                	push   $0x32
    1f12:	6a 32                	push   $0x32
    1f14:	6a 00                	push   $0x0
    1f16:	6a 00                	push   $0x0
    1f18:	53                   	push   %ebx
    1f19:	51                   	push   %ecx
    1f1a:	ff 75 84             	pushl  -0x7c(%ebp)
    1f1d:	57                   	push   %edi
    1f1e:	e8 1c f4 ff ff       	call   133f <APDcCopy>
    1f23:	83 c4 30             	add    $0x30,%esp
                    break;
    1f26:	e9 b7 00 00 00       	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_MOUNTAIN:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_mountain,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f2b:	8d 45 d2             	lea    -0x2e(%ebp),%eax
    1f2e:	6a 0c                	push   $0xc
    1f30:	6a 0c                	push   $0xc
    1f32:	6a 0c                	push   $0xc
    1f34:	50                   	push   %eax
    1f35:	e8 a9 f5 ff ff       	call   14e3 <RGB>
    1f3a:	83 c4 0c             	add    $0xc,%esp
    1f3d:	8b 1d 44 68 00 00    	mov    0x6844,%ebx
    1f43:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f46:	6b c8 32             	imul   $0x32,%eax,%ecx
    1f49:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1f4c:	6b c0 32             	imul   $0x32,%eax,%eax
    1f4f:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1f52:	8b 45 08             	mov    0x8(%ebp),%eax
    1f55:	8d 78 3c             	lea    0x3c(%eax),%edi
    1f58:	83 ec 0c             	sub    $0xc,%esp
    1f5b:	83 ec 04             	sub    $0x4,%esp
    1f5e:	89 e0                	mov    %esp,%eax
    1f60:	0f b7 75 d2          	movzwl -0x2e(%ebp),%esi
    1f64:	66 89 30             	mov    %si,(%eax)
    1f67:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
    1f6b:	88 50 02             	mov    %dl,0x2(%eax)
    1f6e:	6a 32                	push   $0x32
    1f70:	6a 32                	push   $0x32
    1f72:	6a 00                	push   $0x0
    1f74:	6a 00                	push   $0x0
    1f76:	53                   	push   %ebx
    1f77:	51                   	push   %ecx
    1f78:	ff 75 84             	pushl  -0x7c(%ebp)
    1f7b:	57                   	push   %edi
    1f7c:	e8 be f3 ff ff       	call   133f <APDcCopy>
    1f81:	83 c4 30             	add    $0x30,%esp
                    break;
    1f84:	eb 5c                	jmp    1fe2 <APGridPaint+0x6e5>
                case GRID_PROGRAM_SNAKE:
                    APDcCopy(&wnd->Dc,i * GRID_WIDTH ,j * GRID_WIDTH,g_snake,0,0,GRID_WIDTH,GRID_WIDTH,COLOR_NULL);
    1f86:	8d 45 d5             	lea    -0x2b(%ebp),%eax
    1f89:	6a 0c                	push   $0xc
    1f8b:	6a 0c                	push   $0xc
    1f8d:	6a 0c                	push   $0xc
    1f8f:	50                   	push   %eax
    1f90:	e8 4e f5 ff ff       	call   14e3 <RGB>
    1f95:	83 c4 0c             	add    $0xc,%esp
    1f98:	8b 1d 9c 68 00 00    	mov    0x689c,%ebx
    1f9e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fa1:	6b c8 32             	imul   $0x32,%eax,%ecx
    1fa4:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1fa7:	6b c0 32             	imul   $0x32,%eax,%eax
    1faa:	89 45 84             	mov    %eax,-0x7c(%ebp)
    1fad:	8b 45 08             	mov    0x8(%ebp),%eax
    1fb0:	8d 78 3c             	lea    0x3c(%eax),%edi
    1fb3:	83 ec 0c             	sub    $0xc,%esp
    1fb6:	83 ec 04             	sub    $0x4,%esp
    1fb9:	89 e0                	mov    %esp,%eax
    1fbb:	0f b7 75 d5          	movzwl -0x2b(%ebp),%esi
    1fbf:	66 89 30             	mov    %si,(%eax)
    1fc2:	0f b6 55 d7          	movzbl -0x29(%ebp),%edx
    1fc6:	88 50 02             	mov    %dl,0x2(%eax)
    1fc9:	6a 32                	push   $0x32
    1fcb:	6a 32                	push   $0x32
    1fcd:	6a 00                	push   $0x0
    1fcf:	6a 00                	push   $0x0
    1fd1:	53                   	push   %ebx
    1fd2:	51                   	push   %ecx
    1fd3:	ff 75 84             	pushl  -0x7c(%ebp)
    1fd6:	57                   	push   %edi
    1fd7:	e8 63 f3 ff ff       	call   133f <APDcCopy>
    1fdc:	83 c4 30             	add    $0x30,%esp
                    break;
    1fdf:	eb 01                	jmp    1fe2 <APGridPaint+0x6e5>
                default: break;
    1fe1:	90                   	nop
    ...
    {
        for (int i = 0; i < GRID_W_NUMBER;i++)
    1fe2:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
    1fe6:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
    1fea:	0f 8e 1c fc ff ff    	jle    1c0c <APGridPaint+0x30f>
        return;
    }
    ...
    int index = wnd->cur_page * GRID_W_NUMBER * GRID_H_NUMBER,start = index;
    for (int j = 0; j < GRID_H_NUMBER; j++)
    1ff0:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    1ff4:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
    1ff8:	0f 8e 02 fc ff ff    	jle    1c00 <APGridPaint+0x303>
        }
    }
    //Title Part
    APen pen;
    ...
    1ffe:	8d 45 88             	lea    -0x78(%ebp),%eax
    2001:	68 cd 00 00 00       	push   $0xcd
    2006:	6a 74                	push   $0x74
    2008:	6a 18                	push   $0x18
    200a:	50                   	push   %eax
    200b:	e8 d3 f4 ff ff       	call   14e3 <RGB>
    2010:	83 c4 0c             	add    $0xc,%esp
    2013:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2017:	66 89 45 b8          	mov    %ax,-0x48(%ebp)
    201b:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    201f:	88 45 ba             	mov    %al,-0x46(%ebp)
    pen.size = 1;
    2022:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    ...
    2035:	50                   	push   %eax
    2036:	e8 a8 f4 ff ff       	call   14e3 <RGB>
    203b:	83 c4 0c             	add    $0xc,%esp
    203e:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    2042:	66 89 45 b5          	mov    %ax,-0x4b(%ebp)
    2046:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    204a:	88 45 b7             	mov    %al,-0x49(%ebp)
    APSetPen(&wnd->TitleDc,pen);
    204d:	8b 45 08             	mov    0x8(%ebp),%eax
    2050:	8d 50 58             	lea    0x58(%eax),%edx
    2053:	8d 45 88             	lea    -0x78(%ebp),%eax
    2056:	ff 75 bc             	pushl  -0x44(%ebp)
    2059:	ff 75 b8             	pushl  -0x48(%ebp)
    205c:	52                   	push   %edx
    205d:	50                   	push   %eax
    205e:	e8 6d eb ff ff       	call   bd0 <APSetPen>
    2063:	83 c4 0c             	add    $0xc,%esp
    APSetBrush(&wnd->TitleDc,brush);
    2066:	8b 45 08             	mov    0x8(%ebp),%eax
    2069:	8d 58 58             	lea    0x58(%eax),%ebx
    206c:	8d 55 88             	lea    -0x78(%ebp),%edx
    206f:	83 ec 04             	sub    $0x4,%esp
    2072:	83 ec 04             	sub    $0x4,%esp
    2075:	89 e0                	mov    %esp,%eax
    2077:	0f b7 4d b5          	movzwl -0x4b(%ebp),%ecx
    207b:	66 89 08             	mov    %cx,(%eax)
    207e:	0f b6 4d b7          	movzbl -0x49(%ebp),%ecx
    2082:	88 48 02             	mov    %cl,0x2(%eax)
    2085:	53                   	push   %ebx
    2086:	52                   	push   %edx
    2087:	e8 7d eb ff ff       	call   c09 <APSetBrush>
    208c:	83 c4 0c             	add    $0xc,%esp
    APDrawRect(&wnd->TitleDc,0,0,SCREEN_WIDTH,WND_TITLE_HEIGHT);
    208f:	8b 45 08             	mov    0x8(%ebp),%eax
    2092:	83 c0 58             	add    $0x58,%eax
    2095:	83 ec 0c             	sub    $0xc,%esp
    2098:	6a 32                	push   $0x32
    209a:	68 20 03 00 00       	push   $0x320
    209f:	6a 00                	push   $0x0
    20a1:	6a 00                	push   $0x0
    20a3:	50                   	push   %eax
    20a4:	e8 8a ef ff ff       	call   1033 <APDrawRect>
    20a9:	83 c4 20             	add    $0x20,%esp


    AFont font;
    font.color = RGB(0x08,0x08,0x08);
    20ac:	8d 45 88             	lea    -0x78(%ebp),%eax
    20af:	6a 08                	push   $0x8
    20b1:	6a 08                	push   $0x8
    20b3:	6a 08                	push   $0x8
    20b5:	50                   	push   %eax
    20b6:	e8 28 f4 ff ff       	call   14e3 <RGB>
    20bb:	83 c4 0c             	add    $0xc,%esp
    20be:	0f b7 45 88          	movzwl -0x78(%ebp),%eax
    20c2:	66 89 45 b2          	mov    %ax,-0x4e(%ebp)
    20c6:	0f b6 45 8a          	movzbl -0x76(%ebp),%eax
    20ca:	88 45 b4             	mov    %al,-0x4c(%ebp)
    ...
    20de:	0f b7 4d b2          	movzwl -0x4e(%ebp),%ecx
    20e2:	66 89 08             	mov    %cx,(%eax)
    20e5:	0f b6 4d b4          	movzbl -0x4c(%ebp),%ecx
    20e9:	88 48 02             	mov    %cl,0x2(%eax)
    20ec:	53                   	push   %ebx
    20ed:	52                   	push   %edx
    20ee:	e8 58 eb ff ff       	call   c4b <APSetFont>
    20f3:	83 c4 0c             	add    $0xc,%esp
    APDrawText(&wnd->TitleDc,wnd->title,20,20);
    20f6:	8b 45 08             	mov    0x8(%ebp),%eax
    20f9:	8d 90 84 00 00 00    	lea    0x84(%eax),%edx
    20ff:	8b 45 08             	mov    0x8(%ebp),%eax
    2102:	83 c0 58             	add    $0x58,%eax
    2105:	6a 14                	push   $0x14
    2107:	6a 14                	push   $0x14
    2109:	52                   	push   %edx
    210a:	50                   	push   %eax
    210b:	e8 28 f1 ff ff       	call   1238 <APDrawText>
