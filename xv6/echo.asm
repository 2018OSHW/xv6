...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
      ...
      27:	ba a8 20 00 00       	mov    $0x20a8,%edx
      2c:	eb 05                	jmp    33 <main+0x33>
      2e:	ba aa 20 00 00       	mov    $0x20aa,%edx
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     3ff:	0f b6 80 3c 27 00 00 	movzbl 0x273c(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     53b:	75 25                	jne    562 <printf+0xff>
          s = "(null)";
     53d:	c7 45 f4 b1 20 00 00 	movl   $0x20b1,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     603:	a1 6c 27 00 00       	mov    0x276c,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6ce:	a3 6c 27 00 00       	mov    %eax,0x276c
}
     6d3:	90                   	nop
     6d4:	c9                   	leave  
     6d5:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     72f:	a1 6c 27 00 00       	mov    0x276c,%eax
}
     734:	c9                   	leave  
     735:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     74b:	a1 6c 27 00 00       	mov    0x276c,%eax
     750:	89 45 f0             	mov    %eax,-0x10(%ebp)
     753:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     757:	75 23                	jne    77c <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     759:	c7 45 f0 64 27 00 00 	movl   $0x2764,-0x10(%ebp)
     760:	8b 45 f0             	mov    -0x10(%ebp),%eax
     763:	a3 6c 27 00 00       	mov    %eax,0x276c
     768:	a1 6c 27 00 00       	mov    0x276c,%eax
     76d:	a3 64 27 00 00       	mov    %eax,0x2764
    base.s.size = 0;
     772:	c7 05 68 27 00 00 00 	movl   $0x0,0x2768
     779:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7cf:	a3 6c 27 00 00       	mov    %eax,0x276c
      return (void*)(p + 1);
    ...
    if(p == freep)
     7dc:	a1 6c 27 00 00       	mov    0x276c,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     91a:	79 2e                	jns    94a <APLoadBitmap+0x61>
    {
     ...
     922:	68 b8 20 00 00       	push   $0x20b8
     927:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    140a:	68 c8 20 00 00       	push   $0x20c8
    140f:	6a 01                	push   $0x1
    ...
    147d:	68 e8 20 00 00       	push   $0x20e8
    1482:	6a 01                	push   $0x1
    ...
    1521:	68 0c 21 00 00       	push   $0x210c
    1526:	6a 01                	push   $0x1
    ...
    15f2:	68 34 21 00 00       	push   $0x2134
    15f7:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1984:	68 c8 21 00 00       	push   $0x21c8
    1989:	6a 01                	push   $0x1
    ...
    19b5:	68 ee 21 00 00       	push   $0x21ee
    19ba:	6a 01                	push   $0x1
    ...
    1a24:	8b 04 85 04 22 00 00 	mov    0x2204(,%eax,4),%eax
    1a2b:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a3f:	8b 1d a0 27 00 00    	mov    0x27a0,%ebx
    ...
    1b51:	8b 1d e0 27 00 00    	mov    0x27e0,%ebx
    ...
    1baf:	8b 1d c0 27 00 00    	mov    0x27c0,%ebx
    ...
    1c0d:	8b 1d a4 27 00 00    	mov    0x27a4,%ebx
    ...
    1c6b:	8b 1d dc 27 00 00    	mov    0x27dc,%ebx
    ...
    1cc9:	8b 1d 74 27 00 00    	mov    0x2774,%ebx
    ...
    1d24:	8b 1d 90 27 00 00    	mov    0x2790,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1d99:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1da0:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1da4:	74 17                	je     1dbd <sprintint+0x2b>
    1da6:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1daa:	79 11                	jns    1dbd <sprintint+0x2b>
        neg = 1;
    1dac:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1db3:	8b 45 10             	mov    0x10(%ebp),%eax
    1db6:	f7 d8                	neg    %eax
    1db8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1dbb:	eb 06                	jmp    1dc3 <sprintint+0x31>
    } else {
        x = xx;
    ...
    i = 0;
    1dc3:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1dca:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1dcd:	8d 41 01             	lea    0x1(%ecx),%eax
    1dd0:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1dd3:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1dd6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1dd9:	ba 00 00 00 00       	mov    $0x0,%edx
    1dde:	f7 f3                	div    %ebx
    1de0:	89 d0                	mov    %edx,%eax
    1de2:	0f b6 80 50 27 00 00 	movzbl 0x2750(%eax),%eax
    1de9:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1ded:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1df0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1df3:	ba 00 00 00 00       	mov    $0x0,%edx
    1df8:	f7 f3                	div    %ebx
    1dfa:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1dfd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e01:	75 c7                	jne    1dca <sprintint+0x38>
    if(neg)
    1e03:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1e07:	74 0e                	je     1e17 <sprintint+0x85>
        buf[i++] = '-';
    1e09:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e0c:	8d 50 01             	lea    0x1(%eax),%edx
    1e0f:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1e12:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1e17:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e1a:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1e1d:	eb 1b                	jmp    1e3a <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1e1f:	8b 45 0c             	mov    0xc(%ebp),%eax
    1e22:	8b 00                	mov    (%eax),%eax
    1e24:	8d 48 01             	lea    0x1(%eax),%ecx
    1e27:	8b 55 0c             	mov    0xc(%ebp),%edx
    1e2a:	89 0a                	mov    %ecx,(%edx)
    1e2c:	89 c2                	mov    %eax,%edx
    1e2e:	8b 45 08             	mov    0x8(%ebp),%eax
    1e31:	01 d0                	add    %edx,%eax
    1e33:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1e36:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1e3a:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1e3e:	7f df                	jg     1e1f <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e40:	eb 21                	jmp    1e63 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    ...
    1e54:	01 c2                	add    %eax,%edx
    1e56:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1e59:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e5c:	01 c8                	add    %ecx,%eax
    1e5e:	0f b6 00             	movzbl (%eax),%eax
    1e61:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e63:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1e67:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1e6b:	79 d5                	jns    1e42 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1e6d:	90                   	nop
    1e6e:	83 c4 20             	add    $0x20,%esp
    1e71:	5b                   	pop    %ebx
    1e72:	5d                   	pop    %ebp
    1e73:	c3                   	ret    
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1e77:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1e7a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1e81:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1e88:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1e8f:	8d 45 0c             	lea    0xc(%ebp),%eax
    1e92:	83 c0 04             	add    $0x4,%eax
    1e95:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1e98:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1e9f:	e9 d9 01 00 00       	jmp    207d <sprintf+0x209>
        c = fmt[i] & 0xff;
    1ea4:	8b 55 0c             	mov    0xc(%ebp),%edx
    1ea7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1eaa:	01 d0                	add    %edx,%eax
    1eac:	0f b6 00             	movzbl (%eax),%eax
    1eaf:	0f be c0             	movsbl %al,%eax
    1eb2:	25 ff 00 00 00       	and    $0xff,%eax
    1eb7:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1eba:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1ebe:	75 2c                	jne    1eec <sprintf+0x78>
            if(c == '%'){
    1ec0:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1ec4:	75 0c                	jne    1ed2 <sprintf+0x5e>
                state = '%';
    1ec6:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1ecd:	e9 a7 01 00 00       	jmp    2079 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1ed2:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1ed5:	8d 50 01             	lea    0x1(%eax),%edx
    1ed8:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1edb:	89 c2                	mov    %eax,%edx
    1edd:	8b 45 08             	mov    0x8(%ebp),%eax
    1ee0:	01 d0                	add    %edx,%eax
    1ee2:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1ee5:	88 10                	mov    %dl,(%eax)
    1ee7:	e9 8d 01 00 00       	jmp    2079 <sprintf+0x205>
            }
        } else if(state == '%'){
    1eec:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1ef0:	0f 85 83 01 00 00    	jne    2079 <sprintf+0x205>
            if(c == 'd'){
    1ef6:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1efa:	75 4c                	jne    1f48 <sprintf+0xd4>
                buf[bi] = '\0';
    1efc:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1eff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f02:	01 d0                	add    %edx,%eax
    1f04:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f07:	83 ec 0c             	sub    $0xc,%esp
    1f0a:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f0d:	50                   	push   %eax
    1f0e:	e8 17 e3 ff ff       	call   22a <atoi>
    1f13:	83 c4 10             	add    $0x10,%esp
    1f16:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    1f19:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    1f20:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f23:	8b 00                	mov    (%eax),%eax
    1f25:	83 ec 08             	sub    $0x8,%esp
    1f28:	ff 75 d8             	pushl  -0x28(%ebp)
    1f2b:	6a 01                	push   $0x1
    1f2d:	6a 0a                	push   $0xa
    1f2f:	50                   	push   %eax
    1f30:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1f33:	50                   	push   %eax
    1f34:	ff 75 08             	pushl  0x8(%ebp)
    1f37:	e8 56 fe ff ff       	call   1d92 <sprintint>
    1f3c:	83 c4 20             	add    $0x20,%esp
                ap++;
    1f3f:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1f43:	e9 2a 01 00 00       	jmp    2072 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    1f48:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    1f4c:	74 06                	je     1f54 <sprintf+0xe0>
    1f4e:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    1f52:	75 4c                	jne    1fa0 <sprintf+0x12c>
                buf[bi] = '\0';
    1f54:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f57:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f5a:	01 d0                	add    %edx,%eax
    1f5c:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f5f:	83 ec 0c             	sub    $0xc,%esp
    1f62:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f65:	50                   	push   %eax
    1f66:	e8 bf e2 ff ff       	call   22a <atoi>
    1f6b:	83 c4 10             	add    $0x10,%esp
    1f6e:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    1f71:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    1f78:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f7b:	8b 00                	mov    (%eax),%eax
    1f7d:	83 ec 08             	sub    $0x8,%esp
    1f80:	ff 75 dc             	pushl  -0x24(%ebp)
    1f83:	6a 00                	push   $0x0
    1f85:	6a 10                	push   $0x10
    1f87:	50                   	push   %eax
    1f88:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1f8b:	50                   	push   %eax
    1f8c:	ff 75 08             	pushl  0x8(%ebp)
    1f8f:	e8 fe fd ff ff       	call   1d92 <sprintint>
    1f94:	83 c4 20             	add    $0x20,%esp
                ap++;
    1f97:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 10, 1, l);
    ...
    1f9b:	e9 d2 00 00 00       	jmp    2072 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    1fa0:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    1fa4:	75 46                	jne    1fec <sprintf+0x178>
                s = (char*)*ap;
    1fa6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fa9:	8b 00                	mov    (%eax),%eax
    1fab:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    1fae:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    1fb2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fb6:	75 25                	jne    1fdd <sprintf+0x169>
                    s = "(null)";
    1fb8:	c7 45 f4 24 22 00 00 	movl   $0x2224,-0xc(%ebp)
                while(*s != 0){
    1fbf:	eb 1c                	jmp    1fdd <sprintf+0x169>
                    dst[j++] = *s;
    1fc1:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1fc4:	8d 50 01             	lea    0x1(%eax),%edx
    1fc7:	89 55 c8             	mov    %edx,-0x38(%ebp)
    ...
    1fe5:	75 da                	jne    1fc1 <sprintf+0x14d>
    1fe7:	e9 86 00 00 00       	jmp    2072 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    1fec:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    1ff0:	75 1d                	jne    200f <sprintf+0x19b>
                dst[j++] = *ap;
    1ff2:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1ff5:	8d 50 01             	lea    0x1(%eax),%edx
    1ff8:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1ffb:	89 c2                	mov    %eax,%edx
    1ffd:	8b 45 08             	mov    0x8(%ebp),%eax
    2000:	01 c2                	add    %eax,%edx
    2002:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2005:	8b 00                	mov    (%eax),%eax
    2007:	88 02                	mov    %al,(%edx)
                ap++;
    2009:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    200d:	eb 63                	jmp    2072 <sprintf+0x1fe>
            } else if(c == '%'){
    200f:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2013:	75 17                	jne    202c <sprintf+0x1b8>
                dst[j++] = c;
    ...
    2023:	01 d0                	add    %edx,%eax
    2025:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2028:	88 10                	mov    %dl,(%eax)
    202a:	eb 46                	jmp    2072 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    202c:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    2030:	7e 18                	jle    204a <sprintf+0x1d6>
    2032:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2036:	7f 12                	jg     204a <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2038:	8b 45 f0             	mov    -0x10(%ebp),%eax
    203b:	8d 50 01             	lea    0x1(%eax),%edx
    203e:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2041:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2044:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2048:	eb 2f                	jmp    2079 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    204a:	8b 45 c8             	mov    -0x38(%ebp),%eax
    204d:	8d 50 01             	lea    0x1(%eax),%edx
    2050:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2053:	89 c2                	mov    %eax,%edx
    2055:	8b 45 08             	mov    0x8(%ebp),%eax
    2058:	01 d0                	add    %edx,%eax
    205a:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    ...
    206d:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2070:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    2072:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2079:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    207d:	8b 55 0c             	mov    0xc(%ebp),%edx
    2080:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2083:	01 d0                	add    %edx,%eax
    2085:	0f b6 00             	movzbl (%eax),%eax
    2088:	84 c0                	test   %al,%al
    208a:	0f 85 14 fe ff ff    	jne    1ea4 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    2090:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2093:	8d 50 01             	lea    0x1(%eax),%edx
    2096:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2099:	89 c2                	mov    %eax,%edx
    209b:	8b 45 08             	mov    0x8(%ebp),%eax
    209e:	01 d0                	add    %edx,%eax
    20a0:	c6 00 00             	movb   $0x0,(%eax)
}
    20a3:	90                   	nop
    20a4:	c9                   	leave  
    20a5:	c3                   	ret    
