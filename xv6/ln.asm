...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     40e:	0f b6 80 6c 27 00 00 	movzbl 0x276c(%eax),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     54a:	75 25                	jne    571 <printf+0xff>
          s = "(null)";
     54c:	c7 45 f4 df 20 00 00 	movl   $0x20df,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     612:	a1 9c 27 00 00       	mov    0x279c,%eax
...
free(void *ap)
{
  ...
  freep = p;
     ...
     6dd:	a3 9c 27 00 00       	mov    %eax,0x279c
}
     6e2:	90                   	nop
     6e3:	c9                   	leave  
     6e4:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
     73e:	a1 9c 27 00 00       	mov    0x279c,%eax
}
     743:	c9                   	leave  
     744:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     75a:	a1 9c 27 00 00       	mov    0x279c,%eax
     75f:	89 45 f0             	mov    %eax,-0x10(%ebp)
     762:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     766:	75 23                	jne    78b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
     768:	c7 45 f0 94 27 00 00 	movl   $0x2794,-0x10(%ebp)
     76f:	8b 45 f0             	mov    -0x10(%ebp),%eax
     772:	a3 9c 27 00 00       	mov    %eax,0x279c
     777:	a1 9c 27 00 00       	mov    0x279c,%eax
     77c:	a3 94 27 00 00       	mov    %eax,0x2794
    base.s.size = 0;
     781:	c7 05 98 27 00 00 00 	movl   $0x0,0x2798
     788:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     7de:	a3 9c 27 00 00       	mov    %eax,0x279c
      return (void*)(p + 1);
    ...
    if(p == freep)
     7eb:	a1 9c 27 00 00       	mov    0x279c,%eax
...
ABitmap APLoadBitmap(char * filename)
{
     ...
     929:	79 2e                	jns    959 <APLoadBitmap+0x61>
    {
     ...
     931:	68 e6 20 00 00       	push   $0x20e6
     936:	6a 01                	push   $0x1
...
AHwnd APCreateWindow(char * title,int is_map,int page)
{
    ...
    1419:	68 f8 20 00 00       	push   $0x20f8
    141e:	6a 01                	push   $0x1
    ...
    148c:	68 18 21 00 00       	push   $0x2118
    1491:	6a 01                	push   $0x1
    ...
    1530:	68 3c 21 00 00       	push   $0x213c
    1535:	6a 01                	push   $0x1
    ...
    1601:	68 64 21 00 00       	push   $0x2164
    1606:	6a 01                	push   $0x1
...
void APGridPaint(AHwnd wnd)
{
    ...
    1993:	68 f8 21 00 00       	push   $0x21f8
    1998:	6a 01                	push   $0x1
    ...
    19c4:	68 1e 22 00 00       	push   $0x221e
    19c9:	6a 01                	push   $0x1
    ...
    1a33:	8b 04 85 34 22 00 00 	mov    0x2234(,%eax,4),%eax
    1a3a:	ff e0                	jmp    *%eax
            {
                case GRID_WALL:
    ...
    1a4e:	8b 1d d0 27 00 00    	mov    0x27d0,%ebx
    ...
    1b60:	8b 1d 10 28 00 00    	mov    0x2810,%ebx
    ...
    1bbe:	8b 1d f0 27 00 00    	mov    0x27f0,%ebx
    ...
    1c1c:	8b 1d d4 27 00 00    	mov    0x27d4,%ebx
    ...
    1c7a:	8b 1d 0c 28 00 00    	mov    0x280c,%ebx
    ...
    1cd8:	8b 1d a4 27 00 00    	mov    0x27a4,%ebx
    ...
    1d33:	8b 1d c0 27 00 00    	mov    0x27c0,%ebx
...
sprintint(char * dst, int * j, int xx, int base, int sgn, int size)
{
    ...
    neg = 0;
    1da8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(sgn && xx < 0){
    1daf:	83 7d 18 00          	cmpl   $0x0,0x18(%ebp)
    1db3:	74 17                	je     1dcc <sprintint+0x2b>
    1db5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
    1db9:	79 11                	jns    1dcc <sprintint+0x2b>
        neg = 1;
    1dbb:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
        x = -xx;
    1dc2:	8b 45 10             	mov    0x10(%ebp),%eax
    1dc5:	f7 d8                	neg    %eax
    1dc7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1dca:	eb 06                	jmp    1dd2 <sprintint+0x31>
    } else {
        x = xx;
    1dcc:	8b 45 10             	mov    0x10(%ebp),%eax
    1dcf:	89 45 f0             	mov    %eax,-0x10(%ebp)
    }
    
    i = 0;
    1dd2:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    do{
        buf[i++] = digits[x % base];
    1dd9:	8b 4d f8             	mov    -0x8(%ebp),%ecx
    1ddc:	8d 41 01             	lea    0x1(%ecx),%eax
    1ddf:	89 45 f8             	mov    %eax,-0x8(%ebp)
    1de2:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1de5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1de8:	ba 00 00 00 00       	mov    $0x0,%edx
    1ded:	f7 f3                	div    %ebx
    1def:	89 d0                	mov    %edx,%eax
    1df1:	0f b6 80 80 27 00 00 	movzbl 0x2780(%eax),%eax
    1df8:	88 44 0d e0          	mov    %al,-0x20(%ebp,%ecx,1)
    }while((x /= base) != 0);
    1dfc:	8b 5d 14             	mov    0x14(%ebp),%ebx
    1dff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e02:	ba 00 00 00 00       	mov    $0x0,%edx
    1e07:	f7 f3                	div    %ebx
    1e09:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1e0c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e10:	75 c7                	jne    1dd9 <sprintint+0x38>
    if(neg)
    1e12:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1e16:	74 0e                	je     1e26 <sprintint+0x85>
        buf[i++] = '-';
    1e18:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e1b:	8d 50 01             	lea    0x1(%eax),%edx
    1e1e:	89 55 f8             	mov    %edx,-0x8(%ebp)
    1e21:	c6 44 05 e0 2d       	movb   $0x2d,-0x20(%ebp,%eax,1)
    
    size -= i;
    1e26:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e29:	29 45 1c             	sub    %eax,0x1c(%ebp)
    while (size > 0)
    1e2c:	eb 1b                	jmp    1e49 <sprintint+0xa8>
    {
        dst[(*j)++] = '0';
    1e2e:	8b 45 0c             	mov    0xc(%ebp),%eax
    1e31:	8b 00                	mov    (%eax),%eax
    1e33:	8d 48 01             	lea    0x1(%eax),%ecx
    1e36:	8b 55 0c             	mov    0xc(%ebp),%edx
    1e39:	89 0a                	mov    %ecx,(%edx)
    1e3b:	89 c2                	mov    %eax,%edx
    1e3d:	8b 45 08             	mov    0x8(%ebp),%eax
    1e40:	01 d0                	add    %edx,%eax
    1e42:	c6 00 30             	movb   $0x30,(%eax)
        --size;
    1e45:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
    }while((x /= base) != 0);
    if(neg)
        buf[i++] = '-';
    ...
    size -= i;
    while (size > 0)
    1e49:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
    1e4d:	7f df                	jg     1e2e <sprintint+0x8d>
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e4f:	eb 21                	jmp    1e72 <sprintint+0xd1>
        dst[(*j)++] = buf[i];
    1e51:	8b 45 0c             	mov    0xc(%ebp),%eax
    1e54:	8b 00                	mov    (%eax),%eax
    1e56:	8d 48 01             	lea    0x1(%eax),%ecx
    1e59:	8b 55 0c             	mov    0xc(%ebp),%edx
    1e5c:	89 0a                	mov    %ecx,(%edx)
    1e5e:	89 c2                	mov    %eax,%edx
    1e60:	8b 45 08             	mov    0x8(%ebp),%eax
    1e63:	01 c2                	add    %eax,%edx
    1e65:	8d 4d e0             	lea    -0x20(%ebp),%ecx
    1e68:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1e6b:	01 c8                	add    %ecx,%eax
    1e6d:	0f b6 00             	movzbl (%eax),%eax
    1e70:	88 02                	mov    %al,(%edx)
    {
        dst[(*j)++] = '0';
        --size;
    }
    ...
    while(--i >= 0)
    1e72:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
    1e76:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    1e7a:	79 d5                	jns    1e51 <sprintint+0xb0>
        dst[(*j)++] = buf[i];
}
    1e7c:	90                   	nop
...
void sprintf(char * dst, char * fmt, ...)
{
    ...
    1e86:	83 ec 38             	sub    $0x38,%esp
    char *s;
    char buf[10];
    int bi = 0;
    1e89:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    int c, i, state, j;
    uint *ap;
    j = 0;
    1e90:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%ebp)
    
    state = 0;
    1e97:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    ap = (uint*)(void*)&fmt + 1;
    1e9e:	8d 45 0c             	lea    0xc(%ebp),%eax
    1ea1:	83 c0 04             	add    $0x4,%eax
    1ea4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(i = 0; fmt[i]; i++){
    1ea7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    1eae:	e9 d9 01 00 00       	jmp    208c <sprintf+0x209>
        c = fmt[i] & 0xff;
    1eb3:	8b 55 0c             	mov    0xc(%ebp),%edx
    1eb6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1eb9:	01 d0                	add    %edx,%eax
    1ebb:	0f b6 00             	movzbl (%eax),%eax
    1ebe:	0f be c0             	movsbl %al,%eax
    1ec1:	25 ff 00 00 00       	and    $0xff,%eax
    1ec6:	89 45 e0             	mov    %eax,-0x20(%ebp)
        if(state == 0){
    1ec9:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    1ecd:	75 2c                	jne    1efb <sprintf+0x78>
            if(c == '%'){
    1ecf:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    1ed3:	75 0c                	jne    1ee1 <sprintf+0x5e>
                state = '%';
    1ed5:	c7 45 e8 25 00 00 00 	movl   $0x25,-0x18(%ebp)
    1edc:	e9 a7 01 00 00       	jmp    2088 <sprintf+0x205>
            } else {
                dst[j++] = c;
    1ee1:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1ee4:	8d 50 01             	lea    0x1(%eax),%edx
    1ee7:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1eea:	89 c2                	mov    %eax,%edx
    1eec:	8b 45 08             	mov    0x8(%ebp),%eax
    1eef:	01 d0                	add    %edx,%eax
    1ef1:	8b 55 e0             	mov    -0x20(%ebp),%edx
    1ef4:	88 10                	mov    %dl,(%eax)
    1ef6:	e9 8d 01 00 00       	jmp    2088 <sprintf+0x205>
            }
        } else if(state == '%'){
    1efb:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    1eff:	0f 85 83 01 00 00    	jne    2088 <sprintf+0x205>
            if(c == 'd'){
    1f05:	83 7d e0 64          	cmpl   $0x64,-0x20(%ebp)
    1f09:	75 4c                	jne    1f57 <sprintf+0xd4>
                buf[bi] = '\0';
    1f0b:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f11:	01 d0                	add    %edx,%eax
    1f13:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f16:	83 ec 0c             	sub    $0xc,%esp
    1f19:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f1c:	50                   	push   %eax
    1f1d:	e8 17 e3 ff ff       	call   239 <atoi>
    1f22:	83 c4 10             	add    $0x10,%esp
    1f25:	89 45 d8             	mov    %eax,-0x28(%ebp)
                bi = 0;
    1f28:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 10, 1, l);
    1f2f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f32:	8b 00                	mov    (%eax),%eax
    1f34:	83 ec 08             	sub    $0x8,%esp
    1f37:	ff 75 d8             	pushl  -0x28(%ebp)
    1f3a:	6a 01                	push   $0x1
    1f3c:	6a 0a                	push   $0xa
    1f3e:	50                   	push   %eax
    1f3f:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1f42:	50                   	push   %eax
    1f43:	ff 75 08             	pushl  0x8(%ebp)
    1f46:	e8 56 fe ff ff       	call   1da1 <sprintint>
    1f4b:	83 c4 20             	add    $0x20,%esp
                ap++;
    1f4e:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    1f52:	e9 2a 01 00 00       	jmp    2081 <sprintf+0x1fe>
            } else if(c == 'x' || c == 'p'){
    1f57:	83 7d e0 78          	cmpl   $0x78,-0x20(%ebp)
    1f5b:	74 06                	je     1f63 <sprintf+0xe0>
    1f5d:	83 7d e0 70          	cmpl   $0x70,-0x20(%ebp)
    1f61:	75 4c                	jne    1faf <sprintf+0x12c>
                buf[bi] = '\0';
    1f63:	8d 55 ce             	lea    -0x32(%ebp),%edx
    1f66:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1f69:	01 d0                	add    %edx,%eax
    1f6b:	c6 00 00             	movb   $0x0,(%eax)
                int l = atoi(buf);
    1f6e:	83 ec 0c             	sub    $0xc,%esp
    1f71:	8d 45 ce             	lea    -0x32(%ebp),%eax
    1f74:	50                   	push   %eax
    1f75:	e8 bf e2 ff ff       	call   239 <atoi>
    1f7a:	83 c4 10             	add    $0x10,%esp
    1f7d:	89 45 dc             	mov    %eax,-0x24(%ebp)
                bi = 0;
    1f80:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
                sprintint(dst, &j, *ap, 16, 0, l);
    1f87:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1f8a:	8b 00                	mov    (%eax),%eax
    1f8c:	83 ec 08             	sub    $0x8,%esp
    1f8f:	ff 75 dc             	pushl  -0x24(%ebp)
    1f92:	6a 00                	push   $0x0
    1f94:	6a 10                	push   $0x10
    1f96:	50                   	push   %eax
    1f97:	8d 45 c8             	lea    -0x38(%ebp),%eax
    1f9a:	50                   	push   %eax
    1f9b:	ff 75 08             	pushl  0x8(%ebp)
    1f9e:	e8 fe fd ff ff       	call   1da1 <sprintint>
    1fa3:	83 c4 20             	add    $0x20,%esp
                ap++;
    ...
    1faa:	e9 d2 00 00 00       	jmp    2081 <sprintf+0x1fe>
                buf[bi] = '\0';
                int l = atoi(buf);
                bi = 0;
                sprintint(dst, &j, *ap, 16, 0, l);
    ...
    1faf:	83 7d e0 73          	cmpl   $0x73,-0x20(%ebp)
    1fb3:	75 46                	jne    1ffb <sprintf+0x178>
                s = (char*)*ap;
    1fb5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1fb8:	8b 00                	mov    (%eax),%eax
    1fba:	89 45 f4             	mov    %eax,-0xc(%ebp)
                ap++;
    1fbd:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
                if(s == 0)
    1fc1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fc5:	75 25                	jne    1fec <sprintf+0x169>
                    s = "(null)";
    1fc7:	c7 45 f4 54 22 00 00 	movl   $0x2254,-0xc(%ebp)
                while(*s != 0){
    1fce:	eb 1c                	jmp    1fec <sprintf+0x169>
                    dst[j++] = *s;
    1fd0:	8b 45 c8             	mov    -0x38(%ebp),%eax
    1fd3:	8d 50 01             	lea    0x1(%eax),%edx
    1fd6:	89 55 c8             	mov    %edx,-0x38(%ebp)
    1fd9:	89 c2                	mov    %eax,%edx
    ...
    1fe6:	88 02                	mov    %al,(%edx)
                    s++;
    1fe8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            } else if(c == 's'){
                s = (char*)*ap;
                ap++;
                if(s == 0)
                    s = "(null)";
                while(*s != 0){
    1fec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1fef:	0f b6 00             	movzbl (%eax),%eax
    1ff2:	84 c0                	test   %al,%al
    1ff4:	75 da                	jne    1fd0 <sprintf+0x14d>
    1ff6:	e9 86 00 00 00       	jmp    2081 <sprintf+0x1fe>
                    dst[j++] = *s;
                    s++;
                }
            } else if(c == 'c'){
    1ffb:	83 7d e0 63          	cmpl   $0x63,-0x20(%ebp)
    1fff:	75 1d                	jne    201e <sprintf+0x19b>
                dst[j++] = *ap;
    2001:	8b 45 c8             	mov    -0x38(%ebp),%eax
    2004:	8d 50 01             	lea    0x1(%eax),%edx
    2007:	89 55 c8             	mov    %edx,-0x38(%ebp)
    200a:	89 c2                	mov    %eax,%edx
    200c:	8b 45 08             	mov    0x8(%ebp),%eax
    200f:	01 c2                	add    %eax,%edx
    2011:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2014:	8b 00                	mov    (%eax),%eax
    2016:	88 02                	mov    %al,(%edx)
                ap++;
    2018:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
    201c:	eb 63                	jmp    2081 <sprintf+0x1fe>
            } else if(c == '%'){
    201e:	83 7d e0 25          	cmpl   $0x25,-0x20(%ebp)
    2022:	75 17                	jne    203b <sprintf+0x1b8>
                dst[j++] = c;
    ...
    2034:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2037:	88 10                	mov    %dl,(%eax)
    2039:	eb 46                	jmp    2081 <sprintf+0x1fe>
            } else if(c >= '0' && c <= '9')
    203b:	83 7d e0 2f          	cmpl   $0x2f,-0x20(%ebp)
    203f:	7e 18                	jle    2059 <sprintf+0x1d6>
    2041:	83 7d e0 39          	cmpl   $0x39,-0x20(%ebp)
    2045:	7f 12                	jg     2059 <sprintf+0x1d6>
            {
                buf[bi++] = c;
    2047:	8b 45 f0             	mov    -0x10(%ebp),%eax
    204a:	8d 50 01             	lea    0x1(%eax),%edx
    204d:	89 55 f0             	mov    %edx,-0x10(%ebp)
    2050:	8b 55 e0             	mov    -0x20(%ebp),%edx
    2053:	88 54 05 ce          	mov    %dl,-0x32(%ebp,%eax,1)
                continue;
    2057:	eb 2f                	jmp    2088 <sprintf+0x205>
            }
            else {
                // Unknown % sequence.  Print it to draw attention.
                dst[j++] = '%';
    2059:	8b 45 c8             	mov    -0x38(%ebp),%eax
    205c:	8d 50 01             	lea    0x1(%eax),%edx
    205f:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2062:	89 c2                	mov    %eax,%edx
    2064:	8b 45 08             	mov    0x8(%ebp),%eax
    2067:	01 d0                	add    %edx,%eax
    2069:	c6 00 25             	movb   $0x25,(%eax)
                dst[j++] = c;
    206c:	8b 45 c8             	mov    -0x38(%ebp),%eax
    206f:	8d 50 01             	lea    0x1(%eax),%edx
    2072:	89 55 c8             	mov    %edx,-0x38(%ebp)
    2075:	89 c2                	mov    %eax,%edx
    2077:	8b 45 08             	mov    0x8(%ebp),%eax
    207a:	01 d0                	add    %edx,%eax
    207c:	8b 55 e0             	mov    -0x20(%ebp),%edx
    207f:	88 10                	mov    %dl,(%eax)
            }
            state = 0;
    2081:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    uint *ap;
    j = 0;
    ...
    ap = (uint*)(void*)&fmt + 1;
    for(i = 0; fmt[i]; i++){
    2088:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    208c:	8b 55 0c             	mov    0xc(%ebp),%edx
    208f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2092:	01 d0                	add    %edx,%eax
    2094:	0f b6 00             	movzbl (%eax),%eax
    2097:	84 c0                	test   %al,%al
    2099:	0f 85 14 fe ff ff    	jne    1eb3 <sprintf+0x30>
                dst[j++] = c;
            }
            state = 0;
        }
    ...
    dst[j++] = '\0';
    209f:	8b 45 c8             	mov    -0x38(%ebp),%eax
    20a2:	8d 50 01             	lea    0x1(%eax),%edx
    20a5:	89 55 c8             	mov    %edx,-0x38(%ebp)
    20a8:	89 c2                	mov    %eax,%edx
    20aa:	8b 45 08             	mov    0x8(%ebp),%eax
    20ad:	01 d0                	add    %edx,%eax
    20af:	c6 00 00             	movb   $0x0,(%eax)
}
    20b2:	90                   	nop
    20b3:	c9                   	leave  
    20b4:	c3                   	ret    
